...
// checks if the CreateIamV2ApiKeyRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateIamV2ApiKeyRequest{}

// CreateIamV2ApiKeyRequest struct for CreateIamV2ApiKeyRequest
type CreateIamV2ApiKeyRequest struct {
	...
	Spec CreateIamV2ApiKeyRequestAllOf1Spec `json:"spec"`
}
...
func (o *CreateIamV2ApiKeyRequest) GetSpec() CreateIamV2ApiKeyRequestAllOf1Spec {
	if o == nil {
		var ret CreateIamV2ApiKeyRequestAllOf1Spec
		return ret
	}
...
func (o CreateIamV2ApiKeyRequest) MarshalJSON() ([]byte, error) {
...
func (o CreateIamV2ApiKeyRequest) ToMap() (map[string]interface{}, error) {
...
type NullableCreateIamV2ApiKeyRequest struct {
	value *CreateIamV2ApiKeyRequest
	isSet bool
}

func (v NullableCreateIamV2ApiKeyRequest) Get() *CreateIamV2ApiKeyRequest {
	return v.value
}

func (v *NullableCreateIamV2ApiKeyRequest) Set(val *CreateIamV2ApiKeyRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateIamV2ApiKeyRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateIamV2ApiKeyRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateIamV2ApiKeyRequest(val *CreateIamV2ApiKeyRequest) *NullableCreateIamV2ApiKeyRequest {
	return &NullableCreateIamV2ApiKeyRequest{value: val, isSet: true}
}

func (v NullableCreateIamV2ApiKeyRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateIamV2ApiKeyRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
