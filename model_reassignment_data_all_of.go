...
// checks if the ReassignmentDataAllOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ReassignmentDataAllOf{}
...
func (o ReassignmentDataAllOf) ToMap() (map[string]interface{}, error) {
