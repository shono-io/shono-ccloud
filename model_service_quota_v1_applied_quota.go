...
// checks if the ServiceQuotaV1AppliedQuota type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ServiceQuotaV1AppliedQuota{}
...
func (o ServiceQuotaV1AppliedQuota) ToMap() (map[string]interface{}, error) {
