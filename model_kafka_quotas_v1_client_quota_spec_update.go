...
// checks if the KafkaQuotasV1ClientQuotaSpecUpdate type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &KafkaQuotasV1ClientQuotaSpecUpdate{}
...
func (o KafkaQuotasV1ClientQuotaSpecUpdate) ToMap() (map[string]interface{}, error) {
