...
// checks if the GetIamV2User200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetIamV2User200Response{}

// GetIamV2User200Response struct for GetIamV2User200Response
type GetIamV2User200Response struct {
	...
	Id string `json:"id"`
	Metadata *IamV2UserMetadata `json:"metadata,omitempty"`
...
// SetMetadata gets a reference to the given IamV2UserMetadata and assigns it to the Metadata field.
...
func (o GetIamV2User200Response) MarshalJSON() ([]byte, error) {
...
func (o GetIamV2User200Response) ToMap() (map[string]interface{}, error) {
	...
	// skip: auth_type is readOnly
	return toSerialize, nil
}

type NullableGetIamV2User200Response struct {
	value *GetIamV2User200Response
	isSet bool
}

func (v NullableGetIamV2User200Response) Get() *GetIamV2User200Response {
	return v.value
}

func (v *NullableGetIamV2User200Response) Set(val *GetIamV2User200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetIamV2User200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetIamV2User200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetIamV2User200Response(val *GetIamV2User200Response) *NullableGetIamV2User200Response {
	return &NullableGetIamV2User200Response{value: val, isSet: true}
}

func (v NullableGetIamV2User200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetIamV2User200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
