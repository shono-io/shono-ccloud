...
// checks if the GetServiceQuotaV1AppliedQuota200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetServiceQuotaV1AppliedQuota200Response{}

// GetServiceQuotaV1AppliedQuota200Response struct for GetServiceQuotaV1AppliedQuota200Response
type GetServiceQuotaV1AppliedQuota200Response struct {
	...
	Id string `json:"id"`
	Metadata *ServiceQuotaV1AppliedQuotaMetadata `json:"metadata,omitempty"`
...
func NewGetServiceQuotaV1AppliedQuota200Response(apiVersion string, kind string, id string, scope string, displayName string, defaultLimit int32, appliedLimit int32) *GetServiceQuotaV1AppliedQuota200Response {
	this := GetServiceQuotaV1AppliedQuota200Response{}
...
// SetMetadata gets a reference to the given ServiceQuotaV1AppliedQuotaMetadata and assigns it to the Metadata field.
...
func (o GetServiceQuotaV1AppliedQuota200Response) MarshalJSON() ([]byte, error) {
...
func (o GetServiceQuotaV1AppliedQuota200Response) ToMap() (map[string]interface{}, error) {
...
type NullableGetServiceQuotaV1AppliedQuota200Response struct {
	value *GetServiceQuotaV1AppliedQuota200Response
	isSet bool
}

func (v NullableGetServiceQuotaV1AppliedQuota200Response) Get() *GetServiceQuotaV1AppliedQuota200Response {
	return v.value
}

func (v *NullableGetServiceQuotaV1AppliedQuota200Response) Set(val *GetServiceQuotaV1AppliedQuota200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetServiceQuotaV1AppliedQuota200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetServiceQuotaV1AppliedQuota200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetServiceQuotaV1AppliedQuota200Response(val *GetServiceQuotaV1AppliedQuota200Response) *NullableGetServiceQuotaV1AppliedQuota200Response {
	return &NullableGetServiceQuotaV1AppliedQuota200Response{value: val, isSet: true}
}

func (v NullableGetServiceQuotaV1AppliedQuota200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetServiceQuotaV1AppliedQuota200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
