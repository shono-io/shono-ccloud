...
// checks if the NetworkingV1TransitGatewayAttachmentListMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NetworkingV1TransitGatewayAttachmentListMetadata{}

// NetworkingV1TransitGatewayAttachmentListMetadata struct for NetworkingV1TransitGatewayAttachmentListMetadata
type NetworkingV1TransitGatewayAttachmentListMetadata struct {
...
func NewNetworkingV1TransitGatewayAttachmentListMetadata() *NetworkingV1TransitGatewayAttachmentListMetadata {
	this := NetworkingV1TransitGatewayAttachmentListMetadata{}
	return &this
}
...
func (o *NetworkingV1TransitGatewayAttachmentListMetadata) SetFirst(v interface{}) {
	o.First = v
}
...
func (o *NetworkingV1TransitGatewayAttachmentListMetadata) GetPrev() interface{} {
	if o == nil {
		var ret interface{}
		return ret
	}
...
func (o NetworkingV1TransitGatewayAttachmentListMetadata) MarshalJSON() ([]byte, error) {
...
func (o NetworkingV1TransitGatewayAttachmentListMetadata) ToMap() (map[string]interface{}, error) {
...
type NullableNetworkingV1TransitGatewayAttachmentListMetadata struct {
	value *NetworkingV1TransitGatewayAttachmentListMetadata
	isSet bool
}

func (v NullableNetworkingV1TransitGatewayAttachmentListMetadata) Get() *NetworkingV1TransitGatewayAttachmentListMetadata {
	return v.value
}

func (v *NullableNetworkingV1TransitGatewayAttachmentListMetadata) Set(val *NetworkingV1TransitGatewayAttachmentListMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableNetworkingV1TransitGatewayAttachmentListMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableNetworkingV1TransitGatewayAttachmentListMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNetworkingV1TransitGatewayAttachmentListMetadata(val *NetworkingV1TransitGatewayAttachmentListMetadata) *NullableNetworkingV1TransitGatewayAttachmentListMetadata {
	return &NullableNetworkingV1TransitGatewayAttachmentListMetadata{value: val, isSet: true}
}

func (v NullableNetworkingV1TransitGatewayAttachmentListMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNetworkingV1TransitGatewayAttachmentListMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
