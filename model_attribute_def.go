...
// checks if the AttributeDef type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AttributeDef{}
...
func (o *AttributeDef) GetValuesMinCount() int32 {
	if o == nil || IsNil(o.ValuesMinCount) {
		var ret int32
		return ret
	}
...
func (o *AttributeDef) GetValuesMaxCount() int32 {
	if o == nil || IsNil(o.ValuesMaxCount) {
		var ret int32
		return ret
	}
...
func (o *AttributeDef) GetIncludeInNotification() bool {
	if o == nil || IsNil(o.IncludeInNotification) {
		var ret bool
		return ret
	}
...
func (o AttributeDef) ToMap() (map[string]interface{}, error) {
