...
// checks if the UpdateKafkaQuotasV1ClientQuotaRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateKafkaQuotasV1ClientQuotaRequest{}

// UpdateKafkaQuotasV1ClientQuotaRequest struct for UpdateKafkaQuotasV1ClientQuotaRequest
type UpdateKafkaQuotasV1ClientQuotaRequest struct {
...
func NewUpdateKafkaQuotasV1ClientQuotaRequest(spec UpdateCmkV2ClusterRequestAllOfSpec) *UpdateKafkaQuotasV1ClientQuotaRequest {
	this := UpdateKafkaQuotasV1ClientQuotaRequest{}
	this.Spec = spec
	return &this
}
...
func (o UpdateKafkaQuotasV1ClientQuotaRequest) MarshalJSON() ([]byte, error) {
...
func (o UpdateKafkaQuotasV1ClientQuotaRequest) ToMap() (map[string]interface{}, error) {
...
type NullableUpdateKafkaQuotasV1ClientQuotaRequest struct {
	value *UpdateKafkaQuotasV1ClientQuotaRequest
	isSet bool
}

func (v NullableUpdateKafkaQuotasV1ClientQuotaRequest) Get() *UpdateKafkaQuotasV1ClientQuotaRequest {
	return v.value
}

func (v *NullableUpdateKafkaQuotasV1ClientQuotaRequest) Set(val *UpdateKafkaQuotasV1ClientQuotaRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdateKafkaQuotasV1ClientQuotaRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableUpdateKafkaQuotasV1ClientQuotaRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpdateKafkaQuotasV1ClientQuotaRequest(val *UpdateKafkaQuotasV1ClientQuotaRequest) *NullableUpdateKafkaQuotasV1ClientQuotaRequest {
	return &NullableUpdateKafkaQuotasV1ClientQuotaRequest{value: val, isSet: true}
}

func (v NullableUpdateKafkaQuotasV1ClientQuotaRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpdateKafkaQuotasV1ClientQuotaRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
