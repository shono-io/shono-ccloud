...
// checks if the AclDataAllOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AclDataAllOf{}
...
func (o AclDataAllOf) ToMap() (map[string]interface{}, error) {
