...
------------ | ------------- | ------------- | -------------
**Data** | [**[]AlterConfigBatchRequestDataDataInner**](AlterConfigBatchRequestDataDataInner.md) |  | 
...
`func NewAlterConfigBatchRequestData(data []AlterConfigBatchRequestDataDataInner, ) *AlterConfigBatchRequestData`
...
`func (o *AlterConfigBatchRequestData) GetData() []AlterConfigBatchRequestDataDataInner`

GetData returns the Data field if non-nil, zero value otherwise.

### GetDataOk

`func (o *AlterConfigBatchRequestData) GetDataOk() (*[]AlterConfigBatchRequestDataDataInner, bool)`
...
`func (o *AlterConfigBatchRequestData) SetData(v []AlterConfigBatchRequestDataDataInner)`
