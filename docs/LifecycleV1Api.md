...
func main() {
    ...
    r, err := apiClient.LifecycleV1Api.PauseConnectv1Connector(context.Background(), connectorName, environmentId, kafkaClusterId).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    r, err := apiClient.LifecycleV1Api.ResumeConnectv1Connector(context.Background(), connectorName, environmentId, kafkaClusterId).Execute()
    if err != nil {
