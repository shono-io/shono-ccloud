...
// checks if the KafkaQuotasV1ClientQuotaListMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &KafkaQuotasV1ClientQuotaListMetadata{}

// KafkaQuotasV1ClientQuotaListMetadata struct for KafkaQuotasV1ClientQuotaListMetadata
type KafkaQuotasV1ClientQuotaListMetadata struct {
...
func NewKafkaQuotasV1ClientQuotaListMetadata() *KafkaQuotasV1ClientQuotaListMetadata {
	this := KafkaQuotasV1ClientQuotaListMetadata{}
	return &this
}
...
func (o KafkaQuotasV1ClientQuotaListMetadata) MarshalJSON() ([]byte, error) {
...
func (o KafkaQuotasV1ClientQuotaListMetadata) ToMap() (map[string]interface{}, error) {
...
type NullableKafkaQuotasV1ClientQuotaListMetadata struct {
	value *KafkaQuotasV1ClientQuotaListMetadata
	isSet bool
}

func (v NullableKafkaQuotasV1ClientQuotaListMetadata) Get() *KafkaQuotasV1ClientQuotaListMetadata {
	return v.value
}

func (v *NullableKafkaQuotasV1ClientQuotaListMetadata) Set(val *KafkaQuotasV1ClientQuotaListMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableKafkaQuotasV1ClientQuotaListMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableKafkaQuotasV1ClientQuotaListMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableKafkaQuotasV1ClientQuotaListMetadata(val *KafkaQuotasV1ClientQuotaListMetadata) *NullableKafkaQuotasV1ClientQuotaListMetadata {
	return &NullableKafkaQuotasV1ClientQuotaListMetadata{value: val, isSet: true}
}

func (v NullableKafkaQuotasV1ClientQuotaListMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableKafkaQuotasV1ClientQuotaListMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
