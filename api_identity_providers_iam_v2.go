...
type ApiCreateIamV2IdentityProviderRequest struct {
	ctx context.Context
	ApiService *IdentityProvidersIamV2ApiService
	createIamV2IdentityProviderRequest *CreateIamV2IdentityProviderRequest
}

func (r ApiCreateIamV2IdentityProviderRequest) CreateIamV2IdentityProviderRequest(createIamV2IdentityProviderRequest CreateIamV2IdentityProviderRequest) ApiCreateIamV2IdentityProviderRequest {
	r.createIamV2IdentityProviderRequest = &createIamV2IdentityProviderRequest
	return r
}

func (r ApiCreateIamV2IdentityProviderRequest) Execute() (*CreateIamV2IdentityProviderRequest, *http.Response, error) {
...
*/
func (a *IdentityProvidersIamV2ApiService) CreateIamV2IdentityProvider(ctx context.Context) ApiCreateIamV2IdentityProviderRequest {
	return ApiCreateIamV2IdentityProviderRequest{
		ApiService: a,
		ctx: ctx,
	}
...
//  @return CreateIamV2IdentityProviderRequest
func (a *IdentityProvidersIamV2ApiService) CreateIamV2IdentityProviderExecute(r ApiCreateIamV2IdentityProviderRequest) (*CreateIamV2IdentityProviderRequest, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *CreateIamV2IdentityProviderRequest
	)
	...
	// body params
	localVarPostBody = r.createIamV2IdentityProviderRequest
...
func (r ApiDeleteIamV2IdentityProviderRequest) Execute() (*http.Response, error) {
...
*/
func (a *IdentityProvidersIamV2ApiService) DeleteIamV2IdentityProvider(ctx context.Context, id string) ApiDeleteIamV2IdentityProviderRequest {
	return ApiDeleteIamV2IdentityProviderRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
func (a *IdentityProvidersIamV2ApiService) DeleteIamV2IdentityProviderExecute(r ApiDeleteIamV2IdentityProviderRequest) (*http.Response, error) {
	var (
...
func (r ApiGetIamV2IdentityProviderRequest) Execute() (*GetIamV2IdentityProvider200Response, *http.Response, error) {
...
*/
func (a *IdentityProvidersIamV2ApiService) GetIamV2IdentityProvider(ctx context.Context, id string) ApiGetIamV2IdentityProviderRequest {
	return ApiGetIamV2IdentityProviderRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
//  @return GetIamV2IdentityProvider200Response
func (a *IdentityProvidersIamV2ApiService) GetIamV2IdentityProviderExecute(r ApiGetIamV2IdentityProviderRequest) (*GetIamV2IdentityProvider200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *GetIamV2IdentityProvider200Response
	)
...
func (r ApiListIamV2IdentityProvidersRequest) Execute() (*ListIamV2IdentityProviders200Response, *http.Response, error) {
...
*/
func (a *IdentityProvidersIamV2ApiService) ListIamV2IdentityProviders(ctx context.Context) ApiListIamV2IdentityProvidersRequest {
	return ApiListIamV2IdentityProvidersRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return ListIamV2IdentityProviders200Response
func (a *IdentityProvidersIamV2ApiService) ListIamV2IdentityProvidersExecute(r ApiListIamV2IdentityProvidersRequest) (*ListIamV2IdentityProviders200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *ListIamV2IdentityProviders200Response
	)
...
func (r ApiUpdateIamV2IdentityProviderRequest) Execute() (*GetIamV2IdentityProvider200Response, *http.Response, error) {
...
*/
func (a *IdentityProvidersIamV2ApiService) UpdateIamV2IdentityProvider(ctx context.Context, id string) ApiUpdateIamV2IdentityProviderRequest {
	return ApiUpdateIamV2IdentityProviderRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
//  @return GetIamV2IdentityProvider200Response
func (a *IdentityProvidersIamV2ApiService) UpdateIamV2IdentityProviderExecute(r ApiUpdateIamV2IdentityProviderRequest) (*GetIamV2IdentityProvider200Response, *http.Response, error) {
	var (
