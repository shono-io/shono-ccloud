...
// checks if the SrcmV2ClusterListMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SrcmV2ClusterListMetadata{}

// SrcmV2ClusterListMetadata struct for SrcmV2ClusterListMetadata
type SrcmV2ClusterListMetadata struct {
...
func NewSrcmV2ClusterListMetadata() *SrcmV2ClusterListMetadata {
	this := SrcmV2ClusterListMetadata{}
	return &this
}
...
func (o *SrcmV2ClusterListMetadata) HasFirst() bool {
	if o != nil && IsNil(o.First) {
		return true
	}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *SrcmV2ClusterListMetadata) GetPrevOk() (*interface{}, bool) {
...
func (o SrcmV2ClusterListMetadata) MarshalJSON() ([]byte, error) {
...
func (o SrcmV2ClusterListMetadata) ToMap() (map[string]interface{}, error) {
...
type NullableSrcmV2ClusterListMetadata struct {
	value *SrcmV2ClusterListMetadata
	isSet bool
}

func (v NullableSrcmV2ClusterListMetadata) Get() *SrcmV2ClusterListMetadata {
	return v.value
}

func (v *NullableSrcmV2ClusterListMetadata) Set(val *SrcmV2ClusterListMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableSrcmV2ClusterListMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableSrcmV2ClusterListMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSrcmV2ClusterListMetadata(val *SrcmV2ClusterListMetadata) *NullableSrcmV2ClusterListMetadata {
	return &NullableSrcmV2ClusterListMetadata{value: val, isSet: true}
}

func (v NullableSrcmV2ClusterListMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSrcmV2ClusterListMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
