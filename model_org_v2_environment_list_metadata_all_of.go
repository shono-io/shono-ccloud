...
// checks if the OrgV2EnvironmentListMetadataAllOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OrgV2EnvironmentListMetadataAllOf{}

// OrgV2EnvironmentListMetadataAllOf struct for OrgV2EnvironmentListMetadataAllOf
type OrgV2EnvironmentListMetadataAllOf struct {
...
func NewOrgV2EnvironmentListMetadataAllOf() *OrgV2EnvironmentListMetadataAllOf {
	this := OrgV2EnvironmentListMetadataAllOf{}
	return &this
}
...
func (o OrgV2EnvironmentListMetadataAllOf) MarshalJSON() ([]byte, error) {
...
func (o OrgV2EnvironmentListMetadataAllOf) ToMap() (map[string]interface{}, error) {
...
type NullableOrgV2EnvironmentListMetadataAllOf struct {
	value *OrgV2EnvironmentListMetadataAllOf
	isSet bool
}

func (v NullableOrgV2EnvironmentListMetadataAllOf) Get() *OrgV2EnvironmentListMetadataAllOf {
	return v.value
}

func (v *NullableOrgV2EnvironmentListMetadataAllOf) Set(val *OrgV2EnvironmentListMetadataAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableOrgV2EnvironmentListMetadataAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableOrgV2EnvironmentListMetadataAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOrgV2EnvironmentListMetadataAllOf(val *OrgV2EnvironmentListMetadataAllOf) *NullableOrgV2EnvironmentListMetadataAllOf {
	return &NullableOrgV2EnvironmentListMetadataAllOf{value: val, isSet: true}
}

func (v NullableOrgV2EnvironmentListMetadataAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOrgV2EnvironmentListMetadataAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
