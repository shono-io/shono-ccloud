...
// checks if the TagDefResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TagDefResponse{}
...
func (o *TagDefResponse) GetAttributeDefs() []AttributeDef {
	if o == nil || IsNil(o.AttributeDefs) {
...
func (o TagDefResponse) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.AttributeDefs) {
		toSerialize["attributeDefs"] = o.AttributeDefs
	}
	if !IsNil(o.SuperTypes) {
