...
// checks if the GetSrcmV2Region200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetSrcmV2Region200Response{}

// GetSrcmV2Region200Response struct for GetSrcmV2Region200Response
type GetSrcmV2Region200Response struct {
	...
	Id string `json:"id"`
	Metadata *SrcmV2RegionMetadata `json:"metadata,omitempty"`
...
func NewGetSrcmV2Region200Response(apiVersion string, kind string, id string, spec map[string]interface{}) *GetSrcmV2Region200Response {
	this := GetSrcmV2Region200Response{}
...
// SetMetadata gets a reference to the given SrcmV2RegionMetadata and assigns it to the Metadata field.
...
func (o GetSrcmV2Region200Response) MarshalJSON() ([]byte, error) {
...
func (o GetSrcmV2Region200Response) ToMap() (map[string]interface{}, error) {
...
type NullableGetSrcmV2Region200Response struct {
	value *GetSrcmV2Region200Response
	isSet bool
}

func (v NullableGetSrcmV2Region200Response) Get() *GetSrcmV2Region200Response {
	return v.value
}

func (v *NullableGetSrcmV2Region200Response) Set(val *GetSrcmV2Region200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetSrcmV2Region200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetSrcmV2Region200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetSrcmV2Region200Response(val *GetSrcmV2Region200Response) *NullableGetSrcmV2Region200Response {
	return &NullableGetSrcmV2Region200Response{value: val, isSet: true}
}

func (v NullableGetSrcmV2Region200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetSrcmV2Region200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
