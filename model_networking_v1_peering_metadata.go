...
// checks if the NetworkingV1PeeringMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NetworkingV1PeeringMetadata{}

// NetworkingV1PeeringMetadata struct for NetworkingV1PeeringMetadata
type NetworkingV1PeeringMetadata struct {
...
func NewNetworkingV1PeeringMetadata(self interface{}) *NetworkingV1PeeringMetadata {
	this := NetworkingV1PeeringMetadata{}
	this.Self = self
	return &this
}
...
func (o NetworkingV1PeeringMetadata) MarshalJSON() ([]byte, error) {
...
func (o NetworkingV1PeeringMetadata) ToMap() (map[string]interface{}, error) {
...
type NullableNetworkingV1PeeringMetadata struct {
	value *NetworkingV1PeeringMetadata
	isSet bool
}

func (v NullableNetworkingV1PeeringMetadata) Get() *NetworkingV1PeeringMetadata {
	return v.value
}

func (v *NullableNetworkingV1PeeringMetadata) Set(val *NetworkingV1PeeringMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableNetworkingV1PeeringMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableNetworkingV1PeeringMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNetworkingV1PeeringMetadata(val *NetworkingV1PeeringMetadata) *NullableNetworkingV1PeeringMetadata {
	return &NullableNetworkingV1PeeringMetadata{value: val, isSet: true}
}

func (v NullableNetworkingV1PeeringMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNetworkingV1PeeringMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
