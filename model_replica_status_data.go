...
// checks if the ReplicaStatusData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ReplicaStatusData{}
...
func (o ReplicaStatusData) ToMap() (map[string]interface{}, error) {
