...
// checks if the CreateOrgV2EnvironmentRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateOrgV2EnvironmentRequest{}

// CreateOrgV2EnvironmentRequest struct for CreateOrgV2EnvironmentRequest
type CreateOrgV2EnvironmentRequest struct {
...
func NewCreateOrgV2EnvironmentRequest(displayName string) *CreateOrgV2EnvironmentRequest {
	this := CreateOrgV2EnvironmentRequest{}
...
func (o CreateOrgV2EnvironmentRequest) MarshalJSON() ([]byte, error) {
...
func (o CreateOrgV2EnvironmentRequest) ToMap() (map[string]interface{}, error) {
...
type NullableCreateOrgV2EnvironmentRequest struct {
	value *CreateOrgV2EnvironmentRequest
	isSet bool
}

func (v NullableCreateOrgV2EnvironmentRequest) Get() *CreateOrgV2EnvironmentRequest {
	return v.value
}

func (v *NullableCreateOrgV2EnvironmentRequest) Set(val *CreateOrgV2EnvironmentRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateOrgV2EnvironmentRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateOrgV2EnvironmentRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateOrgV2EnvironmentRequest(val *CreateOrgV2EnvironmentRequest) *NullableCreateOrgV2EnvironmentRequest {
	return &NullableCreateOrgV2EnvironmentRequest{value: val, isSet: true}
}

func (v NullableCreateOrgV2EnvironmentRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateOrgV2EnvironmentRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
