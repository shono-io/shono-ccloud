...
// checks if the NetworkingV1NetworkLinkServiceSpec type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NetworkingV1NetworkLinkServiceSpec{}
...
type NetworkingV1NetworkLinkServiceSpec struct {
	...
	Accept *NetworkingV1NetworkLinkServiceSpecAccept `json:"accept,omitempty"`
...
func (o *NetworkingV1NetworkLinkServiceSpec) GetAccept() NetworkingV1NetworkLinkServiceSpecAccept {
	if o == nil || IsNil(o.Accept) {
		var ret NetworkingV1NetworkLinkServiceSpecAccept
		return ret
	}
	return *o.Accept
}
...
// SetAccept gets a reference to the given NetworkingV1NetworkLinkServiceSpecAccept and assigns it to the Accept field.
...
func (o NetworkingV1NetworkLinkServiceSpec) ToMap() (map[string]interface{}, error) {
