...
type ApiGetServiceQuotaV1AppliedQuotaRequest struct {
	ctx context.Context
	ApiService *AppliedQuotasServiceQuotaV1ApiService
	id string
	environment *string
	network *string
	kafkaCluster *string
...
func (r ApiGetServiceQuotaV1AppliedQuotaRequest) Execute() (*GetServiceQuotaV1AppliedQuota200Response, *http.Response, error) {
...
*/
func (a *AppliedQuotasServiceQuotaV1ApiService) GetServiceQuotaV1AppliedQuota(ctx context.Context, id string) ApiGetServiceQuotaV1AppliedQuotaRequest {
	return ApiGetServiceQuotaV1AppliedQuotaRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
//  @return GetServiceQuotaV1AppliedQuota200Response
func (a *AppliedQuotasServiceQuotaV1ApiService) GetServiceQuotaV1AppliedQuotaExecute(r ApiGetServiceQuotaV1AppliedQuotaRequest) (*GetServiceQuotaV1AppliedQuota200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *GetServiceQuotaV1AppliedQuota200Response
	)
	...
	if r.kafkaCluster != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "kafka_cluster", r.kafkaCluster, "")
	}
...
func (r ApiListServiceQuotaV1AppliedQuotasRequest) Execute() (*ListServiceQuotaV1AppliedQuotas200Response, *http.Response, error) {
...
*/
func (a *AppliedQuotasServiceQuotaV1ApiService) ListServiceQuotaV1AppliedQuotas(ctx context.Context) ApiListServiceQuotaV1AppliedQuotasRequest {
	return ApiListServiceQuotaV1AppliedQuotasRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return ListServiceQuotaV1AppliedQuotas200Response
func (a *AppliedQuotasServiceQuotaV1ApiService) ListServiceQuotaV1AppliedQuotasExecute(r ApiListServiceQuotaV1AppliedQuotasRequest) (*ListServiceQuotaV1AppliedQuotas200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *ListServiceQuotaV1AppliedQuotas200Response
	)
