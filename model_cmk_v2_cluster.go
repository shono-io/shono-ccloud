...
// checks if the CmkV2Cluster type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CmkV2Cluster{}
...
func (o *CmkV2Cluster) GetMetadata() CmkV2ClusterMetadata {
...
// and a boolean to check if the value has been set.
func (o *CmkV2Cluster) GetMetadataOk() (*CmkV2ClusterMetadata, bool) {
	if o == nil || IsNil(o.Metadata) {
		return nil, false
	}
...
func (o *CmkV2Cluster) SetMetadata(v CmkV2ClusterMetadata) {
	o.Metadata = &v
}
...
func (o CmkV2Cluster) ToMap() (map[string]interface{}, error) {
