...
// checks if the CreateSdV1Pipeline202Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateSdV1Pipeline202Response{}

// CreateSdV1Pipeline202Response struct for CreateSdV1Pipeline202Response
type CreateSdV1Pipeline202Response struct {
	...
	Metadata *SdV1PipelineMetadata `json:"metadata,omitempty"`
	Spec ListSdV1Pipelines200ResponseAllOfDataInnerSpec `json:"spec"`
...
func NewCreateSdV1Pipeline202Response(spec ListSdV1Pipelines200ResponseAllOfDataInnerSpec) *CreateSdV1Pipeline202Response {
	this := CreateSdV1Pipeline202Response{}
	this.Spec = spec
	return &this
}
...
// SetMetadata gets a reference to the given SdV1PipelineMetadata and assigns it to the Metadata field.
...
func (o *CreateSdV1Pipeline202Response) GetSpec() ListSdV1Pipelines200ResponseAllOfDataInnerSpec {
	if o == nil {
		var ret ListSdV1Pipelines200ResponseAllOfDataInnerSpec
		return ret
	}
...
func (o CreateSdV1Pipeline202Response) MarshalJSON() ([]byte, error) {
...
func (o CreateSdV1Pipeline202Response) ToMap() (map[string]interface{}, error) {
...
type NullableCreateSdV1Pipeline202Response struct {
	value *CreateSdV1Pipeline202Response
	isSet bool
}

func (v NullableCreateSdV1Pipeline202Response) Get() *CreateSdV1Pipeline202Response {
	return v.value
}

func (v *NullableCreateSdV1Pipeline202Response) Set(val *CreateSdV1Pipeline202Response) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateSdV1Pipeline202Response) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateSdV1Pipeline202Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateSdV1Pipeline202Response(val *CreateSdV1Pipeline202Response) *NullableCreateSdV1Pipeline202Response {
	return &NullableCreateSdV1Pipeline202Response{value: val, isSet: true}
}

func (v NullableCreateSdV1Pipeline202Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateSdV1Pipeline202Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
