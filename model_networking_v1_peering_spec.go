...
// checks if the NetworkingV1PeeringSpec type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NetworkingV1PeeringSpec{}

// NetworkingV1PeeringSpec The desired state of the Peering
type NetworkingV1PeeringSpec struct {
	// The name of the peering
	DisplayName *string `json:"display_name,omitempty"`
	Cloud *NetworkingV1PeeringSpecCloud `json:"cloud,omitempty"`
...
func (o *NetworkingV1PeeringSpec) GetCloud() NetworkingV1PeeringSpecCloud {
	if o == nil || IsNil(o.Cloud) {
		var ret NetworkingV1PeeringSpecCloud
		return ret
	}
	return *o.Cloud
}
...
// SetCloud gets a reference to the given NetworkingV1PeeringSpecCloud and assigns it to the Cloud field.
...
func (o NetworkingV1PeeringSpec) ToMap() (map[string]interface{}, error) {
