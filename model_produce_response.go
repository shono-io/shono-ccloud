...
// checks if the ProduceResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProduceResponse{}
...
func (o ProduceResponse) ToMap() (map[string]interface{}, error) {
