...
// checks if the CmkV2ClusterMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CmkV2ClusterMetadata{}

// CmkV2ClusterMetadata struct for CmkV2ClusterMetadata
type CmkV2ClusterMetadata struct {
...
func (o CmkV2ClusterMetadata) MarshalJSON() ([]byte, error) {
...
func (o CmkV2ClusterMetadata) ToMap() (map[string]interface{}, error) {
...
type NullableCmkV2ClusterMetadata struct {
	value *CmkV2ClusterMetadata
	isSet bool
}

func (v NullableCmkV2ClusterMetadata) Get() *CmkV2ClusterMetadata {
	return v.value
}

func (v *NullableCmkV2ClusterMetadata) Set(val *CmkV2ClusterMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableCmkV2ClusterMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableCmkV2ClusterMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCmkV2ClusterMetadata(val *CmkV2ClusterMetadata) *NullableCmkV2ClusterMetadata {
	return &NullableCmkV2ClusterMetadata{value: val, isSet: true}
}

func (v NullableCmkV2ClusterMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCmkV2ClusterMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
