...
// checks if the AclData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AclData{}
...
func (o AclData) ToMap() (map[string]interface{}, error) {
