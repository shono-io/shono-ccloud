...
// checks if the TagDef type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TagDef{}
...
func (o TagDef) ToMap() (map[string]interface{}, error) {
