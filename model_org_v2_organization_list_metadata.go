...
// checks if the OrgV2OrganizationListMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OrgV2OrganizationListMetadata{}

// OrgV2OrganizationListMetadata struct for OrgV2OrganizationListMetadata
type OrgV2OrganizationListMetadata struct {
...
func NewOrgV2OrganizationListMetadata() *OrgV2OrganizationListMetadata {
	this := OrgV2OrganizationListMetadata{}
	return &this
}
...
func (o OrgV2OrganizationListMetadata) MarshalJSON() ([]byte, error) {
...
func (o OrgV2OrganizationListMetadata) ToMap() (map[string]interface{}, error) {
...
type NullableOrgV2OrganizationListMetadata struct {
	value *OrgV2OrganizationListMetadata
	isSet bool
}

func (v NullableOrgV2OrganizationListMetadata) Get() *OrgV2OrganizationListMetadata {
	return v.value
}

func (v *NullableOrgV2OrganizationListMetadata) Set(val *OrgV2OrganizationListMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableOrgV2OrganizationListMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableOrgV2OrganizationListMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOrgV2OrganizationListMetadata(val *OrgV2OrganizationListMetadata) *NullableOrgV2OrganizationListMetadata {
	return &NullableOrgV2OrganizationListMetadata{value: val, isSet: true}
}

func (v NullableOrgV2OrganizationListMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOrgV2OrganizationListMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
