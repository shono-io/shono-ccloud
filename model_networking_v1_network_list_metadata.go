...
// checks if the NetworkingV1NetworkListMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NetworkingV1NetworkListMetadata{}

// NetworkingV1NetworkListMetadata struct for NetworkingV1NetworkListMetadata
type NetworkingV1NetworkListMetadata struct {
...
func NewNetworkingV1NetworkListMetadata() *NetworkingV1NetworkListMetadata {
	this := NetworkingV1NetworkListMetadata{}
	return &this
}
...
func (o NetworkingV1NetworkListMetadata) MarshalJSON() ([]byte, error) {
...
func (o NetworkingV1NetworkListMetadata) ToMap() (map[string]interface{}, error) {
...
type NullableNetworkingV1NetworkListMetadata struct {
	value *NetworkingV1NetworkListMetadata
	isSet bool
}

func (v NullableNetworkingV1NetworkListMetadata) Get() *NetworkingV1NetworkListMetadata {
	return v.value
}

func (v *NullableNetworkingV1NetworkListMetadata) Set(val *NetworkingV1NetworkListMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableNetworkingV1NetworkListMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableNetworkingV1NetworkListMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNetworkingV1NetworkListMetadata(val *NetworkingV1NetworkListMetadata) *NullableNetworkingV1NetworkListMetadata {
	return &NullableNetworkingV1NetworkListMetadata{value: val, isSet: true}
}

func (v NullableNetworkingV1NetworkListMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNetworkingV1NetworkListMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
