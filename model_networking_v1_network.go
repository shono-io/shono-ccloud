...
// checks if the NetworkingV1Network type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NetworkingV1Network{}
...
func (o NetworkingV1Network) ToMap() (map[string]interface{}, error) {
