...
// checks if the UpdateNetworkingV1PrivateLinkAccessRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateNetworkingV1PrivateLinkAccessRequest{}

// UpdateNetworkingV1PrivateLinkAccessRequest struct for UpdateNetworkingV1PrivateLinkAccessRequest
type UpdateNetworkingV1PrivateLinkAccessRequest struct {
...
func NewUpdateNetworkingV1PrivateLinkAccessRequest(spec UpdateCmkV2ClusterRequestAllOfSpec) *UpdateNetworkingV1PrivateLinkAccessRequest {
	this := UpdateNetworkingV1PrivateLinkAccessRequest{}
	this.Spec = spec
	return &this
}
...
func (o UpdateNetworkingV1PrivateLinkAccessRequest) MarshalJSON() ([]byte, error) {
...
func (o UpdateNetworkingV1PrivateLinkAccessRequest) ToMap() (map[string]interface{}, error) {
...
type NullableUpdateNetworkingV1PrivateLinkAccessRequest struct {
	value *UpdateNetworkingV1PrivateLinkAccessRequest
	isSet bool
}

func (v NullableUpdateNetworkingV1PrivateLinkAccessRequest) Get() *UpdateNetworkingV1PrivateLinkAccessRequest {
	return v.value
}

func (v *NullableUpdateNetworkingV1PrivateLinkAccessRequest) Set(val *UpdateNetworkingV1PrivateLinkAccessRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdateNetworkingV1PrivateLinkAccessRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableUpdateNetworkingV1PrivateLinkAccessRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpdateNetworkingV1PrivateLinkAccessRequest(val *UpdateNetworkingV1PrivateLinkAccessRequest) *NullableUpdateNetworkingV1PrivateLinkAccessRequest {
	return &NullableUpdateNetworkingV1PrivateLinkAccessRequest{value: val, isSet: true}
}

func (v NullableUpdateNetworkingV1PrivateLinkAccessRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpdateNetworkingV1PrivateLinkAccessRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
