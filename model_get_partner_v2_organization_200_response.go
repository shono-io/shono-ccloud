...
// checks if the GetPartnerV2Organization200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetPartnerV2Organization200Response{}

// GetPartnerV2Organization200Response struct for GetPartnerV2Organization200Response
type GetPartnerV2Organization200Response struct {
	...
	SsoConfig *PartnerV2OrganizationSsoConfig `json:"sso_config,omitempty"`
}
...
func NewGetPartnerV2Organization200Response(apiVersion string, kind string, id string, metadata ObjectMeta) *GetPartnerV2Organization200Response {
	this := GetPartnerV2Organization200Response{}
...
func (o *GetPartnerV2Organization200Response) GetApiVersionOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
// and a boolean to check if the value has been set.
func (o *GetPartnerV2Organization200Response) GetMetadataOk() (*ObjectMeta, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *GetPartnerV2Organization200Response) HasSsoUrl() bool {
	if o != nil && !IsNil(o.SsoUrl) {
		return true
	}
...
func (o *GetPartnerV2Organization200Response) GetSsoConfig() PartnerV2OrganizationSsoConfig {
	if o == nil || IsNil(o.SsoConfig) {
		var ret PartnerV2OrganizationSsoConfig
		return ret
	}
	return *o.SsoConfig
}
...
// SetSsoConfig gets a reference to the given PartnerV2OrganizationSsoConfig and assigns it to the SsoConfig field.
func (o *GetPartnerV2Organization200Response) SetSsoConfig(v PartnerV2OrganizationSsoConfig) {
	o.SsoConfig = &v
}

func (o GetPartnerV2Organization200Response) MarshalJSON() ([]byte, error) {
...
func (o GetPartnerV2Organization200Response) ToMap() (map[string]interface{}, error) {
	...
	// skip: sso_url is readOnly
	if !IsNil(o.SsoConfig) {
		toSerialize["sso_config"] = o.SsoConfig
	}
	return toSerialize, nil
}

type NullableGetPartnerV2Organization200Response struct {
	value *GetPartnerV2Organization200Response
	isSet bool
}

func (v NullableGetPartnerV2Organization200Response) Get() *GetPartnerV2Organization200Response {
	return v.value
}

func (v *NullableGetPartnerV2Organization200Response) Set(val *GetPartnerV2Organization200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetPartnerV2Organization200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetPartnerV2Organization200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetPartnerV2Organization200Response(val *GetPartnerV2Organization200Response) *NullableGetPartnerV2Organization200Response {
	return &NullableGetPartnerV2Organization200Response{value: val, isSet: true}
}

func (v NullableGetPartnerV2Organization200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetPartnerV2Organization200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
