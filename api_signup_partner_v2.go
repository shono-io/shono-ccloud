...
func (r ApiActivateSignupRequest) Execute() (*PartnerSignupResponse, *http.Response, error) {
	return r.ApiService.ActivateSignupExecute(r)
}
...
*/
func (a *SignupPartnerV2ApiService) ActivateSignup(ctx context.Context) ApiActivateSignupRequest {
	return ApiActivateSignupRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *SignupPartnerV2ApiService) ActivateSignupExecute(r ApiActivateSignupRequest) (*PartnerSignupResponse, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SignupPartnerV2ApiService.ActivateSignup")
	if err != nil {
...
func (r ApiSignupRequest) DryRun(dryRun bool) ApiSignupRequest {
	r.dryRun = &dryRun
	return r
}
...
func (r ApiSignupRequest) Execute() (*PartnerSignupResponse, *http.Response, error) {
...
*/
func (a *SignupPartnerV2ApiService) Signup(ctx context.Context) ApiSignupRequest {
	return ApiSignupRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return PartnerSignupResponse
func (a *SignupPartnerV2ApiService) SignupExecute(r ApiSignupRequest) (*PartnerSignupResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SignupPartnerV2ApiService.Signup")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiSignupPartnerV2LinkRequest struct {
	ctx context.Context
	ApiService *SignupPartnerV2ApiService
	dryRun *bool
...
// If true, only perform validation of signup
func (r ApiSignupPartnerV2LinkRequest) DryRun(dryRun bool) ApiSignupPartnerV2LinkRequest {
	r.dryRun = &dryRun
	return r
}

// A JSON object containing signup information
func (r ApiSignupPartnerV2LinkRequest) PartnerLinkRequest(partnerLinkRequest PartnerLinkRequest) ApiSignupPartnerV2LinkRequest {
	r.partnerLinkRequest = &partnerLinkRequest
	return r
}

func (r ApiSignupPartnerV2LinkRequest) Execute() (*PartnerSignupResponse, *http.Response, error) {
	return r.ApiService.SignupPartnerV2LinkExecute(r)
}
...
Signup a customer by linking a new entitlement to an existing Confluent Cloud organization.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiSignupPartnerV2LinkRequest
*/
func (a *SignupPartnerV2ApiService) SignupPartnerV2Link(ctx context.Context) ApiSignupPartnerV2LinkRequest {
	return ApiSignupPartnerV2LinkRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return PartnerSignupResponse
func (a *SignupPartnerV2ApiService) SignupPartnerV2LinkExecute(r ApiSignupPartnerV2LinkRequest) (*PartnerSignupResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SignupPartnerV2ApiService.SignupPartnerV2Link")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/partner/v2/signup/link"
	...
	// body params
	localVarPostBody = r.partnerLinkRequest
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
