...
// checks if the PartnerSignupRequestEntitlementOneOf1 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PartnerSignupRequestEntitlementOneOf1{}

// PartnerSignupRequestEntitlementOneOf1 struct for PartnerSignupRequestEntitlementOneOf1
type PartnerSignupRequestEntitlementOneOf1 struct {
...
func NewPartnerSignupRequestEntitlementOneOf1(id string, related string, resourceName string) *PartnerSignupRequestEntitlementOneOf1 {
	this := PartnerSignupRequestEntitlementOneOf1{}
	this.Id = id
...
func (o PartnerSignupRequestEntitlementOneOf1) MarshalJSON() ([]byte, error) {
...
func (o PartnerSignupRequestEntitlementOneOf1) ToMap() (map[string]interface{}, error) {
...
type NullablePartnerSignupRequestEntitlementOneOf1 struct {
	value *PartnerSignupRequestEntitlementOneOf1
	isSet bool
}

func (v NullablePartnerSignupRequestEntitlementOneOf1) Get() *PartnerSignupRequestEntitlementOneOf1 {
	return v.value
}

func (v *NullablePartnerSignupRequestEntitlementOneOf1) Set(val *PartnerSignupRequestEntitlementOneOf1) {
	v.value = val
	v.isSet = true
}

func (v NullablePartnerSignupRequestEntitlementOneOf1) IsSet() bool {
	return v.isSet
}

func (v *NullablePartnerSignupRequestEntitlementOneOf1) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePartnerSignupRequestEntitlementOneOf1(val *PartnerSignupRequestEntitlementOneOf1) *NullablePartnerSignupRequestEntitlementOneOf1 {
	return &NullablePartnerSignupRequestEntitlementOneOf1{value: val, isSet: true}
}

func (v NullablePartnerSignupRequestEntitlementOneOf1) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePartnerSignupRequestEntitlementOneOf1) UnmarshalJSON(src []byte) error {
	v.isSet = true
