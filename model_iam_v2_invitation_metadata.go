...
// checks if the IamV2InvitationMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IamV2InvitationMetadata{}

// IamV2InvitationMetadata struct for IamV2InvitationMetadata
type IamV2InvitationMetadata struct {
...
func (o IamV2InvitationMetadata) MarshalJSON() ([]byte, error) {
...
func (o IamV2InvitationMetadata) ToMap() (map[string]interface{}, error) {
...
type NullableIamV2InvitationMetadata struct {
	value *IamV2InvitationMetadata
	isSet bool
}

func (v NullableIamV2InvitationMetadata) Get() *IamV2InvitationMetadata {
	return v.value
}

func (v *NullableIamV2InvitationMetadata) Set(val *IamV2InvitationMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableIamV2InvitationMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableIamV2InvitationMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIamV2InvitationMetadata(val *IamV2InvitationMetadata) *NullableIamV2InvitationMetadata {
	return &NullableIamV2InvitationMetadata{value: val, isSet: true}
}

func (v NullableIamV2InvitationMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIamV2InvitationMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
