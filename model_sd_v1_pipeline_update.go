...
// checks if the SdV1PipelineUpdate type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SdV1PipelineUpdate{}
...
func (o SdV1PipelineUpdate) ToMap() (map[string]interface{}, error) {
