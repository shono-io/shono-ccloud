...
// checks if the NotificationsV1Subscription type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NotificationsV1Subscription{}
...
type NotificationsV1Subscription struct {
	...
	NotificationType *NotificationsV1SubscriptionNotificationType `json:"notification_type,omitempty"`
...
// SetNotificationType gets a reference to the given NotificationsV1SubscriptionNotificationType and assigns it to the NotificationType field.
...
func (o NotificationsV1Subscription) ToMap() (map[string]interface{}, error) {
