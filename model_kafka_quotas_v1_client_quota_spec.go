...
// checks if the KafkaQuotasV1ClientQuotaSpec type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &KafkaQuotasV1ClientQuotaSpec{}
...
type KafkaQuotasV1ClientQuotaSpec struct {
	...
	Throughput *KafkaQuotasV1ClientQuotaSpecThroughput `json:"throughput,omitempty"`
	Cluster *KafkaQuotasV1ClientQuotaSpecCluster `json:"cluster,omitempty"`
...
func (o *KafkaQuotasV1ClientQuotaSpec) GetThroughput() KafkaQuotasV1ClientQuotaSpecThroughput {
	if o == nil || IsNil(o.Throughput) {
		var ret KafkaQuotasV1ClientQuotaSpecThroughput
		return ret
	}
	return *o.Throughput
}
...
// SetThroughput gets a reference to the given KafkaQuotasV1ClientQuotaSpecThroughput and assigns it to the Throughput field.
...
func (o *KafkaQuotasV1ClientQuotaSpec) GetCluster() KafkaQuotasV1ClientQuotaSpecCluster {
	if o == nil || IsNil(o.Cluster) {
		var ret KafkaQuotasV1ClientQuotaSpecCluster
		return ret
	}
	return *o.Cluster
}
...
// SetCluster gets a reference to the given KafkaQuotasV1ClientQuotaSpecCluster and assigns it to the Cluster field.
...
func (o KafkaQuotasV1ClientQuotaSpec) ToMap() (map[string]interface{}, error) {
