...
// checks if the SdV1PipelineListMetadataAllOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SdV1PipelineListMetadataAllOf{}

// SdV1PipelineListMetadataAllOf struct for SdV1PipelineListMetadataAllOf
type SdV1PipelineListMetadataAllOf struct {
...
func NewSdV1PipelineListMetadataAllOf() *SdV1PipelineListMetadataAllOf {
	this := SdV1PipelineListMetadataAllOf{}
	return &this
}
...
func (o SdV1PipelineListMetadataAllOf) MarshalJSON() ([]byte, error) {
...
func (o SdV1PipelineListMetadataAllOf) ToMap() (map[string]interface{}, error) {
...
type NullableSdV1PipelineListMetadataAllOf struct {
	value *SdV1PipelineListMetadataAllOf
	isSet bool
}

func (v NullableSdV1PipelineListMetadataAllOf) Get() *SdV1PipelineListMetadataAllOf {
	return v.value
}

func (v *NullableSdV1PipelineListMetadataAllOf) Set(val *SdV1PipelineListMetadataAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableSdV1PipelineListMetadataAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableSdV1PipelineListMetadataAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSdV1PipelineListMetadataAllOf(val *SdV1PipelineListMetadataAllOf) *NullableSdV1PipelineListMetadataAllOf {
	return &NullableSdV1PipelineListMetadataAllOf{value: val, isSet: true}
}

func (v NullableSdV1PipelineListMetadataAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSdV1PipelineListMetadataAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
