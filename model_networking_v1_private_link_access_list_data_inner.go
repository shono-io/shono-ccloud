...
// checks if the NetworkingV1PrivateLinkAccessListDataInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NetworkingV1PrivateLinkAccessListDataInner{}

// NetworkingV1PrivateLinkAccessListDataInner struct for NetworkingV1PrivateLinkAccessListDataInner
type NetworkingV1PrivateLinkAccessListDataInner struct {
	...
	Id string `json:"id"`
	Metadata NetworkingV1PrivateLinkAccessMetadata `json:"metadata"`
...
func NewNetworkingV1PrivateLinkAccessListDataInner(id string, metadata NetworkingV1PrivateLinkAccessMetadata, spec map[string]interface{}, status NetworkingV1PrivateLinkAccessStatus) *NetworkingV1PrivateLinkAccessListDataInner {
	this := NetworkingV1PrivateLinkAccessListDataInner{}
	this.Id = id
...
func (o NetworkingV1PrivateLinkAccessListDataInner) MarshalJSON() ([]byte, error) {
...
func (o NetworkingV1PrivateLinkAccessListDataInner) ToMap() (map[string]interface{}, error) {
...
type NullableNetworkingV1PrivateLinkAccessListDataInner struct {
	value *NetworkingV1PrivateLinkAccessListDataInner
	isSet bool
}

func (v NullableNetworkingV1PrivateLinkAccessListDataInner) Get() *NetworkingV1PrivateLinkAccessListDataInner {
	return v.value
}

func (v *NullableNetworkingV1PrivateLinkAccessListDataInner) Set(val *NetworkingV1PrivateLinkAccessListDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableNetworkingV1PrivateLinkAccessListDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableNetworkingV1PrivateLinkAccessListDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNetworkingV1PrivateLinkAccessListDataInner(val *NetworkingV1PrivateLinkAccessListDataInner) *NullableNetworkingV1PrivateLinkAccessListDataInner {
	return &NullableNetworkingV1PrivateLinkAccessListDataInner{value: val, isSet: true}
}

func (v NullableNetworkingV1PrivateLinkAccessListDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNetworkingV1PrivateLinkAccessListDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
