...
type ApiGetNetworkingV1NetworkLinkServiceAssociationRequest struct {
	ctx context.Context
	ApiService *NetworkLinkServiceAssociationsNetworkingV1ApiService
	id string
}

func (r ApiGetNetworkingV1NetworkLinkServiceAssociationRequest) Execute() (*GetNetworkingV1NetworkLinkServiceAssociation200Response, *http.Response, error) {
...
*/
func (a *NetworkLinkServiceAssociationsNetworkingV1ApiService) GetNetworkingV1NetworkLinkServiceAssociation(ctx context.Context, id string) ApiGetNetworkingV1NetworkLinkServiceAssociationRequest {
	return ApiGetNetworkingV1NetworkLinkServiceAssociationRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
//  @return GetNetworkingV1NetworkLinkServiceAssociation200Response
func (a *NetworkLinkServiceAssociationsNetworkingV1ApiService) GetNetworkingV1NetworkLinkServiceAssociationExecute(r ApiGetNetworkingV1NetworkLinkServiceAssociationRequest) (*GetNetworkingV1NetworkLinkServiceAssociation200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *GetNetworkingV1NetworkLinkServiceAssociation200Response
	)
...
func (r ApiListNetworkingV1NetworkLinkServiceAssociationsRequest) Execute() (*ListNetworkingV1NetworkLinkServiceAssociations200Response, *http.Response, error) {
...
*/
func (a *NetworkLinkServiceAssociationsNetworkingV1ApiService) ListNetworkingV1NetworkLinkServiceAssociations(ctx context.Context) ApiListNetworkingV1NetworkLinkServiceAssociationsRequest {
	return ApiListNetworkingV1NetworkLinkServiceAssociationsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return ListNetworkingV1NetworkLinkServiceAssociations200Response
func (a *NetworkLinkServiceAssociationsNetworkingV1ApiService) ListNetworkingV1NetworkLinkServiceAssociationsExecute(r ApiListNetworkingV1NetworkLinkServiceAssociationsRequest) (*ListNetworkingV1NetworkLinkServiceAssociations200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *ListNetworkingV1NetworkLinkServiceAssociations200Response
	)
