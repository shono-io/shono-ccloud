...
// checks if the NotificationsV1NotificationType type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NotificationsV1NotificationType{}
...
func (o *NotificationsV1NotificationType) GetSubscriptionPriority() string {
	if o == nil || IsNil(o.SubscriptionPriority) {
		var ret string
		return ret
	}
...
func (o *NotificationsV1NotificationType) GetIsIncludedInPlan() bool {
	if o == nil || IsNil(o.IsIncludedInPlan) {
		var ret bool
		return ret
	}
...
func (o NotificationsV1NotificationType) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.SubscriptionPriority) {
		toSerialize["subscription_priority"] = o.SubscriptionPriority
	}
	if !IsNil(o.IsIncludedInPlan) {
