...
// checks if the CreateIamV2InvitationRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateIamV2InvitationRequest{}

// CreateIamV2InvitationRequest struct for CreateIamV2InvitationRequest
type CreateIamV2InvitationRequest struct {
...
func NewCreateIamV2InvitationRequest(email string) *CreateIamV2InvitationRequest {
	this := CreateIamV2InvitationRequest{}
	this.Email = email
	return &this
}
...
func (o *CreateIamV2InvitationRequest) SetAcceptedAtNil() {
...
func (o CreateIamV2InvitationRequest) MarshalJSON() ([]byte, error) {
...
func (o CreateIamV2InvitationRequest) ToMap() (map[string]interface{}, error) {
...
type NullableCreateIamV2InvitationRequest struct {
	value *CreateIamV2InvitationRequest
	isSet bool
}

func (v NullableCreateIamV2InvitationRequest) Get() *CreateIamV2InvitationRequest {
	return v.value
}

func (v *NullableCreateIamV2InvitationRequest) Set(val *CreateIamV2InvitationRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateIamV2InvitationRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateIamV2InvitationRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateIamV2InvitationRequest(val *CreateIamV2InvitationRequest) *NullableCreateIamV2InvitationRequest {
	return &NullableCreateIamV2InvitationRequest{value: val, isSet: true}
}

func (v NullableCreateIamV2InvitationRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateIamV2InvitationRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
