...
// checks if the GetIamV2Invitation200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetIamV2Invitation200Response{}

// GetIamV2Invitation200Response struct for GetIamV2Invitation200Response
type GetIamV2Invitation200Response struct {
	...
	Id string `json:"id"`
	Metadata *IamV2InvitationMetadata `json:"metadata,omitempty"`
	...
	User *IamV2InvitationUser `json:"user,omitempty"`
	Creator *IamV2InvitationCreator `json:"creator,omitempty"`
}
...
func NewGetIamV2Invitation200Response(apiVersion string, kind string, id string, email string) *GetIamV2Invitation200Response {
	this := GetIamV2Invitation200Response{}
...
func (o *GetIamV2Invitation200Response) GetMetadata() IamV2InvitationMetadata {
	if o == nil || IsNil(o.Metadata) {
		var ret IamV2InvitationMetadata
		return ret
	}
	return *o.Metadata
}
...
// SetMetadata gets a reference to the given IamV2InvitationMetadata and assigns it to the Metadata field.
...
func (o *GetIamV2Invitation200Response) SetAcceptedAtNil() {
...
// SetUser gets a reference to the given IamV2InvitationUser and assigns it to the User field.
...
func (o *GetIamV2Invitation200Response) GetCreator() IamV2InvitationCreator {
	if o == nil || IsNil(o.Creator) {
		var ret IamV2InvitationCreator
		return ret
	}
	return *o.Creator
}
...
// SetCreator gets a reference to the given IamV2InvitationCreator and assigns it to the Creator field.
func (o *GetIamV2Invitation200Response) SetCreator(v IamV2InvitationCreator) {
	o.Creator = &v
}

func (o GetIamV2Invitation200Response) MarshalJSON() ([]byte, error) {
...
func (o GetIamV2Invitation200Response) ToMap() (map[string]interface{}, error) {
...
type NullableGetIamV2Invitation200Response struct {
	value *GetIamV2Invitation200Response
	isSet bool
}

func (v NullableGetIamV2Invitation200Response) Get() *GetIamV2Invitation200Response {
	return v.value
}

func (v *NullableGetIamV2Invitation200Response) Set(val *GetIamV2Invitation200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetIamV2Invitation200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetIamV2Invitation200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetIamV2Invitation200Response(val *GetIamV2Invitation200Response) *NullableGetIamV2Invitation200Response {
	return &NullableGetIamV2Invitation200Response{value: val, isSet: true}
}

func (v NullableGetIamV2Invitation200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetIamV2Invitation200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
