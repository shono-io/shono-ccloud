...
// checks if the CreateByokV1KeyRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateByokV1KeyRequest{}

// CreateByokV1KeyRequest struct for CreateByokV1KeyRequest
type CreateByokV1KeyRequest struct {
...
func (o CreateByokV1KeyRequest) MarshalJSON() ([]byte, error) {
...
func (o CreateByokV1KeyRequest) ToMap() (map[string]interface{}, error) {
...
type NullableCreateByokV1KeyRequest struct {
	value *CreateByokV1KeyRequest
	isSet bool
}

func (v NullableCreateByokV1KeyRequest) Get() *CreateByokV1KeyRequest {
	return v.value
}

func (v *NullableCreateByokV1KeyRequest) Set(val *CreateByokV1KeyRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateByokV1KeyRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateByokV1KeyRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateByokV1KeyRequest(val *CreateByokV1KeyRequest) *NullableCreateByokV1KeyRequest {
	return &NullableCreateByokV1KeyRequest{value: val, isSet: true}
}

func (v NullableCreateByokV1KeyRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateByokV1KeyRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
