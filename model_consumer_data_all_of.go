...
// checks if the ConsumerDataAllOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ConsumerDataAllOf{}
...
func (o ConsumerDataAllOf) ToMap() (map[string]interface{}, error) {
