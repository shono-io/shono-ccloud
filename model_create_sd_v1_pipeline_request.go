...
// checks if the CreateSdV1PipelineRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateSdV1PipelineRequest{}

// CreateSdV1PipelineRequest struct for CreateSdV1PipelineRequest
type CreateSdV1PipelineRequest struct {
	...
	Spec CreateSdV1PipelineRequestAllOf1Spec `json:"spec"`
...
func NewCreateSdV1PipelineRequest(spec CreateSdV1PipelineRequestAllOf1Spec) *CreateSdV1PipelineRequest {
	this := CreateSdV1PipelineRequest{}
	this.Spec = spec
	return &this
}
...
func (o *CreateSdV1PipelineRequest) GetSpec() CreateSdV1PipelineRequestAllOf1Spec {
	if o == nil {
		var ret CreateSdV1PipelineRequestAllOf1Spec
		return ret
	}
...
func (o CreateSdV1PipelineRequest) MarshalJSON() ([]byte, error) {
...
func (o CreateSdV1PipelineRequest) ToMap() (map[string]interface{}, error) {
...
type NullableCreateSdV1PipelineRequest struct {
	value *CreateSdV1PipelineRequest
	isSet bool
}

func (v NullableCreateSdV1PipelineRequest) Get() *CreateSdV1PipelineRequest {
	return v.value
}

func (v *NullableCreateSdV1PipelineRequest) Set(val *CreateSdV1PipelineRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateSdV1PipelineRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateSdV1PipelineRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateSdV1PipelineRequest(val *CreateSdV1PipelineRequest) *NullableCreateSdV1PipelineRequest {
	return &NullableCreateSdV1PipelineRequest{value: val, isSet: true}
}

func (v NullableCreateSdV1PipelineRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateSdV1PipelineRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
