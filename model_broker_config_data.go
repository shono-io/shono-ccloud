...
// checks if the BrokerConfigData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BrokerConfigData{}
...
func (o BrokerConfigData) ToMap() (map[string]interface{}, error) {
