...
// checks if the AlterBrokerReplicaExclusionDataAllOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AlterBrokerReplicaExclusionDataAllOf{}
...
func (o AlterBrokerReplicaExclusionDataAllOf) ToMap() (map[string]interface{}, error) {
