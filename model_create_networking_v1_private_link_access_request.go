...
// checks if the CreateNetworkingV1PrivateLinkAccessRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateNetworkingV1PrivateLinkAccessRequest{}

// CreateNetworkingV1PrivateLinkAccessRequest struct for CreateNetworkingV1PrivateLinkAccessRequest
type CreateNetworkingV1PrivateLinkAccessRequest struct {
...
func NewCreateNetworkingV1PrivateLinkAccessRequest(spec CreateNetworkingV1PeeringRequestAllOf1Spec) *CreateNetworkingV1PrivateLinkAccessRequest {
	this := CreateNetworkingV1PrivateLinkAccessRequest{}
	this.Spec = spec
	return &this
}
...
func (o *CreateNetworkingV1PrivateLinkAccessRequest) SetSpec(v CreateNetworkingV1PeeringRequestAllOf1Spec) {
	o.Spec = v
}
...
func (o CreateNetworkingV1PrivateLinkAccessRequest) MarshalJSON() ([]byte, error) {
...
func (o CreateNetworkingV1PrivateLinkAccessRequest) ToMap() (map[string]interface{}, error) {
...
type NullableCreateNetworkingV1PrivateLinkAccessRequest struct {
	value *CreateNetworkingV1PrivateLinkAccessRequest
	isSet bool
}

func (v NullableCreateNetworkingV1PrivateLinkAccessRequest) Get() *CreateNetworkingV1PrivateLinkAccessRequest {
	return v.value
}

func (v *NullableCreateNetworkingV1PrivateLinkAccessRequest) Set(val *CreateNetworkingV1PrivateLinkAccessRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateNetworkingV1PrivateLinkAccessRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateNetworkingV1PrivateLinkAccessRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateNetworkingV1PrivateLinkAccessRequest(val *CreateNetworkingV1PrivateLinkAccessRequest) *NullableCreateNetworkingV1PrivateLinkAccessRequest {
	return &NullableCreateNetworkingV1PrivateLinkAccessRequest{value: val, isSet: true}
}

func (v NullableCreateNetworkingV1PrivateLinkAccessRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateNetworkingV1PrivateLinkAccessRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
