...
// checks if the ByokV1KeyListMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ByokV1KeyListMetadata{}

// ByokV1KeyListMetadata struct for ByokV1KeyListMetadata
type ByokV1KeyListMetadata struct {
...
func (o *ByokV1KeyListMetadata) HasFirst() bool {
	if o != nil && IsNil(o.First) {
		return true
	}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *ByokV1KeyListMetadata) GetPrevOk() (*interface{}, bool) {
...
func (o ByokV1KeyListMetadata) MarshalJSON() ([]byte, error) {
...
func (o ByokV1KeyListMetadata) ToMap() (map[string]interface{}, error) {
...
type NullableByokV1KeyListMetadata struct {
	value *ByokV1KeyListMetadata
	isSet bool
}

func (v NullableByokV1KeyListMetadata) Get() *ByokV1KeyListMetadata {
	return v.value
}

func (v *NullableByokV1KeyListMetadata) Set(val *ByokV1KeyListMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableByokV1KeyListMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableByokV1KeyListMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableByokV1KeyListMetadata(val *ByokV1KeyListMetadata) *NullableByokV1KeyListMetadata {
	return &NullableByokV1KeyListMetadata{value: val, isSet: true}
}

func (v NullableByokV1KeyListMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableByokV1KeyListMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
