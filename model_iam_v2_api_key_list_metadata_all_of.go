...
// checks if the IamV2ApiKeyListMetadataAllOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IamV2ApiKeyListMetadataAllOf{}

// IamV2ApiKeyListMetadataAllOf struct for IamV2ApiKeyListMetadataAllOf
type IamV2ApiKeyListMetadataAllOf struct {
...
func NewIamV2ApiKeyListMetadataAllOf() *IamV2ApiKeyListMetadataAllOf {
	this := IamV2ApiKeyListMetadataAllOf{}
	return &this
}
...
func (o IamV2ApiKeyListMetadataAllOf) MarshalJSON() ([]byte, error) {
...
func (o IamV2ApiKeyListMetadataAllOf) ToMap() (map[string]interface{}, error) {
...
type NullableIamV2ApiKeyListMetadataAllOf struct {
	value *IamV2ApiKeyListMetadataAllOf
	isSet bool
}

func (v NullableIamV2ApiKeyListMetadataAllOf) Get() *IamV2ApiKeyListMetadataAllOf {
	return v.value
}

func (v *NullableIamV2ApiKeyListMetadataAllOf) Set(val *IamV2ApiKeyListMetadataAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableIamV2ApiKeyListMetadataAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableIamV2ApiKeyListMetadataAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIamV2ApiKeyListMetadataAllOf(val *IamV2ApiKeyListMetadataAllOf) *NullableIamV2ApiKeyListMetadataAllOf {
	return &NullableIamV2ApiKeyListMetadataAllOf{value: val, isSet: true}
}

func (v NullableIamV2ApiKeyListMetadataAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIamV2ApiKeyListMetadataAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
