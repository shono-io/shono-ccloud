...
// checks if the IamV2ServiceAccountListDataInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IamV2ServiceAccountListDataInner{}

// IamV2ServiceAccountListDataInner struct for IamV2ServiceAccountListDataInner
type IamV2ServiceAccountListDataInner struct {
	...
	Id string `json:"id"`
	Metadata IamV2ServiceAccountMetadata `json:"metadata"`
...
func NewIamV2ServiceAccountListDataInner(id string, metadata IamV2ServiceAccountMetadata, displayName string) *IamV2ServiceAccountListDataInner {
	this := IamV2ServiceAccountListDataInner{}
	this.Id = id
...
func (o IamV2ServiceAccountListDataInner) MarshalJSON() ([]byte, error) {
...
func (o IamV2ServiceAccountListDataInner) ToMap() (map[string]interface{}, error) {
...
type NullableIamV2ServiceAccountListDataInner struct {
	value *IamV2ServiceAccountListDataInner
	isSet bool
}

func (v NullableIamV2ServiceAccountListDataInner) Get() *IamV2ServiceAccountListDataInner {
	return v.value
}

func (v *NullableIamV2ServiceAccountListDataInner) Set(val *IamV2ServiceAccountListDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableIamV2ServiceAccountListDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableIamV2ServiceAccountListDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIamV2ServiceAccountListDataInner(val *IamV2ServiceAccountListDataInner) *NullableIamV2ServiceAccountListDataInner {
	return &NullableIamV2ServiceAccountListDataInner{value: val, isSet: true}
}

func (v NullableIamV2ServiceAccountListDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIamV2ServiceAccountListDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
