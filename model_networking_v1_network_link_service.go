...
// checks if the NetworkingV1NetworkLinkService type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NetworkingV1NetworkLinkService{}
...
func (o NetworkingV1NetworkLinkService) ToMap() (map[string]interface{}, error) {
