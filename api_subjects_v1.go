...
type ApiDeleteSchemaVersionRequest struct {
	ctx context.Context
	ApiService *SubjectsV1ApiService
	subject string
	version string
	permanent *bool
}
...
func (r ApiDeleteSchemaVersionRequest) Execute() (int32, *http.Response, error) {
...
*/
func (a *SubjectsV1ApiService) DeleteSchemaVersion(ctx context.Context, subject string, version string) ApiDeleteSchemaVersionRequest {
	return ApiDeleteSchemaVersionRequest{
		ApiService: a,
		ctx: ctx,
		subject: subject,
...
//  @return int32
func (a *SubjectsV1ApiService) DeleteSchemaVersionExecute(r ApiDeleteSchemaVersionRequest) (int32, *http.Response, error) {
	var (
...
func (r ApiDeleteSubjectRequest) Execute() ([]int32, *http.Response, error) {
...
*/
func (a *SubjectsV1ApiService) DeleteSubject(ctx context.Context, subject string) ApiDeleteSubjectRequest {
	return ApiDeleteSubjectRequest{
		ApiService: a,
		ctx: ctx,
		subject: subject,
...
// Execute executes the request
//  @return []int32
func (a *SubjectsV1ApiService) DeleteSubjectExecute(r ApiDeleteSubjectRequest) ([]int32, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodDelete
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r ApiGetReferencedByRequest) Execute() ([]int32, *http.Response, error) {
...
*/
func (a *SubjectsV1ApiService) GetReferencedBy(ctx context.Context, subject string, version string) ApiGetReferencedByRequest {
	return ApiGetReferencedByRequest{
		ApiService: a,
		ctx: ctx,
		subject: subject,
...
// Execute executes the request
//  @return []int32
func (a *SubjectsV1ApiService) GetReferencedByExecute(r ApiGetReferencedByRequest) ([]int32, *http.Response, error) {
	var (
...
func (r ApiGetSchemaByVersionRequest) Execute() (*Schema, *http.Response, error) {
...
*/
func (a *SubjectsV1ApiService) GetSchemaByVersion(ctx context.Context, subject string, version string) ApiGetSchemaByVersionRequest {
	return ApiGetSchemaByVersionRequest{
		ApiService: a,
		ctx: ctx,
		subject: subject,
...
// Execute executes the request
//  @return Schema
func (a *SubjectsV1ApiService) GetSchemaByVersionExecute(r ApiGetSchemaByVersionRequest) (*Schema, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r ApiGetSchemaOnly1Request) Execute() (string, *http.Response, error) {
...
*/
func (a *SubjectsV1ApiService) GetSchemaOnly1(ctx context.Context, subject string, version string) ApiGetSchemaOnly1Request {
	return ApiGetSchemaOnly1Request{
		ApiService: a,
		ctx: ctx,
		subject: subject,
...
// Execute executes the request
//  @return string
func (a *SubjectsV1ApiService) GetSchemaOnly1Execute(r ApiGetSchemaOnly1Request) (string, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
*/
func (a *SubjectsV1ApiService) List(ctx context.Context) ApiListRequest {
	return ApiListRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return []string
func (a *SubjectsV1ApiService) ListExecute(r ApiListRequest) ([]string, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	if r.subjectPrefix != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "subjectPrefix", r.subjectPrefix, "")
	}
	if r.deleted != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "deleted", r.deleted, "")
	}
...
func (r ApiListVersionsRequest) Execute() ([]int32, *http.Response, error) {
...
*/
func (a *SubjectsV1ApiService) ListVersions(ctx context.Context, subject string) ApiListVersionsRequest {
	return ApiListVersionsRequest{
		ApiService: a,
		ctx: ctx,
		subject: subject,
...
// Execute executes the request
//  @return []int32
func (a *SubjectsV1ApiService) ListVersionsExecute(r ApiListVersionsRequest) ([]int32, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r ApiLookUpSchemaUnderSubjectRequest) Execute() (*Schema, *http.Response, error) {
...
*/
func (a *SubjectsV1ApiService) LookUpSchemaUnderSubject(ctx context.Context, subject string) ApiLookUpSchemaUnderSubjectRequest {
	return ApiLookUpSchemaUnderSubjectRequest{
		ApiService: a,
		ctx: ctx,
		subject: subject,
...
// Execute executes the request
//  @return Schema
func (a *SubjectsV1ApiService) LookUpSchemaUnderSubjectExecute(r ApiLookUpSchemaUnderSubjectRequest) (*Schema, *http.Response, error) {
	var (
...
func (r ApiRegisterRequest) Execute() (*RegisterSchemaResponse, *http.Response, error) {
...
*/
func (a *SubjectsV1ApiService) Register(ctx context.Context, subject string) ApiRegisterRequest {
	return ApiRegisterRequest{
		ApiService: a,
		ctx: ctx,
		subject: subject,
...
func (a *SubjectsV1ApiService) RegisterExecute(r ApiRegisterRequest) (*RegisterSchemaResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
