...
// checks if the EntityHeader type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EntityHeader{}
...
func (o *EntityHeader) GetClassificationNames() []string {
	if o == nil || IsNil(o.ClassificationNames) {
		var ret []string
		return ret
	}
...
func (o EntityHeader) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.ClassificationNames) {
