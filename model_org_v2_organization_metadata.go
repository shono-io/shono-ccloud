...
// checks if the OrgV2OrganizationMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OrgV2OrganizationMetadata{}

// OrgV2OrganizationMetadata struct for OrgV2OrganizationMetadata
type OrgV2OrganizationMetadata struct {
...
func NewOrgV2OrganizationMetadata(self interface{}) *OrgV2OrganizationMetadata {
	this := OrgV2OrganizationMetadata{}
	this.Self = self
	return &this
}
...
func (o OrgV2OrganizationMetadata) MarshalJSON() ([]byte, error) {
...
func (o OrgV2OrganizationMetadata) ToMap() (map[string]interface{}, error) {
...
type NullableOrgV2OrganizationMetadata struct {
	value *OrgV2OrganizationMetadata
	isSet bool
}

func (v NullableOrgV2OrganizationMetadata) Get() *OrgV2OrganizationMetadata {
	return v.value
}

func (v *NullableOrgV2OrganizationMetadata) Set(val *OrgV2OrganizationMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableOrgV2OrganizationMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableOrgV2OrganizationMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOrgV2OrganizationMetadata(val *OrgV2OrganizationMetadata) *NullableOrgV2OrganizationMetadata {
	return &NullableOrgV2OrganizationMetadata{value: val, isSet: true}
}

func (v NullableOrgV2OrganizationMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOrgV2OrganizationMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
