...
// checks if the NetworkingV1TransitGatewayAttachmentListMetadataAllOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NetworkingV1TransitGatewayAttachmentListMetadataAllOf{}

// NetworkingV1TransitGatewayAttachmentListMetadataAllOf struct for NetworkingV1TransitGatewayAttachmentListMetadataAllOf
type NetworkingV1TransitGatewayAttachmentListMetadataAllOf struct {
...
func NewNetworkingV1TransitGatewayAttachmentListMetadataAllOf() *NetworkingV1TransitGatewayAttachmentListMetadataAllOf {
	this := NetworkingV1TransitGatewayAttachmentListMetadataAllOf{}
	return &this
}
...
func (o NetworkingV1TransitGatewayAttachmentListMetadataAllOf) MarshalJSON() ([]byte, error) {
...
func (o NetworkingV1TransitGatewayAttachmentListMetadataAllOf) ToMap() (map[string]interface{}, error) {
...
type NullableNetworkingV1TransitGatewayAttachmentListMetadataAllOf struct {
	value *NetworkingV1TransitGatewayAttachmentListMetadataAllOf
	isSet bool
}

func (v NullableNetworkingV1TransitGatewayAttachmentListMetadataAllOf) Get() *NetworkingV1TransitGatewayAttachmentListMetadataAllOf {
	return v.value
}

func (v *NullableNetworkingV1TransitGatewayAttachmentListMetadataAllOf) Set(val *NetworkingV1TransitGatewayAttachmentListMetadataAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableNetworkingV1TransitGatewayAttachmentListMetadataAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableNetworkingV1TransitGatewayAttachmentListMetadataAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNetworkingV1TransitGatewayAttachmentListMetadataAllOf(val *NetworkingV1TransitGatewayAttachmentListMetadataAllOf) *NullableNetworkingV1TransitGatewayAttachmentListMetadataAllOf {
	return &NullableNetworkingV1TransitGatewayAttachmentListMetadataAllOf{value: val, isSet: true}
}

func (v NullableNetworkingV1TransitGatewayAttachmentListMetadataAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNetworkingV1TransitGatewayAttachmentListMetadataAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
