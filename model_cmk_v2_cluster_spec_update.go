...
// checks if the CmkV2ClusterSpecUpdate type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CmkV2ClusterSpecUpdate{}
...
func (o *CmkV2ClusterSpecUpdate) GetConfig() CmkV2ClusterSpecConfig {
...
// and a boolean to check if the value has been set.
func (o *CmkV2ClusterSpecUpdate) GetConfigOk() (*CmkV2ClusterSpecConfig, bool) {
	if o == nil || IsNil(o.Config) {
		return nil, false
	}
...
func (o *CmkV2ClusterSpecUpdate) SetConfig(v CmkV2ClusterSpecConfig) {
	o.Config = &v
}

// GetEnvironment returns the Environment field value if set, zero value otherwise.
func (o *CmkV2ClusterSpecUpdate) GetEnvironment() CmkV2ClusterSpecEnvironment {
...
// and a boolean to check if the value has been set.
func (o *CmkV2ClusterSpecUpdate) GetEnvironmentOk() (*CmkV2ClusterSpecEnvironment, bool) {
	if o == nil || IsNil(o.Environment) {
		return nil, false
	}
...
func (o *CmkV2ClusterSpecUpdate) SetEnvironment(v CmkV2ClusterSpecEnvironment) {
	o.Environment = &v
}
...
func (o CmkV2ClusterSpecUpdate) ToMap() (map[string]interface{}, error) {
