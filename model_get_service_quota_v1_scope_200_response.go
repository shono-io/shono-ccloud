...
// checks if the GetServiceQuotaV1Scope200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetServiceQuotaV1Scope200Response{}

// GetServiceQuotaV1Scope200Response struct for GetServiceQuotaV1Scope200Response
type GetServiceQuotaV1Scope200Response struct {
	...
	Id string `json:"id"`
	Metadata *ServiceQuotaV1ScopeMetadata `json:"metadata,omitempty"`
...
func NewGetServiceQuotaV1Scope200Response(apiVersion string, kind string, id string, description string) *GetServiceQuotaV1Scope200Response {
	this := GetServiceQuotaV1Scope200Response{}
...
func (o *GetServiceQuotaV1Scope200Response) GetMetadata() ServiceQuotaV1ScopeMetadata {
	if o == nil || IsNil(o.Metadata) {
		var ret ServiceQuotaV1ScopeMetadata
		return ret
	}
	return *o.Metadata
}
...
// SetMetadata gets a reference to the given ServiceQuotaV1ScopeMetadata and assigns it to the Metadata field.
...
func (o GetServiceQuotaV1Scope200Response) MarshalJSON() ([]byte, error) {
...
func (o GetServiceQuotaV1Scope200Response) ToMap() (map[string]interface{}, error) {
...
type NullableGetServiceQuotaV1Scope200Response struct {
	value *GetServiceQuotaV1Scope200Response
	isSet bool
}

func (v NullableGetServiceQuotaV1Scope200Response) Get() *GetServiceQuotaV1Scope200Response {
	return v.value
}

func (v *NullableGetServiceQuotaV1Scope200Response) Set(val *GetServiceQuotaV1Scope200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetServiceQuotaV1Scope200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetServiceQuotaV1Scope200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetServiceQuotaV1Scope200Response(val *GetServiceQuotaV1Scope200Response) *NullableGetServiceQuotaV1Scope200Response {
	return &NullableGetServiceQuotaV1Scope200Response{value: val, isSet: true}
}

func (v NullableGetServiceQuotaV1Scope200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetServiceQuotaV1Scope200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
