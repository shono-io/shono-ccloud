...
// checks if the NetworkingV1TransitGatewayAttachmentListDataInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NetworkingV1TransitGatewayAttachmentListDataInner{}

// NetworkingV1TransitGatewayAttachmentListDataInner struct for NetworkingV1TransitGatewayAttachmentListDataInner
type NetworkingV1TransitGatewayAttachmentListDataInner struct {
	...
	Id string `json:"id"`
	Metadata NetworkingV1TransitGatewayAttachmentMetadata `json:"metadata"`
...
func NewNetworkingV1TransitGatewayAttachmentListDataInner(id string, metadata NetworkingV1TransitGatewayAttachmentMetadata, spec map[string]interface{}, status NetworkingV1TransitGatewayAttachmentStatus) *NetworkingV1TransitGatewayAttachmentListDataInner {
	this := NetworkingV1TransitGatewayAttachmentListDataInner{}
	this.Id = id
...
func (o NetworkingV1TransitGatewayAttachmentListDataInner) MarshalJSON() ([]byte, error) {
...
func (o NetworkingV1TransitGatewayAttachmentListDataInner) ToMap() (map[string]interface{}, error) {
...
type NullableNetworkingV1TransitGatewayAttachmentListDataInner struct {
	value *NetworkingV1TransitGatewayAttachmentListDataInner
	isSet bool
}

func (v NullableNetworkingV1TransitGatewayAttachmentListDataInner) Get() *NetworkingV1TransitGatewayAttachmentListDataInner {
	return v.value
}

func (v *NullableNetworkingV1TransitGatewayAttachmentListDataInner) Set(val *NetworkingV1TransitGatewayAttachmentListDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableNetworkingV1TransitGatewayAttachmentListDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableNetworkingV1TransitGatewayAttachmentListDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNetworkingV1TransitGatewayAttachmentListDataInner(val *NetworkingV1TransitGatewayAttachmentListDataInner) *NullableNetworkingV1TransitGatewayAttachmentListDataInner {
	return &NullableNetworkingV1TransitGatewayAttachmentListDataInner{value: val, isSet: true}
}

func (v NullableNetworkingV1TransitGatewayAttachmentListDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNetworkingV1TransitGatewayAttachmentListDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
