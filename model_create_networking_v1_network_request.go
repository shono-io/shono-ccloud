...
// checks if the CreateNetworkingV1NetworkRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateNetworkingV1NetworkRequest{}

// CreateNetworkingV1NetworkRequest struct for CreateNetworkingV1NetworkRequest
type CreateNetworkingV1NetworkRequest struct {
	...
	Spec CreateNetworkingV1NetworkRequestAllOf1Spec `json:"spec"`
...
func NewCreateNetworkingV1NetworkRequest(spec CreateNetworkingV1NetworkRequestAllOf1Spec) *CreateNetworkingV1NetworkRequest {
	this := CreateNetworkingV1NetworkRequest{}
	this.Spec = spec
	return &this
}
...
func (o *CreateNetworkingV1NetworkRequest) GetSpec() CreateNetworkingV1NetworkRequestAllOf1Spec {
	if o == nil {
		var ret CreateNetworkingV1NetworkRequestAllOf1Spec
		return ret
	}
...
func (o CreateNetworkingV1NetworkRequest) MarshalJSON() ([]byte, error) {
...
func (o CreateNetworkingV1NetworkRequest) ToMap() (map[string]interface{}, error) {
...
type NullableCreateNetworkingV1NetworkRequest struct {
	value *CreateNetworkingV1NetworkRequest
	isSet bool
}

func (v NullableCreateNetworkingV1NetworkRequest) Get() *CreateNetworkingV1NetworkRequest {
	return v.value
}

func (v *NullableCreateNetworkingV1NetworkRequest) Set(val *CreateNetworkingV1NetworkRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateNetworkingV1NetworkRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateNetworkingV1NetworkRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateNetworkingV1NetworkRequest(val *CreateNetworkingV1NetworkRequest) *NullableCreateNetworkingV1NetworkRequest {
	return &NullableCreateNetworkingV1NetworkRequest{value: val, isSet: true}
}

func (v NullableCreateNetworkingV1NetworkRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateNetworkingV1NetworkRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
