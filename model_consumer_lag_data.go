...
// checks if the ConsumerLagData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ConsumerLagData{}
...
func (o ConsumerLagData) ToMap() (map[string]interface{}, error) {
