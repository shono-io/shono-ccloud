...
// checks if the BrokerRemovalData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BrokerRemovalData{}
...
func (o BrokerRemovalData) ToMap() (map[string]interface{}, error) {
