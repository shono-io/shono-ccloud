...
// checks if the BrokerTaskData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BrokerTaskData{}
...
func (o BrokerTaskData) ToMap() (map[string]interface{}, error) {
