...
// checks if the IamV2ApiKeySpecOwner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IamV2ApiKeySpecOwner{}

// IamV2ApiKeySpecOwner The owner to which this belongs. The owner can be one of iam.v2.User, iam.v2.ServiceAccount.
type IamV2ApiKeySpecOwner struct {
...
func (o IamV2ApiKeySpecOwner) MarshalJSON() ([]byte, error) {
...
func (o IamV2ApiKeySpecOwner) ToMap() (map[string]interface{}, error) {
...
type NullableIamV2ApiKeySpecOwner struct {
	value *IamV2ApiKeySpecOwner
	isSet bool
}

func (v NullableIamV2ApiKeySpecOwner) Get() *IamV2ApiKeySpecOwner {
	return v.value
}

func (v *NullableIamV2ApiKeySpecOwner) Set(val *IamV2ApiKeySpecOwner) {
	v.value = val
	v.isSet = true
}

func (v NullableIamV2ApiKeySpecOwner) IsSet() bool {
	return v.isSet
}

func (v *NullableIamV2ApiKeySpecOwner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIamV2ApiKeySpecOwner(val *IamV2ApiKeySpecOwner) *NullableIamV2ApiKeySpecOwner {
	return &NullableIamV2ApiKeySpecOwner{value: val, isSet: true}
}

func (v NullableIamV2ApiKeySpecOwner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIamV2ApiKeySpecOwner) UnmarshalJSON(src []byte) error {
	v.isSet = true
