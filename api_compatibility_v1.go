...
type ApiTestCompatibilityBySubjectNameRequest struct {
	ctx context.Context
	ApiService *CompatibilityV1ApiService
	subject string
	version string
...
func (r ApiTestCompatibilityBySubjectNameRequest) Execute() (*CompatibilityCheckResponse, *http.Response, error) {
...
*/
func (a *CompatibilityV1ApiService) TestCompatibilityBySubjectName(ctx context.Context, subject string, version string) ApiTestCompatibilityBySubjectNameRequest {
	return ApiTestCompatibilityBySubjectNameRequest{
		ApiService: a,
		ctx: ctx,
		subject: subject,
...
func (a *CompatibilityV1ApiService) TestCompatibilityBySubjectNameExecute(r ApiTestCompatibilityBySubjectNameRequest) (*CompatibilityCheckResponse, *http.Response, error) {
	var (
...
func (r ApiTestCompatibilityForSubjectRequest) Execute() (*CompatibilityCheckResponse, *http.Response, error) {
...
*/
func (a *CompatibilityV1ApiService) TestCompatibilityForSubject(ctx context.Context, subject string) ApiTestCompatibilityForSubjectRequest {
	return ApiTestCompatibilityForSubjectRequest{
		ApiService: a,
		ctx: ctx,
		subject: subject,
...
// Execute executes the request
//  @return CompatibilityCheckResponse
func (a *CompatibilityV1ApiService) TestCompatibilityForSubjectExecute(r ApiTestCompatibilityForSubjectRequest) (*CompatibilityCheckResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
