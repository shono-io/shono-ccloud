...
// checks if the CmkV2ClusterSpec type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CmkV2ClusterSpec{}
...
type CmkV2ClusterSpec struct {
	...
	Config *CmkV2ClusterSpecConfig `json:"config,omitempty"`
	...
	Environment *CmkV2ClusterSpecEnvironment `json:"environment,omitempty"`
	Network     *CmkV2ClusterSpecNetwork     `json:"network,omitempty"`
	Byok        *CmkV2ClusterSpecByok        `json:"byok,omitempty"`
}
...
func NewCmkV2ClusterSpec() *CmkV2ClusterSpec {
	...
	var config CmkV2ClusterSpecConfig = CmkV2BasicAsCmkV2ClusterSpecConfig(NewCmkV2BasicWithDefaults())
	this.Config = &config
	return &this
}
...
func (o *CmkV2ClusterSpec) GetConfig() CmkV2ClusterSpecConfig {
	if o == nil || IsNil(o.Config) {
		var ret CmkV2ClusterSpecConfig
		return ret
	}
	return *o.Config
}
...
// and a boolean to check if the value has been set.
func (o *CmkV2ClusterSpec) GetConfigOk() (*CmkV2ClusterSpecConfig, bool) {
	if o == nil || IsNil(o.Config) {
		return nil, false
	}
...
// SetConfig gets a reference to the given CmkV2ClusterSpecConfig and assigns it to the Config field.
func (o *CmkV2ClusterSpec) SetConfig(v CmkV2ClusterSpecConfig) {
	o.Config = &v
}
...
func (o *CmkV2ClusterSpec) GetKafkaBootstrapEndpoint() string {
	if o == nil || IsNil(o.KafkaBootstrapEndpoint) {
		var ret string
		return ret
	}
...
func (o *CmkV2ClusterSpec) GetEnvironment() CmkV2ClusterSpecEnvironment {
	if o == nil || IsNil(o.Environment) {
		var ret CmkV2ClusterSpecEnvironment
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *CmkV2ClusterSpec) GetEnvironmentOk() (*CmkV2ClusterSpecEnvironment, bool) {
	if o == nil || IsNil(o.Environment) {
		return nil, false
	}
...
// SetEnvironment gets a reference to the given CmkV2ClusterSpecEnvironment and assigns it to the Environment field.
func (o *CmkV2ClusterSpec) SetEnvironment(v CmkV2ClusterSpecEnvironment) {
	o.Environment = &v
}

// GetNetwork returns the Network field value if set, zero value otherwise.
func (o *CmkV2ClusterSpec) GetNetwork() CmkV2ClusterSpecNetwork {
	if o == nil || IsNil(o.Network) {
		var ret CmkV2ClusterSpecNetwork
		return ret
	}
	return *o.Network
}
...
// and a boolean to check if the value has been set.
func (o *CmkV2ClusterSpec) GetNetworkOk() (*CmkV2ClusterSpecNetwork, bool) {
	if o == nil || IsNil(o.Network) {
		return nil, false
	}
...
// SetNetwork gets a reference to the given CmkV2ClusterSpecNetwork and assigns it to the Network field.
func (o *CmkV2ClusterSpec) SetNetwork(v CmkV2ClusterSpecNetwork) {
	o.Network = &v
}

// GetByok returns the Byok field value if set, zero value otherwise.
func (o *CmkV2ClusterSpec) GetByok() CmkV2ClusterSpecByok {
	if o == nil || IsNil(o.Byok) {
		var ret CmkV2ClusterSpecByok
		return ret
	}
	return *o.Byok
}
...
// and a boolean to check if the value has been set.
func (o *CmkV2ClusterSpec) GetByokOk() (*CmkV2ClusterSpecByok, bool) {
	if o == nil || IsNil(o.Byok) {
		return nil, false
	}
	return o.Byok, true
...
// SetByok gets a reference to the given CmkV2ClusterSpecByok and assigns it to the Byok field.
func (o *CmkV2ClusterSpec) SetByok(v CmkV2ClusterSpecByok) {
	o.Byok = &v
}
...
func (o CmkV2ClusterSpec) ToMap() (map[string]interface{}, error) {
	...
	// skip: kafka_bootstrap_endpoint is readOnly
	// skip: http_endpoint is readOnly
	// skip: api_endpoint is readOnly
