...
// checks if the ClusterDataAllOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ClusterDataAllOf{}
...
func (o ClusterDataAllOf) ToMap() (map[string]interface{}, error) {
