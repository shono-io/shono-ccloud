...
func (r ApiPauseConnectv1ConnectorRequest) Execute() (*http.Response, error) {
...
*/
func (a *LifecycleV1ApiService) PauseConnectv1Connector(ctx context.Context, connectorName string, environmentId string, kafkaClusterId string) ApiPauseConnectv1ConnectorRequest {
	return ApiPauseConnectv1ConnectorRequest{
		ApiService: a,
		ctx: ctx,
...
func (a *LifecycleV1ApiService) PauseConnectv1ConnectorExecute(r ApiPauseConnectv1ConnectorRequest) (*http.Response, error) {
	var (
...
func (r ApiResumeConnectv1ConnectorRequest) Execute() (*http.Response, error) {
...
*/
func (a *LifecycleV1ApiService) ResumeConnectv1Connector(ctx context.Context, connectorName string, environmentId string, kafkaClusterId string) ApiResumeConnectv1ConnectorRequest {
	return ApiResumeConnectv1ConnectorRequest{
		ApiService: a,
		ctx: ctx,
		connectorName: connectorName,
...
// Execute executes the request
func (a *LifecycleV1ApiService) ResumeConnectv1ConnectorExecute(r ApiResumeConnectv1ConnectorRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
