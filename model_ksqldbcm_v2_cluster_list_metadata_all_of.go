...
// checks if the KsqldbcmV2ClusterListMetadataAllOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &KsqldbcmV2ClusterListMetadataAllOf{}

// KsqldbcmV2ClusterListMetadataAllOf struct for KsqldbcmV2ClusterListMetadataAllOf
type KsqldbcmV2ClusterListMetadataAllOf struct {
...
func NewKsqldbcmV2ClusterListMetadataAllOf() *KsqldbcmV2ClusterListMetadataAllOf {
	this := KsqldbcmV2ClusterListMetadataAllOf{}
	return &this
}
...
func (o KsqldbcmV2ClusterListMetadataAllOf) MarshalJSON() ([]byte, error) {
...
func (o KsqldbcmV2ClusterListMetadataAllOf) ToMap() (map[string]interface{}, error) {
...
type NullableKsqldbcmV2ClusterListMetadataAllOf struct {
	value *KsqldbcmV2ClusterListMetadataAllOf
	isSet bool
}

func (v NullableKsqldbcmV2ClusterListMetadataAllOf) Get() *KsqldbcmV2ClusterListMetadataAllOf {
	return v.value
}

func (v *NullableKsqldbcmV2ClusterListMetadataAllOf) Set(val *KsqldbcmV2ClusterListMetadataAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableKsqldbcmV2ClusterListMetadataAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableKsqldbcmV2ClusterListMetadataAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableKsqldbcmV2ClusterListMetadataAllOf(val *KsqldbcmV2ClusterListMetadataAllOf) *NullableKsqldbcmV2ClusterListMetadataAllOf {
	return &NullableKsqldbcmV2ClusterListMetadataAllOf{value: val, isSet: true}
}

func (v NullableKsqldbcmV2ClusterListMetadataAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableKsqldbcmV2ClusterListMetadataAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
