...
// checks if the CreateNotificationsV1SubscriptionRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateNotificationsV1SubscriptionRequest{}

// CreateNotificationsV1SubscriptionRequest struct for CreateNotificationsV1SubscriptionRequest
type CreateNotificationsV1SubscriptionRequest struct {
...
func NewCreateNotificationsV1SubscriptionRequest(notificationType NotificationsV1SubscriptionNotificationType, integrations []GlobalObjectReference) *CreateNotificationsV1SubscriptionRequest {
	this := CreateNotificationsV1SubscriptionRequest{}
...
func (o CreateNotificationsV1SubscriptionRequest) MarshalJSON() ([]byte, error) {
...
func (o CreateNotificationsV1SubscriptionRequest) ToMap() (map[string]interface{}, error) {
...
type NullableCreateNotificationsV1SubscriptionRequest struct {
	value *CreateNotificationsV1SubscriptionRequest
	isSet bool
}

func (v NullableCreateNotificationsV1SubscriptionRequest) Get() *CreateNotificationsV1SubscriptionRequest {
	return v.value
}

func (v *NullableCreateNotificationsV1SubscriptionRequest) Set(val *CreateNotificationsV1SubscriptionRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateNotificationsV1SubscriptionRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateNotificationsV1SubscriptionRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateNotificationsV1SubscriptionRequest(val *CreateNotificationsV1SubscriptionRequest) *NullableCreateNotificationsV1SubscriptionRequest {
	return &NullableCreateNotificationsV1SubscriptionRequest{value: val, isSet: true}
}

func (v NullableCreateNotificationsV1SubscriptionRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateNotificationsV1SubscriptionRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
