...
func (r ApiBatchCreateKafkaAclsRequest) Execute() (*http.Response, error) {
...
*/
func (a *ACLV3ApiService) BatchCreateKafkaAcls(ctx context.Context, clusterId string) ApiBatchCreateKafkaAclsRequest {
	return ApiBatchCreateKafkaAclsRequest{
		ApiService: a,
		ctx: ctx,
		clusterId: clusterId,
...
func (a *ACLV3ApiService) BatchCreateKafkaAclsExecute(r ApiBatchCreateKafkaAclsRequest) (*http.Response, error) {
	var (
...
func (r ApiCreateKafkaAclsRequest) Execute() (*http.Response, error) {
...
*/
func (a *ACLV3ApiService) CreateKafkaAcls(ctx context.Context, clusterId string) ApiCreateKafkaAclsRequest {
	return ApiCreateKafkaAclsRequest{
		ApiService: a,
		ctx: ctx,
		clusterId: clusterId,
...
// Execute executes the request
func (a *ACLV3ApiService) CreateKafkaAclsExecute(r ApiCreateKafkaAclsRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r ApiDeleteKafkaAclsRequest) Execute() (*DeleteKafkaAcls200Response, *http.Response, error) {
...
*/
func (a *ACLV3ApiService) DeleteKafkaAcls(ctx context.Context, clusterId string) ApiDeleteKafkaAclsRequest {
	return ApiDeleteKafkaAclsRequest{
		ApiService: a,
		ctx: ctx,
		clusterId: clusterId,
...
// Execute executes the request
//  @return DeleteKafkaAcls200Response
func (a *ACLV3ApiService) DeleteKafkaAclsExecute(r ApiDeleteKafkaAclsRequest) (*DeleteKafkaAcls200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodDelete
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *DeleteKafkaAcls200Response
	)
	...
	parameterAddToHeaderOrQuery(localVarQueryParams, "pattern_type", r.patternType, "")
	if r.principal != nil {
...
func (r ApiGetKafkaAclsRequest) Execute() (*AclDataList, *http.Response, error) {
...
*/
func (a *ACLV3ApiService) GetKafkaAcls(ctx context.Context, clusterId string) ApiGetKafkaAclsRequest {
	return ApiGetKafkaAclsRequest{
		ApiService: a,
		ctx: ctx,
		clusterId: clusterId,
...
// Execute executes the request
//  @return AclDataList
func (a *ACLV3ApiService) GetKafkaAclsExecute(r ApiGetKafkaAclsRequest) (*AclDataList, *http.Response, error) {
	var (
