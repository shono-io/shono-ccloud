...
// checks if the GetSdV1Pipeline200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetSdV1Pipeline200Response{}

// GetSdV1Pipeline200Response struct for GetSdV1Pipeline200Response
type GetSdV1Pipeline200Response struct {
...
func NewGetSdV1Pipeline200Response(apiVersion string, kind string, id string, spec ListSdV1Pipelines200ResponseAllOfDataInnerSpec) *GetSdV1Pipeline200Response {
	this := GetSdV1Pipeline200Response{}
...
func (o GetSdV1Pipeline200Response) MarshalJSON() ([]byte, error) {
...
func (o GetSdV1Pipeline200Response) ToMap() (map[string]interface{}, error) {
...
type NullableGetSdV1Pipeline200Response struct {
	value *GetSdV1Pipeline200Response
	isSet bool
}

func (v NullableGetSdV1Pipeline200Response) Get() *GetSdV1Pipeline200Response {
	return v.value
}

func (v *NullableGetSdV1Pipeline200Response) Set(val *GetSdV1Pipeline200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetSdV1Pipeline200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetSdV1Pipeline200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetSdV1Pipeline200Response(val *GetSdV1Pipeline200Response) *NullableGetSdV1Pipeline200Response {
	return &NullableGetSdV1Pipeline200Response{value: val, isSet: true}
}

func (v NullableGetSdV1Pipeline200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetSdV1Pipeline200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
