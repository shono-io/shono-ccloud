...
// checks if the IamV2Invitation type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IamV2Invitation{}
...
func (o IamV2Invitation) ToMap() (map[string]interface{}, error) {
