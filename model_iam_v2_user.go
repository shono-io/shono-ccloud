...
// checks if the IamV2User type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IamV2User{}
...
func (o IamV2User) ToMap() (map[string]interface{}, error) {
