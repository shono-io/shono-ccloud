...
// checks if the GetOrgV2Environment200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetOrgV2Environment200Response{}

// GetOrgV2Environment200Response struct for GetOrgV2Environment200Response
type GetOrgV2Environment200Response struct {
	...
	Id string `json:"id"`
	Metadata *OrgV2EnvironmentMetadata `json:"metadata,omitempty"`
...
func NewGetOrgV2Environment200Response(apiVersion string, kind string, id string, displayName string) *GetOrgV2Environment200Response {
	this := GetOrgV2Environment200Response{}
...
func (o *GetOrgV2Environment200Response) GetMetadata() OrgV2EnvironmentMetadata {
	if o == nil || IsNil(o.Metadata) {
		var ret OrgV2EnvironmentMetadata
		return ret
	}
	return *o.Metadata
}
...
// SetMetadata gets a reference to the given OrgV2EnvironmentMetadata and assigns it to the Metadata field.
...
func (o GetOrgV2Environment200Response) MarshalJSON() ([]byte, error) {
...
func (o GetOrgV2Environment200Response) ToMap() (map[string]interface{}, error) {
...
type NullableGetOrgV2Environment200Response struct {
	value *GetOrgV2Environment200Response
	isSet bool
}

func (v NullableGetOrgV2Environment200Response) Get() *GetOrgV2Environment200Response {
	return v.value
}

func (v *NullableGetOrgV2Environment200Response) Set(val *GetOrgV2Environment200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetOrgV2Environment200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetOrgV2Environment200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetOrgV2Environment200Response(val *GetOrgV2Environment200Response) *NullableGetOrgV2Environment200Response {
	return &NullableGetOrgV2Environment200Response{value: val, isSet: true}
}

func (v NullableGetOrgV2Environment200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetOrgV2Environment200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
