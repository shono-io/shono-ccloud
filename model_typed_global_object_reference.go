...
// checks if the TypedGlobalObjectReference type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TypedGlobalObjectReference{}
...
func (o TypedGlobalObjectReference) ToMap() (map[string]interface{}, error) {
