...
// checks if the CmkV2ClusterListDataInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CmkV2ClusterListDataInner{}

// CmkV2ClusterListDataInner struct for CmkV2ClusterListDataInner
type CmkV2ClusterListDataInner struct {
	...
	Id string `json:"id"`
	Metadata CmkV2ClusterMetadata `json:"metadata"`
...
func NewCmkV2ClusterListDataInner(id string, metadata CmkV2ClusterMetadata, spec map[string]interface{}, status CmkV2ClusterStatus) *CmkV2ClusterListDataInner {
	this := CmkV2ClusterListDataInner{}
	this.Id = id
...
func (o CmkV2ClusterListDataInner) MarshalJSON() ([]byte, error) {
...
func (o CmkV2ClusterListDataInner) ToMap() (map[string]interface{}, error) {
...
type NullableCmkV2ClusterListDataInner struct {
	value *CmkV2ClusterListDataInner
	isSet bool
}

func (v NullableCmkV2ClusterListDataInner) Get() *CmkV2ClusterListDataInner {
	return v.value
}

func (v *NullableCmkV2ClusterListDataInner) Set(val *CmkV2ClusterListDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableCmkV2ClusterListDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableCmkV2ClusterListDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCmkV2ClusterListDataInner(val *CmkV2ClusterListDataInner) *NullableCmkV2ClusterListDataInner {
	return &NullableCmkV2ClusterListDataInner{value: val, isSet: true}
}

func (v NullableCmkV2ClusterListDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCmkV2ClusterListDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
