...
// checks if the ReplicaData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ReplicaData{}
...
func (o ReplicaData) ToMap() (map[string]interface{}, error) {
