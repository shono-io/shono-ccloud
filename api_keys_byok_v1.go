...
type ApiCreateByokV1KeyRequest struct {
	ctx context.Context
	ApiService *KeysByokV1ApiService
	createByokV1KeyRequest *CreateByokV1KeyRequest
}

func (r ApiCreateByokV1KeyRequest) CreateByokV1KeyRequest(createByokV1KeyRequest CreateByokV1KeyRequest) ApiCreateByokV1KeyRequest {
	r.createByokV1KeyRequest = &createByokV1KeyRequest
	return r
}

func (r ApiCreateByokV1KeyRequest) Execute() (*CreateByokV1KeyRequest, *http.Response, error) {
...
*/
func (a *KeysByokV1ApiService) CreateByokV1Key(ctx context.Context) ApiCreateByokV1KeyRequest {
	return ApiCreateByokV1KeyRequest{
		ApiService: a,
		ctx: ctx,
	}
...
//  @return CreateByokV1KeyRequest
func (a *KeysByokV1ApiService) CreateByokV1KeyExecute(r ApiCreateByokV1KeyRequest) (*CreateByokV1KeyRequest, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *CreateByokV1KeyRequest
	)
	...
	// body params
	localVarPostBody = r.createByokV1KeyRequest
...
func (r ApiDeleteByokV1KeyRequest) Execute() (*http.Response, error) {
...
*/
func (a *KeysByokV1ApiService) DeleteByokV1Key(ctx context.Context, id string) ApiDeleteByokV1KeyRequest {
	return ApiDeleteByokV1KeyRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
func (a *KeysByokV1ApiService) DeleteByokV1KeyExecute(r ApiDeleteByokV1KeyRequest) (*http.Response, error) {
	var (
...
func (r ApiGetByokV1KeyRequest) Execute() (*GetByokV1Key200Response, *http.Response, error) {
...
*/
func (a *KeysByokV1ApiService) GetByokV1Key(ctx context.Context, id string) ApiGetByokV1KeyRequest {
	return ApiGetByokV1KeyRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
//  @return GetByokV1Key200Response
func (a *KeysByokV1ApiService) GetByokV1KeyExecute(r ApiGetByokV1KeyRequest) (*GetByokV1Key200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *GetByokV1Key200Response
	)
...
func (r ApiListByokV1KeysRequest) Execute() (*ListByokV1Keys200Response, *http.Response, error) {
...
*/
func (a *KeysByokV1ApiService) ListByokV1Keys(ctx context.Context) ApiListByokV1KeysRequest {
	return ApiListByokV1KeysRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return ListByokV1Keys200Response
func (a *KeysByokV1ApiService) ListByokV1KeysExecute(r ApiListByokV1KeysRequest) (*ListByokV1Keys200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *ListByokV1Keys200Response
	)
