...
// checks if the GetOrgV2Organization200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetOrgV2Organization200Response{}

// GetOrgV2Organization200Response struct for GetOrgV2Organization200Response
type GetOrgV2Organization200Response struct {
	...
	Id string `json:"id"`
	Metadata *OrgV2OrganizationMetadata `json:"metadata,omitempty"`
...
func NewGetOrgV2Organization200Response(apiVersion string, kind string, id string, displayName string) *GetOrgV2Organization200Response {
	this := GetOrgV2Organization200Response{}
...
func (o *GetOrgV2Organization200Response) GetMetadata() OrgV2OrganizationMetadata {
	if o == nil || IsNil(o.Metadata) {
		var ret OrgV2OrganizationMetadata
		return ret
	}
	return *o.Metadata
}
...
// SetMetadata gets a reference to the given OrgV2OrganizationMetadata and assigns it to the Metadata field.
...
func (o GetOrgV2Organization200Response) MarshalJSON() ([]byte, error) {
...
func (o GetOrgV2Organization200Response) ToMap() (map[string]interface{}, error) {
...
type NullableGetOrgV2Organization200Response struct {
	value *GetOrgV2Organization200Response
	isSet bool
}

func (v NullableGetOrgV2Organization200Response) Get() *GetOrgV2Organization200Response {
	return v.value
}

func (v *NullableGetOrgV2Organization200Response) Set(val *GetOrgV2Organization200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetOrgV2Organization200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetOrgV2Organization200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetOrgV2Organization200Response(val *GetOrgV2Organization200Response) *NullableGetOrgV2Organization200Response {
	return &NullableGetOrgV2Organization200Response{value: val, isSet: true}
}

func (v NullableGetOrgV2Organization200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetOrgV2Organization200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
