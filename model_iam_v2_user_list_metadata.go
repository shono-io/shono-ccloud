...
// checks if the IamV2UserListMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IamV2UserListMetadata{}

// IamV2UserListMetadata struct for IamV2UserListMetadata
type IamV2UserListMetadata struct {
...
func (o *IamV2UserListMetadata) HasFirst() bool {
	if o != nil && IsNil(o.First) {
		return true
	}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *IamV2UserListMetadata) GetPrevOk() (*interface{}, bool) {
...
func (o IamV2UserListMetadata) MarshalJSON() ([]byte, error) {
...
func (o IamV2UserListMetadata) ToMap() (map[string]interface{}, error) {
...
type NullableIamV2UserListMetadata struct {
	value *IamV2UserListMetadata
	isSet bool
}

func (v NullableIamV2UserListMetadata) Get() *IamV2UserListMetadata {
	return v.value
}

func (v *NullableIamV2UserListMetadata) Set(val *IamV2UserListMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableIamV2UserListMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableIamV2UserListMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIamV2UserListMetadata(val *IamV2UserListMetadata) *NullableIamV2UserListMetadata {
	return &NullableIamV2UserListMetadata{value: val, isSet: true}
}

func (v NullableIamV2UserListMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIamV2UserListMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
