...
// checks if the ListMeta type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListMeta{}
...
func (o ListMeta) ToMap() (map[string]interface{}, error) {
