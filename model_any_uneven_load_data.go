...
// checks if the AnyUnevenLoadData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AnyUnevenLoadData{}
...
func (o AnyUnevenLoadData) ToMap() (map[string]interface{}, error) {
