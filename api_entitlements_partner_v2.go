...
type ApiCreatePartnerV2EntitlementRequest struct {
	...
	createPartnerV2EntitlementRequest *CreatePartnerV2EntitlementRequest
}

func (r ApiCreatePartnerV2EntitlementRequest) CreatePartnerV2EntitlementRequest(createPartnerV2EntitlementRequest CreatePartnerV2EntitlementRequest) ApiCreatePartnerV2EntitlementRequest {
	r.createPartnerV2EntitlementRequest = &createPartnerV2EntitlementRequest
	return r
}

func (r ApiCreatePartnerV2EntitlementRequest) Execute() (*CreatePartnerV2EntitlementRequest, *http.Response, error) {
	return r.ApiService.CreatePartnerV2EntitlementExecute(r)
}
...
*/
func (a *EntitlementsPartnerV2ApiService) CreatePartnerV2Entitlement(ctx context.Context) ApiCreatePartnerV2EntitlementRequest {
	return ApiCreatePartnerV2EntitlementRequest{
		ApiService: a,
		ctx: ctx,
	}
...
//  @return CreatePartnerV2EntitlementRequest
func (a *EntitlementsPartnerV2ApiService) CreatePartnerV2EntitlementExecute(r ApiCreatePartnerV2EntitlementRequest) (*CreatePartnerV2EntitlementRequest, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *CreatePartnerV2EntitlementRequest
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "EntitlementsPartnerV2ApiService.CreatePartnerV2Entitlement")
	if err != nil {
	...
	// body params
	localVarPostBody = r.createPartnerV2EntitlementRequest
...
func (r ApiGetPartnerV2EntitlementRequest) Execute() (*CreatePartnerV2EntitlementRequest, *http.Response, error) {
	return r.ApiService.GetPartnerV2EntitlementExecute(r)
}
...
*/
func (a *EntitlementsPartnerV2ApiService) GetPartnerV2Entitlement(ctx context.Context, id string) ApiGetPartnerV2EntitlementRequest {
	return ApiGetPartnerV2EntitlementRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
//  @return CreatePartnerV2EntitlementRequest
func (a *EntitlementsPartnerV2ApiService) GetPartnerV2EntitlementExecute(r ApiGetPartnerV2EntitlementRequest) (*CreatePartnerV2EntitlementRequest, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "EntitlementsPartnerV2ApiService.GetPartnerV2Entitlement")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
	...
	if r.organizationId != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "organization.id", r.organizationId, "")
	}
	// to determine the Content-Type header
...
func (r ApiListPartnerV2EntitlementsRequest) Execute() (*PartnerV2EntitlementList, *http.Response, error) {
	return r.ApiService.ListPartnerV2EntitlementsExecute(r)
}
...
*/
func (a *EntitlementsPartnerV2ApiService) ListPartnerV2Entitlements(ctx context.Context) ApiListPartnerV2EntitlementsRequest {
	return ApiListPartnerV2EntitlementsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *EntitlementsPartnerV2ApiService) ListPartnerV2EntitlementsExecute(r ApiListPartnerV2EntitlementsRequest) (*PartnerV2EntitlementList, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "EntitlementsPartnerV2ApiService.ListPartnerV2Entitlements")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
