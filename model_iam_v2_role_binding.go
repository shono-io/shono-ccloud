...
// checks if the IamV2RoleBinding type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IamV2RoleBinding{}
...
func (o IamV2RoleBinding) ToMap() (map[string]interface{}, error) {
