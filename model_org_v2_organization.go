...
// checks if the OrgV2Organization type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OrgV2Organization{}
...
func (o OrgV2Organization) ToMap() (map[string]interface{}, error) {
