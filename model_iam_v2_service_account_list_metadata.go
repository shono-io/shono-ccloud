...
// checks if the IamV2ServiceAccountListMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IamV2ServiceAccountListMetadata{}

// IamV2ServiceAccountListMetadata struct for IamV2ServiceAccountListMetadata
type IamV2ServiceAccountListMetadata struct {
...
func NewIamV2ServiceAccountListMetadata() *IamV2ServiceAccountListMetadata {
	this := IamV2ServiceAccountListMetadata{}
	return &this
}
...
func (o IamV2ServiceAccountListMetadata) MarshalJSON() ([]byte, error) {
...
func (o IamV2ServiceAccountListMetadata) ToMap() (map[string]interface{}, error) {
...
type NullableIamV2ServiceAccountListMetadata struct {
	value *IamV2ServiceAccountListMetadata
	isSet bool
}

func (v NullableIamV2ServiceAccountListMetadata) Get() *IamV2ServiceAccountListMetadata {
	return v.value
}

func (v *NullableIamV2ServiceAccountListMetadata) Set(val *IamV2ServiceAccountListMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableIamV2ServiceAccountListMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableIamV2ServiceAccountListMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIamV2ServiceAccountListMetadata(val *IamV2ServiceAccountListMetadata) *NullableIamV2ServiceAccountListMetadata {
	return &NullableIamV2ServiceAccountListMetadata{value: val, isSet: true}
}

func (v NullableIamV2ServiceAccountListMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIamV2ServiceAccountListMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
