...
func (r ApiCreateKafkaTopicRequest) Execute() (*TopicData, *http.Response, error) {
...
*/
func (a *TopicV3ApiService) CreateKafkaTopic(ctx context.Context, clusterId string) ApiCreateKafkaTopicRequest {
	return ApiCreateKafkaTopicRequest{
		ApiService: a,
		ctx: ctx,
		clusterId: clusterId,
...
//  @return TopicData
func (a *TopicV3ApiService) CreateKafkaTopicExecute(r ApiCreateKafkaTopicRequest) (*TopicData, *http.Response, error) {
	var (
...
func (r ApiDeleteKafkaTopicRequest) IncludeAuthorizedOperations(includeAuthorizedOperations bool) ApiDeleteKafkaTopicRequest {
	r.includeAuthorizedOperations = &includeAuthorizedOperations
	return r
}

func (r ApiDeleteKafkaTopicRequest) Execute() (*http.Response, error) {
...
*/
func (a *TopicV3ApiService) DeleteKafkaTopic(ctx context.Context, clusterId string, topicName string) ApiDeleteKafkaTopicRequest {
	return ApiDeleteKafkaTopicRequest{
		ApiService: a,
		ctx: ctx,
		clusterId: clusterId,
...
// Execute executes the request
func (a *TopicV3ApiService) DeleteKafkaTopicExecute(r ApiDeleteKafkaTopicRequest) (*http.Response, error) {
	var (
	...
	if r.includeAuthorizedOperations != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "include_authorized_operations", r.includeAuthorizedOperations, "")
	}
	// to determine the Content-Type header
...
func (r ApiGetKafkaTopicRequest) Execute() (*TopicData, *http.Response, error) {
...
*/
func (a *TopicV3ApiService) GetKafkaTopic(ctx context.Context, clusterId string, topicName string) ApiGetKafkaTopicRequest {
	return ApiGetKafkaTopicRequest{
		ApiService: a,
		ctx: ctx,
		clusterId: clusterId,
...
// Execute executes the request
//  @return TopicData
func (a *TopicV3ApiService) GetKafkaTopicExecute(r ApiGetKafkaTopicRequest) (*TopicData, *http.Response, error) {
	var (
...
func (r ApiListKafkaTopicsRequest) Execute() (*TopicDataList, *http.Response, error) {
...
*/
func (a *TopicV3ApiService) ListKafkaTopics(ctx context.Context, clusterId string) ApiListKafkaTopicsRequest {
	return ApiListKafkaTopicsRequest{
		ApiService: a,
		ctx: ctx,
		clusterId: clusterId,
...
func (a *TopicV3ApiService) ListKafkaTopicsExecute(r ApiListKafkaTopicsRequest) (*TopicDataList, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
// Specify if authorized operations should be included in the response.
func (r ApiUpdatePartitionCountKafkaTopicRequest) IncludeAuthorizedOperations(includeAuthorizedOperations bool) ApiUpdatePartitionCountKafkaTopicRequest {
	r.includeAuthorizedOperations = &includeAuthorizedOperations
	return r
}
...
func (r ApiUpdatePartitionCountKafkaTopicRequest) Execute() (*TopicData, *http.Response, error) {
...
*/
func (a *TopicV3ApiService) UpdatePartitionCountKafkaTopic(ctx context.Context, clusterId string, topicName string) ApiUpdatePartitionCountKafkaTopicRequest {
	return ApiUpdatePartitionCountKafkaTopicRequest{
		ApiService: a,
		ctx: ctx,
		clusterId: clusterId,
...
// Execute executes the request
//  @return TopicData
func (a *TopicV3ApiService) UpdatePartitionCountKafkaTopicExecute(r ApiUpdatePartitionCountKafkaTopicRequest) (*TopicData, *http.Response, error) {
	var (
