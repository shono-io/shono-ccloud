...
// checks if the CreateNetworkingV1Network202Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateNetworkingV1Network202Response{}

// CreateNetworkingV1Network202Response struct for CreateNetworkingV1Network202Response
type CreateNetworkingV1Network202Response struct {
	...
	Metadata *NetworkingV1NetworkMetadata `json:"metadata,omitempty"`
	Spec ListNetworkingV1Networks200ResponseAllOfDataInnerSpec `json:"spec"`
...
func NewCreateNetworkingV1Network202Response(spec ListNetworkingV1Networks200ResponseAllOfDataInnerSpec, status NetworkingV1NetworkStatus) *CreateNetworkingV1Network202Response {
	this := CreateNetworkingV1Network202Response{}
	this.Spec = spec
	this.Status = status
	return &this
}
...
func (o *CreateNetworkingV1Network202Response) GetMetadata() NetworkingV1NetworkMetadata {
	if o == nil || IsNil(o.Metadata) {
		var ret NetworkingV1NetworkMetadata
		return ret
	}
	return *o.Metadata
}
...
// SetMetadata gets a reference to the given NetworkingV1NetworkMetadata and assigns it to the Metadata field.
...
func (o *CreateNetworkingV1Network202Response) GetSpec() ListNetworkingV1Networks200ResponseAllOfDataInnerSpec {
	if o == nil {
		var ret ListNetworkingV1Networks200ResponseAllOfDataInnerSpec
		return ret
	}
...
func (o CreateNetworkingV1Network202Response) MarshalJSON() ([]byte, error) {
...
func (o CreateNetworkingV1Network202Response) ToMap() (map[string]interface{}, error) {
...
type NullableCreateNetworkingV1Network202Response struct {
	value *CreateNetworkingV1Network202Response
	isSet bool
}

func (v NullableCreateNetworkingV1Network202Response) Get() *CreateNetworkingV1Network202Response {
	return v.value
}

func (v *NullableCreateNetworkingV1Network202Response) Set(val *CreateNetworkingV1Network202Response) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateNetworkingV1Network202Response) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateNetworkingV1Network202Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateNetworkingV1Network202Response(val *CreateNetworkingV1Network202Response) *NullableCreateNetworkingV1Network202Response {
	return &NullableCreateNetworkingV1Network202Response{value: val, isSet: true}
}

func (v NullableCreateNetworkingV1Network202Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateNetworkingV1Network202Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
