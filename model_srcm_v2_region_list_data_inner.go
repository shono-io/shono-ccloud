...
// checks if the SrcmV2RegionListDataInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SrcmV2RegionListDataInner{}

// SrcmV2RegionListDataInner struct for SrcmV2RegionListDataInner
type SrcmV2RegionListDataInner struct {
	...
	Id string `json:"id"`
	Metadata SrcmV2RegionMetadata `json:"metadata"`
...
func NewSrcmV2RegionListDataInner(id string, metadata SrcmV2RegionMetadata, spec map[string]interface{}) *SrcmV2RegionListDataInner {
	this := SrcmV2RegionListDataInner{}
	this.Id = id
...
func (o SrcmV2RegionListDataInner) MarshalJSON() ([]byte, error) {
...
func (o SrcmV2RegionListDataInner) ToMap() (map[string]interface{}, error) {
...
type NullableSrcmV2RegionListDataInner struct {
	value *SrcmV2RegionListDataInner
	isSet bool
}

func (v NullableSrcmV2RegionListDataInner) Get() *SrcmV2RegionListDataInner {
	return v.value
}

func (v *NullableSrcmV2RegionListDataInner) Set(val *SrcmV2RegionListDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableSrcmV2RegionListDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableSrcmV2RegionListDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSrcmV2RegionListDataInner(val *SrcmV2RegionListDataInner) *NullableSrcmV2RegionListDataInner {
	return &NullableSrcmV2RegionListDataInner{value: val, isSet: true}
}

func (v NullableSrcmV2RegionListDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSrcmV2RegionListDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
