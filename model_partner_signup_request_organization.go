...
// checks if the PartnerSignupRequestOrganization type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PartnerSignupRequestOrganization{}

// PartnerSignupRequestOrganization struct for PartnerSignupRequestOrganization
type PartnerSignupRequestOrganization struct {
	...
	SsoConfig PartnerV2OrganizationSsoConfig `json:"sso_config"`
}
...
func NewPartnerSignupRequestOrganization(name string, ssoConfig PartnerV2OrganizationSsoConfig) *PartnerSignupRequestOrganization {
	this := PartnerSignupRequestOrganization{}
	this.Name = name
...
// GetSsoConfig returns the SsoConfig field value
...
// GetSsoConfigOk returns a tuple with the SsoConfig field value
// and a boolean to check if the value has been set.
...
// SetSsoConfig sets field value
func (o *PartnerSignupRequestOrganization) SetSsoConfig(v PartnerV2OrganizationSsoConfig) {
	o.SsoConfig = v
}

func (o PartnerSignupRequestOrganization) MarshalJSON() ([]byte, error) {
...
func (o PartnerSignupRequestOrganization) ToMap() (map[string]interface{}, error) {
...
type NullablePartnerSignupRequestOrganization struct {
	value *PartnerSignupRequestOrganization
	isSet bool
}

func (v NullablePartnerSignupRequestOrganization) Get() *PartnerSignupRequestOrganization {
	return v.value
}

func (v *NullablePartnerSignupRequestOrganization) Set(val *PartnerSignupRequestOrganization) {
	v.value = val
	v.isSet = true
}

func (v NullablePartnerSignupRequestOrganization) IsSet() bool {
	return v.isSet
}

func (v *NullablePartnerSignupRequestOrganization) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePartnerSignupRequestOrganization(val *PartnerSignupRequestOrganization) *NullablePartnerSignupRequestOrganization {
	return &NullablePartnerSignupRequestOrganization{value: val, isSet: true}
}

func (v NullablePartnerSignupRequestOrganization) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePartnerSignupRequestOrganization) UnmarshalJSON(src []byte) error {
	v.isSet = true
