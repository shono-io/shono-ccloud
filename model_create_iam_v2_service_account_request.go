...
// checks if the CreateIamV2ServiceAccountRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateIamV2ServiceAccountRequest{}

// CreateIamV2ServiceAccountRequest struct for CreateIamV2ServiceAccountRequest
type CreateIamV2ServiceAccountRequest struct {
...
func NewCreateIamV2ServiceAccountRequest(displayName string) *CreateIamV2ServiceAccountRequest {
	this := CreateIamV2ServiceAccountRequest{}
...
func (o CreateIamV2ServiceAccountRequest) MarshalJSON() ([]byte, error) {
...
func (o CreateIamV2ServiceAccountRequest) ToMap() (map[string]interface{}, error) {
...
type NullableCreateIamV2ServiceAccountRequest struct {
	value *CreateIamV2ServiceAccountRequest
	isSet bool
}

func (v NullableCreateIamV2ServiceAccountRequest) Get() *CreateIamV2ServiceAccountRequest {
	return v.value
}

func (v *NullableCreateIamV2ServiceAccountRequest) Set(val *CreateIamV2ServiceAccountRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateIamV2ServiceAccountRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateIamV2ServiceAccountRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateIamV2ServiceAccountRequest(val *CreateIamV2ServiceAccountRequest) *NullableCreateIamV2ServiceAccountRequest {
	return &NullableCreateIamV2ServiceAccountRequest{value: val, isSet: true}
}

func (v NullableCreateIamV2ServiceAccountRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateIamV2ServiceAccountRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
