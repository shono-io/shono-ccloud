...
// checks if the IamV2IdentityProvider type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IamV2IdentityProvider{}
...
func (o IamV2IdentityProvider) ToMap() (map[string]interface{}, error) {
