...
// checks if the PartnerV2Entitlement type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PartnerV2Entitlement{}
...
func (o PartnerV2Entitlement) ToMap() (map[string]interface{}, error) {
