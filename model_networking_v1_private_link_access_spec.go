...
// checks if the NetworkingV1PrivateLinkAccessSpec type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NetworkingV1PrivateLinkAccessSpec{}
...
type NetworkingV1PrivateLinkAccessSpec struct {
	...
	Cloud *NetworkingV1PrivateLinkAccessSpecCloud `json:"cloud,omitempty"`
...
func (o *NetworkingV1PrivateLinkAccessSpec) GetCloud() NetworkingV1PrivateLinkAccessSpecCloud {
	if o == nil || IsNil(o.Cloud) {
		var ret NetworkingV1PrivateLinkAccessSpecCloud
		return ret
	}
	return *o.Cloud
}
...
// SetCloud gets a reference to the given NetworkingV1PrivateLinkAccessSpecCloud and assigns it to the Cloud field.
...
func (o NetworkingV1PrivateLinkAccessSpec) ToMap() (map[string]interface{}, error) {
