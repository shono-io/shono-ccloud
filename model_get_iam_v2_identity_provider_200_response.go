...
// checks if the GetIamV2IdentityProvider200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetIamV2IdentityProvider200Response{}

// GetIamV2IdentityProvider200Response struct for GetIamV2IdentityProvider200Response
type GetIamV2IdentityProvider200Response struct {
	...
	Id string `json:"id"`
	Metadata *IamV2IdentityProviderMetadata `json:"metadata,omitempty"`
...
func NewGetIamV2IdentityProvider200Response(apiVersion string, kind string, id string, displayName string, description string, state string, issuer string, jwksUri string) *GetIamV2IdentityProvider200Response {
	this := GetIamV2IdentityProvider200Response{}
...
func (o *GetIamV2IdentityProvider200Response) GetMetadata() IamV2IdentityProviderMetadata {
	if o == nil || IsNil(o.Metadata) {
		var ret IamV2IdentityProviderMetadata
		return ret
	}
	return *o.Metadata
}
...
// SetMetadata gets a reference to the given IamV2IdentityProviderMetadata and assigns it to the Metadata field.
...
func (o GetIamV2IdentityProvider200Response) MarshalJSON() ([]byte, error) {
...
func (o GetIamV2IdentityProvider200Response) ToMap() (map[string]interface{}, error) {
	...
	// skip: keys is readOnly
	return toSerialize, nil
}

type NullableGetIamV2IdentityProvider200Response struct {
	value *GetIamV2IdentityProvider200Response
	isSet bool
}

func (v NullableGetIamV2IdentityProvider200Response) Get() *GetIamV2IdentityProvider200Response {
	return v.value
}

func (v *NullableGetIamV2IdentityProvider200Response) Set(val *GetIamV2IdentityProvider200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetIamV2IdentityProvider200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetIamV2IdentityProvider200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetIamV2IdentityProvider200Response(val *GetIamV2IdentityProvider200Response) *NullableGetIamV2IdentityProvider200Response {
	return &NullableGetIamV2IdentityProvider200Response{value: val, isSet: true}
}

func (v NullableGetIamV2IdentityProvider200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetIamV2IdentityProvider200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
