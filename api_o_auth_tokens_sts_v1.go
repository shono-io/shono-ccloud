...
type ApiExchangeStsV1OauthTokenRequest struct {
	ctx context.Context
	ApiService *OAuthTokensStsV1ApiService
	apiVersion *string
	kind *string
	id *string
	metadata *StsV1TokenExchangeRequestMetadata
	grantType *string
	subjectToken *string
...
func (r ApiExchangeStsV1OauthTokenRequest) Metadata(metadata StsV1TokenExchangeRequestMetadata) ApiExchangeStsV1OauthTokenRequest {
	r.metadata = &metadata
	return r
}
...
func (r ApiExchangeStsV1OauthTokenRequest) Execute() (*StsV1TokenExchangeReply, *http.Response, error) {
...
*/
func (a *OAuthTokensStsV1ApiService) ExchangeStsV1OauthToken(ctx context.Context) ApiExchangeStsV1OauthTokenRequest {
	return ApiExchangeStsV1OauthTokenRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *OAuthTokensStsV1ApiService) ExchangeStsV1OauthTokenExecute(r ApiExchangeStsV1OauthTokenRequest) (*StsV1TokenExchangeReply, *http.Response, error) {
	var (
	...
	if r.apiVersion != nil {
		parameterAddToHeaderOrQuery(localVarFormParams, "api_version", r.apiVersion, "")
	}
	if r.kind != nil {
	...
	if r.identityPoolId != nil {
		parameterAddToHeaderOrQuery(localVarFormParams, "identity_pool_id", r.identityPoolId, "")
	}
	...
	if r.expiresIn != nil {
		parameterAddToHeaderOrQuery(localVarFormParams, "expires_in", r.expiresIn, "")
	}
