...
// checks if the NetworkingV1PeeringSpecNetwork type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NetworkingV1PeeringSpecNetwork{}

// NetworkingV1PeeringSpecNetwork The network to which this belongs.
type NetworkingV1PeeringSpecNetwork struct {
...
func NewNetworkingV1PeeringSpecNetwork(id string, related string, resourceName string) *NetworkingV1PeeringSpecNetwork {
	this := NetworkingV1PeeringSpecNetwork{}
	this.Id = id
...
func (o NetworkingV1PeeringSpecNetwork) MarshalJSON() ([]byte, error) {
...
func (o NetworkingV1PeeringSpecNetwork) ToMap() (map[string]interface{}, error) {
...
type NullableNetworkingV1PeeringSpecNetwork struct {
	value *NetworkingV1PeeringSpecNetwork
	isSet bool
}

func (v NullableNetworkingV1PeeringSpecNetwork) Get() *NetworkingV1PeeringSpecNetwork {
	return v.value
}

func (v *NullableNetworkingV1PeeringSpecNetwork) Set(val *NetworkingV1PeeringSpecNetwork) {
	v.value = val
	v.isSet = true
}

func (v NullableNetworkingV1PeeringSpecNetwork) IsSet() bool {
	return v.isSet
}

func (v *NullableNetworkingV1PeeringSpecNetwork) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNetworkingV1PeeringSpecNetwork(val *NetworkingV1PeeringSpecNetwork) *NullableNetworkingV1PeeringSpecNetwork {
	return &NullableNetworkingV1PeeringSpecNetwork{value: val, isSet: true}
}

func (v NullableNetworkingV1PeeringSpecNetwork) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNetworkingV1PeeringSpecNetwork) UnmarshalJSON(src []byte) error {
	v.isSet = true
