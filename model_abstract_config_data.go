...
// checks if the AbstractConfigData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AbstractConfigData{}
...
func (o AbstractConfigData) ToMap() (map[string]interface{}, error) {
