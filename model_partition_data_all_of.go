...
// checks if the PartitionDataAllOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PartitionDataAllOf{}
...
func (o PartitionDataAllOf) ToMap() (map[string]interface{}, error) {
