...
// checks if the CreateNetworkingV1NetworkLinkEndpointRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateNetworkingV1NetworkLinkEndpointRequest{}

// CreateNetworkingV1NetworkLinkEndpointRequest struct for CreateNetworkingV1NetworkLinkEndpointRequest
type CreateNetworkingV1NetworkLinkEndpointRequest struct {
	...
	Spec CreateNetworkingV1NetworkLinkEndpointRequestAllOf1Spec `json:"spec"`
...
func NewCreateNetworkingV1NetworkLinkEndpointRequest(spec CreateNetworkingV1NetworkLinkEndpointRequestAllOf1Spec) *CreateNetworkingV1NetworkLinkEndpointRequest {
	this := CreateNetworkingV1NetworkLinkEndpointRequest{}
	this.Spec = spec
	return &this
}
...
func (o *CreateNetworkingV1NetworkLinkEndpointRequest) GetSpec() CreateNetworkingV1NetworkLinkEndpointRequestAllOf1Spec {
	if o == nil {
		var ret CreateNetworkingV1NetworkLinkEndpointRequestAllOf1Spec
		return ret
	}
...
func (o CreateNetworkingV1NetworkLinkEndpointRequest) MarshalJSON() ([]byte, error) {
...
func (o CreateNetworkingV1NetworkLinkEndpointRequest) ToMap() (map[string]interface{}, error) {
...
type NullableCreateNetworkingV1NetworkLinkEndpointRequest struct {
	value *CreateNetworkingV1NetworkLinkEndpointRequest
	isSet bool
}

func (v NullableCreateNetworkingV1NetworkLinkEndpointRequest) Get() *CreateNetworkingV1NetworkLinkEndpointRequest {
	return v.value
}

func (v *NullableCreateNetworkingV1NetworkLinkEndpointRequest) Set(val *CreateNetworkingV1NetworkLinkEndpointRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateNetworkingV1NetworkLinkEndpointRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateNetworkingV1NetworkLinkEndpointRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateNetworkingV1NetworkLinkEndpointRequest(val *CreateNetworkingV1NetworkLinkEndpointRequest) *NullableCreateNetworkingV1NetworkLinkEndpointRequest {
	return &NullableCreateNetworkingV1NetworkLinkEndpointRequest{value: val, isSet: true}
}

func (v NullableCreateNetworkingV1NetworkLinkEndpointRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateNetworkingV1NetworkLinkEndpointRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
