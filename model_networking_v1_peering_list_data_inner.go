...
// checks if the NetworkingV1PeeringListDataInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NetworkingV1PeeringListDataInner{}

// NetworkingV1PeeringListDataInner struct for NetworkingV1PeeringListDataInner
type NetworkingV1PeeringListDataInner struct {
	...
	Id string `json:"id"`
	Metadata NetworkingV1PeeringMetadata `json:"metadata"`
...
func NewNetworkingV1PeeringListDataInner(id string, metadata NetworkingV1PeeringMetadata, spec map[string]interface{}, status NetworkingV1PeeringStatus) *NetworkingV1PeeringListDataInner {
	this := NetworkingV1PeeringListDataInner{}
	this.Id = id
...
func (o NetworkingV1PeeringListDataInner) MarshalJSON() ([]byte, error) {
...
func (o NetworkingV1PeeringListDataInner) ToMap() (map[string]interface{}, error) {
...
type NullableNetworkingV1PeeringListDataInner struct {
	value *NetworkingV1PeeringListDataInner
	isSet bool
}

func (v NullableNetworkingV1PeeringListDataInner) Get() *NetworkingV1PeeringListDataInner {
	return v.value
}

func (v *NullableNetworkingV1PeeringListDataInner) Set(val *NetworkingV1PeeringListDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableNetworkingV1PeeringListDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableNetworkingV1PeeringListDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNetworkingV1PeeringListDataInner(val *NetworkingV1PeeringListDataInner) *NullableNetworkingV1PeeringListDataInner {
	return &NullableNetworkingV1PeeringListDataInner{value: val, isSet: true}
}

func (v NullableNetworkingV1PeeringListDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNetworkingV1PeeringListDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
