...
// checks if the ListLinkConfigsResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListLinkConfigsResponseData{}
...
func (o ListLinkConfigsResponseData) ToMap() (map[string]interface{}, error) {
