...
// checks if the IamV2JwksObject type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IamV2JwksObject{}
...
func (o IamV2JwksObject) ToMap() (map[string]interface{}, error) {
