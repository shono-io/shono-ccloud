...
// checks if the NetworkingV1PrivateLinkAccessMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NetworkingV1PrivateLinkAccessMetadata{}

// NetworkingV1PrivateLinkAccessMetadata struct for NetworkingV1PrivateLinkAccessMetadata
type NetworkingV1PrivateLinkAccessMetadata struct {
...
func NewNetworkingV1PrivateLinkAccessMetadata(self interface{}) *NetworkingV1PrivateLinkAccessMetadata {
	this := NetworkingV1PrivateLinkAccessMetadata{}
	this.Self = self
	return &this
}
...
func (o *NetworkingV1PrivateLinkAccessMetadata) SetSelf(v interface{}) {
	o.Self = v
}
...
func (o NetworkingV1PrivateLinkAccessMetadata) MarshalJSON() ([]byte, error) {
...
func (o NetworkingV1PrivateLinkAccessMetadata) ToMap() (map[string]interface{}, error) {
...
type NullableNetworkingV1PrivateLinkAccessMetadata struct {
	value *NetworkingV1PrivateLinkAccessMetadata
	isSet bool
}

func (v NullableNetworkingV1PrivateLinkAccessMetadata) Get() *NetworkingV1PrivateLinkAccessMetadata {
	return v.value
}

func (v *NullableNetworkingV1PrivateLinkAccessMetadata) Set(val *NetworkingV1PrivateLinkAccessMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableNetworkingV1PrivateLinkAccessMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableNetworkingV1PrivateLinkAccessMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNetworkingV1PrivateLinkAccessMetadata(val *NetworkingV1PrivateLinkAccessMetadata) *NullableNetworkingV1PrivateLinkAccessMetadata {
	return &NullableNetworkingV1PrivateLinkAccessMetadata{value: val, isSet: true}
}

func (v NullableNetworkingV1PrivateLinkAccessMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNetworkingV1PrivateLinkAccessMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
