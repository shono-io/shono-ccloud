...
// checks if the PartitionData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PartitionData{}
...
func (o PartitionData) ToMap() (map[string]interface{}, error) {
