...
// checks if the IamV2RoleBindingListMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IamV2RoleBindingListMetadata{}

// IamV2RoleBindingListMetadata struct for IamV2RoleBindingListMetadata
type IamV2RoleBindingListMetadata struct {
...
func NewIamV2RoleBindingListMetadata() *IamV2RoleBindingListMetadata {
	this := IamV2RoleBindingListMetadata{}
	return &this
}
...
func (o *IamV2RoleBindingListMetadata) HasFirst() bool {
	if o != nil && IsNil(o.First) {
		return true
	}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *IamV2RoleBindingListMetadata) GetPrevOk() (*interface{}, bool) {
...
func (o IamV2RoleBindingListMetadata) MarshalJSON() ([]byte, error) {
...
func (o IamV2RoleBindingListMetadata) ToMap() (map[string]interface{}, error) {
...
type NullableIamV2RoleBindingListMetadata struct {
	value *IamV2RoleBindingListMetadata
	isSet bool
}

func (v NullableIamV2RoleBindingListMetadata) Get() *IamV2RoleBindingListMetadata {
	return v.value
}

func (v *NullableIamV2RoleBindingListMetadata) Set(val *IamV2RoleBindingListMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableIamV2RoleBindingListMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableIamV2RoleBindingListMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIamV2RoleBindingListMetadata(val *IamV2RoleBindingListMetadata) *NullableIamV2RoleBindingListMetadata {
	return &NullableIamV2RoleBindingListMetadata{value: val, isSet: true}
}

func (v NullableIamV2RoleBindingListMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIamV2RoleBindingListMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
