...
// checks if the ByokV1AzureKey type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ByokV1AzureKey{}
...
func (o ByokV1AzureKey) ToMap() (map[string]interface{}, error) {
