...
// checks if the ValidateConnectv1ConnectorPlugin200ResponseConfigsInnerDefinition type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ValidateConnectv1ConnectorPlugin200ResponseConfigsInnerDefinition{}

// ValidateConnectv1ConnectorPlugin200ResponseConfigsInnerDefinition The definition for a config in the connector plugin, which includes the name, type, importance, etc.
type ValidateConnectv1ConnectorPlugin200ResponseConfigsInnerDefinition struct {
...
func NewValidateConnectv1ConnectorPlugin200ResponseConfigsInnerDefinition() *ValidateConnectv1ConnectorPlugin200ResponseConfigsInnerDefinition {
	this := ValidateConnectv1ConnectorPlugin200ResponseConfigsInnerDefinition{}
	return &this
}
...
func (o ValidateConnectv1ConnectorPlugin200ResponseConfigsInnerDefinition) MarshalJSON() ([]byte, error) {
...
func (o ValidateConnectv1ConnectorPlugin200ResponseConfigsInnerDefinition) ToMap() (map[string]interface{}, error) {
...
type NullableValidateConnectv1ConnectorPlugin200ResponseConfigsInnerDefinition struct {
	value *ValidateConnectv1ConnectorPlugin200ResponseConfigsInnerDefinition
	isSet bool
}

func (v NullableValidateConnectv1ConnectorPlugin200ResponseConfigsInnerDefinition) Get() *ValidateConnectv1ConnectorPlugin200ResponseConfigsInnerDefinition {
	return v.value
}

func (v *NullableValidateConnectv1ConnectorPlugin200ResponseConfigsInnerDefinition) Set(val *ValidateConnectv1ConnectorPlugin200ResponseConfigsInnerDefinition) {
	v.value = val
	v.isSet = true
}

func (v NullableValidateConnectv1ConnectorPlugin200ResponseConfigsInnerDefinition) IsSet() bool {
	return v.isSet
}

func (v *NullableValidateConnectv1ConnectorPlugin200ResponseConfigsInnerDefinition) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableValidateConnectv1ConnectorPlugin200ResponseConfigsInnerDefinition(val *ValidateConnectv1ConnectorPlugin200ResponseConfigsInnerDefinition) *NullableValidateConnectv1ConnectorPlugin200ResponseConfigsInnerDefinition {
	return &NullableValidateConnectv1ConnectorPlugin200ResponseConfigsInnerDefinition{value: val, isSet: true}
}

func (v NullableValidateConnectv1ConnectorPlugin200ResponseConfigsInnerDefinition) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableValidateConnectv1ConnectorPlugin200ResponseConfigsInnerDefinition) UnmarshalJSON(src []byte) error {
	v.isSet = true
