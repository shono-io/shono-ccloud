...
// checks if the IamV2UserMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IamV2UserMetadata{}

// IamV2UserMetadata struct for IamV2UserMetadata
type IamV2UserMetadata struct {
...
func (o IamV2UserMetadata) MarshalJSON() ([]byte, error) {
...
func (o IamV2UserMetadata) ToMap() (map[string]interface{}, error) {
...
type NullableIamV2UserMetadata struct {
	value *IamV2UserMetadata
	isSet bool
}

func (v NullableIamV2UserMetadata) Get() *IamV2UserMetadata {
	return v.value
}

func (v *NullableIamV2UserMetadata) Set(val *IamV2UserMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableIamV2UserMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableIamV2UserMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIamV2UserMetadata(val *IamV2UserMetadata) *NullableIamV2UserMetadata {
	return &NullableIamV2UserMetadata{value: val, isSet: true}
}

func (v NullableIamV2UserMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIamV2UserMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
