...
// checks if the ByokV1KeyListDataInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ByokV1KeyListDataInner{}

// ByokV1KeyListDataInner struct for ByokV1KeyListDataInner
type ByokV1KeyListDataInner struct {
	...
	Id string `json:"id"`
	Metadata ByokV1KeyMetadata `json:"metadata"`
...
func (o ByokV1KeyListDataInner) MarshalJSON() ([]byte, error) {
...
func (o ByokV1KeyListDataInner) ToMap() (map[string]interface{}, error) {
...
type NullableByokV1KeyListDataInner struct {
	value *ByokV1KeyListDataInner
	isSet bool
}

func (v NullableByokV1KeyListDataInner) Get() *ByokV1KeyListDataInner {
	return v.value
}

func (v *NullableByokV1KeyListDataInner) Set(val *ByokV1KeyListDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableByokV1KeyListDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableByokV1KeyListDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableByokV1KeyListDataInner(val *ByokV1KeyListDataInner) *NullableByokV1KeyListDataInner {
	return &NullableByokV1KeyListDataInner{value: val, isSet: true}
}

func (v NullableByokV1KeyListDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableByokV1KeyListDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
