...
// checks if the SdV1PipelineListMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SdV1PipelineListMetadata{}

// SdV1PipelineListMetadata struct for SdV1PipelineListMetadata
type SdV1PipelineListMetadata struct {
...
func (o *SdV1PipelineListMetadata) HasFirst() bool {
	if o != nil && IsNil(o.First) {
		return true
	}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *SdV1PipelineListMetadata) GetPrevOk() (*interface{}, bool) {
...
func (o SdV1PipelineListMetadata) MarshalJSON() ([]byte, error) {
...
func (o SdV1PipelineListMetadata) ToMap() (map[string]interface{}, error) {
...
type NullableSdV1PipelineListMetadata struct {
	value *SdV1PipelineListMetadata
	isSet bool
}

func (v NullableSdV1PipelineListMetadata) Get() *SdV1PipelineListMetadata {
	return v.value
}

func (v *NullableSdV1PipelineListMetadata) Set(val *SdV1PipelineListMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableSdV1PipelineListMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableSdV1PipelineListMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSdV1PipelineListMetadata(val *SdV1PipelineListMetadata) *NullableSdV1PipelineListMetadata {
	return &NullableSdV1PipelineListMetadata{value: val, isSet: true}
}

func (v NullableSdV1PipelineListMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSdV1PipelineListMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
