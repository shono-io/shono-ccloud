...
// checks if the CreateIamV2IdentityProviderRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateIamV2IdentityProviderRequest{}

// CreateIamV2IdentityProviderRequest struct for CreateIamV2IdentityProviderRequest
type CreateIamV2IdentityProviderRequest struct {
...
func NewCreateIamV2IdentityProviderRequest(displayName string, description string, issuer string, jwksUri string) *CreateIamV2IdentityProviderRequest {
	this := CreateIamV2IdentityProviderRequest{}
...
func (o CreateIamV2IdentityProviderRequest) MarshalJSON() ([]byte, error) {
...
func (o CreateIamV2IdentityProviderRequest) ToMap() (map[string]interface{}, error) {
...
type NullableCreateIamV2IdentityProviderRequest struct {
	value *CreateIamV2IdentityProviderRequest
	isSet bool
}

func (v NullableCreateIamV2IdentityProviderRequest) Get() *CreateIamV2IdentityProviderRequest {
	return v.value
}

func (v *NullableCreateIamV2IdentityProviderRequest) Set(val *CreateIamV2IdentityProviderRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateIamV2IdentityProviderRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateIamV2IdentityProviderRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateIamV2IdentityProviderRequest(val *CreateIamV2IdentityProviderRequest) *NullableCreateIamV2IdentityProviderRequest {
	return &NullableCreateIamV2IdentityProviderRequest{value: val, isSet: true}
}

func (v NullableCreateIamV2IdentityProviderRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateIamV2IdentityProviderRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
