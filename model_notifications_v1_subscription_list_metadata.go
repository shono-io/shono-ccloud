...
// checks if the NotificationsV1SubscriptionListMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NotificationsV1SubscriptionListMetadata{}

// NotificationsV1SubscriptionListMetadata struct for NotificationsV1SubscriptionListMetadata
type NotificationsV1SubscriptionListMetadata struct {
...
func NewNotificationsV1SubscriptionListMetadata() *NotificationsV1SubscriptionListMetadata {
	this := NotificationsV1SubscriptionListMetadata{}
	return &this
}
...
func (o *NotificationsV1SubscriptionListMetadata) GetPrev() interface{} {
	if o == nil {
		var ret interface{}
		return ret
	}
...
func (o NotificationsV1SubscriptionListMetadata) MarshalJSON() ([]byte, error) {
...
func (o NotificationsV1SubscriptionListMetadata) ToMap() (map[string]interface{}, error) {
...
type NullableNotificationsV1SubscriptionListMetadata struct {
	value *NotificationsV1SubscriptionListMetadata
	isSet bool
}

func (v NullableNotificationsV1SubscriptionListMetadata) Get() *NotificationsV1SubscriptionListMetadata {
	return v.value
}

func (v *NullableNotificationsV1SubscriptionListMetadata) Set(val *NotificationsV1SubscriptionListMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableNotificationsV1SubscriptionListMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableNotificationsV1SubscriptionListMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNotificationsV1SubscriptionListMetadata(val *NotificationsV1SubscriptionListMetadata) *NullableNotificationsV1SubscriptionListMetadata {
	return &NullableNotificationsV1SubscriptionListMetadata{value: val, isSet: true}
}

func (v NullableNotificationsV1SubscriptionListMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNotificationsV1SubscriptionListMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
