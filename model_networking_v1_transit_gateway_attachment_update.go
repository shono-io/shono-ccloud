...
// checks if the NetworkingV1TransitGatewayAttachmentUpdate type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NetworkingV1TransitGatewayAttachmentUpdate{}
...
func (o NetworkingV1TransitGatewayAttachmentUpdate) ToMap() (map[string]interface{}, error) {
