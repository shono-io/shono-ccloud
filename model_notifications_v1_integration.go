...
// checks if the NotificationsV1Integration type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NotificationsV1Integration{}
...
type NotificationsV1Integration struct {
	...
	Target *NotificationsV1IntegrationTarget `json:"target,omitempty"`
}
...
// SetTarget gets a reference to the given NotificationsV1IntegrationTarget and assigns it to the Target field.
...
func (o NotificationsV1Integration) ToMap() (map[string]interface{}, error) {
