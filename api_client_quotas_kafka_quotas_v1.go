...
type ApiCreateKafkaQuotasV1ClientQuotaRequest struct {
	ctx context.Context
	ApiService *ClientQuotasKafkaQuotasV1ApiService
	createKafkaQuotasV1ClientQuotaRequest *CreateKafkaQuotasV1ClientQuotaRequest
}

func (r ApiCreateKafkaQuotasV1ClientQuotaRequest) CreateKafkaQuotasV1ClientQuotaRequest(createKafkaQuotasV1ClientQuotaRequest CreateKafkaQuotasV1ClientQuotaRequest) ApiCreateKafkaQuotasV1ClientQuotaRequest {
	r.createKafkaQuotasV1ClientQuotaRequest = &createKafkaQuotasV1ClientQuotaRequest
	return r
}

func (r ApiCreateKafkaQuotasV1ClientQuotaRequest) Execute() (*CreateKafkaQuotasV1ClientQuota202Response, *http.Response, error) {
...
*/
func (a *ClientQuotasKafkaQuotasV1ApiService) CreateKafkaQuotasV1ClientQuota(ctx context.Context) ApiCreateKafkaQuotasV1ClientQuotaRequest {
	return ApiCreateKafkaQuotasV1ClientQuotaRequest{
		ApiService: a,
		ctx: ctx,
	}
...
//  @return CreateKafkaQuotasV1ClientQuota202Response
func (a *ClientQuotasKafkaQuotasV1ApiService) CreateKafkaQuotasV1ClientQuotaExecute(r ApiCreateKafkaQuotasV1ClientQuotaRequest) (*CreateKafkaQuotasV1ClientQuota202Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *CreateKafkaQuotasV1ClientQuota202Response
	)
	...
	// body params
	localVarPostBody = r.createKafkaQuotasV1ClientQuotaRequest
...
func (r ApiDeleteKafkaQuotasV1ClientQuotaRequest) Execute() (*http.Response, error) {
...
*/
func (a *ClientQuotasKafkaQuotasV1ApiService) DeleteKafkaQuotasV1ClientQuota(ctx context.Context, id string) ApiDeleteKafkaQuotasV1ClientQuotaRequest {
	return ApiDeleteKafkaQuotasV1ClientQuotaRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
func (a *ClientQuotasKafkaQuotasV1ApiService) DeleteKafkaQuotasV1ClientQuotaExecute(r ApiDeleteKafkaQuotasV1ClientQuotaRequest) (*http.Response, error) {
	var (
...
func (r ApiGetKafkaQuotasV1ClientQuotaRequest) Execute() (*GetKafkaQuotasV1ClientQuota200Response, *http.Response, error) {
...
*/
func (a *ClientQuotasKafkaQuotasV1ApiService) GetKafkaQuotasV1ClientQuota(ctx context.Context, id string) ApiGetKafkaQuotasV1ClientQuotaRequest {
	return ApiGetKafkaQuotasV1ClientQuotaRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
//  @return GetKafkaQuotasV1ClientQuota200Response
func (a *ClientQuotasKafkaQuotasV1ApiService) GetKafkaQuotasV1ClientQuotaExecute(r ApiGetKafkaQuotasV1ClientQuotaRequest) (*GetKafkaQuotasV1ClientQuota200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *GetKafkaQuotasV1ClientQuota200Response
	)
...
func (r ApiListKafkaQuotasV1ClientQuotasRequest) Execute() (*ListKafkaQuotasV1ClientQuotas200Response, *http.Response, error) {
...
*/
func (a *ClientQuotasKafkaQuotasV1ApiService) ListKafkaQuotasV1ClientQuotas(ctx context.Context) ApiListKafkaQuotasV1ClientQuotasRequest {
	return ApiListKafkaQuotasV1ClientQuotasRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return ListKafkaQuotasV1ClientQuotas200Response
func (a *ClientQuotasKafkaQuotasV1ApiService) ListKafkaQuotasV1ClientQuotasExecute(r ApiListKafkaQuotasV1ClientQuotasRequest) (*ListKafkaQuotasV1ClientQuotas200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *ListKafkaQuotasV1ClientQuotas200Response
	)
	...
	parameterAddToHeaderOrQuery(localVarQueryParams, "spec.cluster", r.specCluster, "")
...
type ApiUpdateKafkaQuotasV1ClientQuotaRequest struct {
	...
	ApiService *ClientQuotasKafkaQuotasV1ApiService
	id string
	updateKafkaQuotasV1ClientQuotaRequest *UpdateKafkaQuotasV1ClientQuotaRequest
}

func (r ApiUpdateKafkaQuotasV1ClientQuotaRequest) UpdateKafkaQuotasV1ClientQuotaRequest(updateKafkaQuotasV1ClientQuotaRequest UpdateKafkaQuotasV1ClientQuotaRequest) ApiUpdateKafkaQuotasV1ClientQuotaRequest {
	r.updateKafkaQuotasV1ClientQuotaRequest = &updateKafkaQuotasV1ClientQuotaRequest
	return r
}

func (r ApiUpdateKafkaQuotasV1ClientQuotaRequest) Execute() (*GetKafkaQuotasV1ClientQuota200Response, *http.Response, error) {
...
*/
func (a *ClientQuotasKafkaQuotasV1ApiService) UpdateKafkaQuotasV1ClientQuota(ctx context.Context, id string) ApiUpdateKafkaQuotasV1ClientQuotaRequest {
	return ApiUpdateKafkaQuotasV1ClientQuotaRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
//  @return GetKafkaQuotasV1ClientQuota200Response
func (a *ClientQuotasKafkaQuotasV1ApiService) UpdateKafkaQuotasV1ClientQuotaExecute(r ApiUpdateKafkaQuotasV1ClientQuotaRequest) (*GetKafkaQuotasV1ClientQuota200Response, *http.Response, error) {
	var (
	...
	// body params
	localVarPostBody = r.updateKafkaQuotasV1ClientQuotaRequest
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
