...
type ApiCreateCmkV2ClusterRequest struct {
	...
	createCmkV2ClusterRequest *CreateCmkV2ClusterRequest
}

func (r ApiCreateCmkV2ClusterRequest) CreateCmkV2ClusterRequest(createCmkV2ClusterRequest CreateCmkV2ClusterRequest) ApiCreateCmkV2ClusterRequest {
	r.createCmkV2ClusterRequest = &createCmkV2ClusterRequest
	return r
}

func (r ApiCreateCmkV2ClusterRequest) Execute() (*CreateCmkV2Cluster202Response, *http.Response, error) {
...
*/
func (a *ClustersCmkV2ApiService) CreateCmkV2Cluster(ctx context.Context) ApiCreateCmkV2ClusterRequest {
	return ApiCreateCmkV2ClusterRequest{
		ApiService: a,
		ctx: ctx,
	}
...
//  @return CreateCmkV2Cluster202Response
func (a *ClustersCmkV2ApiService) CreateCmkV2ClusterExecute(r ApiCreateCmkV2ClusterRequest) (*CreateCmkV2Cluster202Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *CreateCmkV2Cluster202Response
	)
	...
	// body params
	localVarPostBody = r.createCmkV2ClusterRequest
...
func (r ApiDeleteCmkV2ClusterRequest) Execute() (*http.Response, error) {
...
*/
func (a *ClustersCmkV2ApiService) DeleteCmkV2Cluster(ctx context.Context, id string) ApiDeleteCmkV2ClusterRequest {
	return ApiDeleteCmkV2ClusterRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
func (a *ClustersCmkV2ApiService) DeleteCmkV2ClusterExecute(r ApiDeleteCmkV2ClusterRequest) (*http.Response, error) {
	var (
...
func (r ApiGetCmkV2ClusterRequest) Execute() (*GetCmkV2Cluster200Response, *http.Response, error) {
...
*/
func (a *ClustersCmkV2ApiService) GetCmkV2Cluster(ctx context.Context, id string) ApiGetCmkV2ClusterRequest {
	return ApiGetCmkV2ClusterRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
//  @return GetCmkV2Cluster200Response
func (a *ClustersCmkV2ApiService) GetCmkV2ClusterExecute(r ApiGetCmkV2ClusterRequest) (*GetCmkV2Cluster200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *GetCmkV2Cluster200Response
	)
...
func (r ApiListCmkV2ClustersRequest) Execute() (*ListCmkV2Clusters200Response, *http.Response, error) {
...
*/
func (a *ClustersCmkV2ApiService) ListCmkV2Clusters(ctx context.Context) ApiListCmkV2ClustersRequest {
	return ApiListCmkV2ClustersRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return ListCmkV2Clusters200Response
func (a *ClustersCmkV2ApiService) ListCmkV2ClustersExecute(r ApiListCmkV2ClustersRequest) (*ListCmkV2Clusters200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *ListCmkV2Clusters200Response
	)
...
type ApiUpdateCmkV2ClusterRequest struct {
	...
	ApiService *ClustersCmkV2ApiService
	id string
	updateCmkV2ClusterRequest *UpdateCmkV2ClusterRequest
}

func (r ApiUpdateCmkV2ClusterRequest) UpdateCmkV2ClusterRequest(updateCmkV2ClusterRequest UpdateCmkV2ClusterRequest) ApiUpdateCmkV2ClusterRequest {
	r.updateCmkV2ClusterRequest = &updateCmkV2ClusterRequest
	return r
}

func (r ApiUpdateCmkV2ClusterRequest) Execute() (*GetCmkV2Cluster200Response, *http.Response, error) {
...
*/
func (a *ClustersCmkV2ApiService) UpdateCmkV2Cluster(ctx context.Context, id string) ApiUpdateCmkV2ClusterRequest {
	return ApiUpdateCmkV2ClusterRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
//  @return GetCmkV2Cluster200Response
func (a *ClustersCmkV2ApiService) UpdateCmkV2ClusterExecute(r ApiUpdateCmkV2ClusterRequest) (*GetCmkV2Cluster200Response, *http.Response, error) {
	var (
	...
	// body params
	localVarPostBody = r.updateCmkV2ClusterRequest
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
