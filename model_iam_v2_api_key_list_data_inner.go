...
// checks if the IamV2ApiKeyListDataInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IamV2ApiKeyListDataInner{}

// IamV2ApiKeyListDataInner struct for IamV2ApiKeyListDataInner
type IamV2ApiKeyListDataInner struct {
	...
	Id string `json:"id"`
	Metadata IamV2ApiKeyMetadata `json:"metadata"`
...
func (o IamV2ApiKeyListDataInner) MarshalJSON() ([]byte, error) {
...
func (o IamV2ApiKeyListDataInner) ToMap() (map[string]interface{}, error) {
...
type NullableIamV2ApiKeyListDataInner struct {
	value *IamV2ApiKeyListDataInner
	isSet bool
}

func (v NullableIamV2ApiKeyListDataInner) Get() *IamV2ApiKeyListDataInner {
	return v.value
}

func (v *NullableIamV2ApiKeyListDataInner) Set(val *IamV2ApiKeyListDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableIamV2ApiKeyListDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableIamV2ApiKeyListDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIamV2ApiKeyListDataInner(val *IamV2ApiKeyListDataInner) *NullableIamV2ApiKeyListDataInner {
	return &NullableIamV2ApiKeyListDataInner{value: val, isSet: true}
}

func (v NullableIamV2ApiKeyListDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIamV2ApiKeyListDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
