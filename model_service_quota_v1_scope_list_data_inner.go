...
// checks if the ServiceQuotaV1ScopeListDataInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ServiceQuotaV1ScopeListDataInner{}

// ServiceQuotaV1ScopeListDataInner struct for ServiceQuotaV1ScopeListDataInner
type ServiceQuotaV1ScopeListDataInner struct {
	...
	Id string `json:"id"`
	Metadata ServiceQuotaV1ScopeMetadata `json:"metadata"`
...
func NewServiceQuotaV1ScopeListDataInner(id string, metadata ServiceQuotaV1ScopeMetadata, description string) *ServiceQuotaV1ScopeListDataInner {
	this := ServiceQuotaV1ScopeListDataInner{}
	this.Id = id
...
func (o ServiceQuotaV1ScopeListDataInner) MarshalJSON() ([]byte, error) {
...
func (o ServiceQuotaV1ScopeListDataInner) ToMap() (map[string]interface{}, error) {
...
type NullableServiceQuotaV1ScopeListDataInner struct {
	value *ServiceQuotaV1ScopeListDataInner
	isSet bool
}

func (v NullableServiceQuotaV1ScopeListDataInner) Get() *ServiceQuotaV1ScopeListDataInner {
	return v.value
}

func (v *NullableServiceQuotaV1ScopeListDataInner) Set(val *ServiceQuotaV1ScopeListDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableServiceQuotaV1ScopeListDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableServiceQuotaV1ScopeListDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableServiceQuotaV1ScopeListDataInner(val *ServiceQuotaV1ScopeListDataInner) *NullableServiceQuotaV1ScopeListDataInner {
	return &NullableServiceQuotaV1ScopeListDataInner{value: val, isSet: true}
}

func (v NullableServiceQuotaV1ScopeListDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableServiceQuotaV1ScopeListDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
