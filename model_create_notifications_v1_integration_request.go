...
// checks if the CreateNotificationsV1IntegrationRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateNotificationsV1IntegrationRequest{}

// CreateNotificationsV1IntegrationRequest struct for CreateNotificationsV1IntegrationRequest
type CreateNotificationsV1IntegrationRequest struct {
...
func NewCreateNotificationsV1IntegrationRequest(displayName string, target NotificationsV1IntegrationTarget) *CreateNotificationsV1IntegrationRequest {
	this := CreateNotificationsV1IntegrationRequest{}
...
func (o CreateNotificationsV1IntegrationRequest) MarshalJSON() ([]byte, error) {
...
func (o CreateNotificationsV1IntegrationRequest) ToMap() (map[string]interface{}, error) {
...
type NullableCreateNotificationsV1IntegrationRequest struct {
	value *CreateNotificationsV1IntegrationRequest
	isSet bool
}

func (v NullableCreateNotificationsV1IntegrationRequest) Get() *CreateNotificationsV1IntegrationRequest {
	return v.value
}

func (v *NullableCreateNotificationsV1IntegrationRequest) Set(val *CreateNotificationsV1IntegrationRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateNotificationsV1IntegrationRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateNotificationsV1IntegrationRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateNotificationsV1IntegrationRequest(val *CreateNotificationsV1IntegrationRequest) *NullableCreateNotificationsV1IntegrationRequest {
	return &NullableCreateNotificationsV1IntegrationRequest{value: val, isSet: true}
}

func (v NullableCreateNotificationsV1IntegrationRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateNotificationsV1IntegrationRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
