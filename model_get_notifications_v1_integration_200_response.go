...
// checks if the GetNotificationsV1Integration200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetNotificationsV1Integration200Response{}

// GetNotificationsV1Integration200Response struct for GetNotificationsV1Integration200Response
type GetNotificationsV1Integration200Response struct {
	...
	Id string `json:"id"`
	Metadata *NotificationsV1IntegrationMetadata `json:"metadata,omitempty"`
	...
	Target NotificationsV1IntegrationTarget `json:"target"`
}
...
func NewGetNotificationsV1Integration200Response(apiVersion string, kind string, id string, displayName string, target NotificationsV1IntegrationTarget) *GetNotificationsV1Integration200Response {
	this := GetNotificationsV1Integration200Response{}
...
func (o *GetNotificationsV1Integration200Response) GetMetadata() NotificationsV1IntegrationMetadata {
	if o == nil || IsNil(o.Metadata) {
		var ret NotificationsV1IntegrationMetadata
		return ret
	}
	return *o.Metadata
}
...
// SetMetadata gets a reference to the given NotificationsV1IntegrationMetadata and assigns it to the Metadata field.
...
func (o *GetNotificationsV1Integration200Response) GetTarget() NotificationsV1IntegrationTarget {
	if o == nil {
		var ret NotificationsV1IntegrationTarget
		return ret
	}
...
func (o GetNotificationsV1Integration200Response) MarshalJSON() ([]byte, error) {
...
func (o GetNotificationsV1Integration200Response) ToMap() (map[string]interface{}, error) {
...
type NullableGetNotificationsV1Integration200Response struct {
	value *GetNotificationsV1Integration200Response
	isSet bool
}

func (v NullableGetNotificationsV1Integration200Response) Get() *GetNotificationsV1Integration200Response {
	return v.value
}

func (v *NullableGetNotificationsV1Integration200Response) Set(val *GetNotificationsV1Integration200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetNotificationsV1Integration200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetNotificationsV1Integration200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetNotificationsV1Integration200Response(val *GetNotificationsV1Integration200Response) *NullableGetNotificationsV1Integration200Response {
	return &NullableGetNotificationsV1Integration200Response{value: val, isSet: true}
}

func (v NullableGetNotificationsV1Integration200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetNotificationsV1Integration200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
