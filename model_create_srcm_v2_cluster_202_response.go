...
// checks if the CreateSrcmV2Cluster202Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateSrcmV2Cluster202Response{}

// CreateSrcmV2Cluster202Response struct for CreateSrcmV2Cluster202Response
type CreateSrcmV2Cluster202Response struct {
	...
	Metadata *SrcmV2ClusterMetadata `json:"metadata,omitempty"`
	Spec ListSrcmV2Clusters200ResponseAllOfDataInnerSpec `json:"spec"`
...
func NewCreateSrcmV2Cluster202Response(spec ListSrcmV2Clusters200ResponseAllOfDataInnerSpec, status SrcmV2ClusterStatus) *CreateSrcmV2Cluster202Response {
	this := CreateSrcmV2Cluster202Response{}
	this.Spec = spec
	this.Status = status
	return &this
}
...
// SetMetadata gets a reference to the given SrcmV2ClusterMetadata and assigns it to the Metadata field.
...
func (o *CreateSrcmV2Cluster202Response) GetSpec() ListSrcmV2Clusters200ResponseAllOfDataInnerSpec {
	if o == nil {
		var ret ListSrcmV2Clusters200ResponseAllOfDataInnerSpec
		return ret
	}
...
func (o *CreateSrcmV2Cluster202Response) GetStatus() SrcmV2ClusterStatus {
	if o == nil {
...
func (o CreateSrcmV2Cluster202Response) MarshalJSON() ([]byte, error) {
...
func (o CreateSrcmV2Cluster202Response) ToMap() (map[string]interface{}, error) {
...
type NullableCreateSrcmV2Cluster202Response struct {
	value *CreateSrcmV2Cluster202Response
	isSet bool
}

func (v NullableCreateSrcmV2Cluster202Response) Get() *CreateSrcmV2Cluster202Response {
	return v.value
}

func (v *NullableCreateSrcmV2Cluster202Response) Set(val *CreateSrcmV2Cluster202Response) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateSrcmV2Cluster202Response) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateSrcmV2Cluster202Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateSrcmV2Cluster202Response(val *CreateSrcmV2Cluster202Response) *NullableCreateSrcmV2Cluster202Response {
	return &NullableCreateSrcmV2Cluster202Response{value: val, isSet: true}
}

func (v NullableCreateSrcmV2Cluster202Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateSrcmV2Cluster202Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
