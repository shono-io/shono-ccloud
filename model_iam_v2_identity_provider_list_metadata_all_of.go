...
// checks if the IamV2IdentityProviderListMetadataAllOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IamV2IdentityProviderListMetadataAllOf{}

// IamV2IdentityProviderListMetadataAllOf struct for IamV2IdentityProviderListMetadataAllOf
type IamV2IdentityProviderListMetadataAllOf struct {
...
func NewIamV2IdentityProviderListMetadataAllOf() *IamV2IdentityProviderListMetadataAllOf {
	this := IamV2IdentityProviderListMetadataAllOf{}
	return &this
}
...
func (o IamV2IdentityProviderListMetadataAllOf) MarshalJSON() ([]byte, error) {
...
func (o IamV2IdentityProviderListMetadataAllOf) ToMap() (map[string]interface{}, error) {
...
type NullableIamV2IdentityProviderListMetadataAllOf struct {
	value *IamV2IdentityProviderListMetadataAllOf
	isSet bool
}

func (v NullableIamV2IdentityProviderListMetadataAllOf) Get() *IamV2IdentityProviderListMetadataAllOf {
	return v.value
}

func (v *NullableIamV2IdentityProviderListMetadataAllOf) Set(val *IamV2IdentityProviderListMetadataAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableIamV2IdentityProviderListMetadataAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableIamV2IdentityProviderListMetadataAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIamV2IdentityProviderListMetadataAllOf(val *IamV2IdentityProviderListMetadataAllOf) *NullableIamV2IdentityProviderListMetadataAllOf {
	return &NullableIamV2IdentityProviderListMetadataAllOf{value: val, isSet: true}
}

func (v NullableIamV2IdentityProviderListMetadataAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIamV2IdentityProviderListMetadataAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
