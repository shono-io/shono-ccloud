...
// checks if the UpdateNetworkingV1PeeringRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateNetworkingV1PeeringRequest{}

// UpdateNetworkingV1PeeringRequest struct for UpdateNetworkingV1PeeringRequest
type UpdateNetworkingV1PeeringRequest struct {
...
func NewUpdateNetworkingV1PeeringRequest(spec UpdateCmkV2ClusterRequestAllOfSpec) *UpdateNetworkingV1PeeringRequest {
	this := UpdateNetworkingV1PeeringRequest{}
	this.Spec = spec
	return &this
}
...
func (o UpdateNetworkingV1PeeringRequest) MarshalJSON() ([]byte, error) {
...
func (o UpdateNetworkingV1PeeringRequest) ToMap() (map[string]interface{}, error) {
...
type NullableUpdateNetworkingV1PeeringRequest struct {
	value *UpdateNetworkingV1PeeringRequest
	isSet bool
}

func (v NullableUpdateNetworkingV1PeeringRequest) Get() *UpdateNetworkingV1PeeringRequest {
	return v.value
}

func (v *NullableUpdateNetworkingV1PeeringRequest) Set(val *UpdateNetworkingV1PeeringRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdateNetworkingV1PeeringRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableUpdateNetworkingV1PeeringRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpdateNetworkingV1PeeringRequest(val *UpdateNetworkingV1PeeringRequest) *NullableUpdateNetworkingV1PeeringRequest {
	return &NullableUpdateNetworkingV1PeeringRequest{value: val, isSet: true}
}

func (v NullableUpdateNetworkingV1PeeringRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpdateNetworkingV1PeeringRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
