...
// checks if the KsqldbcmV2ClusterSpecCredentialIdentity type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &KsqldbcmV2ClusterSpecCredentialIdentity{}

// KsqldbcmV2ClusterSpecCredentialIdentity The credential_identity to which this belongs. The credential_identity can be one of iam.v2.User, iam.v2.ServiceAccount.
type KsqldbcmV2ClusterSpecCredentialIdentity struct {
...
func NewKsqldbcmV2ClusterSpecCredentialIdentity(id string, related string, resourceName string) *KsqldbcmV2ClusterSpecCredentialIdentity {
	this := KsqldbcmV2ClusterSpecCredentialIdentity{}
	this.Id = id
...
func (o KsqldbcmV2ClusterSpecCredentialIdentity) MarshalJSON() ([]byte, error) {
...
func (o KsqldbcmV2ClusterSpecCredentialIdentity) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["id"] = o.Id
	// skip: related is readOnly
	// skip: resource_name is readOnly
	// skip: api_version is readOnly
	// skip: kind is readOnly
	return toSerialize, nil
}

type NullableKsqldbcmV2ClusterSpecCredentialIdentity struct {
	value *KsqldbcmV2ClusterSpecCredentialIdentity
	isSet bool
}

func (v NullableKsqldbcmV2ClusterSpecCredentialIdentity) Get() *KsqldbcmV2ClusterSpecCredentialIdentity {
	return v.value
}

func (v *NullableKsqldbcmV2ClusterSpecCredentialIdentity) Set(val *KsqldbcmV2ClusterSpecCredentialIdentity) {
	v.value = val
	v.isSet = true
}

func (v NullableKsqldbcmV2ClusterSpecCredentialIdentity) IsSet() bool {
	return v.isSet
}

func (v *NullableKsqldbcmV2ClusterSpecCredentialIdentity) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableKsqldbcmV2ClusterSpecCredentialIdentity(val *KsqldbcmV2ClusterSpecCredentialIdentity) *NullableKsqldbcmV2ClusterSpecCredentialIdentity {
	return &NullableKsqldbcmV2ClusterSpecCredentialIdentity{value: val, isSet: true}
}

func (v NullableKsqldbcmV2ClusterSpecCredentialIdentity) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableKsqldbcmV2ClusterSpecCredentialIdentity) UnmarshalJSON(src []byte) error {
	v.isSet = true
