...
// checks if the SdV1Pipeline type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SdV1Pipeline{}
...
func (o SdV1Pipeline) ToMap() (map[string]interface{}, error) {
