...
// checks if the IamV2RoleBindingListDataInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IamV2RoleBindingListDataInner{}

// IamV2RoleBindingListDataInner struct for IamV2RoleBindingListDataInner
type IamV2RoleBindingListDataInner struct {
	...
	Id string `json:"id"`
	Metadata IamV2RoleBindingMetadata `json:"metadata"`
...
func NewIamV2RoleBindingListDataInner(id string, metadata IamV2RoleBindingMetadata, principal string, roleName string, crnPattern string) *IamV2RoleBindingListDataInner {
	this := IamV2RoleBindingListDataInner{}
	this.Id = id
...
func (o IamV2RoleBindingListDataInner) MarshalJSON() ([]byte, error) {
...
func (o IamV2RoleBindingListDataInner) ToMap() (map[string]interface{}, error) {
...
type NullableIamV2RoleBindingListDataInner struct {
	value *IamV2RoleBindingListDataInner
	isSet bool
}

func (v NullableIamV2RoleBindingListDataInner) Get() *IamV2RoleBindingListDataInner {
	return v.value
}

func (v *NullableIamV2RoleBindingListDataInner) Set(val *IamV2RoleBindingListDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableIamV2RoleBindingListDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableIamV2RoleBindingListDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIamV2RoleBindingListDataInner(val *IamV2RoleBindingListDataInner) *NullableIamV2RoleBindingListDataInner {
	return &NullableIamV2RoleBindingListDataInner{value: val, isSet: true}
}

func (v NullableIamV2RoleBindingListDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIamV2RoleBindingListDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
