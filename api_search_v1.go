...
func (r ApiSearchUsingAttributeRequest) Execute() (*SearchResult, *http.Response, error) {
...
*/
func (a *SearchV1ApiService) SearchUsingAttribute(ctx context.Context) ApiSearchUsingAttributeRequest {
	return ApiSearchUsingAttributeRequest{
		ApiService: a,
		ctx: ctx,
	}
...
//  @return SearchResult
func (a *SearchV1ApiService) SearchUsingAttributeExecute(r ApiSearchUsingAttributeRequest) (*SearchResult, *http.Response, error) {
	var (
	...
	if r.attr != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "attr", s.Index(i), "multi")
			}
		} else {
			parameterAddToHeaderOrQuery(localVarQueryParams, "attr", t, "multi")
		}
	}
	if r.attrName != nil {
		t := *r.attrName
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "attrName", s.Index(i), "multi")
			}
		} else {
			parameterAddToHeaderOrQuery(localVarQueryParams, "attrName", t, "multi")
		}
	}
	if r.attrValuePrefix != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "attrValuePrefix", s.Index(i), "multi")
			}
		} else {
			parameterAddToHeaderOrQuery(localVarQueryParams, "attrValuePrefix", t, "multi")
		}
	}
	if r.tag != nil {
...
func (r ApiSearchUsingBasicRequest) Execute() (*SearchResult, *http.Response, error) {
...
*/
func (a *SearchV1ApiService) SearchUsingBasic(ctx context.Context) ApiSearchUsingBasicRequest {
	return ApiSearchUsingBasicRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return SearchResult
func (a *SearchV1ApiService) SearchUsingBasicExecute(r ApiSearchUsingBasicRequest) (*SearchResult, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
