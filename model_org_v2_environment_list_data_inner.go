...
// checks if the OrgV2EnvironmentListDataInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OrgV2EnvironmentListDataInner{}

// OrgV2EnvironmentListDataInner struct for OrgV2EnvironmentListDataInner
type OrgV2EnvironmentListDataInner struct {
	...
	Id string `json:"id"`
	Metadata OrgV2EnvironmentMetadata `json:"metadata"`
...
func NewOrgV2EnvironmentListDataInner(id string, metadata OrgV2EnvironmentMetadata, displayName string) *OrgV2EnvironmentListDataInner {
	this := OrgV2EnvironmentListDataInner{}
	this.Id = id
...
func (o OrgV2EnvironmentListDataInner) MarshalJSON() ([]byte, error) {
...
func (o OrgV2EnvironmentListDataInner) ToMap() (map[string]interface{}, error) {
...
type NullableOrgV2EnvironmentListDataInner struct {
	value *OrgV2EnvironmentListDataInner
	isSet bool
}

func (v NullableOrgV2EnvironmentListDataInner) Get() *OrgV2EnvironmentListDataInner {
	return v.value
}

func (v *NullableOrgV2EnvironmentListDataInner) Set(val *OrgV2EnvironmentListDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableOrgV2EnvironmentListDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableOrgV2EnvironmentListDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOrgV2EnvironmentListDataInner(val *OrgV2EnvironmentListDataInner) *NullableOrgV2EnvironmentListDataInner {
	return &NullableOrgV2EnvironmentListDataInner{value: val, isSet: true}
}

func (v NullableOrgV2EnvironmentListDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOrgV2EnvironmentListDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
