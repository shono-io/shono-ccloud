...
// checks if the IamV2ApiKeyListMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IamV2ApiKeyListMetadata{}

// IamV2ApiKeyListMetadata struct for IamV2ApiKeyListMetadata
type IamV2ApiKeyListMetadata struct {
...
func (o *IamV2ApiKeyListMetadata) HasFirst() bool {
	if o != nil && IsNil(o.First) {
		return true
	}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *IamV2ApiKeyListMetadata) GetPrevOk() (*interface{}, bool) {
...
func (o IamV2ApiKeyListMetadata) MarshalJSON() ([]byte, error) {
...
func (o IamV2ApiKeyListMetadata) ToMap() (map[string]interface{}, error) {
...
type NullableIamV2ApiKeyListMetadata struct {
	value *IamV2ApiKeyListMetadata
	isSet bool
}

func (v NullableIamV2ApiKeyListMetadata) Get() *IamV2ApiKeyListMetadata {
	return v.value
}

func (v *NullableIamV2ApiKeyListMetadata) Set(val *IamV2ApiKeyListMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableIamV2ApiKeyListMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableIamV2ApiKeyListMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIamV2ApiKeyListMetadata(val *IamV2ApiKeyListMetadata) *NullableIamV2ApiKeyListMetadata {
	return &NullableIamV2ApiKeyListMetadata{value: val, isSet: true}
}

func (v NullableIamV2ApiKeyListMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIamV2ApiKeyListMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
