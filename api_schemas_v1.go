...
type ApiGetSchemaRequest struct {
	ctx context.Context
	ApiService *SchemasV1ApiService
	id int32
	subject *string
	format *string
	fetchMaxId *bool
...
func (r ApiGetSchemaRequest) Execute() (*SchemaString, *http.Response, error) {
...
*/
func (a *SchemasV1ApiService) GetSchema(ctx context.Context, id int32) ApiGetSchemaRequest {
	return ApiGetSchemaRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
//  @return SchemaString
func (a *SchemasV1ApiService) GetSchemaExecute(r ApiGetSchemaRequest) (*SchemaString, *http.Response, error) {
	var (
	...
	if r.fetchMaxId != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "fetchMaxId", r.fetchMaxId, "")
	}
...
func (r ApiGetSchemaOnlyRequest) Execute() (string, *http.Response, error) {
...
*/
func (a *SchemasV1ApiService) GetSchemaOnly(ctx context.Context, id int32) ApiGetSchemaOnlyRequest {
	return ApiGetSchemaOnlyRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
//  @return string
func (a *SchemasV1ApiService) GetSchemaOnlyExecute(r ApiGetSchemaOnlyRequest) (string, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r ApiGetSchemaTypesRequest) Execute() ([]string, *http.Response, error) {
...
*/
func (a *SchemasV1ApiService) GetSchemaTypes(ctx context.Context) ApiGetSchemaTypesRequest {
	return ApiGetSchemaTypesRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return []string
func (a *SchemasV1ApiService) GetSchemaTypesExecute(r ApiGetSchemaTypesRequest) ([]string, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r ApiGetSchemasRequest) Execute() ([]Schema, *http.Response, error) {
...
*/
func (a *SchemasV1ApiService) GetSchemas(ctx context.Context) ApiGetSchemasRequest {
	return ApiGetSchemasRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return []Schema
func (a *SchemasV1ApiService) GetSchemasExecute(r ApiGetSchemasRequest) ([]Schema, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r ApiGetSubjectsRequest) Execute() ([]string, *http.Response, error) {
...
*/
func (a *SchemasV1ApiService) GetSubjects(ctx context.Context, id int32) ApiGetSubjectsRequest {
	return ApiGetSubjectsRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
//  @return []string
func (a *SchemasV1ApiService) GetSubjectsExecute(r ApiGetSubjectsRequest) ([]string, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r ApiGetVersionsRequest) Execute() ([]SubjectVersion, *http.Response, error) {
...
*/
func (a *SchemasV1ApiService) GetVersions(ctx context.Context, id int32) ApiGetVersionsRequest {
	return ApiGetVersionsRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
func (a *SchemasV1ApiService) GetVersionsExecute(r ApiGetVersionsRequest) ([]SubjectVersion, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
