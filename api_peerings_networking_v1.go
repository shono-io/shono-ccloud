...
type ApiCreateNetworkingV1PeeringRequest struct {
	...
	createNetworkingV1PeeringRequest *CreateNetworkingV1PeeringRequest
}

func (r ApiCreateNetworkingV1PeeringRequest) CreateNetworkingV1PeeringRequest(createNetworkingV1PeeringRequest CreateNetworkingV1PeeringRequest) ApiCreateNetworkingV1PeeringRequest {
	r.createNetworkingV1PeeringRequest = &createNetworkingV1PeeringRequest
	return r
}

func (r ApiCreateNetworkingV1PeeringRequest) Execute() (*CreateNetworkingV1Peering202Response, *http.Response, error) {
...
*/
func (a *PeeringsNetworkingV1ApiService) CreateNetworkingV1Peering(ctx context.Context) ApiCreateNetworkingV1PeeringRequest {
	return ApiCreateNetworkingV1PeeringRequest{
		ApiService: a,
		ctx: ctx,
	}
...
//  @return CreateNetworkingV1Peering202Response
func (a *PeeringsNetworkingV1ApiService) CreateNetworkingV1PeeringExecute(r ApiCreateNetworkingV1PeeringRequest) (*CreateNetworkingV1Peering202Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *CreateNetworkingV1Peering202Response
	)
	...
	// body params
	localVarPostBody = r.createNetworkingV1PeeringRequest
...
func (r ApiDeleteNetworkingV1PeeringRequest) Execute() (*http.Response, error) {
...
*/
func (a *PeeringsNetworkingV1ApiService) DeleteNetworkingV1Peering(ctx context.Context, id string) ApiDeleteNetworkingV1PeeringRequest {
	return ApiDeleteNetworkingV1PeeringRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
func (a *PeeringsNetworkingV1ApiService) DeleteNetworkingV1PeeringExecute(r ApiDeleteNetworkingV1PeeringRequest) (*http.Response, error) {
	var (
...
func (r ApiGetNetworkingV1PeeringRequest) Execute() (*GetNetworkingV1Peering200Response, *http.Response, error) {
...
*/
func (a *PeeringsNetworkingV1ApiService) GetNetworkingV1Peering(ctx context.Context, id string) ApiGetNetworkingV1PeeringRequest {
	return ApiGetNetworkingV1PeeringRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
//  @return GetNetworkingV1Peering200Response
func (a *PeeringsNetworkingV1ApiService) GetNetworkingV1PeeringExecute(r ApiGetNetworkingV1PeeringRequest) (*GetNetworkingV1Peering200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *GetNetworkingV1Peering200Response
	)
...
func (r ApiListNetworkingV1PeeringsRequest) Execute() (*ListNetworkingV1Peerings200Response, *http.Response, error) {
...
*/
func (a *PeeringsNetworkingV1ApiService) ListNetworkingV1Peerings(ctx context.Context) ApiListNetworkingV1PeeringsRequest {
	return ApiListNetworkingV1PeeringsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return ListNetworkingV1Peerings200Response
func (a *PeeringsNetworkingV1ApiService) ListNetworkingV1PeeringsExecute(r ApiListNetworkingV1PeeringsRequest) (*ListNetworkingV1Peerings200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *ListNetworkingV1Peerings200Response
	)
...
type ApiUpdateNetworkingV1PeeringRequest struct {
	...
	ApiService *PeeringsNetworkingV1ApiService
	id string
	updateNetworkingV1PeeringRequest *UpdateNetworkingV1PeeringRequest
}

func (r ApiUpdateNetworkingV1PeeringRequest) UpdateNetworkingV1PeeringRequest(updateNetworkingV1PeeringRequest UpdateNetworkingV1PeeringRequest) ApiUpdateNetworkingV1PeeringRequest {
	r.updateNetworkingV1PeeringRequest = &updateNetworkingV1PeeringRequest
	return r
}

func (r ApiUpdateNetworkingV1PeeringRequest) Execute() (*GetNetworkingV1Peering200Response, *http.Response, error) {
...
*/
func (a *PeeringsNetworkingV1ApiService) UpdateNetworkingV1Peering(ctx context.Context, id string) ApiUpdateNetworkingV1PeeringRequest {
	return ApiUpdateNetworkingV1PeeringRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
//  @return GetNetworkingV1Peering200Response
func (a *PeeringsNetworkingV1ApiService) UpdateNetworkingV1PeeringExecute(r ApiUpdateNetworkingV1PeeringRequest) (*GetNetworkingV1Peering200Response, *http.Response, error) {
	var (
	...
	// body params
	localVarPostBody = r.updateNetworkingV1PeeringRequest
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
