...
// checks if the NotificationsV1IntegrationListMetadataAllOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NotificationsV1IntegrationListMetadataAllOf{}

// NotificationsV1IntegrationListMetadataAllOf struct for NotificationsV1IntegrationListMetadataAllOf
type NotificationsV1IntegrationListMetadataAllOf struct {
...
func NewNotificationsV1IntegrationListMetadataAllOf() *NotificationsV1IntegrationListMetadataAllOf {
	this := NotificationsV1IntegrationListMetadataAllOf{}
	return &this
}
...
func (o NotificationsV1IntegrationListMetadataAllOf) MarshalJSON() ([]byte, error) {
...
func (o NotificationsV1IntegrationListMetadataAllOf) ToMap() (map[string]interface{}, error) {
...
type NullableNotificationsV1IntegrationListMetadataAllOf struct {
	value *NotificationsV1IntegrationListMetadataAllOf
	isSet bool
}

func (v NullableNotificationsV1IntegrationListMetadataAllOf) Get() *NotificationsV1IntegrationListMetadataAllOf {
	return v.value
}

func (v *NullableNotificationsV1IntegrationListMetadataAllOf) Set(val *NotificationsV1IntegrationListMetadataAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableNotificationsV1IntegrationListMetadataAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableNotificationsV1IntegrationListMetadataAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNotificationsV1IntegrationListMetadataAllOf(val *NotificationsV1IntegrationListMetadataAllOf) *NullableNotificationsV1IntegrationListMetadataAllOf {
	return &NullableNotificationsV1IntegrationListMetadataAllOf{value: val, isSet: true}
}

func (v NullableNotificationsV1IntegrationListMetadataAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNotificationsV1IntegrationListMetadataAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
