...
type ApiCreateKafkaLinkRequest struct {
	ctx context.Context
	ApiService *ClusterLinkingV3ApiService
	clusterId string
	linkName *string
	validateOnly *bool
	validateLink *bool
...
func (r ApiCreateKafkaLinkRequest) Execute() (*http.Response, error) {
...
*/
func (a *ClusterLinkingV3ApiService) CreateKafkaLink(ctx context.Context, clusterId string) ApiCreateKafkaLinkRequest {
	return ApiCreateKafkaLinkRequest{
		ApiService: a,
		ctx: ctx,
		clusterId: clusterId,
...
func (a *ClusterLinkingV3ApiService) CreateKafkaLinkExecute(r ApiCreateKafkaLinkRequest) (*http.Response, error) {
	var (
	...
	parameterAddToHeaderOrQuery(localVarQueryParams, "link_name", r.linkName, "")
	if r.validateOnly != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "validate_only", r.validateOnly, "")
	}
	if r.validateLink != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "validate_link", r.validateLink, "")
	}
...
func (r ApiCreateKafkaMirrorTopicRequest) Execute() (*http.Response, error) {
...
*/
func (a *ClusterLinkingV3ApiService) CreateKafkaMirrorTopic(ctx context.Context, clusterId string, linkName string) ApiCreateKafkaMirrorTopicRequest {
	return ApiCreateKafkaMirrorTopicRequest{
		ApiService: a,
		ctx: ctx,
		clusterId: clusterId,
...
// Execute executes the request
func (a *ClusterLinkingV3ApiService) CreateKafkaMirrorTopicExecute(r ApiCreateKafkaMirrorTopicRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localVarPath = strings.Replace(localVarPath, "{"+"cluster_id"+"}", url.PathEscape(parameterValueToString(r.clusterId, "clusterId")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"link_name"+"}", url.PathEscape(parameterValueToString(r.linkName, "linkName")), -1)
...
func (r ApiDeleteKafkaLinkRequest) Execute() (*http.Response, error) {
...
*/
func (a *ClusterLinkingV3ApiService) DeleteKafkaLink(ctx context.Context, clusterId string, linkName string) ApiDeleteKafkaLinkRequest {
	return ApiDeleteKafkaLinkRequest{
		ApiService: a,
		ctx: ctx,
		clusterId: clusterId,
...
// Execute executes the request
func (a *ClusterLinkingV3ApiService) DeleteKafkaLinkExecute(r ApiDeleteKafkaLinkRequest) (*http.Response, error) {
	var (
...
func (r ApiDeleteKafkaLinkConfigRequest) Execute() (*http.Response, error) {
...
*/
func (a *ClusterLinkingV3ApiService) DeleteKafkaLinkConfig(ctx context.Context, clusterId string, linkName string, configName string) ApiDeleteKafkaLinkConfigRequest {
	return ApiDeleteKafkaLinkConfigRequest{
		ApiService: a,
		ctx: ctx,
		clusterId: clusterId,
...
// Execute executes the request
func (a *ClusterLinkingV3ApiService) DeleteKafkaLinkConfigExecute(r ApiDeleteKafkaLinkConfigRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodDelete
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localVarPath = strings.Replace(localVarPath, "{"+"cluster_id"+"}", url.PathEscape(parameterValueToString(r.clusterId, "clusterId")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"link_name"+"}", url.PathEscape(parameterValueToString(r.linkName, "linkName")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"config_name"+"}", url.PathEscape(parameterValueToString(r.configName, "configName")), -1)
...
func (r ApiGetKafkaLinkRequest) Execute() (*ListLinksResponseData, *http.Response, error) {
...
*/
func (a *ClusterLinkingV3ApiService) GetKafkaLink(ctx context.Context, clusterId string, linkName string) ApiGetKafkaLinkRequest {
	return ApiGetKafkaLinkRequest{
		ApiService: a,
		ctx: ctx,
		clusterId: clusterId,
...
func (a *ClusterLinkingV3ApiService) GetKafkaLinkExecute(r ApiGetKafkaLinkRequest) (*ListLinksResponseData, *http.Response, error) {
	var (
...
func (r ApiGetKafkaLinkConfigsRequest) Execute() (*ListLinkConfigsResponseData, *http.Response, error) {
...
*/
func (a *ClusterLinkingV3ApiService) GetKafkaLinkConfigs(ctx context.Context, clusterId string, linkName string, configName string) ApiGetKafkaLinkConfigsRequest {
	return ApiGetKafkaLinkConfigsRequest{
		ApiService: a,
		ctx: ctx,
		clusterId: clusterId,
...
func (a *ClusterLinkingV3ApiService) GetKafkaLinkConfigsExecute(r ApiGetKafkaLinkConfigsRequest) (*ListLinkConfigsResponseData, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r ApiListKafkaLinkConfigsRequest) Execute() (*ListLinkConfigsResponseDataList, *http.Response, error) {
...
*/
func (a *ClusterLinkingV3ApiService) ListKafkaLinkConfigs(ctx context.Context, clusterId string, linkName string) ApiListKafkaLinkConfigsRequest {
	return ApiListKafkaLinkConfigsRequest{
		ApiService: a,
		ctx: ctx,
		clusterId: clusterId,
...
func (a *ClusterLinkingV3ApiService) ListKafkaLinkConfigsExecute(r ApiListKafkaLinkConfigsRequest) (*ListLinkConfigsResponseDataList, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r ApiListKafkaLinksRequest) Execute() (*ListLinksResponseDataList, *http.Response, error) {
...
*/
func (a *ClusterLinkingV3ApiService) ListKafkaLinks(ctx context.Context, clusterId string) ApiListKafkaLinksRequest {
	return ApiListKafkaLinksRequest{
		ApiService: a,
		ctx: ctx,
		clusterId: clusterId,
...
func (a *ClusterLinkingV3ApiService) ListKafkaLinksExecute(r ApiListKafkaLinksRequest) (*ListLinksResponseDataList, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r ApiListKafkaMirrorTopicsRequest) Execute() (*ListMirrorTopicsResponseDataList, *http.Response, error) {
...
*/
func (a *ClusterLinkingV3ApiService) ListKafkaMirrorTopics(ctx context.Context, clusterId string) ApiListKafkaMirrorTopicsRequest {
	return ApiListKafkaMirrorTopicsRequest{
		ApiService: a,
		ctx: ctx,
		clusterId: clusterId,
...
func (a *ClusterLinkingV3ApiService) ListKafkaMirrorTopicsExecute(r ApiListKafkaMirrorTopicsRequest) (*ListMirrorTopicsResponseDataList, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	if r.mirrorStatus != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "mirror_status", r.mirrorStatus, "")
	}
	// to determine the Content-Type header
	localVarHTTPContentTypes := []string{}
...
func (r ApiListKafkaMirrorTopicsUnderLinkRequest) Execute() (*ListMirrorTopicsResponseDataList, *http.Response, error) {
...
*/
func (a *ClusterLinkingV3ApiService) ListKafkaMirrorTopicsUnderLink(ctx context.Context, clusterId string, linkName string) ApiListKafkaMirrorTopicsUnderLinkRequest {
	return ApiListKafkaMirrorTopicsUnderLinkRequest{
		ApiService: a,
		ctx: ctx,
		clusterId: clusterId,
...
// Execute executes the request
//  @return ListMirrorTopicsResponseDataList
func (a *ClusterLinkingV3ApiService) ListKafkaMirrorTopicsUnderLinkExecute(r ApiListKafkaMirrorTopicsUnderLinkRequest) (*ListMirrorTopicsResponseDataList, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r ApiReadKafkaMirrorTopicRequest) Execute() (*ListMirrorTopicsResponseData, *http.Response, error) {
...
*/
func (a *ClusterLinkingV3ApiService) ReadKafkaMirrorTopic(ctx context.Context, clusterId string, linkName string, mirrorTopicName string) ApiReadKafkaMirrorTopicRequest {
	return ApiReadKafkaMirrorTopicRequest{
		ApiService: a,
		ctx: ctx,
		clusterId: clusterId,
...
func (a *ClusterLinkingV3ApiService) ReadKafkaMirrorTopicExecute(r ApiReadKafkaMirrorTopicRequest) (*ListMirrorTopicsResponseData, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localVarPath = strings.Replace(localVarPath, "{"+"cluster_id"+"}", url.PathEscape(parameterValueToString(r.clusterId, "clusterId")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"link_name"+"}", url.PathEscape(parameterValueToString(r.linkName, "linkName")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"mirror_topic_name"+"}", url.PathEscape(parameterValueToString(r.mirrorTopicName, "mirrorTopicName")), -1)
...
func (r ApiUpdateKafkaLinkConfigRequest) Execute() (*http.Response, error) {
...
*/
func (a *ClusterLinkingV3ApiService) UpdateKafkaLinkConfig(ctx context.Context, clusterId string, linkName string, configName string) ApiUpdateKafkaLinkConfigRequest {
	return ApiUpdateKafkaLinkConfigRequest{
		ApiService: a,
		ctx: ctx,
		clusterId: clusterId,
...
// Execute executes the request
func (a *ClusterLinkingV3ApiService) UpdateKafkaLinkConfigExecute(r ApiUpdateKafkaLinkConfigRequest) (*http.Response, error) {
	var (
...
func (r ApiUpdateKafkaLinkConfigBatchRequest) Execute() (*http.Response, error) {
...
*/
func (a *ClusterLinkingV3ApiService) UpdateKafkaLinkConfigBatch(ctx context.Context, clusterId string, linkName string) ApiUpdateKafkaLinkConfigBatchRequest {
	return ApiUpdateKafkaLinkConfigBatchRequest{
		ApiService: a,
		ctx: ctx,
		clusterId: clusterId,
...
// Execute executes the request
func (a *ClusterLinkingV3ApiService) UpdateKafkaLinkConfigBatchExecute(r ApiUpdateKafkaLinkConfigBatchRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r ApiUpdateKafkaMirrorTopicsFailoverRequest) Execute() (*AlterMirrorStatusResponseDataList, *http.Response, error) {
...
*/
func (a *ClusterLinkingV3ApiService) UpdateKafkaMirrorTopicsFailover(ctx context.Context, clusterId string, linkName string) ApiUpdateKafkaMirrorTopicsFailoverRequest {
	return ApiUpdateKafkaMirrorTopicsFailoverRequest{
		ApiService: a,
		ctx: ctx,
		clusterId: clusterId,
...
func (a *ClusterLinkingV3ApiService) UpdateKafkaMirrorTopicsFailoverExecute(r ApiUpdateKafkaMirrorTopicsFailoverRequest) (*AlterMirrorStatusResponseDataList, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r ApiUpdateKafkaMirrorTopicsPauseRequest) Execute() (*AlterMirrorStatusResponseDataList, *http.Response, error) {
...
*/
func (a *ClusterLinkingV3ApiService) UpdateKafkaMirrorTopicsPause(ctx context.Context, clusterId string, linkName string) ApiUpdateKafkaMirrorTopicsPauseRequest {
	return ApiUpdateKafkaMirrorTopicsPauseRequest{
		ApiService: a,
		ctx: ctx,
		clusterId: clusterId,
...
// Execute executes the request
//  @return AlterMirrorStatusResponseDataList
func (a *ClusterLinkingV3ApiService) UpdateKafkaMirrorTopicsPauseExecute(r ApiUpdateKafkaMirrorTopicsPauseRequest) (*AlterMirrorStatusResponseDataList, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r ApiUpdateKafkaMirrorTopicsPromoteRequest) Execute() (*AlterMirrorStatusResponseDataList, *http.Response, error) {
...
*/
func (a *ClusterLinkingV3ApiService) UpdateKafkaMirrorTopicsPromote(ctx context.Context, clusterId string, linkName string) ApiUpdateKafkaMirrorTopicsPromoteRequest {
	return ApiUpdateKafkaMirrorTopicsPromoteRequest{
		ApiService: a,
		ctx: ctx,
		clusterId: clusterId,
...
// Execute executes the request
//  @return AlterMirrorStatusResponseDataList
func (a *ClusterLinkingV3ApiService) UpdateKafkaMirrorTopicsPromoteExecute(r ApiUpdateKafkaMirrorTopicsPromoteRequest) (*AlterMirrorStatusResponseDataList, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r ApiUpdateKafkaMirrorTopicsResumeRequest) Execute() (*AlterMirrorStatusResponseDataList, *http.Response, error) {
...
*/
func (a *ClusterLinkingV3ApiService) UpdateKafkaMirrorTopicsResume(ctx context.Context, clusterId string, linkName string) ApiUpdateKafkaMirrorTopicsResumeRequest {
	return ApiUpdateKafkaMirrorTopicsResumeRequest{
		ApiService: a,
		ctx: ctx,
		clusterId: clusterId,
...
// Execute executes the request
//  @return AlterMirrorStatusResponseDataList
func (a *ClusterLinkingV3ApiService) UpdateKafkaMirrorTopicsResumeExecute(r ApiUpdateKafkaMirrorTopicsResumeRequest) (*AlterMirrorStatusResponseDataList, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
