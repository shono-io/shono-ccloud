...
// checks if the IamV2ApiKey type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IamV2ApiKey{}
...
func (o IamV2ApiKey) ToMap() (map[string]interface{}, error) {
