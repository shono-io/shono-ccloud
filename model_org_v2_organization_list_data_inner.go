...
// checks if the OrgV2OrganizationListDataInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OrgV2OrganizationListDataInner{}

// OrgV2OrganizationListDataInner struct for OrgV2OrganizationListDataInner
type OrgV2OrganizationListDataInner struct {
	...
	Id string `json:"id"`
	Metadata OrgV2OrganizationMetadata `json:"metadata"`
...
func NewOrgV2OrganizationListDataInner(id string, metadata OrgV2OrganizationMetadata, displayName string) *OrgV2OrganizationListDataInner {
	this := OrgV2OrganizationListDataInner{}
	this.Id = id
...
func (o OrgV2OrganizationListDataInner) MarshalJSON() ([]byte, error) {
...
func (o OrgV2OrganizationListDataInner) ToMap() (map[string]interface{}, error) {
...
type NullableOrgV2OrganizationListDataInner struct {
	value *OrgV2OrganizationListDataInner
	isSet bool
}

func (v NullableOrgV2OrganizationListDataInner) Get() *OrgV2OrganizationListDataInner {
	return v.value
}

func (v *NullableOrgV2OrganizationListDataInner) Set(val *OrgV2OrganizationListDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableOrgV2OrganizationListDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableOrgV2OrganizationListDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOrgV2OrganizationListDataInner(val *OrgV2OrganizationListDataInner) *NullableOrgV2OrganizationListDataInner {
	return &NullableOrgV2OrganizationListDataInner{value: val, isSet: true}
}

func (v NullableOrgV2OrganizationListDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOrgV2OrganizationListDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
