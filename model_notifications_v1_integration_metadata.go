...
// checks if the NotificationsV1IntegrationMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NotificationsV1IntegrationMetadata{}

// NotificationsV1IntegrationMetadata struct for NotificationsV1IntegrationMetadata
type NotificationsV1IntegrationMetadata struct {
...
func NewNotificationsV1IntegrationMetadata(self interface{}) *NotificationsV1IntegrationMetadata {
	this := NotificationsV1IntegrationMetadata{}
	this.Self = self
	return &this
}
...
func (o NotificationsV1IntegrationMetadata) MarshalJSON() ([]byte, error) {
...
func (o NotificationsV1IntegrationMetadata) ToMap() (map[string]interface{}, error) {
...
type NullableNotificationsV1IntegrationMetadata struct {
	value *NotificationsV1IntegrationMetadata
	isSet bool
}

func (v NullableNotificationsV1IntegrationMetadata) Get() *NotificationsV1IntegrationMetadata {
	return v.value
}

func (v *NullableNotificationsV1IntegrationMetadata) Set(val *NotificationsV1IntegrationMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableNotificationsV1IntegrationMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableNotificationsV1IntegrationMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNotificationsV1IntegrationMetadata(val *NotificationsV1IntegrationMetadata) *NullableNotificationsV1IntegrationMetadata {
	return &NullableNotificationsV1IntegrationMetadata{value: val, isSet: true}
}

func (v NullableNotificationsV1IntegrationMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNotificationsV1IntegrationMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
