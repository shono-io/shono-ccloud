...
// checks if the KsqldbcmV2ClusterListMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &KsqldbcmV2ClusterListMetadata{}

// KsqldbcmV2ClusterListMetadata struct for KsqldbcmV2ClusterListMetadata
type KsqldbcmV2ClusterListMetadata struct {
...
func NewKsqldbcmV2ClusterListMetadata() *KsqldbcmV2ClusterListMetadata {
	this := KsqldbcmV2ClusterListMetadata{}
	return &this
}
...
func (o KsqldbcmV2ClusterListMetadata) MarshalJSON() ([]byte, error) {
...
func (o KsqldbcmV2ClusterListMetadata) ToMap() (map[string]interface{}, error) {
...
type NullableKsqldbcmV2ClusterListMetadata struct {
	value *KsqldbcmV2ClusterListMetadata
	isSet bool
}

func (v NullableKsqldbcmV2ClusterListMetadata) Get() *KsqldbcmV2ClusterListMetadata {
	return v.value
}

func (v *NullableKsqldbcmV2ClusterListMetadata) Set(val *KsqldbcmV2ClusterListMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableKsqldbcmV2ClusterListMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableKsqldbcmV2ClusterListMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableKsqldbcmV2ClusterListMetadata(val *KsqldbcmV2ClusterListMetadata) *NullableKsqldbcmV2ClusterListMetadata {
	return &NullableKsqldbcmV2ClusterListMetadata{value: val, isSet: true}
}

func (v NullableKsqldbcmV2ClusterListMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableKsqldbcmV2ClusterListMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
