...
// checks if the ServiceQuotaV1ScopeListMetadataAllOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ServiceQuotaV1ScopeListMetadataAllOf{}

// ServiceQuotaV1ScopeListMetadataAllOf struct for ServiceQuotaV1ScopeListMetadataAllOf
type ServiceQuotaV1ScopeListMetadataAllOf struct {
...
func NewServiceQuotaV1ScopeListMetadataAllOf() *ServiceQuotaV1ScopeListMetadataAllOf {
	this := ServiceQuotaV1ScopeListMetadataAllOf{}
	return &this
}
...
func (o ServiceQuotaV1ScopeListMetadataAllOf) MarshalJSON() ([]byte, error) {
...
func (o ServiceQuotaV1ScopeListMetadataAllOf) ToMap() (map[string]interface{}, error) {
...
type NullableServiceQuotaV1ScopeListMetadataAllOf struct {
	value *ServiceQuotaV1ScopeListMetadataAllOf
	isSet bool
}

func (v NullableServiceQuotaV1ScopeListMetadataAllOf) Get() *ServiceQuotaV1ScopeListMetadataAllOf {
	return v.value
}

func (v *NullableServiceQuotaV1ScopeListMetadataAllOf) Set(val *ServiceQuotaV1ScopeListMetadataAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableServiceQuotaV1ScopeListMetadataAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableServiceQuotaV1ScopeListMetadataAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableServiceQuotaV1ScopeListMetadataAllOf(val *ServiceQuotaV1ScopeListMetadataAllOf) *NullableServiceQuotaV1ScopeListMetadataAllOf {
	return &NullableServiceQuotaV1ScopeListMetadataAllOf{value: val, isSet: true}
}

func (v NullableServiceQuotaV1ScopeListMetadataAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableServiceQuotaV1ScopeListMetadataAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
