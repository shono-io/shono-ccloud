...
// checks if the NotificationsV1NotificationTypeMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NotificationsV1NotificationTypeMetadata{}

// NotificationsV1NotificationTypeMetadata struct for NotificationsV1NotificationTypeMetadata
type NotificationsV1NotificationTypeMetadata struct {
...
func NewNotificationsV1NotificationTypeMetadata(self interface{}) *NotificationsV1NotificationTypeMetadata {
	this := NotificationsV1NotificationTypeMetadata{}
	this.Self = self
	return &this
}
...
func (o NotificationsV1NotificationTypeMetadata) MarshalJSON() ([]byte, error) {
...
func (o NotificationsV1NotificationTypeMetadata) ToMap() (map[string]interface{}, error) {
...
type NullableNotificationsV1NotificationTypeMetadata struct {
	value *NotificationsV1NotificationTypeMetadata
	isSet bool
}

func (v NullableNotificationsV1NotificationTypeMetadata) Get() *NotificationsV1NotificationTypeMetadata {
	return v.value
}

func (v *NullableNotificationsV1NotificationTypeMetadata) Set(val *NotificationsV1NotificationTypeMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableNotificationsV1NotificationTypeMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableNotificationsV1NotificationTypeMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNotificationsV1NotificationTypeMetadata(val *NotificationsV1NotificationTypeMetadata) *NullableNotificationsV1NotificationTypeMetadata {
	return &NullableNotificationsV1NotificationTypeMetadata{value: val, isSet: true}
}

func (v NullableNotificationsV1NotificationTypeMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNotificationsV1NotificationTypeMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
