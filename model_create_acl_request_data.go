...
// checks if the CreateAclRequestData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateAclRequestData{}
...
func (o CreateAclRequestData) ToMap() (map[string]interface{}, error) {
