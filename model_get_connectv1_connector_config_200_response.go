...
// checks if the GetConnectv1ConnectorConfig200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetConnectv1ConnectorConfig200Response{}

// GetConnectv1ConnectorConfig200Response Configuration parameters for the connector.
type GetConnectv1ConnectorConfig200Response struct {
...
func NewGetConnectv1ConnectorConfig200Response(cloudEnvironment string, cloudProvider string, connectorClass string, name string, kafkaEndpoint string, kafkaRegion string, kafkaApiKey string, kafkaApiSecret string) *GetConnectv1ConnectorConfig200Response {
	this := GetConnectv1ConnectorConfig200Response{}
...
func (o GetConnectv1ConnectorConfig200Response) MarshalJSON() ([]byte, error) {
...
func (o GetConnectv1ConnectorConfig200Response) ToMap() (map[string]interface{}, error) {
...
type NullableGetConnectv1ConnectorConfig200Response struct {
	value *GetConnectv1ConnectorConfig200Response
	isSet bool
}

func (v NullableGetConnectv1ConnectorConfig200Response) Get() *GetConnectv1ConnectorConfig200Response {
	return v.value
}

func (v *NullableGetConnectv1ConnectorConfig200Response) Set(val *GetConnectv1ConnectorConfig200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetConnectv1ConnectorConfig200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetConnectv1ConnectorConfig200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetConnectv1ConnectorConfig200Response(val *GetConnectv1ConnectorConfig200Response) *NullableGetConnectv1ConnectorConfig200Response {
	return &NullableGetConnectv1ConnectorConfig200Response{value: val, isSet: true}
}

func (v NullableGetConnectv1ConnectorConfig200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetConnectv1ConnectorConfig200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
