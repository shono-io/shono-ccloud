...
// checks if the SrcmV2RegionMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SrcmV2RegionMetadata{}

// SrcmV2RegionMetadata struct for SrcmV2RegionMetadata
type SrcmV2RegionMetadata struct {
...
func (o SrcmV2RegionMetadata) MarshalJSON() ([]byte, error) {
...
func (o SrcmV2RegionMetadata) ToMap() (map[string]interface{}, error) {
...
type NullableSrcmV2RegionMetadata struct {
	value *SrcmV2RegionMetadata
	isSet bool
}

func (v NullableSrcmV2RegionMetadata) Get() *SrcmV2RegionMetadata {
	return v.value
}

func (v *NullableSrcmV2RegionMetadata) Set(val *SrcmV2RegionMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableSrcmV2RegionMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableSrcmV2RegionMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSrcmV2RegionMetadata(val *SrcmV2RegionMetadata) *NullableSrcmV2RegionMetadata {
	return &NullableSrcmV2RegionMetadata{value: val, isSet: true}
}

func (v NullableSrcmV2RegionMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSrcmV2RegionMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
