...
// checks if the TopicDataAllOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TopicDataAllOf{}
...
func (o *TopicDataAllOf) GetAuthorizedOperations() []string {
	if o == nil || IsNil(o.AuthorizedOperations) {
		var ret []string
		return ret
	}
...
// SetAuthorizedOperations gets a reference to the given []string and assigns it to the AuthorizedOperations field.
...
func (o TopicDataAllOf) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.AuthorizedOperations) {
