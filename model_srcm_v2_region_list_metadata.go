...
// checks if the SrcmV2RegionListMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SrcmV2RegionListMetadata{}

// SrcmV2RegionListMetadata struct for SrcmV2RegionListMetadata
type SrcmV2RegionListMetadata struct {
...
func (o *SrcmV2RegionListMetadata) HasFirst() bool {
	if o != nil && IsNil(o.First) {
		return true
	}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *SrcmV2RegionListMetadata) GetPrevOk() (*interface{}, bool) {
...
func (o SrcmV2RegionListMetadata) MarshalJSON() ([]byte, error) {
...
func (o SrcmV2RegionListMetadata) ToMap() (map[string]interface{}, error) {
...
type NullableSrcmV2RegionListMetadata struct {
	value *SrcmV2RegionListMetadata
	isSet bool
}

func (v NullableSrcmV2RegionListMetadata) Get() *SrcmV2RegionListMetadata {
	return v.value
}

func (v *NullableSrcmV2RegionListMetadata) Set(val *SrcmV2RegionListMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableSrcmV2RegionListMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableSrcmV2RegionListMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSrcmV2RegionListMetadata(val *SrcmV2RegionListMetadata) *NullableSrcmV2RegionListMetadata {
	return &NullableSrcmV2RegionListMetadata{value: val, isSet: true}
}

func (v NullableSrcmV2RegionListMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSrcmV2RegionListMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
