...
// checks if the NetworkingV1NetworkLinkServiceAssociationMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NetworkingV1NetworkLinkServiceAssociationMetadata{}

// NetworkingV1NetworkLinkServiceAssociationMetadata struct for NetworkingV1NetworkLinkServiceAssociationMetadata
type NetworkingV1NetworkLinkServiceAssociationMetadata struct {
...
func NewNetworkingV1NetworkLinkServiceAssociationMetadata(self interface{}) *NetworkingV1NetworkLinkServiceAssociationMetadata {
	this := NetworkingV1NetworkLinkServiceAssociationMetadata{}
	this.Self = self
	return &this
}
...
// SetResourceName gets a reference to the given interface{} and assigns it to the ResourceName field.
func (o *NetworkingV1NetworkLinkServiceAssociationMetadata) SetResourceName(v interface{}) {
	o.ResourceName = v
}

// GetCreatedAt returns the CreatedAt field value if set, zero value otherwise.
func (o *NetworkingV1NetworkLinkServiceAssociationMetadata) GetCreatedAt() time.Time {
...
func (o NetworkingV1NetworkLinkServiceAssociationMetadata) MarshalJSON() ([]byte, error) {
...
func (o NetworkingV1NetworkLinkServiceAssociationMetadata) ToMap() (map[string]interface{}, error) {
	...
	// skip: deleted_at is readOnly
	return toSerialize, nil
}

type NullableNetworkingV1NetworkLinkServiceAssociationMetadata struct {
	value *NetworkingV1NetworkLinkServiceAssociationMetadata
	isSet bool
}

func (v NullableNetworkingV1NetworkLinkServiceAssociationMetadata) Get() *NetworkingV1NetworkLinkServiceAssociationMetadata {
	return v.value
}

func (v *NullableNetworkingV1NetworkLinkServiceAssociationMetadata) Set(val *NetworkingV1NetworkLinkServiceAssociationMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableNetworkingV1NetworkLinkServiceAssociationMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableNetworkingV1NetworkLinkServiceAssociationMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNetworkingV1NetworkLinkServiceAssociationMetadata(val *NetworkingV1NetworkLinkServiceAssociationMetadata) *NullableNetworkingV1NetworkLinkServiceAssociationMetadata {
	return &NullableNetworkingV1NetworkLinkServiceAssociationMetadata{value: val, isSet: true}
}

func (v NullableNetworkingV1NetworkLinkServiceAssociationMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNetworkingV1NetworkLinkServiceAssociationMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
