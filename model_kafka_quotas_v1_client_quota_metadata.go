...
// checks if the KafkaQuotasV1ClientQuotaMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &KafkaQuotasV1ClientQuotaMetadata{}

// KafkaQuotasV1ClientQuotaMetadata struct for KafkaQuotasV1ClientQuotaMetadata
type KafkaQuotasV1ClientQuotaMetadata struct {
...
func NewKafkaQuotasV1ClientQuotaMetadata(self interface{}) *KafkaQuotasV1ClientQuotaMetadata {
	this := KafkaQuotasV1ClientQuotaMetadata{}
	this.Self = self
	return &this
}
...
func (o KafkaQuotasV1ClientQuotaMetadata) MarshalJSON() ([]byte, error) {
...
func (o KafkaQuotasV1ClientQuotaMetadata) ToMap() (map[string]interface{}, error) {
...
type NullableKafkaQuotasV1ClientQuotaMetadata struct {
	value *KafkaQuotasV1ClientQuotaMetadata
	isSet bool
}

func (v NullableKafkaQuotasV1ClientQuotaMetadata) Get() *KafkaQuotasV1ClientQuotaMetadata {
	return v.value
}

func (v *NullableKafkaQuotasV1ClientQuotaMetadata) Set(val *KafkaQuotasV1ClientQuotaMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableKafkaQuotasV1ClientQuotaMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableKafkaQuotasV1ClientQuotaMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableKafkaQuotasV1ClientQuotaMetadata(val *KafkaQuotasV1ClientQuotaMetadata) *NullableKafkaQuotasV1ClientQuotaMetadata {
	return &NullableKafkaQuotasV1ClientQuotaMetadata{value: val, isSet: true}
}

func (v NullableKafkaQuotasV1ClientQuotaMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableKafkaQuotasV1ClientQuotaMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
