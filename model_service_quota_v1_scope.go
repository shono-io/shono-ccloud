...
// checks if the ServiceQuotaV1Scope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ServiceQuotaV1Scope{}
...
func (o ServiceQuotaV1Scope) ToMap() (map[string]interface{}, error) {
