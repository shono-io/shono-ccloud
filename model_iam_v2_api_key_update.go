...
// checks if the IamV2ApiKeyUpdate type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IamV2ApiKeyUpdate{}
...
func (o IamV2ApiKeyUpdate) ToMap() (map[string]interface{}, error) {
