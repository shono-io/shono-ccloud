...
func (r ApiCreateTagsRequest) Execute() ([]TagResponse, *http.Response, error) {
...
*/
func (a *EntityV1ApiService) CreateTags(ctx context.Context) ApiCreateTagsRequest {
	return ApiCreateTagsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
//  @return []TagResponse
func (a *EntityV1ApiService) CreateTagsExecute(r ApiCreateTagsRequest) ([]TagResponse, *http.Response, error) {
	var (
...
*/
func (a *EntityV1ApiService) DeleteTag(ctx context.Context, typeName string, qualifiedName string, tagName string) ApiDeleteTagRequest {
	return ApiDeleteTagRequest{
		ApiService: a,
		ctx: ctx,
		typeName: typeName,
...
// Execute executes the request
func (a *EntityV1ApiService) DeleteTagExecute(r ApiDeleteTagRequest) (*http.Response, error) {
	var (
	...
	localVarPath = strings.Replace(localVarPath, "{"+"typeName"+"}", url.PathEscape(parameterValueToString(r.typeName, "typeName")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"qualifiedName"+"}", url.PathEscape(parameterValueToString(r.qualifiedName, "qualifiedName")), -1)
...
func (r ApiGetByUniqueAttributesRequest) Execute() (*EntityWithExtInfo, *http.Response, error) {
...
*/
func (a *EntityV1ApiService) GetByUniqueAttributes(ctx context.Context, typeName string, qualifiedName string) ApiGetByUniqueAttributesRequest {
	return ApiGetByUniqueAttributesRequest{
		ApiService: a,
		ctx: ctx,
		typeName: typeName,
...
func (a *EntityV1ApiService) GetByUniqueAttributesExecute(r ApiGetByUniqueAttributesRequest) (*EntityWithExtInfo, *http.Response, error) {
	var (
	...
	if r.minExtInfo != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "minExtInfo", r.minExtInfo, "")
	}
	if r.ignoreRelationships != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "ignoreRelationships", r.ignoreRelationships, "")
	}
	// to determine the Content-Type header
	localVarHTTPContentTypes := []string{}
...
func (r ApiGetTagsRequest) Execute() ([]TagResponse, *http.Response, error) {
...
*/
func (a *EntityV1ApiService) GetTags(ctx context.Context, typeName string, qualifiedName string) ApiGetTagsRequest {
	return ApiGetTagsRequest{
		ApiService: a,
		ctx: ctx,
		typeName: typeName,
...
// Execute executes the request
//  @return []TagResponse
func (a *EntityV1ApiService) GetTagsExecute(r ApiGetTagsRequest) ([]TagResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r ApiUpdateTagsRequest) Execute() ([]TagResponse, *http.Response, error) {
...
*/
func (a *EntityV1ApiService) UpdateTags(ctx context.Context) ApiUpdateTagsRequest {
	return ApiUpdateTagsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return []TagResponse
func (a *EntityV1ApiService) UpdateTagsExecute(r ApiUpdateTagsRequest) ([]TagResponse, *http.Response, error) {
	var (
