...
type ApiCreateIamV2RoleBindingRequest struct {
	...
	createIamV2RoleBindingRequest *CreateIamV2RoleBindingRequest
}

func (r ApiCreateIamV2RoleBindingRequest) CreateIamV2RoleBindingRequest(createIamV2RoleBindingRequest CreateIamV2RoleBindingRequest) ApiCreateIamV2RoleBindingRequest {
	r.createIamV2RoleBindingRequest = &createIamV2RoleBindingRequest
	return r
}

func (r ApiCreateIamV2RoleBindingRequest) Execute() (*CreateIamV2RoleBindingRequest, *http.Response, error) {
...
*/
func (a *RoleBindingsIamV2ApiService) CreateIamV2RoleBinding(ctx context.Context) ApiCreateIamV2RoleBindingRequest {
	return ApiCreateIamV2RoleBindingRequest{
		ApiService: a,
		ctx: ctx,
	}
...
//  @return CreateIamV2RoleBindingRequest
func (a *RoleBindingsIamV2ApiService) CreateIamV2RoleBindingExecute(r ApiCreateIamV2RoleBindingRequest) (*CreateIamV2RoleBindingRequest, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *CreateIamV2RoleBindingRequest
	)
	...
	// body params
	localVarPostBody = r.createIamV2RoleBindingRequest
...
func (r ApiDeleteIamV2RoleBindingRequest) Execute() (*GetIamV2RoleBinding200Response, *http.Response, error) {
...
*/
func (a *RoleBindingsIamV2ApiService) DeleteIamV2RoleBinding(ctx context.Context, id string) ApiDeleteIamV2RoleBindingRequest {
	return ApiDeleteIamV2RoleBindingRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
//  @return GetIamV2RoleBinding200Response
func (a *RoleBindingsIamV2ApiService) DeleteIamV2RoleBindingExecute(r ApiDeleteIamV2RoleBindingRequest) (*GetIamV2RoleBinding200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodDelete
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *GetIamV2RoleBinding200Response
	)
...
func (r ApiGetIamV2RoleBindingRequest) Execute() (*GetIamV2RoleBinding200Response, *http.Response, error) {
...
*/
func (a *RoleBindingsIamV2ApiService) GetIamV2RoleBinding(ctx context.Context, id string) ApiGetIamV2RoleBindingRequest {
	return ApiGetIamV2RoleBindingRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
//  @return GetIamV2RoleBinding200Response
func (a *RoleBindingsIamV2ApiService) GetIamV2RoleBindingExecute(r ApiGetIamV2RoleBindingRequest) (*GetIamV2RoleBinding200Response, *http.Response, error) {
	var (
...
func (r ApiListIamV2RoleBindingsRequest) Execute() (*ListIamV2RoleBindings200Response, *http.Response, error) {
...
*/
func (a *RoleBindingsIamV2ApiService) ListIamV2RoleBindings(ctx context.Context) ApiListIamV2RoleBindingsRequest {
	return ApiListIamV2RoleBindingsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return ListIamV2RoleBindings200Response
func (a *RoleBindingsIamV2ApiService) ListIamV2RoleBindingsExecute(r ApiListIamV2RoleBindingsRequest) (*ListIamV2RoleBindings200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *ListIamV2RoleBindings200Response
	)
	...
	parameterAddToHeaderOrQuery(localVarQueryParams, "crn_pattern", r.crnPattern, "")
	if r.pageSize != nil {
