...
// checks if the CmkV2ClusterUpdate type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CmkV2ClusterUpdate{}
...
func (o CmkV2ClusterUpdate) ToMap() (map[string]interface{}, error) {
