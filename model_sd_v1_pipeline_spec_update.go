...
// checks if the SdV1PipelineSpecUpdate type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SdV1PipelineSpecUpdate{}
...
func (o SdV1PipelineSpecUpdate) ToMap() (map[string]interface{}, error) {
