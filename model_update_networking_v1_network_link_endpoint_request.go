...
// checks if the UpdateNetworkingV1NetworkLinkEndpointRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateNetworkingV1NetworkLinkEndpointRequest{}

// UpdateNetworkingV1NetworkLinkEndpointRequest struct for UpdateNetworkingV1NetworkLinkEndpointRequest
type UpdateNetworkingV1NetworkLinkEndpointRequest struct {
...
func NewUpdateNetworkingV1NetworkLinkEndpointRequest(spec UpdateCmkV2ClusterRequestAllOfSpec) *UpdateNetworkingV1NetworkLinkEndpointRequest {
	this := UpdateNetworkingV1NetworkLinkEndpointRequest{}
	this.Spec = spec
	return &this
}
...
func (o UpdateNetworkingV1NetworkLinkEndpointRequest) MarshalJSON() ([]byte, error) {
...
func (o UpdateNetworkingV1NetworkLinkEndpointRequest) ToMap() (map[string]interface{}, error) {
...
type NullableUpdateNetworkingV1NetworkLinkEndpointRequest struct {
	value *UpdateNetworkingV1NetworkLinkEndpointRequest
	isSet bool
}

func (v NullableUpdateNetworkingV1NetworkLinkEndpointRequest) Get() *UpdateNetworkingV1NetworkLinkEndpointRequest {
	return v.value
}

func (v *NullableUpdateNetworkingV1NetworkLinkEndpointRequest) Set(val *UpdateNetworkingV1NetworkLinkEndpointRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdateNetworkingV1NetworkLinkEndpointRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableUpdateNetworkingV1NetworkLinkEndpointRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpdateNetworkingV1NetworkLinkEndpointRequest(val *UpdateNetworkingV1NetworkLinkEndpointRequest) *NullableUpdateNetworkingV1NetworkLinkEndpointRequest {
	return &NullableUpdateNetworkingV1NetworkLinkEndpointRequest{value: val, isSet: true}
}

func (v NullableUpdateNetworkingV1NetworkLinkEndpointRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpdateNetworkingV1NetworkLinkEndpointRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
