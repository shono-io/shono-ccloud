...
// checks if the NetworkingV1NetworkLinkServiceUpdate type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NetworkingV1NetworkLinkServiceUpdate{}
...
func (o NetworkingV1NetworkLinkServiceUpdate) ToMap() (map[string]interface{}, error) {
