...
func (r ApiDeleteIamV2UserRequest) Execute() (*http.Response, error) {
...
*/
func (a *UsersIamV2ApiService) DeleteIamV2User(ctx context.Context, id string) ApiDeleteIamV2UserRequest {
	return ApiDeleteIamV2UserRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
func (a *UsersIamV2ApiService) DeleteIamV2UserExecute(r ApiDeleteIamV2UserRequest) (*http.Response, error) {
	var (
...
func (r ApiGetIamV2UserRequest) Execute() (*GetIamV2User200Response, *http.Response, error) {
...
*/
func (a *UsersIamV2ApiService) GetIamV2User(ctx context.Context, id string) ApiGetIamV2UserRequest {
	return ApiGetIamV2UserRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
//  @return GetIamV2User200Response
func (a *UsersIamV2ApiService) GetIamV2UserExecute(r ApiGetIamV2UserRequest) (*GetIamV2User200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *GetIamV2User200Response
	)
...
func (r ApiListIamV2UsersRequest) Execute() (*ListIamV2Users200Response, *http.Response, error) {
...
*/
func (a *UsersIamV2ApiService) ListIamV2Users(ctx context.Context) ApiListIamV2UsersRequest {
	return ApiListIamV2UsersRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return ListIamV2Users200Response
func (a *UsersIamV2ApiService) ListIamV2UsersExecute(r ApiListIamV2UsersRequest) (*ListIamV2Users200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *ListIamV2Users200Response
	)
...
func (r ApiUpdateIamV2UserRequest) Execute() (*GetIamV2User200Response, *http.Response, error) {
...
*/
func (a *UsersIamV2ApiService) UpdateIamV2User(ctx context.Context, id string) ApiUpdateIamV2UserRequest {
	return ApiUpdateIamV2UserRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
//  @return GetIamV2User200Response
func (a *UsersIamV2ApiService) UpdateIamV2UserExecute(r ApiUpdateIamV2UserRequest) (*GetIamV2User200Response, *http.Response, error) {
	var (
