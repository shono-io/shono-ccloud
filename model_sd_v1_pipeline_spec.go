...
// checks if the SdV1PipelineSpec type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SdV1PipelineSpec{}
...
type SdV1PipelineSpec struct {
	...
	SourceCode *SdV1PipelineSpecSourceCode `json:"source_code,omitempty"`
	// A map of secrets used in the pipeline source code.
	Secrets *map[string]string `json:"secrets,omitempty"`
	Environment *NetworkingV1NetworkSpecEnvironment `json:"environment,omitempty"`
	KafkaCluster *SdV1PipelineSpecKafkaCluster `json:"kafka_cluster,omitempty"`
	KsqlCluster *SdV1PipelineSpecKsqlCluster `json:"ksql_cluster,omitempty"`
	StreamGovernanceCluster *SdV1PipelineSpecStreamGovernanceCluster `json:"stream_governance_cluster,omitempty"`
}
...
func (o *SdV1PipelineSpec) GetRetainedTopicNames() []string {
	if o == nil || IsNil(o.RetainedTopicNames) {
		var ret []string
		return ret
	}
...
func (o *SdV1PipelineSpec) GetActivationPrivilege() bool {
	if o == nil || IsNil(o.ActivationPrivilege) {
		var ret bool
		return ret
	}
...
func (o *SdV1PipelineSpec) GetSourceCode() SdV1PipelineSpecSourceCode {
	if o == nil || IsNil(o.SourceCode) {
		var ret SdV1PipelineSpecSourceCode
		return ret
	}
	return *o.SourceCode
}
...
// SetSourceCode gets a reference to the given SdV1PipelineSpecSourceCode and assigns it to the SourceCode field.
...
func (o *SdV1PipelineSpec) GetEnvironment() NetworkingV1NetworkSpecEnvironment {
	if o == nil || IsNil(o.Environment) {
		var ret NetworkingV1NetworkSpecEnvironment
		return ret
	}
...
// SetEnvironment gets a reference to the given NetworkingV1NetworkSpecEnvironment and assigns it to the Environment field.
...
func (o *SdV1PipelineSpec) GetKafkaCluster() SdV1PipelineSpecKafkaCluster {
	if o == nil || IsNil(o.KafkaCluster) {
		var ret SdV1PipelineSpecKafkaCluster
		return ret
	}
...
// SetKafkaCluster gets a reference to the given SdV1PipelineSpecKafkaCluster and assigns it to the KafkaCluster field.
...
func (o *SdV1PipelineSpec) GetKsqlCluster() SdV1PipelineSpecKsqlCluster {
	if o == nil || IsNil(o.KsqlCluster) {
		var ret SdV1PipelineSpecKsqlCluster
		return ret
	}
...
// SetKsqlCluster gets a reference to the given SdV1PipelineSpecKsqlCluster and assigns it to the KsqlCluster field.
...
func (o *SdV1PipelineSpec) GetStreamGovernanceCluster() SdV1PipelineSpecStreamGovernanceCluster {
	if o == nil || IsNil(o.StreamGovernanceCluster) {
		var ret SdV1PipelineSpecStreamGovernanceCluster
		return ret
	}
...
// SetStreamGovernanceCluster gets a reference to the given SdV1PipelineSpecStreamGovernanceCluster and assigns it to the StreamGovernanceCluster field.
...
func (o SdV1PipelineSpec) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.KafkaCluster) {
		toSerialize["kafka_cluster"] = o.KafkaCluster
	}
	if !IsNil(o.KsqlCluster) {
		toSerialize["ksql_cluster"] = o.KsqlCluster
	}
	if !IsNil(o.StreamGovernanceCluster) {
