...
type ApiCreateIamV2InvitationRequest struct {
	ctx context.Context
	ApiService *InvitationsIamV2ApiService
	createIamV2InvitationRequest *CreateIamV2InvitationRequest
}

func (r ApiCreateIamV2InvitationRequest) CreateIamV2InvitationRequest(createIamV2InvitationRequest CreateIamV2InvitationRequest) ApiCreateIamV2InvitationRequest {
	r.createIamV2InvitationRequest = &createIamV2InvitationRequest
	return r
}

func (r ApiCreateIamV2InvitationRequest) Execute() (*CreateIamV2InvitationRequest, *http.Response, error) {
...
*/
func (a *InvitationsIamV2ApiService) CreateIamV2Invitation(ctx context.Context) ApiCreateIamV2InvitationRequest {
	return ApiCreateIamV2InvitationRequest{
		ApiService: a,
		ctx: ctx,
	}
...
//  @return CreateIamV2InvitationRequest
func (a *InvitationsIamV2ApiService) CreateIamV2InvitationExecute(r ApiCreateIamV2InvitationRequest) (*CreateIamV2InvitationRequest, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *CreateIamV2InvitationRequest
	)
	...
	// body params
	localVarPostBody = r.createIamV2InvitationRequest
...
func (r ApiDeleteIamV2InvitationRequest) Execute() (*http.Response, error) {
...
*/
func (a *InvitationsIamV2ApiService) DeleteIamV2Invitation(ctx context.Context, id string) ApiDeleteIamV2InvitationRequest {
	return ApiDeleteIamV2InvitationRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
func (a *InvitationsIamV2ApiService) DeleteIamV2InvitationExecute(r ApiDeleteIamV2InvitationRequest) (*http.Response, error) {
	var (
...
func (r ApiGetIamV2InvitationRequest) Execute() (*GetIamV2Invitation200Response, *http.Response, error) {
...
*/
func (a *InvitationsIamV2ApiService) GetIamV2Invitation(ctx context.Context, id string) ApiGetIamV2InvitationRequest {
	return ApiGetIamV2InvitationRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
//  @return GetIamV2Invitation200Response
func (a *InvitationsIamV2ApiService) GetIamV2InvitationExecute(r ApiGetIamV2InvitationRequest) (*GetIamV2Invitation200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *GetIamV2Invitation200Response
	)
...
func (r ApiListIamV2InvitationsRequest) Execute() (*ListIamV2Invitations200Response, *http.Response, error) {
...
*/
func (a *InvitationsIamV2ApiService) ListIamV2Invitations(ctx context.Context) ApiListIamV2InvitationsRequest {
	return ApiListIamV2InvitationsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return ListIamV2Invitations200Response
func (a *InvitationsIamV2ApiService) ListIamV2InvitationsExecute(r ApiListIamV2InvitationsRequest) (*ListIamV2Invitations200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *ListIamV2Invitations200Response
	)
