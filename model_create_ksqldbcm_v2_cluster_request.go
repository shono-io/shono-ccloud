...
// checks if the CreateKsqldbcmV2ClusterRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateKsqldbcmV2ClusterRequest{}

// CreateKsqldbcmV2ClusterRequest struct for CreateKsqldbcmV2ClusterRequest
type CreateKsqldbcmV2ClusterRequest struct {
	...
	Spec CreateKsqldbcmV2ClusterRequestAllOf1Spec `json:"spec"`
...
func NewCreateKsqldbcmV2ClusterRequest(spec CreateKsqldbcmV2ClusterRequestAllOf1Spec) *CreateKsqldbcmV2ClusterRequest {
	this := CreateKsqldbcmV2ClusterRequest{}
	this.Spec = spec
	return &this
}
...
func (o *CreateKsqldbcmV2ClusterRequest) GetSpec() CreateKsqldbcmV2ClusterRequestAllOf1Spec {
	if o == nil {
		var ret CreateKsqldbcmV2ClusterRequestAllOf1Spec
		return ret
	}
...
func (o CreateKsqldbcmV2ClusterRequest) MarshalJSON() ([]byte, error) {
...
func (o CreateKsqldbcmV2ClusterRequest) ToMap() (map[string]interface{}, error) {
...
type NullableCreateKsqldbcmV2ClusterRequest struct {
	value *CreateKsqldbcmV2ClusterRequest
	isSet bool
}

func (v NullableCreateKsqldbcmV2ClusterRequest) Get() *CreateKsqldbcmV2ClusterRequest {
	return v.value
}

func (v *NullableCreateKsqldbcmV2ClusterRequest) Set(val *CreateKsqldbcmV2ClusterRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateKsqldbcmV2ClusterRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateKsqldbcmV2ClusterRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateKsqldbcmV2ClusterRequest(val *CreateKsqldbcmV2ClusterRequest) *NullableCreateKsqldbcmV2ClusterRequest {
	return &NullableCreateKsqldbcmV2ClusterRequest{value: val, isSet: true}
}

func (v NullableCreateKsqldbcmV2ClusterRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateKsqldbcmV2ClusterRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
