...
// checks if the TermAssignmentHeader type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TermAssignmentHeader{}
...
func (o TermAssignmentHeader) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.TermGuid) {
		toSerialize["termGuid"] = o.TermGuid
	}
	if !IsNil(o.RelationGuid) {
