...
// checks if the ReplicaStatusDataAllOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ReplicaStatusDataAllOf{}
...
func (o ReplicaStatusDataAllOf) ToMap() (map[string]interface{}, error) {
