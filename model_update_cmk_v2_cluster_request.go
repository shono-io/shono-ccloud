...
// checks if the UpdateCmkV2ClusterRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateCmkV2ClusterRequest{}

// UpdateCmkV2ClusterRequest struct for UpdateCmkV2ClusterRequest
type UpdateCmkV2ClusterRequest struct {
...
func NewUpdateCmkV2ClusterRequest(spec UpdateCmkV2ClusterRequestAllOfSpec) *UpdateCmkV2ClusterRequest {
	this := UpdateCmkV2ClusterRequest{}
	this.Spec = spec
	return &this
}
...
func (o *UpdateCmkV2ClusterRequest) HasId() bool {
	if o != nil && !IsNil(o.Id) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *UpdateCmkV2ClusterRequest) GetStatusOk() (*CmkV2ClusterStatus, bool) {
	if o == nil || IsNil(o.Status) {
		return nil, false
	}
...
func (o UpdateCmkV2ClusterRequest) MarshalJSON() ([]byte, error) {
...
func (o UpdateCmkV2ClusterRequest) ToMap() (map[string]interface{}, error) {
...
type NullableUpdateCmkV2ClusterRequest struct {
	value *UpdateCmkV2ClusterRequest
	isSet bool
}

func (v NullableUpdateCmkV2ClusterRequest) Get() *UpdateCmkV2ClusterRequest {
	return v.value
}

func (v *NullableUpdateCmkV2ClusterRequest) Set(val *UpdateCmkV2ClusterRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdateCmkV2ClusterRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableUpdateCmkV2ClusterRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpdateCmkV2ClusterRequest(val *UpdateCmkV2ClusterRequest) *NullableUpdateCmkV2ClusterRequest {
	return &NullableUpdateCmkV2ClusterRequest{value: val, isSet: true}
}

func (v NullableUpdateCmkV2ClusterRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpdateCmkV2ClusterRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
