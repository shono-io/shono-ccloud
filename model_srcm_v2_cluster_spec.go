...
// checks if the SrcmV2ClusterSpec type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SrcmV2ClusterSpec{}
...
type SrcmV2ClusterSpec struct {
	...
	Region *SrcmV2ClusterSpecRegion `json:"region,omitempty"`
}
...
func (o *SrcmV2ClusterSpec) GetRegion() SrcmV2ClusterSpecRegion {
	if o == nil || IsNil(o.Region) {
		var ret SrcmV2ClusterSpecRegion
		return ret
	}
	return *o.Region
}
...
// SetRegion gets a reference to the given SrcmV2ClusterSpecRegion and assigns it to the Region field.
...
func (o SrcmV2ClusterSpec) ToMap() (map[string]interface{}, error) {
