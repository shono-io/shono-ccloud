...
// checks if the UpdateNetworkingV1NetworkRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateNetworkingV1NetworkRequest{}

// UpdateNetworkingV1NetworkRequest struct for UpdateNetworkingV1NetworkRequest
type UpdateNetworkingV1NetworkRequest struct {
...
func NewUpdateNetworkingV1NetworkRequest(spec UpdateCmkV2ClusterRequestAllOfSpec) *UpdateNetworkingV1NetworkRequest {
	this := UpdateNetworkingV1NetworkRequest{}
	this.Spec = spec
	return &this
}
...
func (o UpdateNetworkingV1NetworkRequest) MarshalJSON() ([]byte, error) {
...
func (o UpdateNetworkingV1NetworkRequest) ToMap() (map[string]interface{}, error) {
...
type NullableUpdateNetworkingV1NetworkRequest struct {
	value *UpdateNetworkingV1NetworkRequest
	isSet bool
}

func (v NullableUpdateNetworkingV1NetworkRequest) Get() *UpdateNetworkingV1NetworkRequest {
	return v.value
}

func (v *NullableUpdateNetworkingV1NetworkRequest) Set(val *UpdateNetworkingV1NetworkRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdateNetworkingV1NetworkRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableUpdateNetworkingV1NetworkRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpdateNetworkingV1NetworkRequest(val *UpdateNetworkingV1NetworkRequest) *NullableUpdateNetworkingV1NetworkRequest {
	return &NullableUpdateNetworkingV1NetworkRequest{value: val, isSet: true}
}

func (v NullableUpdateNetworkingV1NetworkRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpdateNetworkingV1NetworkRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
