...
// checks if the ConsumerGroupLagSummaryData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ConsumerGroupLagSummaryData{}
...
func (o ConsumerGroupLagSummaryData) ToMap() (map[string]interface{}, error) {
