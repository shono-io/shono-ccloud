...
// checks if the SdV1PipelineStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SdV1PipelineStatus{}
...
func (o SdV1PipelineStatus) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	// skip: state is readOnly
	// skip: topic_count is readOnly
	// skip: connector_count is readOnly
	// skip: query_count is readOnly
