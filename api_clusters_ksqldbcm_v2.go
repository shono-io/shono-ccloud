...
type ApiCreateKsqldbcmV2ClusterRequest struct {
	ctx context.Context
	ApiService *ClustersKsqldbcmV2ApiService
	createKsqldbcmV2ClusterRequest *CreateKsqldbcmV2ClusterRequest
}

func (r ApiCreateKsqldbcmV2ClusterRequest) CreateKsqldbcmV2ClusterRequest(createKsqldbcmV2ClusterRequest CreateKsqldbcmV2ClusterRequest) ApiCreateKsqldbcmV2ClusterRequest {
	r.createKsqldbcmV2ClusterRequest = &createKsqldbcmV2ClusterRequest
	return r
}

func (r ApiCreateKsqldbcmV2ClusterRequest) Execute() (*CreateKsqldbcmV2Cluster202Response, *http.Response, error) {
...
*/
func (a *ClustersKsqldbcmV2ApiService) CreateKsqldbcmV2Cluster(ctx context.Context) ApiCreateKsqldbcmV2ClusterRequest {
	return ApiCreateKsqldbcmV2ClusterRequest{
		ApiService: a,
		ctx: ctx,
	}
...
//  @return CreateKsqldbcmV2Cluster202Response
func (a *ClustersKsqldbcmV2ApiService) CreateKsqldbcmV2ClusterExecute(r ApiCreateKsqldbcmV2ClusterRequest) (*CreateKsqldbcmV2Cluster202Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *CreateKsqldbcmV2Cluster202Response
	)
	...
	// body params
	localVarPostBody = r.createKsqldbcmV2ClusterRequest
...
func (r ApiDeleteKsqldbcmV2ClusterRequest) Execute() (*http.Response, error) {
...
*/
func (a *ClustersKsqldbcmV2ApiService) DeleteKsqldbcmV2Cluster(ctx context.Context, id string) ApiDeleteKsqldbcmV2ClusterRequest {
	return ApiDeleteKsqldbcmV2ClusterRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
func (a *ClustersKsqldbcmV2ApiService) DeleteKsqldbcmV2ClusterExecute(r ApiDeleteKsqldbcmV2ClusterRequest) (*http.Response, error) {
	var (
...
func (r ApiGetKsqldbcmV2ClusterRequest) Execute() (*GetKsqldbcmV2Cluster200Response, *http.Response, error) {
...
*/
func (a *ClustersKsqldbcmV2ApiService) GetKsqldbcmV2Cluster(ctx context.Context, id string) ApiGetKsqldbcmV2ClusterRequest {
	return ApiGetKsqldbcmV2ClusterRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
//  @return GetKsqldbcmV2Cluster200Response
func (a *ClustersKsqldbcmV2ApiService) GetKsqldbcmV2ClusterExecute(r ApiGetKsqldbcmV2ClusterRequest) (*GetKsqldbcmV2Cluster200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *GetKsqldbcmV2Cluster200Response
	)
...
func (r ApiListKsqldbcmV2ClustersRequest) Execute() (*ListKsqldbcmV2Clusters200Response, *http.Response, error) {
...
*/
func (a *ClustersKsqldbcmV2ApiService) ListKsqldbcmV2Clusters(ctx context.Context) ApiListKsqldbcmV2ClustersRequest {
	return ApiListKsqldbcmV2ClustersRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return ListKsqldbcmV2Clusters200Response
func (a *ClustersKsqldbcmV2ApiService) ListKsqldbcmV2ClustersExecute(r ApiListKsqldbcmV2ClustersRequest) (*ListKsqldbcmV2Clusters200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *ListKsqldbcmV2Clusters200Response
	)
