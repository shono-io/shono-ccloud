...
// checks if the NetworkingV1NetworkLinkEndpointMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NetworkingV1NetworkLinkEndpointMetadata{}

// NetworkingV1NetworkLinkEndpointMetadata struct for NetworkingV1NetworkLinkEndpointMetadata
type NetworkingV1NetworkLinkEndpointMetadata struct {
...
func NewNetworkingV1NetworkLinkEndpointMetadata(self interface{}) *NetworkingV1NetworkLinkEndpointMetadata {
	this := NetworkingV1NetworkLinkEndpointMetadata{}
	this.Self = self
	return &this
}
...
func (o NetworkingV1NetworkLinkEndpointMetadata) MarshalJSON() ([]byte, error) {
...
func (o NetworkingV1NetworkLinkEndpointMetadata) ToMap() (map[string]interface{}, error) {
...
type NullableNetworkingV1NetworkLinkEndpointMetadata struct {
	value *NetworkingV1NetworkLinkEndpointMetadata
	isSet bool
}

func (v NullableNetworkingV1NetworkLinkEndpointMetadata) Get() *NetworkingV1NetworkLinkEndpointMetadata {
	return v.value
}

func (v *NullableNetworkingV1NetworkLinkEndpointMetadata) Set(val *NetworkingV1NetworkLinkEndpointMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableNetworkingV1NetworkLinkEndpointMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableNetworkingV1NetworkLinkEndpointMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNetworkingV1NetworkLinkEndpointMetadata(val *NetworkingV1NetworkLinkEndpointMetadata) *NullableNetworkingV1NetworkLinkEndpointMetadata {
	return &NullableNetworkingV1NetworkLinkEndpointMetadata{value: val, isSet: true}
}

func (v NullableNetworkingV1NetworkLinkEndpointMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNetworkingV1NetworkLinkEndpointMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
