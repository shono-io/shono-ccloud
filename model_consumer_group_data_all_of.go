...
// checks if the ConsumerGroupDataAllOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ConsumerGroupDataAllOf{}
...
func (o ConsumerGroupDataAllOf) ToMap() (map[string]interface{}, error) {
