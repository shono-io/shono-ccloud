...
// checks if the PartnerV2EntitlementOrganization type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PartnerV2EntitlementOrganization{}

// PartnerV2EntitlementOrganization The organization associated with this object.
type PartnerV2EntitlementOrganization struct {
...
func NewPartnerV2EntitlementOrganization(id string, related string, resourceName string) *PartnerV2EntitlementOrganization {
	this := PartnerV2EntitlementOrganization{}
	this.Id = id
...
func (o PartnerV2EntitlementOrganization) MarshalJSON() ([]byte, error) {
...
func (o PartnerV2EntitlementOrganization) ToMap() (map[string]interface{}, error) {
...
type NullablePartnerV2EntitlementOrganization struct {
	value *PartnerV2EntitlementOrganization
	isSet bool
}

func (v NullablePartnerV2EntitlementOrganization) Get() *PartnerV2EntitlementOrganization {
	return v.value
}

func (v *NullablePartnerV2EntitlementOrganization) Set(val *PartnerV2EntitlementOrganization) {
	v.value = val
	v.isSet = true
}

func (v NullablePartnerV2EntitlementOrganization) IsSet() bool {
	return v.isSet
}

func (v *NullablePartnerV2EntitlementOrganization) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePartnerV2EntitlementOrganization(val *PartnerV2EntitlementOrganization) *NullablePartnerV2EntitlementOrganization {
	return &NullablePartnerV2EntitlementOrganization{value: val, isSet: true}
}

func (v NullablePartnerV2EntitlementOrganization) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePartnerV2EntitlementOrganization) UnmarshalJSON(src []byte) error {
	v.isSet = true
