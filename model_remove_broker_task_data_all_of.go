...
// checks if the RemoveBrokerTaskDataAllOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RemoveBrokerTaskDataAllOf{}
...
func (o RemoveBrokerTaskDataAllOf) ToMap() (map[string]interface{}, error) {
