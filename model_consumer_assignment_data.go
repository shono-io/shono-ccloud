...
// checks if the ConsumerAssignmentData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ConsumerAssignmentData{}
...
func (o ConsumerAssignmentData) ToMap() (map[string]interface{}, error) {
