...
// checks if the NetworkingV1PrivateLinkAccessListMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NetworkingV1PrivateLinkAccessListMetadata{}

// NetworkingV1PrivateLinkAccessListMetadata struct for NetworkingV1PrivateLinkAccessListMetadata
type NetworkingV1PrivateLinkAccessListMetadata struct {
...
func NewNetworkingV1PrivateLinkAccessListMetadata() *NetworkingV1PrivateLinkAccessListMetadata {
	this := NetworkingV1PrivateLinkAccessListMetadata{}
	return &this
}
...
func (o *NetworkingV1PrivateLinkAccessListMetadata) SetFirst(v interface{}) {
	o.First = v
}
...
func (o *NetworkingV1PrivateLinkAccessListMetadata) GetPrev() interface{} {
	if o == nil {
		var ret interface{}
		return ret
	}
...
func (o NetworkingV1PrivateLinkAccessListMetadata) MarshalJSON() ([]byte, error) {
...
func (o NetworkingV1PrivateLinkAccessListMetadata) ToMap() (map[string]interface{}, error) {
...
type NullableNetworkingV1PrivateLinkAccessListMetadata struct {
	value *NetworkingV1PrivateLinkAccessListMetadata
	isSet bool
}

func (v NullableNetworkingV1PrivateLinkAccessListMetadata) Get() *NetworkingV1PrivateLinkAccessListMetadata {
	return v.value
}

func (v *NullableNetworkingV1PrivateLinkAccessListMetadata) Set(val *NetworkingV1PrivateLinkAccessListMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableNetworkingV1PrivateLinkAccessListMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableNetworkingV1PrivateLinkAccessListMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNetworkingV1PrivateLinkAccessListMetadata(val *NetworkingV1PrivateLinkAccessListMetadata) *NullableNetworkingV1PrivateLinkAccessListMetadata {
	return &NullableNetworkingV1PrivateLinkAccessListMetadata{value: val, isSet: true}
}

func (v NullableNetworkingV1PrivateLinkAccessListMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNetworkingV1PrivateLinkAccessListMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
