...
// checks if the NetworkingV1NetworkLinkEndpointListMetadataAllOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NetworkingV1NetworkLinkEndpointListMetadataAllOf{}

// NetworkingV1NetworkLinkEndpointListMetadataAllOf struct for NetworkingV1NetworkLinkEndpointListMetadataAllOf
type NetworkingV1NetworkLinkEndpointListMetadataAllOf struct {
...
func NewNetworkingV1NetworkLinkEndpointListMetadataAllOf() *NetworkingV1NetworkLinkEndpointListMetadataAllOf {
	this := NetworkingV1NetworkLinkEndpointListMetadataAllOf{}
	return &this
}
...
func (o NetworkingV1NetworkLinkEndpointListMetadataAllOf) MarshalJSON() ([]byte, error) {
...
func (o NetworkingV1NetworkLinkEndpointListMetadataAllOf) ToMap() (map[string]interface{}, error) {
...
type NullableNetworkingV1NetworkLinkEndpointListMetadataAllOf struct {
	value *NetworkingV1NetworkLinkEndpointListMetadataAllOf
	isSet bool
}

func (v NullableNetworkingV1NetworkLinkEndpointListMetadataAllOf) Get() *NetworkingV1NetworkLinkEndpointListMetadataAllOf {
	return v.value
}

func (v *NullableNetworkingV1NetworkLinkEndpointListMetadataAllOf) Set(val *NetworkingV1NetworkLinkEndpointListMetadataAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableNetworkingV1NetworkLinkEndpointListMetadataAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableNetworkingV1NetworkLinkEndpointListMetadataAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNetworkingV1NetworkLinkEndpointListMetadataAllOf(val *NetworkingV1NetworkLinkEndpointListMetadataAllOf) *NullableNetworkingV1NetworkLinkEndpointListMetadataAllOf {
	return &NullableNetworkingV1NetworkLinkEndpointListMetadataAllOf{value: val, isSet: true}
}

func (v NullableNetworkingV1NetworkLinkEndpointListMetadataAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNetworkingV1NetworkLinkEndpointListMetadataAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
