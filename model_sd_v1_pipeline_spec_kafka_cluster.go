...
// checks if the SdV1PipelineSpecKafkaCluster type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SdV1PipelineSpecKafkaCluster{}

// SdV1PipelineSpecKafkaCluster The kafka_cluster to which this belongs.
type SdV1PipelineSpecKafkaCluster struct {
...
func NewSdV1PipelineSpecKafkaCluster(id string, related string, resourceName string) *SdV1PipelineSpecKafkaCluster {
	this := SdV1PipelineSpecKafkaCluster{}
	this.Id = id
...
func (o SdV1PipelineSpecKafkaCluster) MarshalJSON() ([]byte, error) {
...
func (o SdV1PipelineSpecKafkaCluster) ToMap() (map[string]interface{}, error) {
...
type NullableSdV1PipelineSpecKafkaCluster struct {
	value *SdV1PipelineSpecKafkaCluster
	isSet bool
}

func (v NullableSdV1PipelineSpecKafkaCluster) Get() *SdV1PipelineSpecKafkaCluster {
	return v.value
}

func (v *NullableSdV1PipelineSpecKafkaCluster) Set(val *SdV1PipelineSpecKafkaCluster) {
	v.value = val
	v.isSet = true
}

func (v NullableSdV1PipelineSpecKafkaCluster) IsSet() bool {
	return v.isSet
}

func (v *NullableSdV1PipelineSpecKafkaCluster) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSdV1PipelineSpecKafkaCluster(val *SdV1PipelineSpecKafkaCluster) *NullableSdV1PipelineSpecKafkaCluster {
	return &NullableSdV1PipelineSpecKafkaCluster{value: val, isSet: true}
}

func (v NullableSdV1PipelineSpecKafkaCluster) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSdV1PipelineSpecKafkaCluster) UnmarshalJSON(src []byte) error {
	v.isSet = true
