...
// checks if the OrgV2OrganizationListMetadataAllOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OrgV2OrganizationListMetadataAllOf{}

// OrgV2OrganizationListMetadataAllOf struct for OrgV2OrganizationListMetadataAllOf
type OrgV2OrganizationListMetadataAllOf struct {
...
func NewOrgV2OrganizationListMetadataAllOf() *OrgV2OrganizationListMetadataAllOf {
	this := OrgV2OrganizationListMetadataAllOf{}
	return &this
}
...
func (o OrgV2OrganizationListMetadataAllOf) MarshalJSON() ([]byte, error) {
...
func (o OrgV2OrganizationListMetadataAllOf) ToMap() (map[string]interface{}, error) {
...
type NullableOrgV2OrganizationListMetadataAllOf struct {
	value *OrgV2OrganizationListMetadataAllOf
	isSet bool
}

func (v NullableOrgV2OrganizationListMetadataAllOf) Get() *OrgV2OrganizationListMetadataAllOf {
	return v.value
}

func (v *NullableOrgV2OrganizationListMetadataAllOf) Set(val *OrgV2OrganizationListMetadataAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableOrgV2OrganizationListMetadataAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableOrgV2OrganizationListMetadataAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOrgV2OrganizationListMetadataAllOf(val *OrgV2OrganizationListMetadataAllOf) *NullableOrgV2OrganizationListMetadataAllOf {
	return &NullableOrgV2OrganizationListMetadataAllOf{value: val, isSet: true}
}

func (v NullableOrgV2OrganizationListMetadataAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOrgV2OrganizationListMetadataAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
