...
// checks if the CreateIamV2IdentityPoolRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateIamV2IdentityPoolRequest{}

// CreateIamV2IdentityPoolRequest struct for CreateIamV2IdentityPoolRequest
type CreateIamV2IdentityPoolRequest struct {
...
func NewCreateIamV2IdentityPoolRequest(displayName string, description string, identityClaim string, filter string) *CreateIamV2IdentityPoolRequest {
	this := CreateIamV2IdentityPoolRequest{}
...
func (o CreateIamV2IdentityPoolRequest) MarshalJSON() ([]byte, error) {
...
func (o CreateIamV2IdentityPoolRequest) ToMap() (map[string]interface{}, error) {
...
type NullableCreateIamV2IdentityPoolRequest struct {
	value *CreateIamV2IdentityPoolRequest
	isSet bool
}

func (v NullableCreateIamV2IdentityPoolRequest) Get() *CreateIamV2IdentityPoolRequest {
	return v.value
}

func (v *NullableCreateIamV2IdentityPoolRequest) Set(val *CreateIamV2IdentityPoolRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateIamV2IdentityPoolRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateIamV2IdentityPoolRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateIamV2IdentityPoolRequest(val *CreateIamV2IdentityPoolRequest) *NullableCreateIamV2IdentityPoolRequest {
	return &NullableCreateIamV2IdentityPoolRequest{value: val, isSet: true}
}

func (v NullableCreateIamV2IdentityPoolRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateIamV2IdentityPoolRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
