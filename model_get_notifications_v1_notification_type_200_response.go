...
// checks if the GetNotificationsV1NotificationType200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetNotificationsV1NotificationType200Response{}

// GetNotificationsV1NotificationType200Response struct for GetNotificationsV1NotificationType200Response
type GetNotificationsV1NotificationType200Response struct {
	...
	Id string `json:"id"`
	Metadata *NotificationsV1NotificationTypeMetadata `json:"metadata,omitempty"`
...
func NewGetNotificationsV1NotificationType200Response(apiVersion string, kind string, id string, displayName string, category string, description string, subscriptionPriority string, isIncludedInPlan bool, severity string) *GetNotificationsV1NotificationType200Response {
	this := GetNotificationsV1NotificationType200Response{}
...
func (o *GetNotificationsV1NotificationType200Response) GetMetadata() NotificationsV1NotificationTypeMetadata {
	if o == nil || IsNil(o.Metadata) {
		var ret NotificationsV1NotificationTypeMetadata
		return ret
	}
	return *o.Metadata
}
...
// SetMetadata gets a reference to the given NotificationsV1NotificationTypeMetadata and assigns it to the Metadata field.
...
// GetSubscriptionPriority returns the SubscriptionPriority field value
...
// GetSubscriptionPriorityOk returns a tuple with the SubscriptionPriority field value
// and a boolean to check if the value has been set.
...
// GetIsIncludedInPlanOk returns a tuple with the IsIncludedInPlan field value
// and a boolean to check if the value has been set.
...
// SetIsIncludedInPlan sets field value
...
func (o GetNotificationsV1NotificationType200Response) MarshalJSON() ([]byte, error) {
...
func (o GetNotificationsV1NotificationType200Response) ToMap() (map[string]interface{}, error) {
...
type NullableGetNotificationsV1NotificationType200Response struct {
	value *GetNotificationsV1NotificationType200Response
	isSet bool
}

func (v NullableGetNotificationsV1NotificationType200Response) Get() *GetNotificationsV1NotificationType200Response {
	return v.value
}

func (v *NullableGetNotificationsV1NotificationType200Response) Set(val *GetNotificationsV1NotificationType200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetNotificationsV1NotificationType200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetNotificationsV1NotificationType200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetNotificationsV1NotificationType200Response(val *GetNotificationsV1NotificationType200Response) *NullableGetNotificationsV1NotificationType200Response {
	return &NullableGetNotificationsV1NotificationType200Response{value: val, isSet: true}
}

func (v NullableGetNotificationsV1NotificationType200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetNotificationsV1NotificationType200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
