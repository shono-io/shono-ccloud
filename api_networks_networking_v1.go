...
type ApiCreateNetworkingV1NetworkRequest struct {
	...
	createNetworkingV1NetworkRequest *CreateNetworkingV1NetworkRequest
}

func (r ApiCreateNetworkingV1NetworkRequest) CreateNetworkingV1NetworkRequest(createNetworkingV1NetworkRequest CreateNetworkingV1NetworkRequest) ApiCreateNetworkingV1NetworkRequest {
	r.createNetworkingV1NetworkRequest = &createNetworkingV1NetworkRequest
	return r
}

func (r ApiCreateNetworkingV1NetworkRequest) Execute() (*CreateNetworkingV1Network202Response, *http.Response, error) {
...
*/
func (a *NetworksNetworkingV1ApiService) CreateNetworkingV1Network(ctx context.Context) ApiCreateNetworkingV1NetworkRequest {
	return ApiCreateNetworkingV1NetworkRequest{
		ApiService: a,
		ctx: ctx,
	}
...
//  @return CreateNetworkingV1Network202Response
func (a *NetworksNetworkingV1ApiService) CreateNetworkingV1NetworkExecute(r ApiCreateNetworkingV1NetworkRequest) (*CreateNetworkingV1Network202Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *CreateNetworkingV1Network202Response
	)
	...
	// body params
	localVarPostBody = r.createNetworkingV1NetworkRequest
...
func (r ApiDeleteNetworkingV1NetworkRequest) Execute() (*http.Response, error) {
...
*/
func (a *NetworksNetworkingV1ApiService) DeleteNetworkingV1Network(ctx context.Context, id string) ApiDeleteNetworkingV1NetworkRequest {
	return ApiDeleteNetworkingV1NetworkRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
func (a *NetworksNetworkingV1ApiService) DeleteNetworkingV1NetworkExecute(r ApiDeleteNetworkingV1NetworkRequest) (*http.Response, error) {
	var (
...
func (r ApiGetNetworkingV1NetworkRequest) Execute() (*GetNetworkingV1Network200Response, *http.Response, error) {
...
*/
func (a *NetworksNetworkingV1ApiService) GetNetworkingV1Network(ctx context.Context, id string) ApiGetNetworkingV1NetworkRequest {
	return ApiGetNetworkingV1NetworkRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
//  @return GetNetworkingV1Network200Response
func (a *NetworksNetworkingV1ApiService) GetNetworkingV1NetworkExecute(r ApiGetNetworkingV1NetworkRequest) (*GetNetworkingV1Network200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *GetNetworkingV1Network200Response
	)
...
func (r ApiListNetworkingV1NetworksRequest) Execute() (*ListNetworkingV1Networks200Response, *http.Response, error) {
...
*/
func (a *NetworksNetworkingV1ApiService) ListNetworkingV1Networks(ctx context.Context) ApiListNetworkingV1NetworksRequest {
	return ApiListNetworkingV1NetworksRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return ListNetworkingV1Networks200Response
func (a *NetworksNetworkingV1ApiService) ListNetworkingV1NetworksExecute(r ApiListNetworkingV1NetworksRequest) (*ListNetworkingV1Networks200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *ListNetworkingV1Networks200Response
	)
	...
	if r.specCloud != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "spec.cloud", s.Index(i), "multi")
			}
		} else {
			parameterAddToHeaderOrQuery(localVarQueryParams, "spec.cloud", t, "multi")
		}
	}
	if r.specRegion != nil {
		t := *r.specRegion
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "spec.region", s.Index(i), "multi")
			}
		} else {
			parameterAddToHeaderOrQuery(localVarQueryParams, "spec.region", t, "multi")
		}
	}
	if r.specCidr != nil {
		t := *r.specCidr
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "spec.cidr", s.Index(i), "multi")
			}
		} else {
			parameterAddToHeaderOrQuery(localVarQueryParams, "spec.cidr", t, "multi")
		}
	}
...
type ApiUpdateNetworkingV1NetworkRequest struct {
	...
	ApiService *NetworksNetworkingV1ApiService
	id string
	updateNetworkingV1NetworkRequest *UpdateNetworkingV1NetworkRequest
}

func (r ApiUpdateNetworkingV1NetworkRequest) UpdateNetworkingV1NetworkRequest(updateNetworkingV1NetworkRequest UpdateNetworkingV1NetworkRequest) ApiUpdateNetworkingV1NetworkRequest {
	r.updateNetworkingV1NetworkRequest = &updateNetworkingV1NetworkRequest
	return r
}

func (r ApiUpdateNetworkingV1NetworkRequest) Execute() (*GetNetworkingV1Network200Response, *http.Response, error) {
...
*/
func (a *NetworksNetworkingV1ApiService) UpdateNetworkingV1Network(ctx context.Context, id string) ApiUpdateNetworkingV1NetworkRequest {
	return ApiUpdateNetworkingV1NetworkRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
//  @return GetNetworkingV1Network200Response
func (a *NetworksNetworkingV1ApiService) UpdateNetworkingV1NetworkExecute(r ApiUpdateNetworkingV1NetworkRequest) (*GetNetworkingV1Network200Response, *http.Response, error) {
	var (
	...
	// body params
	localVarPostBody = r.updateNetworkingV1NetworkRequest
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
