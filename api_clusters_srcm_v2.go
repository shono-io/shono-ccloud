...
type ApiCreateSrcmV2ClusterRequest struct {
	ctx context.Context
	ApiService *ClustersSrcmV2ApiService
	createSrcmV2ClusterRequest *CreateSrcmV2ClusterRequest
}

func (r ApiCreateSrcmV2ClusterRequest) CreateSrcmV2ClusterRequest(createSrcmV2ClusterRequest CreateSrcmV2ClusterRequest) ApiCreateSrcmV2ClusterRequest {
	r.createSrcmV2ClusterRequest = &createSrcmV2ClusterRequest
	return r
}

func (r ApiCreateSrcmV2ClusterRequest) Execute() (*CreateSrcmV2Cluster202Response, *http.Response, error) {
...
*/
func (a *ClustersSrcmV2ApiService) CreateSrcmV2Cluster(ctx context.Context) ApiCreateSrcmV2ClusterRequest {
	return ApiCreateSrcmV2ClusterRequest{
		ApiService: a,
		ctx: ctx,
	}
...
//  @return CreateSrcmV2Cluster202Response
func (a *ClustersSrcmV2ApiService) CreateSrcmV2ClusterExecute(r ApiCreateSrcmV2ClusterRequest) (*CreateSrcmV2Cluster202Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *CreateSrcmV2Cluster202Response
	)
	...
	// body params
	localVarPostBody = r.createSrcmV2ClusterRequest
...
func (r ApiDeleteSrcmV2ClusterRequest) Execute() (*http.Response, error) {
...
*/
func (a *ClustersSrcmV2ApiService) DeleteSrcmV2Cluster(ctx context.Context, id string) ApiDeleteSrcmV2ClusterRequest {
	return ApiDeleteSrcmV2ClusterRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
func (a *ClustersSrcmV2ApiService) DeleteSrcmV2ClusterExecute(r ApiDeleteSrcmV2ClusterRequest) (*http.Response, error) {
	var (
...
func (r ApiGetSrcmV2ClusterRequest) Execute() (*GetSrcmV2Cluster200Response, *http.Response, error) {
...
*/
func (a *ClustersSrcmV2ApiService) GetSrcmV2Cluster(ctx context.Context, id string) ApiGetSrcmV2ClusterRequest {
	return ApiGetSrcmV2ClusterRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
//  @return GetSrcmV2Cluster200Response
func (a *ClustersSrcmV2ApiService) GetSrcmV2ClusterExecute(r ApiGetSrcmV2ClusterRequest) (*GetSrcmV2Cluster200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *GetSrcmV2Cluster200Response
	)
...
func (r ApiListSrcmV2ClustersRequest) Execute() (*ListSrcmV2Clusters200Response, *http.Response, error) {
...
*/
func (a *ClustersSrcmV2ApiService) ListSrcmV2Clusters(ctx context.Context) ApiListSrcmV2ClustersRequest {
	return ApiListSrcmV2ClustersRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return ListSrcmV2Clusters200Response
func (a *ClustersSrcmV2ApiService) ListSrcmV2ClustersExecute(r ApiListSrcmV2ClustersRequest) (*ListSrcmV2Clusters200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *ListSrcmV2Clusters200Response
	)
...
type ApiUpdateSrcmV2ClusterRequest struct {
	...
	ApiService *ClustersSrcmV2ApiService
	id string
	updateSrcmV2ClusterRequest *UpdateSrcmV2ClusterRequest
}

func (r ApiUpdateSrcmV2ClusterRequest) UpdateSrcmV2ClusterRequest(updateSrcmV2ClusterRequest UpdateSrcmV2ClusterRequest) ApiUpdateSrcmV2ClusterRequest {
	r.updateSrcmV2ClusterRequest = &updateSrcmV2ClusterRequest
	return r
}

func (r ApiUpdateSrcmV2ClusterRequest) Execute() (*GetSrcmV2Cluster200Response, *http.Response, error) {
...
*/
func (a *ClustersSrcmV2ApiService) UpdateSrcmV2Cluster(ctx context.Context, id string) ApiUpdateSrcmV2ClusterRequest {
	return ApiUpdateSrcmV2ClusterRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
//  @return GetSrcmV2Cluster200Response
func (a *ClustersSrcmV2ApiService) UpdateSrcmV2ClusterExecute(r ApiUpdateSrcmV2ClusterRequest) (*GetSrcmV2Cluster200Response, *http.Response, error) {
	var (
	...
	// body params
	localVarPostBody = r.updateSrcmV2ClusterRequest
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
