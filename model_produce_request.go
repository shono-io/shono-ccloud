...
// checks if the ProduceRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProduceRequest{}
...
func (o *ProduceRequest) GetPartitionId() int32 {
	if o == nil || IsNil(o.PartitionId.Get()) {
		var ret int32
		return ret
	}
...
func (o ProduceRequest) ToMap() (map[string]interface{}, error) {
