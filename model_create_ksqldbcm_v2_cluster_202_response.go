...
// checks if the CreateKsqldbcmV2Cluster202Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateKsqldbcmV2Cluster202Response{}

// CreateKsqldbcmV2Cluster202Response struct for CreateKsqldbcmV2Cluster202Response
type CreateKsqldbcmV2Cluster202Response struct {
	...
	Metadata *KsqldbcmV2ClusterMetadata `json:"metadata,omitempty"`
	Spec ListKsqldbcmV2Clusters200ResponseAllOfDataInnerSpec `json:"spec"`
...
func NewCreateKsqldbcmV2Cluster202Response(spec ListKsqldbcmV2Clusters200ResponseAllOfDataInnerSpec, status KsqldbcmV2ClusterStatus) *CreateKsqldbcmV2Cluster202Response {
	this := CreateKsqldbcmV2Cluster202Response{}
	this.Spec = spec
	this.Status = status
	return &this
}
...
func (o *CreateKsqldbcmV2Cluster202Response) GetMetadata() KsqldbcmV2ClusterMetadata {
	if o == nil || IsNil(o.Metadata) {
		var ret KsqldbcmV2ClusterMetadata
		return ret
	}
	return *o.Metadata
}
...
// SetMetadata gets a reference to the given KsqldbcmV2ClusterMetadata and assigns it to the Metadata field.
...
func (o *CreateKsqldbcmV2Cluster202Response) GetSpec() ListKsqldbcmV2Clusters200ResponseAllOfDataInnerSpec {
	if o == nil {
		var ret ListKsqldbcmV2Clusters200ResponseAllOfDataInnerSpec
		return ret
	}
...
func (o CreateKsqldbcmV2Cluster202Response) MarshalJSON() ([]byte, error) {
...
func (o CreateKsqldbcmV2Cluster202Response) ToMap() (map[string]interface{}, error) {
...
type NullableCreateKsqldbcmV2Cluster202Response struct {
	value *CreateKsqldbcmV2Cluster202Response
	isSet bool
}

func (v NullableCreateKsqldbcmV2Cluster202Response) Get() *CreateKsqldbcmV2Cluster202Response {
	return v.value
}

func (v *NullableCreateKsqldbcmV2Cluster202Response) Set(val *CreateKsqldbcmV2Cluster202Response) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateKsqldbcmV2Cluster202Response) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateKsqldbcmV2Cluster202Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateKsqldbcmV2Cluster202Response(val *CreateKsqldbcmV2Cluster202Response) *NullableCreateKsqldbcmV2Cluster202Response {
	return &NullableCreateKsqldbcmV2Cluster202Response{value: val, isSet: true}
}

func (v NullableCreateKsqldbcmV2Cluster202Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateKsqldbcmV2Cluster202Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
