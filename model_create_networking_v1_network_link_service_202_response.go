...
// checks if the CreateNetworkingV1NetworkLinkService202Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateNetworkingV1NetworkLinkService202Response{}

// CreateNetworkingV1NetworkLinkService202Response struct for CreateNetworkingV1NetworkLinkService202Response
type CreateNetworkingV1NetworkLinkService202Response struct {
	...
	Metadata *NetworkingV1NetworkLinkServiceMetadata `json:"metadata,omitempty"`
...
func NewCreateNetworkingV1NetworkLinkService202Response(spec ListNetworkingV1Peerings200ResponseAllOfDataInnerSpec, status NetworkingV1NetworkLinkServiceStatus) *CreateNetworkingV1NetworkLinkService202Response {
	this := CreateNetworkingV1NetworkLinkService202Response{}
	this.Spec = spec
	this.Status = status
	return &this
}
...
func (o *CreateNetworkingV1NetworkLinkService202Response) GetMetadata() NetworkingV1NetworkLinkServiceMetadata {
	if o == nil || IsNil(o.Metadata) {
		var ret NetworkingV1NetworkLinkServiceMetadata
		return ret
	}
	return *o.Metadata
}
...
// SetMetadata gets a reference to the given NetworkingV1NetworkLinkServiceMetadata and assigns it to the Metadata field.
...
func (o CreateNetworkingV1NetworkLinkService202Response) MarshalJSON() ([]byte, error) {
...
func (o CreateNetworkingV1NetworkLinkService202Response) ToMap() (map[string]interface{}, error) {
...
type NullableCreateNetworkingV1NetworkLinkService202Response struct {
	value *CreateNetworkingV1NetworkLinkService202Response
	isSet bool
}

func (v NullableCreateNetworkingV1NetworkLinkService202Response) Get() *CreateNetworkingV1NetworkLinkService202Response {
	return v.value
}

func (v *NullableCreateNetworkingV1NetworkLinkService202Response) Set(val *CreateNetworkingV1NetworkLinkService202Response) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateNetworkingV1NetworkLinkService202Response) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateNetworkingV1NetworkLinkService202Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateNetworkingV1NetworkLinkService202Response(val *CreateNetworkingV1NetworkLinkService202Response) *NullableCreateNetworkingV1NetworkLinkService202Response {
	return &NullableCreateNetworkingV1NetworkLinkService202Response{value: val, isSet: true}
}

func (v NullableCreateNetworkingV1NetworkLinkService202Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateNetworkingV1NetworkLinkService202Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
