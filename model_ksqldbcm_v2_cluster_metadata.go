...
// checks if the KsqldbcmV2ClusterMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &KsqldbcmV2ClusterMetadata{}

// KsqldbcmV2ClusterMetadata struct for KsqldbcmV2ClusterMetadata
type KsqldbcmV2ClusterMetadata struct {
...
func NewKsqldbcmV2ClusterMetadata(self interface{}) *KsqldbcmV2ClusterMetadata {
	this := KsqldbcmV2ClusterMetadata{}
	this.Self = self
	return &this
}
...
func (o KsqldbcmV2ClusterMetadata) MarshalJSON() ([]byte, error) {
...
func (o KsqldbcmV2ClusterMetadata) ToMap() (map[string]interface{}, error) {
...
type NullableKsqldbcmV2ClusterMetadata struct {
	value *KsqldbcmV2ClusterMetadata
	isSet bool
}

func (v NullableKsqldbcmV2ClusterMetadata) Get() *KsqldbcmV2ClusterMetadata {
	return v.value
}

func (v *NullableKsqldbcmV2ClusterMetadata) Set(val *KsqldbcmV2ClusterMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableKsqldbcmV2ClusterMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableKsqldbcmV2ClusterMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableKsqldbcmV2ClusterMetadata(val *KsqldbcmV2ClusterMetadata) *NullableKsqldbcmV2ClusterMetadata {
	return &NullableKsqldbcmV2ClusterMetadata{value: val, isSet: true}
}

func (v NullableKsqldbcmV2ClusterMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableKsqldbcmV2ClusterMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
