...
// checks if the IamV2RoleBindingListMetadataAllOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IamV2RoleBindingListMetadataAllOf{}

// IamV2RoleBindingListMetadataAllOf struct for IamV2RoleBindingListMetadataAllOf
type IamV2RoleBindingListMetadataAllOf struct {
...
func NewIamV2RoleBindingListMetadataAllOf() *IamV2RoleBindingListMetadataAllOf {
	this := IamV2RoleBindingListMetadataAllOf{}
	return &this
}
...
func (o IamV2RoleBindingListMetadataAllOf) MarshalJSON() ([]byte, error) {
...
func (o IamV2RoleBindingListMetadataAllOf) ToMap() (map[string]interface{}, error) {
...
type NullableIamV2RoleBindingListMetadataAllOf struct {
	value *IamV2RoleBindingListMetadataAllOf
	isSet bool
}

func (v NullableIamV2RoleBindingListMetadataAllOf) Get() *IamV2RoleBindingListMetadataAllOf {
	return v.value
}

func (v *NullableIamV2RoleBindingListMetadataAllOf) Set(val *IamV2RoleBindingListMetadataAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableIamV2RoleBindingListMetadataAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableIamV2RoleBindingListMetadataAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIamV2RoleBindingListMetadataAllOf(val *IamV2RoleBindingListMetadataAllOf) *NullableIamV2RoleBindingListMetadataAllOf {
	return &NullableIamV2RoleBindingListMetadataAllOf{value: val, isSet: true}
}

func (v NullableIamV2RoleBindingListMetadataAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIamV2RoleBindingListMetadataAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
