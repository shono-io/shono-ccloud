...
// checks if the NetworkingV1NetworkLinkServiceListMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NetworkingV1NetworkLinkServiceListMetadata{}

// NetworkingV1NetworkLinkServiceListMetadata struct for NetworkingV1NetworkLinkServiceListMetadata
type NetworkingV1NetworkLinkServiceListMetadata struct {
...
func NewNetworkingV1NetworkLinkServiceListMetadata() *NetworkingV1NetworkLinkServiceListMetadata {
	this := NetworkingV1NetworkLinkServiceListMetadata{}
	return &this
}
...
func (o *NetworkingV1NetworkLinkServiceListMetadata) SetFirst(v interface{}) {
	o.First = v
}
...
func (o *NetworkingV1NetworkLinkServiceListMetadata) GetPrev() interface{} {
	if o == nil {
		var ret interface{}
		return ret
	}
...
func (o NetworkingV1NetworkLinkServiceListMetadata) MarshalJSON() ([]byte, error) {
...
func (o NetworkingV1NetworkLinkServiceListMetadata) ToMap() (map[string]interface{}, error) {
...
type NullableNetworkingV1NetworkLinkServiceListMetadata struct {
	value *NetworkingV1NetworkLinkServiceListMetadata
	isSet bool
}

func (v NullableNetworkingV1NetworkLinkServiceListMetadata) Get() *NetworkingV1NetworkLinkServiceListMetadata {
	return v.value
}

func (v *NullableNetworkingV1NetworkLinkServiceListMetadata) Set(val *NetworkingV1NetworkLinkServiceListMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableNetworkingV1NetworkLinkServiceListMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableNetworkingV1NetworkLinkServiceListMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNetworkingV1NetworkLinkServiceListMetadata(val *NetworkingV1NetworkLinkServiceListMetadata) *NullableNetworkingV1NetworkLinkServiceListMetadata {
	return &NullableNetworkingV1NetworkLinkServiceListMetadata{value: val, isSet: true}
}

func (v NullableNetworkingV1NetworkLinkServiceListMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNetworkingV1NetworkLinkServiceListMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
