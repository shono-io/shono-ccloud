...
// checks if the UpdateNetworkingV1NetworkLinkServiceRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateNetworkingV1NetworkLinkServiceRequest{}

// UpdateNetworkingV1NetworkLinkServiceRequest struct for UpdateNetworkingV1NetworkLinkServiceRequest
type UpdateNetworkingV1NetworkLinkServiceRequest struct {
...
func NewUpdateNetworkingV1NetworkLinkServiceRequest(spec UpdateCmkV2ClusterRequestAllOfSpec) *UpdateNetworkingV1NetworkLinkServiceRequest {
	this := UpdateNetworkingV1NetworkLinkServiceRequest{}
	this.Spec = spec
	return &this
}
...
func (o *UpdateNetworkingV1NetworkLinkServiceRequest) SetSpec(v UpdateCmkV2ClusterRequestAllOfSpec) {
	o.Spec = v
}
...
func (o UpdateNetworkingV1NetworkLinkServiceRequest) MarshalJSON() ([]byte, error) {
...
func (o UpdateNetworkingV1NetworkLinkServiceRequest) ToMap() (map[string]interface{}, error) {
...
type NullableUpdateNetworkingV1NetworkLinkServiceRequest struct {
	value *UpdateNetworkingV1NetworkLinkServiceRequest
	isSet bool
}

func (v NullableUpdateNetworkingV1NetworkLinkServiceRequest) Get() *UpdateNetworkingV1NetworkLinkServiceRequest {
	return v.value
}

func (v *NullableUpdateNetworkingV1NetworkLinkServiceRequest) Set(val *UpdateNetworkingV1NetworkLinkServiceRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdateNetworkingV1NetworkLinkServiceRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableUpdateNetworkingV1NetworkLinkServiceRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpdateNetworkingV1NetworkLinkServiceRequest(val *UpdateNetworkingV1NetworkLinkServiceRequest) *NullableUpdateNetworkingV1NetworkLinkServiceRequest {
	return &NullableUpdateNetworkingV1NetworkLinkServiceRequest{value: val, isSet: true}
}

func (v NullableUpdateNetworkingV1NetworkLinkServiceRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpdateNetworkingV1NetworkLinkServiceRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
