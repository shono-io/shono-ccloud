...
// checks if the SrcmV2RegionSpec type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SrcmV2RegionSpec{}
...
func (o SrcmV2RegionSpec) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	// skip: display_name is readOnly
	// skip: cloud is readOnly
	// skip: region_name is readOnly
