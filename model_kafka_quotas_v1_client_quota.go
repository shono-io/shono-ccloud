...
// checks if the KafkaQuotasV1ClientQuota type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &KafkaQuotasV1ClientQuota{}
...
func (o KafkaQuotasV1ClientQuota) ToMap() (map[string]interface{}, error) {
