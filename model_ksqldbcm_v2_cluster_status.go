...
// checks if the KsqldbcmV2ClusterStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &KsqldbcmV2ClusterStatus{}
...
func (o KsqldbcmV2ClusterStatus) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	// skip: http_endpoint is readOnly
	// skip: phase is readOnly
	// skip: is_paused is readOnly
	// skip: storage is readOnly
	// skip: topic_prefix is readOnly
