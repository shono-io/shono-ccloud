...
// checks if the CreateIamV2ApiKey202Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateIamV2ApiKey202Response{}

// CreateIamV2ApiKey202Response struct for CreateIamV2ApiKey202Response
type CreateIamV2ApiKey202Response struct {
	...
	Metadata *IamV2ApiKeyMetadata `json:"metadata,omitempty"`
	Spec ListIamV2ApiKeys200ResponseAllOfDataInnerSpec `json:"spec"`
}
...
func NewCreateIamV2ApiKey202Response(spec ListIamV2ApiKeys200ResponseAllOfDataInnerSpec) *CreateIamV2ApiKey202Response {
	this := CreateIamV2ApiKey202Response{}
	this.Spec = spec
	return &this
}
...
// SetMetadata gets a reference to the given IamV2ApiKeyMetadata and assigns it to the Metadata field.
...
func (o *CreateIamV2ApiKey202Response) GetSpec() ListIamV2ApiKeys200ResponseAllOfDataInnerSpec {
	if o == nil {
		var ret ListIamV2ApiKeys200ResponseAllOfDataInnerSpec
		return ret
	}
...
func (o CreateIamV2ApiKey202Response) MarshalJSON() ([]byte, error) {
...
func (o CreateIamV2ApiKey202Response) ToMap() (map[string]interface{}, error) {
...
type NullableCreateIamV2ApiKey202Response struct {
	value *CreateIamV2ApiKey202Response
	isSet bool
}

func (v NullableCreateIamV2ApiKey202Response) Get() *CreateIamV2ApiKey202Response {
	return v.value
}

func (v *NullableCreateIamV2ApiKey202Response) Set(val *CreateIamV2ApiKey202Response) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateIamV2ApiKey202Response) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateIamV2ApiKey202Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateIamV2ApiKey202Response(val *CreateIamV2ApiKey202Response) *NullableCreateIamV2ApiKey202Response {
	return &NullableCreateIamV2ApiKey202Response{value: val, isSet: true}
}

func (v NullableCreateIamV2ApiKey202Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateIamV2ApiKey202Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
