...
// checks if the NetworkingV1NetworkListDataInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NetworkingV1NetworkListDataInner{}

// NetworkingV1NetworkListDataInner struct for NetworkingV1NetworkListDataInner
type NetworkingV1NetworkListDataInner struct {
	...
	Id string `json:"id"`
	Metadata NetworkingV1NetworkMetadata `json:"metadata"`
...
func NewNetworkingV1NetworkListDataInner(id string, metadata NetworkingV1NetworkMetadata, spec map[string]interface{}, status NetworkingV1NetworkStatus) *NetworkingV1NetworkListDataInner {
	this := NetworkingV1NetworkListDataInner{}
	this.Id = id
...
func (o NetworkingV1NetworkListDataInner) MarshalJSON() ([]byte, error) {
...
func (o NetworkingV1NetworkListDataInner) ToMap() (map[string]interface{}, error) {
...
type NullableNetworkingV1NetworkListDataInner struct {
	value *NetworkingV1NetworkListDataInner
	isSet bool
}

func (v NullableNetworkingV1NetworkListDataInner) Get() *NetworkingV1NetworkListDataInner {
	return v.value
}

func (v *NullableNetworkingV1NetworkListDataInner) Set(val *NetworkingV1NetworkListDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableNetworkingV1NetworkListDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableNetworkingV1NetworkListDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNetworkingV1NetworkListDataInner(val *NetworkingV1NetworkListDataInner) *NullableNetworkingV1NetworkListDataInner {
	return &NullableNetworkingV1NetworkListDataInner{value: val, isSet: true}
}

func (v NullableNetworkingV1NetworkListDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNetworkingV1NetworkListDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
