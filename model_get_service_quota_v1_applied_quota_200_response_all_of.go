...
// checks if the GetServiceQuotaV1AppliedQuota200ResponseAllOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetServiceQuotaV1AppliedQuota200ResponseAllOf{}

// GetServiceQuotaV1AppliedQuota200ResponseAllOf struct for GetServiceQuotaV1AppliedQuota200ResponseAllOf
type GetServiceQuotaV1AppliedQuota200ResponseAllOf struct {
...
func NewGetServiceQuotaV1AppliedQuota200ResponseAllOf() *GetServiceQuotaV1AppliedQuota200ResponseAllOf {
	this := GetServiceQuotaV1AppliedQuota200ResponseAllOf{}
	return &this
}
...
func (o *GetServiceQuotaV1AppliedQuota200ResponseAllOf) SetUser(v interface{}) {
	o.User = v
}
...
func (o *GetServiceQuotaV1AppliedQuota200ResponseAllOf) GetEnvironment() interface{} {
	if o == nil {
		var ret interface{}
		return ret
	}
...
func (o GetServiceQuotaV1AppliedQuota200ResponseAllOf) MarshalJSON() ([]byte, error) {
...
func (o GetServiceQuotaV1AppliedQuota200ResponseAllOf) ToMap() (map[string]interface{}, error) {
...
type NullableGetServiceQuotaV1AppliedQuota200ResponseAllOf struct {
	value *GetServiceQuotaV1AppliedQuota200ResponseAllOf
	isSet bool
}

func (v NullableGetServiceQuotaV1AppliedQuota200ResponseAllOf) Get() *GetServiceQuotaV1AppliedQuota200ResponseAllOf {
	return v.value
}

func (v *NullableGetServiceQuotaV1AppliedQuota200ResponseAllOf) Set(val *GetServiceQuotaV1AppliedQuota200ResponseAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableGetServiceQuotaV1AppliedQuota200ResponseAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableGetServiceQuotaV1AppliedQuota200ResponseAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetServiceQuotaV1AppliedQuota200ResponseAllOf(val *GetServiceQuotaV1AppliedQuota200ResponseAllOf) *NullableGetServiceQuotaV1AppliedQuota200ResponseAllOf {
	return &NullableGetServiceQuotaV1AppliedQuota200ResponseAllOf{value: val, isSet: true}
}

func (v NullableGetServiceQuotaV1AppliedQuota200ResponseAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetServiceQuotaV1AppliedQuota200ResponseAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
