...
// checks if the BrokerDataAllOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BrokerDataAllOf{}
...
func (o BrokerDataAllOf) ToMap() (map[string]interface{}, error) {
