...
// checks if the NetworkingV1TransitGatewayAttachmentSpec type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NetworkingV1TransitGatewayAttachmentSpec{}
...
type NetworkingV1TransitGatewayAttachmentSpec struct {
	...
	Cloud *NetworkingV1TransitGatewayAttachmentSpecCloud `json:"cloud,omitempty"`
	Environment *NetworkingV1NetworkSpecEnvironment `json:"environment,omitempty"`
	Network *NetworkingV1PeeringSpecNetwork `json:"network,omitempty"`
}
...
func (o *NetworkingV1TransitGatewayAttachmentSpec) GetCloud() NetworkingV1TransitGatewayAttachmentSpecCloud {
	if o == nil || IsNil(o.Cloud) {
		var ret NetworkingV1TransitGatewayAttachmentSpecCloud
		return ret
	}
	return *o.Cloud
}
...
// SetCloud gets a reference to the given NetworkingV1TransitGatewayAttachmentSpecCloud and assigns it to the Cloud field.
...
func (o *NetworkingV1TransitGatewayAttachmentSpec) GetNetwork() NetworkingV1PeeringSpecNetwork {
	if o == nil || IsNil(o.Network) {
		var ret NetworkingV1PeeringSpecNetwork
		return ret
	}
	return *o.Network
}
...
// SetNetwork gets a reference to the given NetworkingV1PeeringSpecNetwork and assigns it to the Network field.
...
func (o NetworkingV1TransitGatewayAttachmentSpec) ToMap() (map[string]interface{}, error) {
