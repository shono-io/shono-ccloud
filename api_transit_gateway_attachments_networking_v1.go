...
type ApiCreateNetworkingV1TransitGatewayAttachmentRequest struct {
	...
	createNetworkingV1TransitGatewayAttachmentRequest *CreateNetworkingV1TransitGatewayAttachmentRequest
}

func (r ApiCreateNetworkingV1TransitGatewayAttachmentRequest) CreateNetworkingV1TransitGatewayAttachmentRequest(createNetworkingV1TransitGatewayAttachmentRequest CreateNetworkingV1TransitGatewayAttachmentRequest) ApiCreateNetworkingV1TransitGatewayAttachmentRequest {
	r.createNetworkingV1TransitGatewayAttachmentRequest = &createNetworkingV1TransitGatewayAttachmentRequest
	return r
}

func (r ApiCreateNetworkingV1TransitGatewayAttachmentRequest) Execute() (*CreateNetworkingV1TransitGatewayAttachment202Response, *http.Response, error) {
...
*/
func (a *TransitGatewayAttachmentsNetworkingV1ApiService) CreateNetworkingV1TransitGatewayAttachment(ctx context.Context) ApiCreateNetworkingV1TransitGatewayAttachmentRequest {
	return ApiCreateNetworkingV1TransitGatewayAttachmentRequest{
		ApiService: a,
		ctx: ctx,
	}
...
//  @return CreateNetworkingV1TransitGatewayAttachment202Response
func (a *TransitGatewayAttachmentsNetworkingV1ApiService) CreateNetworkingV1TransitGatewayAttachmentExecute(r ApiCreateNetworkingV1TransitGatewayAttachmentRequest) (*CreateNetworkingV1TransitGatewayAttachment202Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *CreateNetworkingV1TransitGatewayAttachment202Response
	)
	...
	// body params
	localVarPostBody = r.createNetworkingV1TransitGatewayAttachmentRequest
...
func (r ApiDeleteNetworkingV1TransitGatewayAttachmentRequest) Execute() (*http.Response, error) {
...
*/
func (a *TransitGatewayAttachmentsNetworkingV1ApiService) DeleteNetworkingV1TransitGatewayAttachment(ctx context.Context, id string) ApiDeleteNetworkingV1TransitGatewayAttachmentRequest {
	return ApiDeleteNetworkingV1TransitGatewayAttachmentRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
func (a *TransitGatewayAttachmentsNetworkingV1ApiService) DeleteNetworkingV1TransitGatewayAttachmentExecute(r ApiDeleteNetworkingV1TransitGatewayAttachmentRequest) (*http.Response, error) {
	var (
...
func (r ApiGetNetworkingV1TransitGatewayAttachmentRequest) Execute() (*GetNetworkingV1TransitGatewayAttachment200Response, *http.Response, error) {
...
*/
func (a *TransitGatewayAttachmentsNetworkingV1ApiService) GetNetworkingV1TransitGatewayAttachment(ctx context.Context, id string) ApiGetNetworkingV1TransitGatewayAttachmentRequest {
	return ApiGetNetworkingV1TransitGatewayAttachmentRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
//  @return GetNetworkingV1TransitGatewayAttachment200Response
func (a *TransitGatewayAttachmentsNetworkingV1ApiService) GetNetworkingV1TransitGatewayAttachmentExecute(r ApiGetNetworkingV1TransitGatewayAttachmentRequest) (*GetNetworkingV1TransitGatewayAttachment200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *GetNetworkingV1TransitGatewayAttachment200Response
	)
...
func (r ApiListNetworkingV1TransitGatewayAttachmentsRequest) Execute() (*ListNetworkingV1TransitGatewayAttachments200Response, *http.Response, error) {
...
*/
func (a *TransitGatewayAttachmentsNetworkingV1ApiService) ListNetworkingV1TransitGatewayAttachments(ctx context.Context) ApiListNetworkingV1TransitGatewayAttachmentsRequest {
	return ApiListNetworkingV1TransitGatewayAttachmentsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return ListNetworkingV1TransitGatewayAttachments200Response
func (a *TransitGatewayAttachmentsNetworkingV1ApiService) ListNetworkingV1TransitGatewayAttachmentsExecute(r ApiListNetworkingV1TransitGatewayAttachmentsRequest) (*ListNetworkingV1TransitGatewayAttachments200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *ListNetworkingV1TransitGatewayAttachments200Response
	)
	...
	if r.specDisplayName != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "spec.display_name", s.Index(i), "multi")
			}
		} else {
			parameterAddToHeaderOrQuery(localVarQueryParams, "spec.display_name", t, "multi")
		}
	}
	if r.statusPhase != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "status.phase", s.Index(i), "multi")
			}
		} else {
			parameterAddToHeaderOrQuery(localVarQueryParams, "status.phase", t, "multi")
		}
	}
	parameterAddToHeaderOrQuery(localVarQueryParams, "environment", r.environment, "")
	if r.specNetwork != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "spec.network", s.Index(i), "multi")
			}
		} else {
			parameterAddToHeaderOrQuery(localVarQueryParams, "spec.network", t, "multi")
		}
	}
	if r.pageSize != nil {
...
type ApiUpdateNetworkingV1TransitGatewayAttachmentRequest struct {
	...
	ApiService *TransitGatewayAttachmentsNetworkingV1ApiService
	id string
	updateNetworkingV1TransitGatewayAttachmentRequest *UpdateNetworkingV1TransitGatewayAttachmentRequest
}

func (r ApiUpdateNetworkingV1TransitGatewayAttachmentRequest) UpdateNetworkingV1TransitGatewayAttachmentRequest(updateNetworkingV1TransitGatewayAttachmentRequest UpdateNetworkingV1TransitGatewayAttachmentRequest) ApiUpdateNetworkingV1TransitGatewayAttachmentRequest {
	r.updateNetworkingV1TransitGatewayAttachmentRequest = &updateNetworkingV1TransitGatewayAttachmentRequest
	return r
}

func (r ApiUpdateNetworkingV1TransitGatewayAttachmentRequest) Execute() (*GetNetworkingV1TransitGatewayAttachment200Response, *http.Response, error) {
...
*/
func (a *TransitGatewayAttachmentsNetworkingV1ApiService) UpdateNetworkingV1TransitGatewayAttachment(ctx context.Context, id string) ApiUpdateNetworkingV1TransitGatewayAttachmentRequest {
	return ApiUpdateNetworkingV1TransitGatewayAttachmentRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
//  @return GetNetworkingV1TransitGatewayAttachment200Response
func (a *TransitGatewayAttachmentsNetworkingV1ApiService) UpdateNetworkingV1TransitGatewayAttachmentExecute(r ApiUpdateNetworkingV1TransitGatewayAttachmentRequest) (*GetNetworkingV1TransitGatewayAttachment200Response, *http.Response, error) {
	var (
	...
	// body params
	localVarPostBody = r.updateNetworkingV1TransitGatewayAttachmentRequest
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
