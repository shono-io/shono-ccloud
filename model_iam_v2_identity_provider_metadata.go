...
// checks if the IamV2IdentityProviderMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IamV2IdentityProviderMetadata{}

// IamV2IdentityProviderMetadata struct for IamV2IdentityProviderMetadata
type IamV2IdentityProviderMetadata struct {
...
func NewIamV2IdentityProviderMetadata(self interface{}) *IamV2IdentityProviderMetadata {
	this := IamV2IdentityProviderMetadata{}
	this.Self = self
	return &this
}
...
func (o IamV2IdentityProviderMetadata) MarshalJSON() ([]byte, error) {
...
func (o IamV2IdentityProviderMetadata) ToMap() (map[string]interface{}, error) {
...
type NullableIamV2IdentityProviderMetadata struct {
	value *IamV2IdentityProviderMetadata
	isSet bool
}

func (v NullableIamV2IdentityProviderMetadata) Get() *IamV2IdentityProviderMetadata {
	return v.value
}

func (v *NullableIamV2IdentityProviderMetadata) Set(val *IamV2IdentityProviderMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableIamV2IdentityProviderMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableIamV2IdentityProviderMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIamV2IdentityProviderMetadata(val *IamV2IdentityProviderMetadata) *NullableIamV2IdentityProviderMetadata {
	return &NullableIamV2IdentityProviderMetadata{value: val, isSet: true}
}

func (v NullableIamV2IdentityProviderMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIamV2IdentityProviderMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
