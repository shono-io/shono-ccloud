...
// checks if the SdV1PipelineSpecStreamGovernanceCluster type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SdV1PipelineSpecStreamGovernanceCluster{}

// SdV1PipelineSpecStreamGovernanceCluster The stream_governance_cluster associated with this object.
type SdV1PipelineSpecStreamGovernanceCluster struct {
...
func NewSdV1PipelineSpecStreamGovernanceCluster(id string, related string, resourceName string) *SdV1PipelineSpecStreamGovernanceCluster {
	this := SdV1PipelineSpecStreamGovernanceCluster{}
	this.Id = id
...
func (o SdV1PipelineSpecStreamGovernanceCluster) MarshalJSON() ([]byte, error) {
...
func (o SdV1PipelineSpecStreamGovernanceCluster) ToMap() (map[string]interface{}, error) {
...
type NullableSdV1PipelineSpecStreamGovernanceCluster struct {
	value *SdV1PipelineSpecStreamGovernanceCluster
	isSet bool
}

func (v NullableSdV1PipelineSpecStreamGovernanceCluster) Get() *SdV1PipelineSpecStreamGovernanceCluster {
	return v.value
}

func (v *NullableSdV1PipelineSpecStreamGovernanceCluster) Set(val *SdV1PipelineSpecStreamGovernanceCluster) {
	v.value = val
	v.isSet = true
}

func (v NullableSdV1PipelineSpecStreamGovernanceCluster) IsSet() bool {
	return v.isSet
}

func (v *NullableSdV1PipelineSpecStreamGovernanceCluster) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSdV1PipelineSpecStreamGovernanceCluster(val *SdV1PipelineSpecStreamGovernanceCluster) *NullableSdV1PipelineSpecStreamGovernanceCluster {
	return &NullableSdV1PipelineSpecStreamGovernanceCluster{value: val, isSet: true}
}

func (v NullableSdV1PipelineSpecStreamGovernanceCluster) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSdV1PipelineSpecStreamGovernanceCluster) UnmarshalJSON(src []byte) error {
	v.isSet = true
