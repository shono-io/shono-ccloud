...
// checks if the CreateKafkaQuotasV1ClientQuota202Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateKafkaQuotasV1ClientQuota202Response{}

// CreateKafkaQuotasV1ClientQuota202Response struct for CreateKafkaQuotasV1ClientQuota202Response
type CreateKafkaQuotasV1ClientQuota202Response struct {
	...
	Metadata *KafkaQuotasV1ClientQuotaMetadata `json:"metadata,omitempty"`
	Spec ListKafkaQuotasV1ClientQuotas200ResponseAllOfDataInnerSpec `json:"spec"`
}
...
func NewCreateKafkaQuotasV1ClientQuota202Response(spec ListKafkaQuotasV1ClientQuotas200ResponseAllOfDataInnerSpec) *CreateKafkaQuotasV1ClientQuota202Response {
	this := CreateKafkaQuotasV1ClientQuota202Response{}
	this.Spec = spec
	return &this
}
...
func (o *CreateKafkaQuotasV1ClientQuota202Response) GetMetadata() KafkaQuotasV1ClientQuotaMetadata {
	if o == nil || IsNil(o.Metadata) {
		var ret KafkaQuotasV1ClientQuotaMetadata
		return ret
	}
	return *o.Metadata
}
...
// SetMetadata gets a reference to the given KafkaQuotasV1ClientQuotaMetadata and assigns it to the Metadata field.
...
func (o *CreateKafkaQuotasV1ClientQuota202Response) GetSpec() ListKafkaQuotasV1ClientQuotas200ResponseAllOfDataInnerSpec {
	if o == nil {
		var ret ListKafkaQuotasV1ClientQuotas200ResponseAllOfDataInnerSpec
		return ret
	}
...
func (o CreateKafkaQuotasV1ClientQuota202Response) MarshalJSON() ([]byte, error) {
...
func (o CreateKafkaQuotasV1ClientQuota202Response) ToMap() (map[string]interface{}, error) {
...
type NullableCreateKafkaQuotasV1ClientQuota202Response struct {
	value *CreateKafkaQuotasV1ClientQuota202Response
	isSet bool
}

func (v NullableCreateKafkaQuotasV1ClientQuota202Response) Get() *CreateKafkaQuotasV1ClientQuota202Response {
	return v.value
}

func (v *NullableCreateKafkaQuotasV1ClientQuota202Response) Set(val *CreateKafkaQuotasV1ClientQuota202Response) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateKafkaQuotasV1ClientQuota202Response) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateKafkaQuotasV1ClientQuota202Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateKafkaQuotasV1ClientQuota202Response(val *CreateKafkaQuotasV1ClientQuota202Response) *NullableCreateKafkaQuotasV1ClientQuota202Response {
	return &NullableCreateKafkaQuotasV1ClientQuota202Response{value: val, isSet: true}
}

func (v NullableCreateKafkaQuotasV1ClientQuota202Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateKafkaQuotasV1ClientQuota202Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
