...
// checks if the NotificationsV1SubscriptionListDataInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NotificationsV1SubscriptionListDataInner{}

// NotificationsV1SubscriptionListDataInner struct for NotificationsV1SubscriptionListDataInner
type NotificationsV1SubscriptionListDataInner struct {
	...
	Id string `json:"id"`
	Metadata NotificationsV1SubscriptionMetadata `json:"metadata"`
...
func NewNotificationsV1SubscriptionListDataInner(id string, metadata NotificationsV1SubscriptionMetadata, notificationType NotificationsV1SubscriptionNotificationType, integrations []GlobalObjectReference) *NotificationsV1SubscriptionListDataInner {
	this := NotificationsV1SubscriptionListDataInner{}
	this.Id = id
...
func (o NotificationsV1SubscriptionListDataInner) MarshalJSON() ([]byte, error) {
...
func (o NotificationsV1SubscriptionListDataInner) ToMap() (map[string]interface{}, error) {
...
type NullableNotificationsV1SubscriptionListDataInner struct {
	value *NotificationsV1SubscriptionListDataInner
	isSet bool
}

func (v NullableNotificationsV1SubscriptionListDataInner) Get() *NotificationsV1SubscriptionListDataInner {
	return v.value
}

func (v *NullableNotificationsV1SubscriptionListDataInner) Set(val *NotificationsV1SubscriptionListDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableNotificationsV1SubscriptionListDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableNotificationsV1SubscriptionListDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNotificationsV1SubscriptionListDataInner(val *NotificationsV1SubscriptionListDataInner) *NullableNotificationsV1SubscriptionListDataInner {
	return &NullableNotificationsV1SubscriptionListDataInner{value: val, isSet: true}
}

func (v NullableNotificationsV1SubscriptionListDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNotificationsV1SubscriptionListDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
