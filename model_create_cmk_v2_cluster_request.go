...
// checks if the CreateCmkV2ClusterRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateCmkV2ClusterRequest{}

// CreateCmkV2ClusterRequest struct for CreateCmkV2ClusterRequest
type CreateCmkV2ClusterRequest struct {
	...
	Metadata *CmkV2ClusterMetadata `json:"metadata,omitempty"`
	Spec CreateCmkV2ClusterRequestAllOf1Spec `json:"spec"`
...
func NewCreateCmkV2ClusterRequest(spec CreateCmkV2ClusterRequestAllOf1Spec) *CreateCmkV2ClusterRequest {
	this := CreateCmkV2ClusterRequest{}
	this.Spec = spec
	return &this
}
...
func (o *CreateCmkV2ClusterRequest) HasId() bool {
	if o != nil && !IsNil(o.Id) {
		return true
	}
...
// SetMetadata gets a reference to the given CmkV2ClusterMetadata and assigns it to the Metadata field.
...
func (o *CreateCmkV2ClusterRequest) GetSpec() CreateCmkV2ClusterRequestAllOf1Spec {
	if o == nil {
		var ret CreateCmkV2ClusterRequestAllOf1Spec
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *CreateCmkV2ClusterRequest) GetStatusOk() (*CmkV2ClusterStatus, bool) {
	if o == nil || IsNil(o.Status) {
		return nil, false
	}
...
func (o CreateCmkV2ClusterRequest) MarshalJSON() ([]byte, error) {
...
func (o CreateCmkV2ClusterRequest) ToMap() (map[string]interface{}, error) {
...
type NullableCreateCmkV2ClusterRequest struct {
	value *CreateCmkV2ClusterRequest
	isSet bool
}

func (v NullableCreateCmkV2ClusterRequest) Get() *CreateCmkV2ClusterRequest {
	return v.value
}

func (v *NullableCreateCmkV2ClusterRequest) Set(val *CreateCmkV2ClusterRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateCmkV2ClusterRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateCmkV2ClusterRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateCmkV2ClusterRequest(val *CreateCmkV2ClusterRequest) *NullableCreateCmkV2ClusterRequest {
	return &NullableCreateCmkV2ClusterRequest{value: val, isSet: true}
}

func (v NullableCreateCmkV2ClusterRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateCmkV2ClusterRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
