...
type ApiGetOrgV2OrganizationRequest struct {
	ctx context.Context
	ApiService *OrganizationsOrgV2ApiService
	id string
}

func (r ApiGetOrgV2OrganizationRequest) Execute() (*GetOrgV2Organization200Response, *http.Response, error) {
...
*/
func (a *OrganizationsOrgV2ApiService) GetOrgV2Organization(ctx context.Context, id string) ApiGetOrgV2OrganizationRequest {
	return ApiGetOrgV2OrganizationRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
//  @return GetOrgV2Organization200Response
func (a *OrganizationsOrgV2ApiService) GetOrgV2OrganizationExecute(r ApiGetOrgV2OrganizationRequest) (*GetOrgV2Organization200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *GetOrgV2Organization200Response
	)
...
func (r ApiListOrgV2OrganizationsRequest) Execute() (*ListOrgV2Organizations200Response, *http.Response, error) {
...
*/
func (a *OrganizationsOrgV2ApiService) ListOrgV2Organizations(ctx context.Context) ApiListOrgV2OrganizationsRequest {
	return ApiListOrgV2OrganizationsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return ListOrgV2Organizations200Response
func (a *OrganizationsOrgV2ApiService) ListOrgV2OrganizationsExecute(r ApiListOrgV2OrganizationsRequest) (*ListOrgV2Organizations200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *ListOrgV2Organizations200Response
	)
...
func (r ApiUpdateOrgV2OrganizationRequest) Execute() (*GetOrgV2Organization200Response, *http.Response, error) {
...
*/
func (a *OrganizationsOrgV2ApiService) UpdateOrgV2Organization(ctx context.Context, id string) ApiUpdateOrgV2OrganizationRequest {
	return ApiUpdateOrgV2OrganizationRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
//  @return GetOrgV2Organization200Response
func (a *OrganizationsOrgV2ApiService) UpdateOrgV2OrganizationExecute(r ApiUpdateOrgV2OrganizationRequest) (*GetOrgV2Organization200Response, *http.Response, error) {
	var (
