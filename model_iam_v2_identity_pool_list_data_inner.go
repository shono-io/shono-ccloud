...
// checks if the IamV2IdentityPoolListDataInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IamV2IdentityPoolListDataInner{}

// IamV2IdentityPoolListDataInner struct for IamV2IdentityPoolListDataInner
type IamV2IdentityPoolListDataInner struct {
	...
	Id string `json:"id"`
	Metadata IamV2IdentityPoolMetadata `json:"metadata"`
...
func NewIamV2IdentityPoolListDataInner(id string, metadata IamV2IdentityPoolMetadata, displayName string, description string, identityClaim string, filter string, principal string, state string) *IamV2IdentityPoolListDataInner {
	this := IamV2IdentityPoolListDataInner{}
	this.Id = id
...
func (o IamV2IdentityPoolListDataInner) MarshalJSON() ([]byte, error) {
...
func (o IamV2IdentityPoolListDataInner) ToMap() (map[string]interface{}, error) {
...
type NullableIamV2IdentityPoolListDataInner struct {
	value *IamV2IdentityPoolListDataInner
	isSet bool
}

func (v NullableIamV2IdentityPoolListDataInner) Get() *IamV2IdentityPoolListDataInner {
	return v.value
}

func (v *NullableIamV2IdentityPoolListDataInner) Set(val *IamV2IdentityPoolListDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableIamV2IdentityPoolListDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableIamV2IdentityPoolListDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIamV2IdentityPoolListDataInner(val *IamV2IdentityPoolListDataInner) *NullableIamV2IdentityPoolListDataInner {
	return &NullableIamV2IdentityPoolListDataInner{value: val, isSet: true}
}

func (v NullableIamV2IdentityPoolListDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIamV2IdentityPoolListDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
