...
// checks if the ByokV1KeyListMetadataAllOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ByokV1KeyListMetadataAllOf{}

// ByokV1KeyListMetadataAllOf struct for ByokV1KeyListMetadataAllOf
type ByokV1KeyListMetadataAllOf struct {
...
func NewByokV1KeyListMetadataAllOf() *ByokV1KeyListMetadataAllOf {
	this := ByokV1KeyListMetadataAllOf{}
	return &this
}
...
func (o ByokV1KeyListMetadataAllOf) MarshalJSON() ([]byte, error) {
...
func (o ByokV1KeyListMetadataAllOf) ToMap() (map[string]interface{}, error) {
...
type NullableByokV1KeyListMetadataAllOf struct {
	value *ByokV1KeyListMetadataAllOf
	isSet bool
}

func (v NullableByokV1KeyListMetadataAllOf) Get() *ByokV1KeyListMetadataAllOf {
	return v.value
}

func (v *NullableByokV1KeyListMetadataAllOf) Set(val *ByokV1KeyListMetadataAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableByokV1KeyListMetadataAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableByokV1KeyListMetadataAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableByokV1KeyListMetadataAllOf(val *ByokV1KeyListMetadataAllOf) *NullableByokV1KeyListMetadataAllOf {
	return &NullableByokV1KeyListMetadataAllOf{value: val, isSet: true}
}

func (v NullableByokV1KeyListMetadataAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableByokV1KeyListMetadataAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
