...
type ApiGetNotificationsV1NotificationTypeRequest struct {
	ctx context.Context
	ApiService *NotificationTypesNotificationsV1ApiService
	id string
}

func (r ApiGetNotificationsV1NotificationTypeRequest) Execute() (*GetNotificationsV1NotificationType200Response, *http.Response, error) {
...
*/
func (a *NotificationTypesNotificationsV1ApiService) GetNotificationsV1NotificationType(ctx context.Context, id string) ApiGetNotificationsV1NotificationTypeRequest {
	return ApiGetNotificationsV1NotificationTypeRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
//  @return GetNotificationsV1NotificationType200Response
func (a *NotificationTypesNotificationsV1ApiService) GetNotificationsV1NotificationTypeExecute(r ApiGetNotificationsV1NotificationTypeRequest) (*GetNotificationsV1NotificationType200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *GetNotificationsV1NotificationType200Response
	)
...
func (r ApiListNotificationsV1NotificationTypesRequest) Execute() (*ListNotificationsV1NotificationTypes200Response, *http.Response, error) {
	return r.ApiService.ListNotificationsV1NotificationTypesExecute(r)
}

/*
ListNotificationsV1NotificationTypes List of Notification Types
...
*/
func (a *NotificationTypesNotificationsV1ApiService) ListNotificationsV1NotificationTypes(ctx context.Context) ApiListNotificationsV1NotificationTypesRequest {
	return ApiListNotificationsV1NotificationTypesRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return ListNotificationsV1NotificationTypes200Response
func (a *NotificationTypesNotificationsV1ApiService) ListNotificationsV1NotificationTypesExecute(r ApiListNotificationsV1NotificationTypesRequest) (*ListNotificationsV1NotificationTypes200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *ListNotificationsV1NotificationTypes200Response
	)
