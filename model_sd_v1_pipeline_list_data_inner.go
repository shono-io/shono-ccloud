...
// checks if the SdV1PipelineListDataInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SdV1PipelineListDataInner{}

// SdV1PipelineListDataInner struct for SdV1PipelineListDataInner
type SdV1PipelineListDataInner struct {
	...
	Id string `json:"id"`
	Metadata SdV1PipelineMetadata `json:"metadata"`
...
func NewSdV1PipelineListDataInner(id string, metadata SdV1PipelineMetadata, spec map[string]interface{}) *SdV1PipelineListDataInner {
	this := SdV1PipelineListDataInner{}
	this.Id = id
...
func (o SdV1PipelineListDataInner) MarshalJSON() ([]byte, error) {
...
func (o SdV1PipelineListDataInner) ToMap() (map[string]interface{}, error) {
...
type NullableSdV1PipelineListDataInner struct {
	value *SdV1PipelineListDataInner
	isSet bool
}

func (v NullableSdV1PipelineListDataInner) Get() *SdV1PipelineListDataInner {
	return v.value
}

func (v *NullableSdV1PipelineListDataInner) Set(val *SdV1PipelineListDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableSdV1PipelineListDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableSdV1PipelineListDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSdV1PipelineListDataInner(val *SdV1PipelineListDataInner) *NullableSdV1PipelineListDataInner {
	return &NullableSdV1PipelineListDataInner{value: val, isSet: true}
}

func (v NullableSdV1PipelineListDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSdV1PipelineListDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
