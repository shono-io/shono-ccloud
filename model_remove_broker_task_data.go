...
// checks if the RemoveBrokerTaskData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RemoveBrokerTaskData{}
...
func (o RemoveBrokerTaskData) ToMap() (map[string]interface{}, error) {
