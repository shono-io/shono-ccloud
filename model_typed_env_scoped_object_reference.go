...
// checks if the TypedEnvScopedObjectReference type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TypedEnvScopedObjectReference{}
...
func (o TypedEnvScopedObjectReference) ToMap() (map[string]interface{}, error) {
