...
// checks if the PartnerV2EntitlementListDataInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PartnerV2EntitlementListDataInner{}

// PartnerV2EntitlementListDataInner struct for PartnerV2EntitlementListDataInner
type PartnerV2EntitlementListDataInner struct {
...
func NewPartnerV2EntitlementListDataInner(id string, metadata ObjectMeta, externalId string, name string, planId string, productId string) *PartnerV2EntitlementListDataInner {
	this := PartnerV2EntitlementListDataInner{}
	this.Id = id
...
func (o PartnerV2EntitlementListDataInner) MarshalJSON() ([]byte, error) {
...
func (o PartnerV2EntitlementListDataInner) ToMap() (map[string]interface{}, error) {
...
type NullablePartnerV2EntitlementListDataInner struct {
	value *PartnerV2EntitlementListDataInner
	isSet bool
}

func (v NullablePartnerV2EntitlementListDataInner) Get() *PartnerV2EntitlementListDataInner {
	return v.value
}

func (v *NullablePartnerV2EntitlementListDataInner) Set(val *PartnerV2EntitlementListDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullablePartnerV2EntitlementListDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullablePartnerV2EntitlementListDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePartnerV2EntitlementListDataInner(val *PartnerV2EntitlementListDataInner) *NullablePartnerV2EntitlementListDataInner {
	return &NullablePartnerV2EntitlementListDataInner{value: val, isSet: true}
}

func (v NullablePartnerV2EntitlementListDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePartnerV2EntitlementListDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
