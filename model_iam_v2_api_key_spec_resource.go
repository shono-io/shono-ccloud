...
// checks if the IamV2ApiKeySpecResource type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IamV2ApiKeySpecResource{}

// IamV2ApiKeySpecResource The resource associated with this object. The resource can be one of Kafka Cluster ID (example: lkc-12345), Schema Registry Cluster ID (example: lsrc-12345) or ksqlDB Cluster ID (example: lksqlc-12345). May be null or omitted if not associated with a resource. For Cloud API keys, resource should be `null`. [Learn more in Authentication](https://docs.confluent.io/cloud/current/api.html#section/Authentication). 
type IamV2ApiKeySpecResource struct {
...
func (o IamV2ApiKeySpecResource) MarshalJSON() ([]byte, error) {
...
func (o IamV2ApiKeySpecResource) ToMap() (map[string]interface{}, error) {
...
type NullableIamV2ApiKeySpecResource struct {
	value *IamV2ApiKeySpecResource
	isSet bool
}

func (v NullableIamV2ApiKeySpecResource) Get() *IamV2ApiKeySpecResource {
	return v.value
}

func (v *NullableIamV2ApiKeySpecResource) Set(val *IamV2ApiKeySpecResource) {
	v.value = val
	v.isSet = true
}

func (v NullableIamV2ApiKeySpecResource) IsSet() bool {
	return v.isSet
}

func (v *NullableIamV2ApiKeySpecResource) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIamV2ApiKeySpecResource(val *IamV2ApiKeySpecResource) *NullableIamV2ApiKeySpecResource {
	return &NullableIamV2ApiKeySpecResource{value: val, isSet: true}
}

func (v NullableIamV2ApiKeySpecResource) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIamV2ApiKeySpecResource) UnmarshalJSON(src []byte) error {
	v.isSet = true
