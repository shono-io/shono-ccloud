...
// checks if the SrcmV2Region type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SrcmV2Region{}
...
func (o SrcmV2Region) ToMap() (map[string]interface{}, error) {
