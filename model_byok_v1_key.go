...
// checks if the ByokV1Key type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ByokV1Key{}
...
type ByokV1Key struct {
	...
	Key *ByokV1KeyKey `json:"key,omitempty"`
...
// SetKey gets a reference to the given ByokV1KeyKey and assigns it to the Key field.
...
func (o ByokV1Key) ToMap() (map[string]interface{}, error) {
