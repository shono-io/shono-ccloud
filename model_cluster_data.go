...
// checks if the ClusterData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ClusterData{}
...
func (o ClusterData) ToMap() (map[string]interface{}, error) {
