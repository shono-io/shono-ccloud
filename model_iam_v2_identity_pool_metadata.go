...
// checks if the IamV2IdentityPoolMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IamV2IdentityPoolMetadata{}

// IamV2IdentityPoolMetadata struct for IamV2IdentityPoolMetadata
type IamV2IdentityPoolMetadata struct {
...
func NewIamV2IdentityPoolMetadata(self interface{}) *IamV2IdentityPoolMetadata {
	this := IamV2IdentityPoolMetadata{}
	this.Self = self
	return &this
}
...
func (o IamV2IdentityPoolMetadata) MarshalJSON() ([]byte, error) {
...
func (o IamV2IdentityPoolMetadata) ToMap() (map[string]interface{}, error) {
...
type NullableIamV2IdentityPoolMetadata struct {
	value *IamV2IdentityPoolMetadata
	isSet bool
}

func (v NullableIamV2IdentityPoolMetadata) Get() *IamV2IdentityPoolMetadata {
	return v.value
}

func (v *NullableIamV2IdentityPoolMetadata) Set(val *IamV2IdentityPoolMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableIamV2IdentityPoolMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableIamV2IdentityPoolMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIamV2IdentityPoolMetadata(val *IamV2IdentityPoolMetadata) *NullableIamV2IdentityPoolMetadata {
	return &NullableIamV2IdentityPoolMetadata{value: val, isSet: true}
}

func (v NullableIamV2IdentityPoolMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIamV2IdentityPoolMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
