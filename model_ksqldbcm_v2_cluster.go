...
// checks if the KsqldbcmV2Cluster type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &KsqldbcmV2Cluster{}
...
func (o *KsqldbcmV2Cluster) GetMetadata() KsqldbcmV2ClusterMetadata {
...
// and a boolean to check if the value has been set.
func (o *KsqldbcmV2Cluster) GetMetadataOk() (*KsqldbcmV2ClusterMetadata, bool) {
	if o == nil || IsNil(o.Metadata) {
		return nil, false
	}
...
func (o *KsqldbcmV2Cluster) SetMetadata(v KsqldbcmV2ClusterMetadata) {
	o.Metadata = &v
}
...
func (o KsqldbcmV2Cluster) ToMap() (map[string]interface{}, error) {
