...
// checks if the IamV2IdentityPoolListMetadataAllOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IamV2IdentityPoolListMetadataAllOf{}

// IamV2IdentityPoolListMetadataAllOf struct for IamV2IdentityPoolListMetadataAllOf
type IamV2IdentityPoolListMetadataAllOf struct {
...
func NewIamV2IdentityPoolListMetadataAllOf() *IamV2IdentityPoolListMetadataAllOf {
	this := IamV2IdentityPoolListMetadataAllOf{}
	return &this
}
...
func (o IamV2IdentityPoolListMetadataAllOf) MarshalJSON() ([]byte, error) {
...
func (o IamV2IdentityPoolListMetadataAllOf) ToMap() (map[string]interface{}, error) {
...
type NullableIamV2IdentityPoolListMetadataAllOf struct {
	value *IamV2IdentityPoolListMetadataAllOf
	isSet bool
}

func (v NullableIamV2IdentityPoolListMetadataAllOf) Get() *IamV2IdentityPoolListMetadataAllOf {
	return v.value
}

func (v *NullableIamV2IdentityPoolListMetadataAllOf) Set(val *IamV2IdentityPoolListMetadataAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableIamV2IdentityPoolListMetadataAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableIamV2IdentityPoolListMetadataAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIamV2IdentityPoolListMetadataAllOf(val *IamV2IdentityPoolListMetadataAllOf) *NullableIamV2IdentityPoolListMetadataAllOf {
	return &NullableIamV2IdentityPoolListMetadataAllOf{value: val, isSet: true}
}

func (v NullableIamV2IdentityPoolListMetadataAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIamV2IdentityPoolListMetadataAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
