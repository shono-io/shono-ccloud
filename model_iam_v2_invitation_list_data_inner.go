...
// checks if the IamV2InvitationListDataInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IamV2InvitationListDataInner{}

// IamV2InvitationListDataInner struct for IamV2InvitationListDataInner
type IamV2InvitationListDataInner struct {
	...
	Id string `json:"id"`
	Metadata IamV2InvitationMetadata `json:"metadata"`
...
func NewIamV2InvitationListDataInner(id string, metadata IamV2InvitationMetadata, email string) *IamV2InvitationListDataInner {
	this := IamV2InvitationListDataInner{}
	this.Id = id
...
func (o *IamV2InvitationListDataInner) SetAcceptedAtNil() {
...
func (o IamV2InvitationListDataInner) MarshalJSON() ([]byte, error) {
...
func (o IamV2InvitationListDataInner) ToMap() (map[string]interface{}, error) {
...
type NullableIamV2InvitationListDataInner struct {
	value *IamV2InvitationListDataInner
	isSet bool
}

func (v NullableIamV2InvitationListDataInner) Get() *IamV2InvitationListDataInner {
	return v.value
}

func (v *NullableIamV2InvitationListDataInner) Set(val *IamV2InvitationListDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableIamV2InvitationListDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableIamV2InvitationListDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIamV2InvitationListDataInner(val *IamV2InvitationListDataInner) *NullableIamV2InvitationListDataInner {
	return &NullableIamV2InvitationListDataInner{value: val, isSet: true}
}

func (v NullableIamV2InvitationListDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIamV2InvitationListDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
