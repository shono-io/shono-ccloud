...
// checks if the NetworkingV1NetworkMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NetworkingV1NetworkMetadata{}

// NetworkingV1NetworkMetadata struct for NetworkingV1NetworkMetadata
type NetworkingV1NetworkMetadata struct {
...
func NewNetworkingV1NetworkMetadata(self interface{}) *NetworkingV1NetworkMetadata {
	this := NetworkingV1NetworkMetadata{}
	this.Self = self
	return &this
}
...
func (o NetworkingV1NetworkMetadata) MarshalJSON() ([]byte, error) {
...
func (o NetworkingV1NetworkMetadata) ToMap() (map[string]interface{}, error) {
...
type NullableNetworkingV1NetworkMetadata struct {
	value *NetworkingV1NetworkMetadata
	isSet bool
}

func (v NullableNetworkingV1NetworkMetadata) Get() *NetworkingV1NetworkMetadata {
	return v.value
}

func (v *NullableNetworkingV1NetworkMetadata) Set(val *NetworkingV1NetworkMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableNetworkingV1NetworkMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableNetworkingV1NetworkMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNetworkingV1NetworkMetadata(val *NetworkingV1NetworkMetadata) *NullableNetworkingV1NetworkMetadata {
	return &NullableNetworkingV1NetworkMetadata{value: val, isSet: true}
}

func (v NullableNetworkingV1NetworkMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNetworkingV1NetworkMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
