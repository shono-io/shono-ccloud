...
// checks if the NetworkingV1NetworkListMetadataAllOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NetworkingV1NetworkListMetadataAllOf{}

// NetworkingV1NetworkListMetadataAllOf struct for NetworkingV1NetworkListMetadataAllOf
type NetworkingV1NetworkListMetadataAllOf struct {
...
func NewNetworkingV1NetworkListMetadataAllOf() *NetworkingV1NetworkListMetadataAllOf {
	this := NetworkingV1NetworkListMetadataAllOf{}
	return &this
}
...
func (o NetworkingV1NetworkListMetadataAllOf) MarshalJSON() ([]byte, error) {
...
func (o NetworkingV1NetworkListMetadataAllOf) ToMap() (map[string]interface{}, error) {
...
type NullableNetworkingV1NetworkListMetadataAllOf struct {
	value *NetworkingV1NetworkListMetadataAllOf
	isSet bool
}

func (v NullableNetworkingV1NetworkListMetadataAllOf) Get() *NetworkingV1NetworkListMetadataAllOf {
	return v.value
}

func (v *NullableNetworkingV1NetworkListMetadataAllOf) Set(val *NetworkingV1NetworkListMetadataAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableNetworkingV1NetworkListMetadataAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableNetworkingV1NetworkListMetadataAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNetworkingV1NetworkListMetadataAllOf(val *NetworkingV1NetworkListMetadataAllOf) *NullableNetworkingV1NetworkListMetadataAllOf {
	return &NullableNetworkingV1NetworkListMetadataAllOf{value: val, isSet: true}
}

func (v NullableNetworkingV1NetworkListMetadataAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNetworkingV1NetworkListMetadataAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
