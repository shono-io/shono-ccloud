...
// checks if the NetworkingV1PeeringListMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NetworkingV1PeeringListMetadata{}

// NetworkingV1PeeringListMetadata struct for NetworkingV1PeeringListMetadata
type NetworkingV1PeeringListMetadata struct {
...
func NewNetworkingV1PeeringListMetadata() *NetworkingV1PeeringListMetadata {
	this := NetworkingV1PeeringListMetadata{}
	return &this
}
...
func (o NetworkingV1PeeringListMetadata) MarshalJSON() ([]byte, error) {
...
func (o NetworkingV1PeeringListMetadata) ToMap() (map[string]interface{}, error) {
...
type NullableNetworkingV1PeeringListMetadata struct {
	value *NetworkingV1PeeringListMetadata
	isSet bool
}

func (v NullableNetworkingV1PeeringListMetadata) Get() *NetworkingV1PeeringListMetadata {
	return v.value
}

func (v *NullableNetworkingV1PeeringListMetadata) Set(val *NetworkingV1PeeringListMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableNetworkingV1PeeringListMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableNetworkingV1PeeringListMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNetworkingV1PeeringListMetadata(val *NetworkingV1PeeringListMetadata) *NullableNetworkingV1PeeringListMetadata {
	return &NullableNetworkingV1PeeringListMetadata{value: val, isSet: true}
}

func (v NullableNetworkingV1PeeringListMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNetworkingV1PeeringListMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
