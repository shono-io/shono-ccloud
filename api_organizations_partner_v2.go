...
func (r ApiGetPartnerV2OrganizationRequest) Execute() (*GetPartnerV2Organization200Response, *http.Response, error) {
	return r.ApiService.GetPartnerV2OrganizationExecute(r)
}
...
*/
func (a *OrganizationsPartnerV2ApiService) GetPartnerV2Organization(ctx context.Context, id string) ApiGetPartnerV2OrganizationRequest {
	return ApiGetPartnerV2OrganizationRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
//  @return GetPartnerV2Organization200Response
func (a *OrganizationsPartnerV2ApiService) GetPartnerV2OrganizationExecute(r ApiGetPartnerV2OrganizationRequest) (*GetPartnerV2Organization200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *GetPartnerV2Organization200Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "OrganizationsPartnerV2ApiService.GetPartnerV2Organization")
	if err != nil {
...
func (r ApiListPartnerV2OrganizationsRequest) Execute() (*PartnerV2OrganizationList, *http.Response, error) {
	return r.ApiService.ListPartnerV2OrganizationsExecute(r)
}
...
*/
func (a *OrganizationsPartnerV2ApiService) ListPartnerV2Organizations(ctx context.Context) ApiListPartnerV2OrganizationsRequest {
	return ApiListPartnerV2OrganizationsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *OrganizationsPartnerV2ApiService) ListPartnerV2OrganizationsExecute(r ApiListPartnerV2OrganizationsRequest) (*PartnerV2OrganizationList, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "OrganizationsPartnerV2ApiService.ListPartnerV2Organizations")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
