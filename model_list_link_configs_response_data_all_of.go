...
// checks if the ListLinkConfigsResponseDataAllOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListLinkConfigsResponseDataAllOf{}
...
func (o ListLinkConfigsResponseDataAllOf) ToMap() (map[string]interface{}, error) {
