...
// checks if the GetIamV2RoleBinding200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetIamV2RoleBinding200Response{}

// GetIamV2RoleBinding200Response struct for GetIamV2RoleBinding200Response
type GetIamV2RoleBinding200Response struct {
	...
	Id string `json:"id"`
	Metadata *IamV2RoleBindingMetadata `json:"metadata,omitempty"`
...
func NewGetIamV2RoleBinding200Response(apiVersion string, kind string, id string, principal string, roleName string, crnPattern string) *GetIamV2RoleBinding200Response {
	this := GetIamV2RoleBinding200Response{}
...
func (o *GetIamV2RoleBinding200Response) GetMetadata() IamV2RoleBindingMetadata {
	if o == nil || IsNil(o.Metadata) {
		var ret IamV2RoleBindingMetadata
		return ret
	}
	return *o.Metadata
}
...
// SetMetadata gets a reference to the given IamV2RoleBindingMetadata and assigns it to the Metadata field.
...
// GetCrnPattern returns the CrnPattern field value
...
// GetCrnPatternOk returns a tuple with the CrnPattern field value
// and a boolean to check if the value has been set.
...
// SetCrnPattern sets field value
func (o *GetIamV2RoleBinding200Response) SetCrnPattern(v string) {
	o.CrnPattern = v
}

func (o GetIamV2RoleBinding200Response) MarshalJSON() ([]byte, error) {
...
func (o GetIamV2RoleBinding200Response) ToMap() (map[string]interface{}, error) {
...
type NullableGetIamV2RoleBinding200Response struct {
	value *GetIamV2RoleBinding200Response
	isSet bool
}

func (v NullableGetIamV2RoleBinding200Response) Get() *GetIamV2RoleBinding200Response {
	return v.value
}

func (v *NullableGetIamV2RoleBinding200Response) Set(val *GetIamV2RoleBinding200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetIamV2RoleBinding200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetIamV2RoleBinding200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetIamV2RoleBinding200Response(val *GetIamV2RoleBinding200Response) *NullableGetIamV2RoleBinding200Response {
	return &NullableGetIamV2RoleBinding200Response{value: val, isSet: true}
}

func (v NullableGetIamV2RoleBinding200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetIamV2RoleBinding200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
