...
// checks if the KsqldbcmV2ClusterListDataInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &KsqldbcmV2ClusterListDataInner{}

// KsqldbcmV2ClusterListDataInner struct for KsqldbcmV2ClusterListDataInner
type KsqldbcmV2ClusterListDataInner struct {
	...
	Id string `json:"id"`
	Metadata KsqldbcmV2ClusterMetadata `json:"metadata"`
...
func NewKsqldbcmV2ClusterListDataInner(id string, metadata KsqldbcmV2ClusterMetadata, spec map[string]interface{}, status KsqldbcmV2ClusterStatus) *KsqldbcmV2ClusterListDataInner {
	this := KsqldbcmV2ClusterListDataInner{}
	this.Id = id
...
func (o KsqldbcmV2ClusterListDataInner) MarshalJSON() ([]byte, error) {
...
func (o KsqldbcmV2ClusterListDataInner) ToMap() (map[string]interface{}, error) {
...
type NullableKsqldbcmV2ClusterListDataInner struct {
	value *KsqldbcmV2ClusterListDataInner
	isSet bool
}

func (v NullableKsqldbcmV2ClusterListDataInner) Get() *KsqldbcmV2ClusterListDataInner {
	return v.value
}

func (v *NullableKsqldbcmV2ClusterListDataInner) Set(val *KsqldbcmV2ClusterListDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableKsqldbcmV2ClusterListDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableKsqldbcmV2ClusterListDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableKsqldbcmV2ClusterListDataInner(val *KsqldbcmV2ClusterListDataInner) *NullableKsqldbcmV2ClusterListDataInner {
	return &NullableKsqldbcmV2ClusterListDataInner{value: val, isSet: true}
}

func (v NullableKsqldbcmV2ClusterListDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableKsqldbcmV2ClusterListDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
