...
// checks if the KsqldbcmV2ClusterSpec type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &KsqldbcmV2ClusterSpec{}
...
type KsqldbcmV2ClusterSpec struct {
	...
	KafkaCluster *KsqldbcmV2ClusterSpecKafkaCluster `json:"kafka_cluster,omitempty"`
	CredentialIdentity *KsqldbcmV2ClusterSpecCredentialIdentity `json:"credential_identity,omitempty"`
	Environment *KsqldbcmV2ClusterSpecEnvironment `json:"environment,omitempty"`
}
...
func (o *KsqldbcmV2ClusterSpec) GetUseDetailedProcessingLog() bool {
	if o == nil || IsNil(o.UseDetailedProcessingLog) {
		var ret bool
		return ret
	}
...
func (o *KsqldbcmV2ClusterSpec) GetKafkaCluster() KsqldbcmV2ClusterSpecKafkaCluster {
	if o == nil || IsNil(o.KafkaCluster) {
		var ret KsqldbcmV2ClusterSpecKafkaCluster
		return ret
	}
...
// SetKafkaCluster gets a reference to the given KsqldbcmV2ClusterSpecKafkaCluster and assigns it to the KafkaCluster field.
...
func (o *KsqldbcmV2ClusterSpec) GetCredentialIdentity() KsqldbcmV2ClusterSpecCredentialIdentity {
	if o == nil || IsNil(o.CredentialIdentity) {
		var ret KsqldbcmV2ClusterSpecCredentialIdentity
		return ret
	}
...
// SetCredentialIdentity gets a reference to the given KsqldbcmV2ClusterSpecCredentialIdentity and assigns it to the CredentialIdentity field.
...
func (o *KsqldbcmV2ClusterSpec) GetEnvironment() KsqldbcmV2ClusterSpecEnvironment {
	if o == nil || IsNil(o.Environment) {
		var ret KsqldbcmV2ClusterSpecEnvironment
		return ret
	}
...
// SetEnvironment gets a reference to the given KsqldbcmV2ClusterSpecEnvironment and assigns it to the Environment field.
...
func (o KsqldbcmV2ClusterSpec) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.DisplayName) {
		toSerialize["display_name"] = o.DisplayName
	}
	if !IsNil(o.UseDetailedProcessingLog) {
