...
// checks if the ConsumerGroupData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ConsumerGroupData{}
...
func (o ConsumerGroupData) ToMap() (map[string]interface{}, error) {
