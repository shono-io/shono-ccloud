...
// checks if the KafkaQuotasV1ClientQuotaListMetadataAllOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &KafkaQuotasV1ClientQuotaListMetadataAllOf{}

// KafkaQuotasV1ClientQuotaListMetadataAllOf struct for KafkaQuotasV1ClientQuotaListMetadataAllOf
type KafkaQuotasV1ClientQuotaListMetadataAllOf struct {
...
func NewKafkaQuotasV1ClientQuotaListMetadataAllOf() *KafkaQuotasV1ClientQuotaListMetadataAllOf {
	this := KafkaQuotasV1ClientQuotaListMetadataAllOf{}
	return &this
}
...
func (o KafkaQuotasV1ClientQuotaListMetadataAllOf) MarshalJSON() ([]byte, error) {
...
func (o KafkaQuotasV1ClientQuotaListMetadataAllOf) ToMap() (map[string]interface{}, error) {
...
type NullableKafkaQuotasV1ClientQuotaListMetadataAllOf struct {
	value *KafkaQuotasV1ClientQuotaListMetadataAllOf
	isSet bool
}

func (v NullableKafkaQuotasV1ClientQuotaListMetadataAllOf) Get() *KafkaQuotasV1ClientQuotaListMetadataAllOf {
	return v.value
}

func (v *NullableKafkaQuotasV1ClientQuotaListMetadataAllOf) Set(val *KafkaQuotasV1ClientQuotaListMetadataAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableKafkaQuotasV1ClientQuotaListMetadataAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableKafkaQuotasV1ClientQuotaListMetadataAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableKafkaQuotasV1ClientQuotaListMetadataAllOf(val *KafkaQuotasV1ClientQuotaListMetadataAllOf) *NullableKafkaQuotasV1ClientQuotaListMetadataAllOf {
	return &NullableKafkaQuotasV1ClientQuotaListMetadataAllOf{value: val, isSet: true}
}

func (v NullableKafkaQuotasV1ClientQuotaListMetadataAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableKafkaQuotasV1ClientQuotaListMetadataAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
