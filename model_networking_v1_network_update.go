...
// checks if the NetworkingV1NetworkUpdate type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NetworkingV1NetworkUpdate{}
...
func (o NetworkingV1NetworkUpdate) ToMap() (map[string]interface{}, error) {
