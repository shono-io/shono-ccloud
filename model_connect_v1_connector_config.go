...
// checks if the ConnectV1ConnectorConfig type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ConnectV1ConnectorConfig{}

// ConnectV1ConnectorConfig Configuration parameters for the connector. These configurations are the minimum set of key-value pairs (KVP) which can be used to define how the connector connects Kafka to the external system. Some of these KVPs are common to all the connectors, such as connection parameters to Kafka, connector metadata, etc. The list of common connector configurations is as follows  - cloud.environment - cloud.provider - connector.class - kafka.api.key - kafka.api.secret - kafka.endpoint - kafka.region - name  A specific connector such as `GcsSink` would have additional parameters such as `gcs.bucket.name`, `flush.size`, etc.
...
func (o ConnectV1ConnectorConfig) MarshalJSON() ([]byte, error) {
...
func (o ConnectV1ConnectorConfig) ToMap() (map[string]interface{}, error) {
...
type NullableConnectV1ConnectorConfig struct {
	value *ConnectV1ConnectorConfig
	isSet bool
}

func (v NullableConnectV1ConnectorConfig) Get() *ConnectV1ConnectorConfig {
	return v.value
}

func (v *NullableConnectV1ConnectorConfig) Set(val *ConnectV1ConnectorConfig) {
	v.value = val
	v.isSet = true
}

func (v NullableConnectV1ConnectorConfig) IsSet() bool {
	return v.isSet
}

func (v *NullableConnectV1ConnectorConfig) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableConnectV1ConnectorConfig(val *ConnectV1ConnectorConfig) *NullableConnectV1ConnectorConfig {
	return &NullableConnectV1ConnectorConfig{value: val, isSet: true}
}

func (v NullableConnectV1ConnectorConfig) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableConnectV1ConnectorConfig) UnmarshalJSON(src []byte) error {
	v.isSet = true
