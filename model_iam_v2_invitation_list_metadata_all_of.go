...
// checks if the IamV2InvitationListMetadataAllOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IamV2InvitationListMetadataAllOf{}

// IamV2InvitationListMetadataAllOf struct for IamV2InvitationListMetadataAllOf
type IamV2InvitationListMetadataAllOf struct {
...
func NewIamV2InvitationListMetadataAllOf() *IamV2InvitationListMetadataAllOf {
	this := IamV2InvitationListMetadataAllOf{}
	return &this
}
...
func (o IamV2InvitationListMetadataAllOf) MarshalJSON() ([]byte, error) {
...
func (o IamV2InvitationListMetadataAllOf) ToMap() (map[string]interface{}, error) {
...
type NullableIamV2InvitationListMetadataAllOf struct {
	value *IamV2InvitationListMetadataAllOf
	isSet bool
}

func (v NullableIamV2InvitationListMetadataAllOf) Get() *IamV2InvitationListMetadataAllOf {
	return v.value
}

func (v *NullableIamV2InvitationListMetadataAllOf) Set(val *IamV2InvitationListMetadataAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableIamV2InvitationListMetadataAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableIamV2InvitationListMetadataAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIamV2InvitationListMetadataAllOf(val *IamV2InvitationListMetadataAllOf) *NullableIamV2InvitationListMetadataAllOf {
	return &NullableIamV2InvitationListMetadataAllOf{value: val, isSet: true}
}

func (v NullableIamV2InvitationListMetadataAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIamV2InvitationListMetadataAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
