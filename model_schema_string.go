...
// checks if the SchemaString type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SchemaString{}
...
func (o SchemaString) ToMap() (map[string]interface{}, error) {
