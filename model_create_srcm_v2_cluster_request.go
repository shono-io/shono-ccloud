...
// checks if the CreateSrcmV2ClusterRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateSrcmV2ClusterRequest{}

// CreateSrcmV2ClusterRequest struct for CreateSrcmV2ClusterRequest
type CreateSrcmV2ClusterRequest struct {
	...
	Spec CreateSrcmV2ClusterRequestAllOf1Spec `json:"spec"`
...
func NewCreateSrcmV2ClusterRequest(spec CreateSrcmV2ClusterRequestAllOf1Spec) *CreateSrcmV2ClusterRequest {
	this := CreateSrcmV2ClusterRequest{}
	this.Spec = spec
	return &this
}
...
func (o *CreateSrcmV2ClusterRequest) HasId() bool {
	if o != nil && !IsNil(o.Id) {
		return true
	}
...
func (o *CreateSrcmV2ClusterRequest) GetSpec() CreateSrcmV2ClusterRequestAllOf1Spec {
	if o == nil {
		var ret CreateSrcmV2ClusterRequestAllOf1Spec
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *CreateSrcmV2ClusterRequest) GetStatusOk() (*SrcmV2ClusterStatus, bool) {
	if o == nil || IsNil(o.Status) {
		return nil, false
	}
...
func (o CreateSrcmV2ClusterRequest) MarshalJSON() ([]byte, error) {
...
func (o CreateSrcmV2ClusterRequest) ToMap() (map[string]interface{}, error) {
...
type NullableCreateSrcmV2ClusterRequest struct {
	value *CreateSrcmV2ClusterRequest
	isSet bool
}

func (v NullableCreateSrcmV2ClusterRequest) Get() *CreateSrcmV2ClusterRequest {
	return v.value
}

func (v *NullableCreateSrcmV2ClusterRequest) Set(val *CreateSrcmV2ClusterRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateSrcmV2ClusterRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateSrcmV2ClusterRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateSrcmV2ClusterRequest(val *CreateSrcmV2ClusterRequest) *NullableCreateSrcmV2ClusterRequest {
	return &NullableCreateSrcmV2ClusterRequest{value: val, isSet: true}
}

func (v NullableCreateSrcmV2ClusterRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateSrcmV2ClusterRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
