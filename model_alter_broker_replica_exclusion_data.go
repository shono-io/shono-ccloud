...
// checks if the AlterBrokerReplicaExclusionData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AlterBrokerReplicaExclusionData{}
...
func (o AlterBrokerReplicaExclusionData) ToMap() (map[string]interface{}, error) {
