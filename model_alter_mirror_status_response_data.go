...
// checks if the AlterMirrorStatusResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AlterMirrorStatusResponseData{}
...
func (o AlterMirrorStatusResponseData) ToMap() (map[string]interface{}, error) {
