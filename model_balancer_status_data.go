...
// checks if the BalancerStatusData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BalancerStatusData{}
...
func (o BalancerStatusData) ToMap() (map[string]interface{}, error) {
