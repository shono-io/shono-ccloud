...
// checks if the ServiceQuotaV1AppliedQuotaListDataInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ServiceQuotaV1AppliedQuotaListDataInner{}

// ServiceQuotaV1AppliedQuotaListDataInner struct for ServiceQuotaV1AppliedQuotaListDataInner
type ServiceQuotaV1AppliedQuotaListDataInner struct {
	...
	Id string `json:"id"`
	Metadata ServiceQuotaV1AppliedQuotaMetadata `json:"metadata"`
	...
	User *ServiceQuotaV1AppliedQuotaUser `json:"user,omitempty"`
	Organization NullableServiceQuotaV1AppliedQuotaOrganization `json:"organization,omitempty"`
	Environment NullableServiceQuotaV1AppliedQuotaEnvironment `json:"environment,omitempty"`
	Network NullableServiceQuotaV1AppliedQuotaNetwork `json:"network,omitempty"`
	KafkaCluster NullableServiceQuotaV1AppliedQuotaKafkaCluster `json:"kafka_cluster,omitempty"`
}
...
func NewServiceQuotaV1AppliedQuotaListDataInner(id string, metadata ServiceQuotaV1AppliedQuotaMetadata, scope string, displayName string, defaultLimit int32, appliedLimit int32) *ServiceQuotaV1AppliedQuotaListDataInner {
	this := ServiceQuotaV1AppliedQuotaListDataInner{}
	this.Id = id
...
func (o *ServiceQuotaV1AppliedQuotaListDataInner) GetMetadata() ServiceQuotaV1AppliedQuotaMetadata {
	if o == nil {
		var ret ServiceQuotaV1AppliedQuotaMetadata
		return ret
	}
...
// GetAppliedLimit returns the AppliedLimit field value
...
// GetAppliedLimitOk returns a tuple with the AppliedLimit field value
// and a boolean to check if the value has been set.
...
// SetAppliedLimit sets field value
...
func (o *ServiceQuotaV1AppliedQuotaListDataInner) GetUser() ServiceQuotaV1AppliedQuotaUser {
	if o == nil || IsNil(o.User) {
		var ret ServiceQuotaV1AppliedQuotaUser
		return ret
	}
	return *o.User
}
...
// SetUser gets a reference to the given ServiceQuotaV1AppliedQuotaUser and assigns it to the User field.
...
func (o *ServiceQuotaV1AppliedQuotaListDataInner) GetOrganization() ServiceQuotaV1AppliedQuotaOrganization {
	if o == nil || IsNil(o.Organization.Get()) {
		var ret ServiceQuotaV1AppliedQuotaOrganization
		return ret
	}
...
// SetOrganization gets a reference to the given NullableServiceQuotaV1AppliedQuotaOrganization and assigns it to the Organization field.
...
func (o *ServiceQuotaV1AppliedQuotaListDataInner) SetOrganizationNil() {
...
func (o *ServiceQuotaV1AppliedQuotaListDataInner) GetEnvironment() ServiceQuotaV1AppliedQuotaEnvironment {
	if o == nil || IsNil(o.Environment.Get()) {
		var ret ServiceQuotaV1AppliedQuotaEnvironment
		return ret
	}
...
// SetEnvironment gets a reference to the given NullableServiceQuotaV1AppliedQuotaEnvironment and assigns it to the Environment field.
func (o *ServiceQuotaV1AppliedQuotaListDataInner) SetEnvironment(v ServiceQuotaV1AppliedQuotaEnvironment) {
	o.Environment.Set(&v)
}
// SetEnvironmentNil sets the value for Environment to be an explicit nil
func (o *ServiceQuotaV1AppliedQuotaListDataInner) SetEnvironmentNil() {
...
func (o *ServiceQuotaV1AppliedQuotaListDataInner) GetNetwork() ServiceQuotaV1AppliedQuotaNetwork {
	if o == nil || IsNil(o.Network.Get()) {
		var ret ServiceQuotaV1AppliedQuotaNetwork
		return ret
	}
...
// SetNetwork gets a reference to the given NullableServiceQuotaV1AppliedQuotaNetwork and assigns it to the Network field.
func (o *ServiceQuotaV1AppliedQuotaListDataInner) SetNetwork(v ServiceQuotaV1AppliedQuotaNetwork) {
	o.Network.Set(&v)
}
// SetNetworkNil sets the value for Network to be an explicit nil
func (o *ServiceQuotaV1AppliedQuotaListDataInner) SetNetworkNil() {
	o.Network.Set(nil)
}
...
func (o *ServiceQuotaV1AppliedQuotaListDataInner) GetKafkaCluster() ServiceQuotaV1AppliedQuotaKafkaCluster {
	if o == nil || IsNil(o.KafkaCluster.Get()) {
		var ret ServiceQuotaV1AppliedQuotaKafkaCluster
		return ret
	}
...
// SetKafkaCluster gets a reference to the given NullableServiceQuotaV1AppliedQuotaKafkaCluster and assigns it to the KafkaCluster field.
...
func (o *ServiceQuotaV1AppliedQuotaListDataInner) SetKafkaClusterNil() {
...
func (o ServiceQuotaV1AppliedQuotaListDataInner) MarshalJSON() ([]byte, error) {
...
func (o ServiceQuotaV1AppliedQuotaListDataInner) ToMap() (map[string]interface{}, error) {
...
type NullableServiceQuotaV1AppliedQuotaListDataInner struct {
	value *ServiceQuotaV1AppliedQuotaListDataInner
	isSet bool
}

func (v NullableServiceQuotaV1AppliedQuotaListDataInner) Get() *ServiceQuotaV1AppliedQuotaListDataInner {
	return v.value
}

func (v *NullableServiceQuotaV1AppliedQuotaListDataInner) Set(val *ServiceQuotaV1AppliedQuotaListDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableServiceQuotaV1AppliedQuotaListDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableServiceQuotaV1AppliedQuotaListDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableServiceQuotaV1AppliedQuotaListDataInner(val *ServiceQuotaV1AppliedQuotaListDataInner) *NullableServiceQuotaV1AppliedQuotaListDataInner {
	return &NullableServiceQuotaV1AppliedQuotaListDataInner{value: val, isSet: true}
}

func (v NullableServiceQuotaV1AppliedQuotaListDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableServiceQuotaV1AppliedQuotaListDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
