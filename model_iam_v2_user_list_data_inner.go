...
// checks if the IamV2UserListDataInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IamV2UserListDataInner{}

// IamV2UserListDataInner struct for IamV2UserListDataInner
type IamV2UserListDataInner struct {
	...
	Id string `json:"id"`
	Metadata IamV2UserMetadata `json:"metadata"`
...
func (o IamV2UserListDataInner) MarshalJSON() ([]byte, error) {
...
func (o IamV2UserListDataInner) ToMap() (map[string]interface{}, error) {
...
type NullableIamV2UserListDataInner struct {
	value *IamV2UserListDataInner
	isSet bool
}

func (v NullableIamV2UserListDataInner) Get() *IamV2UserListDataInner {
	return v.value
}

func (v *NullableIamV2UserListDataInner) Set(val *IamV2UserListDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableIamV2UserListDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableIamV2UserListDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIamV2UserListDataInner(val *IamV2UserListDataInner) *NullableIamV2UserListDataInner {
	return &NullableIamV2UserListDataInner{value: val, isSet: true}
}

func (v NullableIamV2UserListDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIamV2UserListDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
