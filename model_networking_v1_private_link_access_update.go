...
// checks if the NetworkingV1PrivateLinkAccessUpdate type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NetworkingV1PrivateLinkAccessUpdate{}
...
func (o NetworkingV1PrivateLinkAccessUpdate) ToMap() (map[string]interface{}, error) {
