...
type ApiGetSrcmV2RegionRequest struct {
	ctx context.Context
	ApiService *RegionsSrcmV2ApiService
	id string
}

func (r ApiGetSrcmV2RegionRequest) Execute() (*GetSrcmV2Region200Response, *http.Response, error) {
...
*/
func (a *RegionsSrcmV2ApiService) GetSrcmV2Region(ctx context.Context, id string) ApiGetSrcmV2RegionRequest {
	return ApiGetSrcmV2RegionRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
//  @return GetSrcmV2Region200Response
func (a *RegionsSrcmV2ApiService) GetSrcmV2RegionExecute(r ApiGetSrcmV2RegionRequest) (*GetSrcmV2Region200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *GetSrcmV2Region200Response
	)
...
func (r ApiListSrcmV2RegionsRequest) Execute() (*ListSrcmV2Regions200Response, *http.Response, error) {
...
*/
func (a *RegionsSrcmV2ApiService) ListSrcmV2Regions(ctx context.Context) ApiListSrcmV2RegionsRequest {
	return ApiListSrcmV2RegionsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return ListSrcmV2Regions200Response
func (a *RegionsSrcmV2ApiService) ListSrcmV2RegionsExecute(r ApiListSrcmV2RegionsRequest) (*ListSrcmV2Regions200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *ListSrcmV2Regions200Response
	)
	...
	if r.specRegionName != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "spec.region_name", r.specRegionName, "")
	}
	if r.specPackages != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "spec.packages", s.Index(i), "multi")
			}
		} else {
			parameterAddToHeaderOrQuery(localVarQueryParams, "spec.packages", t, "multi")
		}
	}
	if r.pageSize != nil {
