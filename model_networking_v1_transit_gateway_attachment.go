...
// checks if the NetworkingV1TransitGatewayAttachment type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NetworkingV1TransitGatewayAttachment{}
...
func (o NetworkingV1TransitGatewayAttachment) ToMap() (map[string]interface{}, error) {
