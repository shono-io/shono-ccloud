...
// checks if the ByokV1KeyMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ByokV1KeyMetadata{}

// ByokV1KeyMetadata struct for ByokV1KeyMetadata
type ByokV1KeyMetadata struct {
...
func (o ByokV1KeyMetadata) MarshalJSON() ([]byte, error) {
...
func (o ByokV1KeyMetadata) ToMap() (map[string]interface{}, error) {
...
type NullableByokV1KeyMetadata struct {
	value *ByokV1KeyMetadata
	isSet bool
}

func (v NullableByokV1KeyMetadata) Get() *ByokV1KeyMetadata {
	return v.value
}

func (v *NullableByokV1KeyMetadata) Set(val *ByokV1KeyMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableByokV1KeyMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableByokV1KeyMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableByokV1KeyMetadata(val *ByokV1KeyMetadata) *NullableByokV1KeyMetadata {
	return &NullableByokV1KeyMetadata{value: val, isSet: true}
}

func (v NullableByokV1KeyMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableByokV1KeyMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
