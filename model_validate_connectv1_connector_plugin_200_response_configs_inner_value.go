...
// checks if the ValidateConnectv1ConnectorPlugin200ResponseConfigsInnerValue type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ValidateConnectv1ConnectorPlugin200ResponseConfigsInnerValue{}

// ValidateConnectv1ConnectorPlugin200ResponseConfigsInnerValue The current value for a config, which includes the name, value, recommended values, etc.
type ValidateConnectv1ConnectorPlugin200ResponseConfigsInnerValue struct {
...
func NewValidateConnectv1ConnectorPlugin200ResponseConfigsInnerValue() *ValidateConnectv1ConnectorPlugin200ResponseConfigsInnerValue {
	this := ValidateConnectv1ConnectorPlugin200ResponseConfigsInnerValue{}
	return &this
}
...
func (o ValidateConnectv1ConnectorPlugin200ResponseConfigsInnerValue) MarshalJSON() ([]byte, error) {
...
func (o ValidateConnectv1ConnectorPlugin200ResponseConfigsInnerValue) ToMap() (map[string]interface{}, error) {
...
type NullableValidateConnectv1ConnectorPlugin200ResponseConfigsInnerValue struct {
	value *ValidateConnectv1ConnectorPlugin200ResponseConfigsInnerValue
	isSet bool
}

func (v NullableValidateConnectv1ConnectorPlugin200ResponseConfigsInnerValue) Get() *ValidateConnectv1ConnectorPlugin200ResponseConfigsInnerValue {
	return v.value
}

func (v *NullableValidateConnectv1ConnectorPlugin200ResponseConfigsInnerValue) Set(val *ValidateConnectv1ConnectorPlugin200ResponseConfigsInnerValue) {
	v.value = val
	v.isSet = true
}

func (v NullableValidateConnectv1ConnectorPlugin200ResponseConfigsInnerValue) IsSet() bool {
	return v.isSet
}

func (v *NullableValidateConnectv1ConnectorPlugin200ResponseConfigsInnerValue) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableValidateConnectv1ConnectorPlugin200ResponseConfigsInnerValue(val *ValidateConnectv1ConnectorPlugin200ResponseConfigsInnerValue) *NullableValidateConnectv1ConnectorPlugin200ResponseConfigsInnerValue {
	return &NullableValidateConnectv1ConnectorPlugin200ResponseConfigsInnerValue{value: val, isSet: true}
}

func (v NullableValidateConnectv1ConnectorPlugin200ResponseConfigsInnerValue) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableValidateConnectv1ConnectorPlugin200ResponseConfigsInnerValue) UnmarshalJSON(src []byte) error {
	v.isSet = true
