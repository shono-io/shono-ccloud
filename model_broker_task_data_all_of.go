...
// checks if the BrokerTaskDataAllOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BrokerTaskDataAllOf{}
...
func (o *BrokerTaskDataAllOf) GetShutdownScheduled() bool {
	if o == nil || IsNil(o.ShutdownScheduled.Get()) {
		var ret bool
		return ret
	}
...
func (o BrokerTaskDataAllOf) ToMap() (map[string]interface{}, error) {
