...
// checks if the NetworkingV1AwsPeering type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NetworkingV1AwsPeering{}
...
func (o NetworkingV1AwsPeering) ToMap() (map[string]interface{}, error) {
