...
// checks if the GetNotificationsV1Subscription200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetNotificationsV1Subscription200Response{}

// GetNotificationsV1Subscription200Response struct for GetNotificationsV1Subscription200Response
type GetNotificationsV1Subscription200Response struct {
	...
	Id string `json:"id"`
	Metadata *NotificationsV1SubscriptionMetadata `json:"metadata,omitempty"`
	...
	NotificationType NotificationsV1SubscriptionNotificationType `json:"notification_type"`
...
func NewGetNotificationsV1Subscription200Response(apiVersion string, kind string, id string, notificationType NotificationsV1SubscriptionNotificationType, integrations []GlobalObjectReference) *GetNotificationsV1Subscription200Response {
	this := GetNotificationsV1Subscription200Response{}
...
func (o *GetNotificationsV1Subscription200Response) GetMetadata() NotificationsV1SubscriptionMetadata {
	if o == nil || IsNil(o.Metadata) {
		var ret NotificationsV1SubscriptionMetadata
		return ret
	}
	return *o.Metadata
}
...
// SetMetadata gets a reference to the given NotificationsV1SubscriptionMetadata and assigns it to the Metadata field.
...
func (o *GetNotificationsV1Subscription200Response) GetNotificationType() NotificationsV1SubscriptionNotificationType {
	if o == nil {
		var ret NotificationsV1SubscriptionNotificationType
		return ret
	}
...
func (o GetNotificationsV1Subscription200Response) MarshalJSON() ([]byte, error) {
...
func (o GetNotificationsV1Subscription200Response) ToMap() (map[string]interface{}, error) {
...
type NullableGetNotificationsV1Subscription200Response struct {
	value *GetNotificationsV1Subscription200Response
	isSet bool
}

func (v NullableGetNotificationsV1Subscription200Response) Get() *GetNotificationsV1Subscription200Response {
	return v.value
}

func (v *NullableGetNotificationsV1Subscription200Response) Set(val *GetNotificationsV1Subscription200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetNotificationsV1Subscription200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetNotificationsV1Subscription200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetNotificationsV1Subscription200Response(val *GetNotificationsV1Subscription200Response) *NullableGetNotificationsV1Subscription200Response {
	return &NullableGetNotificationsV1Subscription200Response{value: val, isSet: true}
}

func (v NullableGetNotificationsV1Subscription200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetNotificationsV1Subscription200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
