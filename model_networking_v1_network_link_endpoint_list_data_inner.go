...
// checks if the NetworkingV1NetworkLinkEndpointListDataInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NetworkingV1NetworkLinkEndpointListDataInner{}

// NetworkingV1NetworkLinkEndpointListDataInner struct for NetworkingV1NetworkLinkEndpointListDataInner
type NetworkingV1NetworkLinkEndpointListDataInner struct {
	...
	Id string `json:"id"`
	Metadata NetworkingV1NetworkLinkEndpointMetadata `json:"metadata"`
...
func NewNetworkingV1NetworkLinkEndpointListDataInner(id string, metadata NetworkingV1NetworkLinkEndpointMetadata, spec map[string]interface{}, status NetworkingV1NetworkLinkEndpointStatus) *NetworkingV1NetworkLinkEndpointListDataInner {
	this := NetworkingV1NetworkLinkEndpointListDataInner{}
	this.Id = id
...
func (o NetworkingV1NetworkLinkEndpointListDataInner) MarshalJSON() ([]byte, error) {
...
func (o NetworkingV1NetworkLinkEndpointListDataInner) ToMap() (map[string]interface{}, error) {
...
type NullableNetworkingV1NetworkLinkEndpointListDataInner struct {
	value *NetworkingV1NetworkLinkEndpointListDataInner
	isSet bool
}

func (v NullableNetworkingV1NetworkLinkEndpointListDataInner) Get() *NetworkingV1NetworkLinkEndpointListDataInner {
	return v.value
}

func (v *NullableNetworkingV1NetworkLinkEndpointListDataInner) Set(val *NetworkingV1NetworkLinkEndpointListDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableNetworkingV1NetworkLinkEndpointListDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableNetworkingV1NetworkLinkEndpointListDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNetworkingV1NetworkLinkEndpointListDataInner(val *NetworkingV1NetworkLinkEndpointListDataInner) *NullableNetworkingV1NetworkLinkEndpointListDataInner {
	return &NullableNetworkingV1NetworkLinkEndpointListDataInner{value: val, isSet: true}
}

func (v NullableNetworkingV1NetworkLinkEndpointListDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNetworkingV1NetworkLinkEndpointListDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
