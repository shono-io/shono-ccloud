...
// checks if the BillingV1CostListMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BillingV1CostListMetadata{}

// BillingV1CostListMetadata struct for BillingV1CostListMetadata
type BillingV1CostListMetadata struct {
...
func NewBillingV1CostListMetadata() *BillingV1CostListMetadata {
	this := BillingV1CostListMetadata{}
	return &this
}
...
func (o *BillingV1CostListMetadata) HasFirst() bool {
	if o != nil && IsNil(o.First) {
		return true
	}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *BillingV1CostListMetadata) GetPrevOk() (*interface{}, bool) {
...
func (o BillingV1CostListMetadata) MarshalJSON() ([]byte, error) {
...
func (o BillingV1CostListMetadata) ToMap() (map[string]interface{}, error) {
...
type NullableBillingV1CostListMetadata struct {
	value *BillingV1CostListMetadata
	isSet bool
}

func (v NullableBillingV1CostListMetadata) Get() *BillingV1CostListMetadata {
	return v.value
}

func (v *NullableBillingV1CostListMetadata) Set(val *BillingV1CostListMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableBillingV1CostListMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableBillingV1CostListMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBillingV1CostListMetadata(val *BillingV1CostListMetadata) *NullableBillingV1CostListMetadata {
	return &NullableBillingV1CostListMetadata{value: val, isSet: true}
}

func (v NullableBillingV1CostListMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBillingV1CostListMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
