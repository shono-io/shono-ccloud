...
// checks if the NetworkingV1Peering type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NetworkingV1Peering{}
...
func (o NetworkingV1Peering) ToMap() (map[string]interface{}, error) {
