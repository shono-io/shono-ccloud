...
// checks if the NetworkingV1NetworkLinkServiceAssociationListMetadataAllOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NetworkingV1NetworkLinkServiceAssociationListMetadataAllOf{}

// NetworkingV1NetworkLinkServiceAssociationListMetadataAllOf struct for NetworkingV1NetworkLinkServiceAssociationListMetadataAllOf
type NetworkingV1NetworkLinkServiceAssociationListMetadataAllOf struct {
...
func NewNetworkingV1NetworkLinkServiceAssociationListMetadataAllOf() *NetworkingV1NetworkLinkServiceAssociationListMetadataAllOf {
	this := NetworkingV1NetworkLinkServiceAssociationListMetadataAllOf{}
	return &this
}
...
func (o NetworkingV1NetworkLinkServiceAssociationListMetadataAllOf) MarshalJSON() ([]byte, error) {
...
func (o NetworkingV1NetworkLinkServiceAssociationListMetadataAllOf) ToMap() (map[string]interface{}, error) {
...
type NullableNetworkingV1NetworkLinkServiceAssociationListMetadataAllOf struct {
	value *NetworkingV1NetworkLinkServiceAssociationListMetadataAllOf
	isSet bool
}

func (v NullableNetworkingV1NetworkLinkServiceAssociationListMetadataAllOf) Get() *NetworkingV1NetworkLinkServiceAssociationListMetadataAllOf {
	return v.value
}

func (v *NullableNetworkingV1NetworkLinkServiceAssociationListMetadataAllOf) Set(val *NetworkingV1NetworkLinkServiceAssociationListMetadataAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableNetworkingV1NetworkLinkServiceAssociationListMetadataAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableNetworkingV1NetworkLinkServiceAssociationListMetadataAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNetworkingV1NetworkLinkServiceAssociationListMetadataAllOf(val *NetworkingV1NetworkLinkServiceAssociationListMetadataAllOf) *NullableNetworkingV1NetworkLinkServiceAssociationListMetadataAllOf {
	return &NullableNetworkingV1NetworkLinkServiceAssociationListMetadataAllOf{value: val, isSet: true}
}

func (v NullableNetworkingV1NetworkLinkServiceAssociationListMetadataAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNetworkingV1NetworkLinkServiceAssociationListMetadataAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
