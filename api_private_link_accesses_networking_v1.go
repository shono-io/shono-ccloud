...
type ApiCreateNetworkingV1PrivateLinkAccessRequest struct {
	...
	createNetworkingV1PrivateLinkAccessRequest *CreateNetworkingV1PrivateLinkAccessRequest
}

func (r ApiCreateNetworkingV1PrivateLinkAccessRequest) CreateNetworkingV1PrivateLinkAccessRequest(createNetworkingV1PrivateLinkAccessRequest CreateNetworkingV1PrivateLinkAccessRequest) ApiCreateNetworkingV1PrivateLinkAccessRequest {
	r.createNetworkingV1PrivateLinkAccessRequest = &createNetworkingV1PrivateLinkAccessRequest
	return r
}

func (r ApiCreateNetworkingV1PrivateLinkAccessRequest) Execute() (*CreateNetworkingV1PrivateLinkAccess202Response, *http.Response, error) {
...
*/
func (a *PrivateLinkAccessesNetworkingV1ApiService) CreateNetworkingV1PrivateLinkAccess(ctx context.Context) ApiCreateNetworkingV1PrivateLinkAccessRequest {
	return ApiCreateNetworkingV1PrivateLinkAccessRequest{
		ApiService: a,
		ctx: ctx,
	}
...
//  @return CreateNetworkingV1PrivateLinkAccess202Response
func (a *PrivateLinkAccessesNetworkingV1ApiService) CreateNetworkingV1PrivateLinkAccessExecute(r ApiCreateNetworkingV1PrivateLinkAccessRequest) (*CreateNetworkingV1PrivateLinkAccess202Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *CreateNetworkingV1PrivateLinkAccess202Response
	)
	...
	// body params
	localVarPostBody = r.createNetworkingV1PrivateLinkAccessRequest
...
func (r ApiDeleteNetworkingV1PrivateLinkAccessRequest) Execute() (*http.Response, error) {
...
*/
func (a *PrivateLinkAccessesNetworkingV1ApiService) DeleteNetworkingV1PrivateLinkAccess(ctx context.Context, id string) ApiDeleteNetworkingV1PrivateLinkAccessRequest {
	return ApiDeleteNetworkingV1PrivateLinkAccessRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
func (a *PrivateLinkAccessesNetworkingV1ApiService) DeleteNetworkingV1PrivateLinkAccessExecute(r ApiDeleteNetworkingV1PrivateLinkAccessRequest) (*http.Response, error) {
	var (
...
func (r ApiGetNetworkingV1PrivateLinkAccessRequest) Execute() (*GetNetworkingV1PrivateLinkAccess200Response, *http.Response, error) {
...
*/
func (a *PrivateLinkAccessesNetworkingV1ApiService) GetNetworkingV1PrivateLinkAccess(ctx context.Context, id string) ApiGetNetworkingV1PrivateLinkAccessRequest {
	return ApiGetNetworkingV1PrivateLinkAccessRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
//  @return GetNetworkingV1PrivateLinkAccess200Response
func (a *PrivateLinkAccessesNetworkingV1ApiService) GetNetworkingV1PrivateLinkAccessExecute(r ApiGetNetworkingV1PrivateLinkAccessRequest) (*GetNetworkingV1PrivateLinkAccess200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *GetNetworkingV1PrivateLinkAccess200Response
	)
...
func (r ApiListNetworkingV1PrivateLinkAccessesRequest) Execute() (*ListNetworkingV1PrivateLinkAccesses200Response, *http.Response, error) {
...
*/
func (a *PrivateLinkAccessesNetworkingV1ApiService) ListNetworkingV1PrivateLinkAccesses(ctx context.Context) ApiListNetworkingV1PrivateLinkAccessesRequest {
	return ApiListNetworkingV1PrivateLinkAccessesRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return ListNetworkingV1PrivateLinkAccesses200Response
func (a *PrivateLinkAccessesNetworkingV1ApiService) ListNetworkingV1PrivateLinkAccessesExecute(r ApiListNetworkingV1PrivateLinkAccessesRequest) (*ListNetworkingV1PrivateLinkAccesses200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *ListNetworkingV1PrivateLinkAccesses200Response
	)
...
type ApiUpdateNetworkingV1PrivateLinkAccessRequest struct {
	...
	ApiService *PrivateLinkAccessesNetworkingV1ApiService
	id string
	updateNetworkingV1PrivateLinkAccessRequest *UpdateNetworkingV1PrivateLinkAccessRequest
}

func (r ApiUpdateNetworkingV1PrivateLinkAccessRequest) UpdateNetworkingV1PrivateLinkAccessRequest(updateNetworkingV1PrivateLinkAccessRequest UpdateNetworkingV1PrivateLinkAccessRequest) ApiUpdateNetworkingV1PrivateLinkAccessRequest {
	r.updateNetworkingV1PrivateLinkAccessRequest = &updateNetworkingV1PrivateLinkAccessRequest
	return r
}

func (r ApiUpdateNetworkingV1PrivateLinkAccessRequest) Execute() (*GetNetworkingV1PrivateLinkAccess200Response, *http.Response, error) {
...
*/
func (a *PrivateLinkAccessesNetworkingV1ApiService) UpdateNetworkingV1PrivateLinkAccess(ctx context.Context, id string) ApiUpdateNetworkingV1PrivateLinkAccessRequest {
	return ApiUpdateNetworkingV1PrivateLinkAccessRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
//  @return GetNetworkingV1PrivateLinkAccess200Response
func (a *PrivateLinkAccessesNetworkingV1ApiService) UpdateNetworkingV1PrivateLinkAccessExecute(r ApiUpdateNetworkingV1PrivateLinkAccessRequest) (*GetNetworkingV1PrivateLinkAccess200Response, *http.Response, error) {
	var (
	...
	// body params
	localVarPostBody = r.updateNetworkingV1PrivateLinkAccessRequest
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
