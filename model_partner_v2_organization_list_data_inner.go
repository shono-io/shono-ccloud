...
// checks if the PartnerV2OrganizationListDataInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PartnerV2OrganizationListDataInner{}

// PartnerV2OrganizationListDataInner struct for PartnerV2OrganizationListDataInner
type PartnerV2OrganizationListDataInner struct {
...
func NewPartnerV2OrganizationListDataInner(id string, metadata ObjectMeta) *PartnerV2OrganizationListDataInner {
	this := PartnerV2OrganizationListDataInner{}
	this.Id = id
...
func (o PartnerV2OrganizationListDataInner) MarshalJSON() ([]byte, error) {
...
func (o PartnerV2OrganizationListDataInner) ToMap() (map[string]interface{}, error) {
...
type NullablePartnerV2OrganizationListDataInner struct {
	value *PartnerV2OrganizationListDataInner
	isSet bool
}

func (v NullablePartnerV2OrganizationListDataInner) Get() *PartnerV2OrganizationListDataInner {
	return v.value
}

func (v *NullablePartnerV2OrganizationListDataInner) Set(val *PartnerV2OrganizationListDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullablePartnerV2OrganizationListDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullablePartnerV2OrganizationListDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePartnerV2OrganizationListDataInner(val *PartnerV2OrganizationListDataInner) *NullablePartnerV2OrganizationListDataInner {
	return &NullablePartnerV2OrganizationListDataInner{value: val, isSet: true}
}

func (v NullablePartnerV2OrganizationListDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePartnerV2OrganizationListDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
