...
// checks if the ServiceQuotaV1AppliedQuotaListMetadataAllOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ServiceQuotaV1AppliedQuotaListMetadataAllOf{}

// ServiceQuotaV1AppliedQuotaListMetadataAllOf struct for ServiceQuotaV1AppliedQuotaListMetadataAllOf
type ServiceQuotaV1AppliedQuotaListMetadataAllOf struct {
...
func NewServiceQuotaV1AppliedQuotaListMetadataAllOf() *ServiceQuotaV1AppliedQuotaListMetadataAllOf {
	this := ServiceQuotaV1AppliedQuotaListMetadataAllOf{}
	return &this
}
...
func (o ServiceQuotaV1AppliedQuotaListMetadataAllOf) MarshalJSON() ([]byte, error) {
...
func (o ServiceQuotaV1AppliedQuotaListMetadataAllOf) ToMap() (map[string]interface{}, error) {
...
type NullableServiceQuotaV1AppliedQuotaListMetadataAllOf struct {
	value *ServiceQuotaV1AppliedQuotaListMetadataAllOf
	isSet bool
}

func (v NullableServiceQuotaV1AppliedQuotaListMetadataAllOf) Get() *ServiceQuotaV1AppliedQuotaListMetadataAllOf {
	return v.value
}

func (v *NullableServiceQuotaV1AppliedQuotaListMetadataAllOf) Set(val *ServiceQuotaV1AppliedQuotaListMetadataAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableServiceQuotaV1AppliedQuotaListMetadataAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableServiceQuotaV1AppliedQuotaListMetadataAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableServiceQuotaV1AppliedQuotaListMetadataAllOf(val *ServiceQuotaV1AppliedQuotaListMetadataAllOf) *NullableServiceQuotaV1AppliedQuotaListMetadataAllOf {
	return &NullableServiceQuotaV1AppliedQuotaListMetadataAllOf{value: val, isSet: true}
}

func (v NullableServiceQuotaV1AppliedQuotaListMetadataAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableServiceQuotaV1AppliedQuotaListMetadataAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
