...
// checks if the NotificationsV1SubscriptionMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NotificationsV1SubscriptionMetadata{}

// NotificationsV1SubscriptionMetadata struct for NotificationsV1SubscriptionMetadata
type NotificationsV1SubscriptionMetadata struct {
...
func NewNotificationsV1SubscriptionMetadata(self interface{}) *NotificationsV1SubscriptionMetadata {
	this := NotificationsV1SubscriptionMetadata{}
	this.Self = self
	return &this
}
...
func (o NotificationsV1SubscriptionMetadata) MarshalJSON() ([]byte, error) {
...
func (o NotificationsV1SubscriptionMetadata) ToMap() (map[string]interface{}, error) {
...
type NullableNotificationsV1SubscriptionMetadata struct {
	value *NotificationsV1SubscriptionMetadata
	isSet bool
}

func (v NullableNotificationsV1SubscriptionMetadata) Get() *NotificationsV1SubscriptionMetadata {
	return v.value
}

func (v *NullableNotificationsV1SubscriptionMetadata) Set(val *NotificationsV1SubscriptionMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableNotificationsV1SubscriptionMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableNotificationsV1SubscriptionMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNotificationsV1SubscriptionMetadata(val *NotificationsV1SubscriptionMetadata) *NullableNotificationsV1SubscriptionMetadata {
	return &NullableNotificationsV1SubscriptionMetadata{value: val, isSet: true}
}

func (v NullableNotificationsV1SubscriptionMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNotificationsV1SubscriptionMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
