...
// checks if the ConnectV1ConnectorExpansionInfoConfig type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ConnectV1ConnectorExpansionInfoConfig{}
...
type ConnectV1ConnectorExpansionInfoConfig struct {
...
func NewConnectV1ConnectorExpansionInfoConfig(cloudEnvironment string, cloudProvider string, connectorClass string, name string, kafkaEndpoint string, kafkaRegion string, kafkaApiKey string, kafkaApiSecret string) *ConnectV1ConnectorExpansionInfoConfig {
	this := ConnectV1ConnectorExpansionInfoConfig{}
...
func (o ConnectV1ConnectorExpansionInfoConfig) MarshalJSON() ([]byte, error) {
...
func (o ConnectV1ConnectorExpansionInfoConfig) ToMap() (map[string]interface{}, error) {
...
type NullableConnectV1ConnectorExpansionInfoConfig struct {
	value *ConnectV1ConnectorExpansionInfoConfig
	isSet bool
}

func (v NullableConnectV1ConnectorExpansionInfoConfig) Get() *ConnectV1ConnectorExpansionInfoConfig {
	return v.value
}

func (v *NullableConnectV1ConnectorExpansionInfoConfig) Set(val *ConnectV1ConnectorExpansionInfoConfig) {
	v.value = val
	v.isSet = true
}

func (v NullableConnectV1ConnectorExpansionInfoConfig) IsSet() bool {
	return v.isSet
}

func (v *NullableConnectV1ConnectorExpansionInfoConfig) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableConnectV1ConnectorExpansionInfoConfig(val *ConnectV1ConnectorExpansionInfoConfig) *NullableConnectV1ConnectorExpansionInfoConfig {
	return &NullableConnectV1ConnectorExpansionInfoConfig{value: val, isSet: true}
}

func (v NullableConnectV1ConnectorExpansionInfoConfig) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableConnectV1ConnectorExpansionInfoConfig) UnmarshalJSON(src []byte) error {
	v.isSet = true
