...
// checks if the IamV2IdentityPool type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IamV2IdentityPool{}
...
func (o *IamV2IdentityPool) GetIdentityClaim() string {
	if o == nil || IsNil(o.IdentityClaim) {
		var ret string
		return ret
	}
...
func (o IamV2IdentityPool) ToMap() (map[string]interface{}, error) {
