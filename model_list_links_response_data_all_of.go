...
// checks if the ListLinksResponseDataAllOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListLinksResponseDataAllOf{}
...
func (o ListLinksResponseDataAllOf) ToMap() (map[string]interface{}, error) {
