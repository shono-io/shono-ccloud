...
// checks if the CreateNetworkingV1TransitGatewayAttachmentRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateNetworkingV1TransitGatewayAttachmentRequest{}

// CreateNetworkingV1TransitGatewayAttachmentRequest struct for CreateNetworkingV1TransitGatewayAttachmentRequest
type CreateNetworkingV1TransitGatewayAttachmentRequest struct {
...
func NewCreateNetworkingV1TransitGatewayAttachmentRequest(spec CreateNetworkingV1PeeringRequestAllOf1Spec) *CreateNetworkingV1TransitGatewayAttachmentRequest {
	this := CreateNetworkingV1TransitGatewayAttachmentRequest{}
	this.Spec = spec
	return &this
}
...
func (o *CreateNetworkingV1TransitGatewayAttachmentRequest) SetSpec(v CreateNetworkingV1PeeringRequestAllOf1Spec) {
	o.Spec = v
}
...
func (o CreateNetworkingV1TransitGatewayAttachmentRequest) MarshalJSON() ([]byte, error) {
...
func (o CreateNetworkingV1TransitGatewayAttachmentRequest) ToMap() (map[string]interface{}, error) {
...
type NullableCreateNetworkingV1TransitGatewayAttachmentRequest struct {
	value *CreateNetworkingV1TransitGatewayAttachmentRequest
	isSet bool
}

func (v NullableCreateNetworkingV1TransitGatewayAttachmentRequest) Get() *CreateNetworkingV1TransitGatewayAttachmentRequest {
	return v.value
}

func (v *NullableCreateNetworkingV1TransitGatewayAttachmentRequest) Set(val *CreateNetworkingV1TransitGatewayAttachmentRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateNetworkingV1TransitGatewayAttachmentRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateNetworkingV1TransitGatewayAttachmentRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateNetworkingV1TransitGatewayAttachmentRequest(val *CreateNetworkingV1TransitGatewayAttachmentRequest) *NullableCreateNetworkingV1TransitGatewayAttachmentRequest {
	return &NullableCreateNetworkingV1TransitGatewayAttachmentRequest{value: val, isSet: true}
}

func (v NullableCreateNetworkingV1TransitGatewayAttachmentRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateNetworkingV1TransitGatewayAttachmentRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
