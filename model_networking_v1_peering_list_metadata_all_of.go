...
// checks if the NetworkingV1PeeringListMetadataAllOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NetworkingV1PeeringListMetadataAllOf{}

// NetworkingV1PeeringListMetadataAllOf struct for NetworkingV1PeeringListMetadataAllOf
type NetworkingV1PeeringListMetadataAllOf struct {
...
func NewNetworkingV1PeeringListMetadataAllOf() *NetworkingV1PeeringListMetadataAllOf {
	this := NetworkingV1PeeringListMetadataAllOf{}
	return &this
}
...
func (o NetworkingV1PeeringListMetadataAllOf) MarshalJSON() ([]byte, error) {
...
func (o NetworkingV1PeeringListMetadataAllOf) ToMap() (map[string]interface{}, error) {
...
type NullableNetworkingV1PeeringListMetadataAllOf struct {
	value *NetworkingV1PeeringListMetadataAllOf
	isSet bool
}

func (v NullableNetworkingV1PeeringListMetadataAllOf) Get() *NetworkingV1PeeringListMetadataAllOf {
	return v.value
}

func (v *NullableNetworkingV1PeeringListMetadataAllOf) Set(val *NetworkingV1PeeringListMetadataAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableNetworkingV1PeeringListMetadataAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableNetworkingV1PeeringListMetadataAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNetworkingV1PeeringListMetadataAllOf(val *NetworkingV1PeeringListMetadataAllOf) *NullableNetworkingV1PeeringListMetadataAllOf {
	return &NullableNetworkingV1PeeringListMetadataAllOf{value: val, isSet: true}
}

func (v NullableNetworkingV1PeeringListMetadataAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNetworkingV1PeeringListMetadataAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
