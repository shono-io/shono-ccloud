...
// checks if the IamV2Jwks type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IamV2Jwks{}
...
func (o IamV2Jwks) ToMap() (map[string]interface{}, error) {
