...
// checks if the NotificationsV1SubscriptionUpdate type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NotificationsV1SubscriptionUpdate{}
...
func (o NotificationsV1SubscriptionUpdate) ToMap() (map[string]interface{}, error) {
