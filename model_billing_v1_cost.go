...
// checks if the BillingV1Cost type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BillingV1Cost{}
...
func (o BillingV1Cost) ToMap() (map[string]interface{}, error) {
