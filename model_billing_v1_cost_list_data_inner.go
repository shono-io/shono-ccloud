...
// checks if the BillingV1CostListDataInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BillingV1CostListDataInner{}

// BillingV1CostListDataInner struct for BillingV1CostListDataInner
type BillingV1CostListDataInner struct {
	...
	Resource *BillingV1CostResource `json:"resource,omitempty"`
}
...
func NewBillingV1CostListDataInner(id string, startDate string, endDate string, unit string, originalAmount float64) *BillingV1CostListDataInner {
	this := BillingV1CostListDataInner{}
	this.Id = id
...
// SetResource gets a reference to the given BillingV1CostResource and assigns it to the Resource field.
func (o *BillingV1CostListDataInner) SetResource(v BillingV1CostResource) {
	o.Resource = &v
}

func (o BillingV1CostListDataInner) MarshalJSON() ([]byte, error) {
...
func (o BillingV1CostListDataInner) ToMap() (map[string]interface{}, error) {
...
type NullableBillingV1CostListDataInner struct {
	value *BillingV1CostListDataInner
	isSet bool
}

func (v NullableBillingV1CostListDataInner) Get() *BillingV1CostListDataInner {
	return v.value
}

func (v *NullableBillingV1CostListDataInner) Set(val *BillingV1CostListDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableBillingV1CostListDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableBillingV1CostListDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBillingV1CostListDataInner(val *BillingV1CostListDataInner) *NullableBillingV1CostListDataInner {
	return &NullableBillingV1CostListDataInner{value: val, isSet: true}
}

func (v NullableBillingV1CostListDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBillingV1CostListDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
