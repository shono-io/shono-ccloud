...
// checks if the ServiceQuotaV1ScopeMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ServiceQuotaV1ScopeMetadata{}

// ServiceQuotaV1ScopeMetadata struct for ServiceQuotaV1ScopeMetadata
type ServiceQuotaV1ScopeMetadata struct {
...
func NewServiceQuotaV1ScopeMetadata(self interface{}) *ServiceQuotaV1ScopeMetadata {
	this := ServiceQuotaV1ScopeMetadata{}
	this.Self = self
	return &this
}
...
func (o ServiceQuotaV1ScopeMetadata) MarshalJSON() ([]byte, error) {
...
func (o ServiceQuotaV1ScopeMetadata) ToMap() (map[string]interface{}, error) {
...
type NullableServiceQuotaV1ScopeMetadata struct {
	value *ServiceQuotaV1ScopeMetadata
	isSet bool
}

func (v NullableServiceQuotaV1ScopeMetadata) Get() *ServiceQuotaV1ScopeMetadata {
	return v.value
}

func (v *NullableServiceQuotaV1ScopeMetadata) Set(val *ServiceQuotaV1ScopeMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableServiceQuotaV1ScopeMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableServiceQuotaV1ScopeMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableServiceQuotaV1ScopeMetadata(val *ServiceQuotaV1ScopeMetadata) *NullableServiceQuotaV1ScopeMetadata {
	return &NullableServiceQuotaV1ScopeMetadata{value: val, isSet: true}
}

func (v NullableServiceQuotaV1ScopeMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableServiceQuotaV1ScopeMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
