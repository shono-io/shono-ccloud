...
// checks if the ReassignmentData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ReassignmentData{}
...
func (o ReassignmentData) ToMap() (map[string]interface{}, error) {
