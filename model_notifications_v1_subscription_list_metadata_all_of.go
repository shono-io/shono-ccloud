...
// checks if the NotificationsV1SubscriptionListMetadataAllOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NotificationsV1SubscriptionListMetadataAllOf{}

// NotificationsV1SubscriptionListMetadataAllOf struct for NotificationsV1SubscriptionListMetadataAllOf
type NotificationsV1SubscriptionListMetadataAllOf struct {
...
func NewNotificationsV1SubscriptionListMetadataAllOf() *NotificationsV1SubscriptionListMetadataAllOf {
	this := NotificationsV1SubscriptionListMetadataAllOf{}
	return &this
}
...
func (o NotificationsV1SubscriptionListMetadataAllOf) MarshalJSON() ([]byte, error) {
...
func (o NotificationsV1SubscriptionListMetadataAllOf) ToMap() (map[string]interface{}, error) {
...
type NullableNotificationsV1SubscriptionListMetadataAllOf struct {
	value *NotificationsV1SubscriptionListMetadataAllOf
	isSet bool
}

func (v NullableNotificationsV1SubscriptionListMetadataAllOf) Get() *NotificationsV1SubscriptionListMetadataAllOf {
	return v.value
}

func (v *NullableNotificationsV1SubscriptionListMetadataAllOf) Set(val *NotificationsV1SubscriptionListMetadataAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableNotificationsV1SubscriptionListMetadataAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableNotificationsV1SubscriptionListMetadataAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNotificationsV1SubscriptionListMetadataAllOf(val *NotificationsV1SubscriptionListMetadataAllOf) *NullableNotificationsV1SubscriptionListMetadataAllOf {
	return &NullableNotificationsV1SubscriptionListMetadataAllOf{value: val, isSet: true}
}

func (v NullableNotificationsV1SubscriptionListMetadataAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNotificationsV1SubscriptionListMetadataAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
