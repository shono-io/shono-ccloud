...
// checks if the ServiceQuotaV1ScopeListMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ServiceQuotaV1ScopeListMetadata{}

// ServiceQuotaV1ScopeListMetadata struct for ServiceQuotaV1ScopeListMetadata
type ServiceQuotaV1ScopeListMetadata struct {
...
func NewServiceQuotaV1ScopeListMetadata() *ServiceQuotaV1ScopeListMetadata {
	this := ServiceQuotaV1ScopeListMetadata{}
	return &this
}
...
func (o ServiceQuotaV1ScopeListMetadata) MarshalJSON() ([]byte, error) {
...
func (o ServiceQuotaV1ScopeListMetadata) ToMap() (map[string]interface{}, error) {
...
type NullableServiceQuotaV1ScopeListMetadata struct {
	value *ServiceQuotaV1ScopeListMetadata
	isSet bool
}

func (v NullableServiceQuotaV1ScopeListMetadata) Get() *ServiceQuotaV1ScopeListMetadata {
	return v.value
}

func (v *NullableServiceQuotaV1ScopeListMetadata) Set(val *ServiceQuotaV1ScopeListMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableServiceQuotaV1ScopeListMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableServiceQuotaV1ScopeListMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableServiceQuotaV1ScopeListMetadata(val *ServiceQuotaV1ScopeListMetadata) *NullableServiceQuotaV1ScopeListMetadata {
	return &NullableServiceQuotaV1ScopeListMetadata{value: val, isSet: true}
}

func (v NullableServiceQuotaV1ScopeListMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableServiceQuotaV1ScopeListMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
