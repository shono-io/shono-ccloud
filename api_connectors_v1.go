...
type ApiCreateConnectv1ConnectorRequest struct {
	...
	createConnectv1ConnectorRequest *CreateConnectv1ConnectorRequest
}

// 
func (r ApiCreateConnectv1ConnectorRequest) CreateConnectv1ConnectorRequest(createConnectv1ConnectorRequest CreateConnectv1ConnectorRequest) ApiCreateConnectv1ConnectorRequest {
	r.createConnectv1ConnectorRequest = &createConnectv1ConnectorRequest
	return r
}

func (r ApiCreateConnectv1ConnectorRequest) Execute() (*ConnectV1Connector, *http.Response, error) {
...
*/
func (a *ConnectorsV1ApiService) CreateConnectv1Connector(ctx context.Context, environmentId string, kafkaClusterId string) ApiCreateConnectv1ConnectorRequest {
	return ApiCreateConnectv1ConnectorRequest{
		ApiService: a,
		ctx: ctx,
...
func (a *ConnectorsV1ApiService) CreateConnectv1ConnectorExecute(r ApiCreateConnectv1ConnectorRequest) (*ConnectV1Connector, *http.Response, error) {
	var (
	...
	localVarPath = strings.Replace(localVarPath, "{"+"kafka_cluster_id"+"}", url.PathEscape(parameterValueToString(r.kafkaClusterId, "kafkaClusterId")), -1)
	...
	// body params
	localVarPostBody = r.createConnectv1ConnectorRequest
	...
	if localVarHTTPResponse.StatusCode >= 300 {
		...
		if localVarHTTPResponse.StatusCode == 400 {
			var v CreateConnectv1Connector400Response
		...
		if localVarHTTPResponse.StatusCode == 500 {
			var v CreateConnectv1Connector500Response
			err = a.client.decode(&v, localVarBody, localVarHTTPResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHTTPResponse, newErr
...
func (r ApiCreateOrUpdateConnectv1ConnectorConfigRequest) Execute() (*ConnectV1Connector, *http.Response, error) {
...
*/
func (a *ConnectorsV1ApiService) CreateOrUpdateConnectv1ConnectorConfig(ctx context.Context, connectorName string, environmentId string, kafkaClusterId string) ApiCreateOrUpdateConnectv1ConnectorConfigRequest {
	return ApiCreateOrUpdateConnectv1ConnectorConfigRequest{
		ApiService: a,
		ctx: ctx,
...
// Execute executes the request
//  @return ConnectV1Connector
func (a *ConnectorsV1ApiService) CreateOrUpdateConnectv1ConnectorConfigExecute(r ApiCreateOrUpdateConnectv1ConnectorConfigRequest) (*ConnectV1Connector, *http.Response, error) {
	var (
...
func (r ApiDeleteConnectv1ConnectorRequest) Execute() (*DeleteConnectv1Connector200Response, *http.Response, error) {
...
*/
func (a *ConnectorsV1ApiService) DeleteConnectv1Connector(ctx context.Context, connectorName string, environmentId string, kafkaClusterId string) ApiDeleteConnectv1ConnectorRequest {
	return ApiDeleteConnectv1ConnectorRequest{
		ApiService: a,
		ctx: ctx,
		connectorName: connectorName,
...
// Execute executes the request
//  @return DeleteConnectv1Connector200Response
func (a *ConnectorsV1ApiService) DeleteConnectv1ConnectorExecute(r ApiDeleteConnectv1ConnectorRequest) (*DeleteConnectv1Connector200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodDelete
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *DeleteConnectv1Connector200Response
	)
...
func (r ApiGetConnectv1ConnectorConfigRequest) Execute() (*GetConnectv1ConnectorConfig200Response, *http.Response, error) {
...
*/
func (a *ConnectorsV1ApiService) GetConnectv1ConnectorConfig(ctx context.Context, connectorName string, environmentId string, kafkaClusterId string) ApiGetConnectv1ConnectorConfigRequest {
	return ApiGetConnectv1ConnectorConfigRequest{
		ApiService: a,
		ctx: ctx,
		connectorName: connectorName,
...
// Execute executes the request
//  @return GetConnectv1ConnectorConfig200Response
func (a *ConnectorsV1ApiService) GetConnectv1ConnectorConfigExecute(r ApiGetConnectv1ConnectorConfigRequest) (*GetConnectv1ConnectorConfig200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *GetConnectv1ConnectorConfig200Response
	)
...
func (r ApiListConnectv1ConnectorsRequest) Execute() ([]string, *http.Response, error) {
...
*/
func (a *ConnectorsV1ApiService) ListConnectv1Connectors(ctx context.Context, environmentId string, kafkaClusterId string) ApiListConnectv1ConnectorsRequest {
	return ApiListConnectv1ConnectorsRequest{
		ApiService: a,
		ctx: ctx,
		environmentId: environmentId,
...
// Execute executes the request
//  @return []string
func (a *ConnectorsV1ApiService) ListConnectv1ConnectorsExecute(r ApiListConnectv1ConnectorsRequest) ([]string, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r ApiListConnectv1ConnectorsWithExpansionsRequest) Execute() (*map[string]ConnectV1ConnectorExpansion, *http.Response, error) {
...
*/
func (a *ConnectorsV1ApiService) ListConnectv1ConnectorsWithExpansions(ctx context.Context, environmentId string, kafkaClusterId string) ApiListConnectv1ConnectorsWithExpansionsRequest {
	return ApiListConnectv1ConnectorsWithExpansionsRequest{
		ApiService: a,
		ctx: ctx,
		environmentId: environmentId,
...
func (a *ConnectorsV1ApiService) ListConnectv1ConnectorsWithExpansionsExecute(r ApiListConnectv1ConnectorsWithExpansionsRequest) (*map[string]ConnectV1ConnectorExpansion, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r ApiReadConnectv1ConnectorRequest) Execute() (*ConnectV1Connector, *http.Response, error) {
...
*/
func (a *ConnectorsV1ApiService) ReadConnectv1Connector(ctx context.Context, connectorName string, environmentId string, kafkaClusterId string) ApiReadConnectv1ConnectorRequest {
	return ApiReadConnectv1ConnectorRequest{
		ApiService: a,
		ctx: ctx,
		connectorName: connectorName,
...
// Execute executes the request
//  @return ConnectV1Connector
func (a *ConnectorsV1ApiService) ReadConnectv1ConnectorExecute(r ApiReadConnectv1ConnectorRequest) (*ConnectV1Connector, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
