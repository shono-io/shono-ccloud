...
// checks if the SdV1PipelineMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SdV1PipelineMetadata{}

// SdV1PipelineMetadata struct for SdV1PipelineMetadata
type SdV1PipelineMetadata struct {
...
func (o SdV1PipelineMetadata) MarshalJSON() ([]byte, error) {
...
func (o SdV1PipelineMetadata) ToMap() (map[string]interface{}, error) {
...
type NullableSdV1PipelineMetadata struct {
	value *SdV1PipelineMetadata
	isSet bool
}

func (v NullableSdV1PipelineMetadata) Get() *SdV1PipelineMetadata {
	return v.value
}

func (v *NullableSdV1PipelineMetadata) Set(val *SdV1PipelineMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableSdV1PipelineMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableSdV1PipelineMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSdV1PipelineMetadata(val *SdV1PipelineMetadata) *NullableSdV1PipelineMetadata {
	return &NullableSdV1PipelineMetadata{value: val, isSet: true}
}

func (v NullableSdV1PipelineMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSdV1PipelineMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
