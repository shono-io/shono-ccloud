...
func (o *Entity) GetProvenanceType() int32 {
	if o == nil || IsNil(o.ProvenanceType) {
		var ret int32
		return ret
	}
...
func (o *Entity) GetRelationshipAttributes() map[string]map[string]interface{} {
	if o == nil || IsNil(o.RelationshipAttributes) {
		var ret map[string]map[string]interface{}
		return ret
	}
...
func (o *Entity) GetBusinessAttributes() map[string]map[string]map[string]interface{} {
	if o == nil || IsNil(o.BusinessAttributes) {
...
func (o Entity) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.RelationshipAttributes) {
