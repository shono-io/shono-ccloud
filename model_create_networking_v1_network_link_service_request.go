...
// checks if the CreateNetworkingV1NetworkLinkServiceRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateNetworkingV1NetworkLinkServiceRequest{}

// CreateNetworkingV1NetworkLinkServiceRequest struct for CreateNetworkingV1NetworkLinkServiceRequest
type CreateNetworkingV1NetworkLinkServiceRequest struct {
...
func NewCreateNetworkingV1NetworkLinkServiceRequest(spec CreateNetworkingV1PeeringRequestAllOf1Spec) *CreateNetworkingV1NetworkLinkServiceRequest {
	this := CreateNetworkingV1NetworkLinkServiceRequest{}
	this.Spec = spec
	return &this
}
...
func (o CreateNetworkingV1NetworkLinkServiceRequest) MarshalJSON() ([]byte, error) {
...
func (o CreateNetworkingV1NetworkLinkServiceRequest) ToMap() (map[string]interface{}, error) {
...
type NullableCreateNetworkingV1NetworkLinkServiceRequest struct {
	value *CreateNetworkingV1NetworkLinkServiceRequest
	isSet bool
}

func (v NullableCreateNetworkingV1NetworkLinkServiceRequest) Get() *CreateNetworkingV1NetworkLinkServiceRequest {
	return v.value
}

func (v *NullableCreateNetworkingV1NetworkLinkServiceRequest) Set(val *CreateNetworkingV1NetworkLinkServiceRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateNetworkingV1NetworkLinkServiceRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateNetworkingV1NetworkLinkServiceRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateNetworkingV1NetworkLinkServiceRequest(val *CreateNetworkingV1NetworkLinkServiceRequest) *NullableCreateNetworkingV1NetworkLinkServiceRequest {
	return &NullableCreateNetworkingV1NetworkLinkServiceRequest{value: val, isSet: true}
}

func (v NullableCreateNetworkingV1NetworkLinkServiceRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateNetworkingV1NetworkLinkServiceRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
