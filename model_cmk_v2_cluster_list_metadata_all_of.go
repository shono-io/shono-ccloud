...
// checks if the CmkV2ClusterListMetadataAllOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CmkV2ClusterListMetadataAllOf{}

// CmkV2ClusterListMetadataAllOf struct for CmkV2ClusterListMetadataAllOf
type CmkV2ClusterListMetadataAllOf struct {
...
func NewCmkV2ClusterListMetadataAllOf() *CmkV2ClusterListMetadataAllOf {
	this := CmkV2ClusterListMetadataAllOf{}
	return &this
}
...
func (o CmkV2ClusterListMetadataAllOf) MarshalJSON() ([]byte, error) {
...
func (o CmkV2ClusterListMetadataAllOf) ToMap() (map[string]interface{}, error) {
...
type NullableCmkV2ClusterListMetadataAllOf struct {
	value *CmkV2ClusterListMetadataAllOf
	isSet bool
}

func (v NullableCmkV2ClusterListMetadataAllOf) Get() *CmkV2ClusterListMetadataAllOf {
	return v.value
}

func (v *NullableCmkV2ClusterListMetadataAllOf) Set(val *CmkV2ClusterListMetadataAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableCmkV2ClusterListMetadataAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableCmkV2ClusterListMetadataAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCmkV2ClusterListMetadataAllOf(val *CmkV2ClusterListMetadataAllOf) *NullableCmkV2ClusterListMetadataAllOf {
	return &NullableCmkV2ClusterListMetadataAllOf{value: val, isSet: true}
}

func (v NullableCmkV2ClusterListMetadataAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCmkV2ClusterListMetadataAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
