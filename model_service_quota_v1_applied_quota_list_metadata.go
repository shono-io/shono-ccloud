...
// checks if the ServiceQuotaV1AppliedQuotaListMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ServiceQuotaV1AppliedQuotaListMetadata{}

// ServiceQuotaV1AppliedQuotaListMetadata struct for ServiceQuotaV1AppliedQuotaListMetadata
type ServiceQuotaV1AppliedQuotaListMetadata struct {
...
func NewServiceQuotaV1AppliedQuotaListMetadata() *ServiceQuotaV1AppliedQuotaListMetadata {
	this := ServiceQuotaV1AppliedQuotaListMetadata{}
	return &this
}
...
func (o *ServiceQuotaV1AppliedQuotaListMetadata) GetPrev() interface{} {
	if o == nil {
		var ret interface{}
		return ret
	}
...
func (o ServiceQuotaV1AppliedQuotaListMetadata) MarshalJSON() ([]byte, error) {
...
func (o ServiceQuotaV1AppliedQuotaListMetadata) ToMap() (map[string]interface{}, error) {
...
type NullableServiceQuotaV1AppliedQuotaListMetadata struct {
	value *ServiceQuotaV1AppliedQuotaListMetadata
	isSet bool
}

func (v NullableServiceQuotaV1AppliedQuotaListMetadata) Get() *ServiceQuotaV1AppliedQuotaListMetadata {
	return v.value
}

func (v *NullableServiceQuotaV1AppliedQuotaListMetadata) Set(val *ServiceQuotaV1AppliedQuotaListMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableServiceQuotaV1AppliedQuotaListMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableServiceQuotaV1AppliedQuotaListMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableServiceQuotaV1AppliedQuotaListMetadata(val *ServiceQuotaV1AppliedQuotaListMetadata) *NullableServiceQuotaV1AppliedQuotaListMetadata {
	return &NullableServiceQuotaV1AppliedQuotaListMetadata{value: val, isSet: true}
}

func (v NullableServiceQuotaV1AppliedQuotaListMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableServiceQuotaV1AppliedQuotaListMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
