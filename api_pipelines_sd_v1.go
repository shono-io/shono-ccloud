...
type ApiCreateSdV1PipelineRequest struct {
	ctx context.Context
	ApiService *PipelinesSdV1ApiService
	createSdV1PipelineRequest *CreateSdV1PipelineRequest
}

func (r ApiCreateSdV1PipelineRequest) CreateSdV1PipelineRequest(createSdV1PipelineRequest CreateSdV1PipelineRequest) ApiCreateSdV1PipelineRequest {
	r.createSdV1PipelineRequest = &createSdV1PipelineRequest
	return r
}

func (r ApiCreateSdV1PipelineRequest) Execute() (*CreateSdV1Pipeline202Response, *http.Response, error) {
...
*/
func (a *PipelinesSdV1ApiService) CreateSdV1Pipeline(ctx context.Context) ApiCreateSdV1PipelineRequest {
	return ApiCreateSdV1PipelineRequest{
		ApiService: a,
		ctx: ctx,
	}
...
//  @return CreateSdV1Pipeline202Response
func (a *PipelinesSdV1ApiService) CreateSdV1PipelineExecute(r ApiCreateSdV1PipelineRequest) (*CreateSdV1Pipeline202Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *CreateSdV1Pipeline202Response
	)
	...
	// body params
	localVarPostBody = r.createSdV1PipelineRequest
...
func (r ApiDeleteSdV1PipelineRequest) Execute() (*http.Response, error) {
...
*/
func (a *PipelinesSdV1ApiService) DeleteSdV1Pipeline(ctx context.Context, id string) ApiDeleteSdV1PipelineRequest {
	return ApiDeleteSdV1PipelineRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
func (a *PipelinesSdV1ApiService) DeleteSdV1PipelineExecute(r ApiDeleteSdV1PipelineRequest) (*http.Response, error) {
	var (
	...
	parameterAddToHeaderOrQuery(localVarQueryParams, "spec.kafka_cluster", r.specKafkaCluster, "")
	// to determine the Content-Type header
...
func (r ApiGetSdV1PipelineRequest) Execute() (*GetSdV1Pipeline200Response, *http.Response, error) {
...
*/
func (a *PipelinesSdV1ApiService) GetSdV1Pipeline(ctx context.Context, id string) ApiGetSdV1PipelineRequest {
	return ApiGetSdV1PipelineRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
//  @return GetSdV1Pipeline200Response
func (a *PipelinesSdV1ApiService) GetSdV1PipelineExecute(r ApiGetSdV1PipelineRequest) (*GetSdV1Pipeline200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *GetSdV1Pipeline200Response
	)
...
func (r ApiListSdV1PipelinesRequest) Execute() (*ListSdV1Pipelines200Response, *http.Response, error) {
...
*/
func (a *PipelinesSdV1ApiService) ListSdV1Pipelines(ctx context.Context) ApiListSdV1PipelinesRequest {
	return ApiListSdV1PipelinesRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return ListSdV1Pipelines200Response
func (a *PipelinesSdV1ApiService) ListSdV1PipelinesExecute(r ApiListSdV1PipelinesRequest) (*ListSdV1Pipelines200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *ListSdV1Pipelines200Response
	)
...
type ApiUpdateSdV1PipelineRequest struct {
	...
	ApiService *PipelinesSdV1ApiService
	id string
	updateSdV1PipelineRequest *UpdateSdV1PipelineRequest
}

func (r ApiUpdateSdV1PipelineRequest) UpdateSdV1PipelineRequest(updateSdV1PipelineRequest UpdateSdV1PipelineRequest) ApiUpdateSdV1PipelineRequest {
	r.updateSdV1PipelineRequest = &updateSdV1PipelineRequest
	return r
}

func (r ApiUpdateSdV1PipelineRequest) Execute() (*GetSdV1Pipeline200Response, *http.Response, error) {
...
*/
func (a *PipelinesSdV1ApiService) UpdateSdV1Pipeline(ctx context.Context, id string) ApiUpdateSdV1PipelineRequest {
	return ApiUpdateSdV1PipelineRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
//  @return GetSdV1Pipeline200Response
func (a *PipelinesSdV1ApiService) UpdateSdV1PipelineExecute(r ApiUpdateSdV1PipelineRequest) (*GetSdV1Pipeline200Response, *http.Response, error) {
	var (
	...
	// body params
	localVarPostBody = r.updateSdV1PipelineRequest
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
