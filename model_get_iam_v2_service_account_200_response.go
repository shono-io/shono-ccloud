...
// checks if the GetIamV2ServiceAccount200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetIamV2ServiceAccount200Response{}

// GetIamV2ServiceAccount200Response struct for GetIamV2ServiceAccount200Response
type GetIamV2ServiceAccount200Response struct {
	...
	Id string `json:"id"`
	Metadata *IamV2ServiceAccountMetadata `json:"metadata,omitempty"`
...
func NewGetIamV2ServiceAccount200Response(apiVersion string, kind string, id string, displayName string) *GetIamV2ServiceAccount200Response {
	this := GetIamV2ServiceAccount200Response{}
...
func (o *GetIamV2ServiceAccount200Response) GetMetadata() IamV2ServiceAccountMetadata {
	if o == nil || IsNil(o.Metadata) {
		var ret IamV2ServiceAccountMetadata
		return ret
	}
	return *o.Metadata
}
...
// SetMetadata gets a reference to the given IamV2ServiceAccountMetadata and assigns it to the Metadata field.
...
func (o GetIamV2ServiceAccount200Response) MarshalJSON() ([]byte, error) {
...
func (o GetIamV2ServiceAccount200Response) ToMap() (map[string]interface{}, error) {
...
type NullableGetIamV2ServiceAccount200Response struct {
	value *GetIamV2ServiceAccount200Response
	isSet bool
}

func (v NullableGetIamV2ServiceAccount200Response) Get() *GetIamV2ServiceAccount200Response {
	return v.value
}

func (v *NullableGetIamV2ServiceAccount200Response) Set(val *GetIamV2ServiceAccount200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetIamV2ServiceAccount200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetIamV2ServiceAccount200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetIamV2ServiceAccount200Response(val *GetIamV2ServiceAccount200Response) *NullableGetIamV2ServiceAccount200Response {
	return &NullableGetIamV2ServiceAccount200Response{value: val, isSet: true}
}

func (v NullableGetIamV2ServiceAccount200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetIamV2ServiceAccount200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
