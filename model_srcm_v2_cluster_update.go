...
// checks if the SrcmV2ClusterUpdate type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SrcmV2ClusterUpdate{}
...
func (o SrcmV2ClusterUpdate) ToMap() (map[string]interface{}, error) {
