...
// checks if the TopicData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TopicData{}
...
func (o TopicData) ToMap() (map[string]interface{}, error) {
