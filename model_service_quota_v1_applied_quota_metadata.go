...
// checks if the ServiceQuotaV1AppliedQuotaMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ServiceQuotaV1AppliedQuotaMetadata{}

// ServiceQuotaV1AppliedQuotaMetadata struct for ServiceQuotaV1AppliedQuotaMetadata
type ServiceQuotaV1AppliedQuotaMetadata struct {
...
func NewServiceQuotaV1AppliedQuotaMetadata(self interface{}) *ServiceQuotaV1AppliedQuotaMetadata {
	this := ServiceQuotaV1AppliedQuotaMetadata{}
	this.Self = self
	return &this
}
...
func (o ServiceQuotaV1AppliedQuotaMetadata) MarshalJSON() ([]byte, error) {
...
func (o ServiceQuotaV1AppliedQuotaMetadata) ToMap() (map[string]interface{}, error) {
...
type NullableServiceQuotaV1AppliedQuotaMetadata struct {
	value *ServiceQuotaV1AppliedQuotaMetadata
	isSet bool
}

func (v NullableServiceQuotaV1AppliedQuotaMetadata) Get() *ServiceQuotaV1AppliedQuotaMetadata {
	return v.value
}

func (v *NullableServiceQuotaV1AppliedQuotaMetadata) Set(val *ServiceQuotaV1AppliedQuotaMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableServiceQuotaV1AppliedQuotaMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableServiceQuotaV1AppliedQuotaMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableServiceQuotaV1AppliedQuotaMetadata(val *ServiceQuotaV1AppliedQuotaMetadata) *NullableServiceQuotaV1AppliedQuotaMetadata {
	return &NullableServiceQuotaV1AppliedQuotaMetadata{value: val, isSet: true}
}

func (v NullableServiceQuotaV1AppliedQuotaMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableServiceQuotaV1AppliedQuotaMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
