...
type ApiCreateNetworkingV1NetworkLinkEndpointRequest struct {
	ctx context.Context
	ApiService *NetworkLinkEndpointsNetworkingV1ApiService
	createNetworkingV1NetworkLinkEndpointRequest *CreateNetworkingV1NetworkLinkEndpointRequest
}

func (r ApiCreateNetworkingV1NetworkLinkEndpointRequest) CreateNetworkingV1NetworkLinkEndpointRequest(createNetworkingV1NetworkLinkEndpointRequest CreateNetworkingV1NetworkLinkEndpointRequest) ApiCreateNetworkingV1NetworkLinkEndpointRequest {
	r.createNetworkingV1NetworkLinkEndpointRequest = &createNetworkingV1NetworkLinkEndpointRequest
	return r
}

func (r ApiCreateNetworkingV1NetworkLinkEndpointRequest) Execute() (*CreateNetworkingV1NetworkLinkEndpoint202Response, *http.Response, error) {
...
*/
func (a *NetworkLinkEndpointsNetworkingV1ApiService) CreateNetworkingV1NetworkLinkEndpoint(ctx context.Context) ApiCreateNetworkingV1NetworkLinkEndpointRequest {
	return ApiCreateNetworkingV1NetworkLinkEndpointRequest{
		ApiService: a,
		ctx: ctx,
	}
...
//  @return CreateNetworkingV1NetworkLinkEndpoint202Response
func (a *NetworkLinkEndpointsNetworkingV1ApiService) CreateNetworkingV1NetworkLinkEndpointExecute(r ApiCreateNetworkingV1NetworkLinkEndpointRequest) (*CreateNetworkingV1NetworkLinkEndpoint202Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *CreateNetworkingV1NetworkLinkEndpoint202Response
	)
	...
	// body params
	localVarPostBody = r.createNetworkingV1NetworkLinkEndpointRequest
...
func (r ApiDeleteNetworkingV1NetworkLinkEndpointRequest) Execute() (*http.Response, error) {
...
*/
func (a *NetworkLinkEndpointsNetworkingV1ApiService) DeleteNetworkingV1NetworkLinkEndpoint(ctx context.Context, id string) ApiDeleteNetworkingV1NetworkLinkEndpointRequest {
	return ApiDeleteNetworkingV1NetworkLinkEndpointRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
func (a *NetworkLinkEndpointsNetworkingV1ApiService) DeleteNetworkingV1NetworkLinkEndpointExecute(r ApiDeleteNetworkingV1NetworkLinkEndpointRequest) (*http.Response, error) {
	var (
...
func (r ApiGetNetworkingV1NetworkLinkEndpointRequest) Execute() (*GetNetworkingV1NetworkLinkEndpoint200Response, *http.Response, error) {
...
*/
func (a *NetworkLinkEndpointsNetworkingV1ApiService) GetNetworkingV1NetworkLinkEndpoint(ctx context.Context, id string) ApiGetNetworkingV1NetworkLinkEndpointRequest {
	return ApiGetNetworkingV1NetworkLinkEndpointRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
//  @return GetNetworkingV1NetworkLinkEndpoint200Response
func (a *NetworkLinkEndpointsNetworkingV1ApiService) GetNetworkingV1NetworkLinkEndpointExecute(r ApiGetNetworkingV1NetworkLinkEndpointRequest) (*GetNetworkingV1NetworkLinkEndpoint200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *GetNetworkingV1NetworkLinkEndpoint200Response
	)
...
func (r ApiListNetworkingV1NetworkLinkEndpointsRequest) Execute() (*ListNetworkingV1NetworkLinkEndpoints200Response, *http.Response, error) {
...
*/
func (a *NetworkLinkEndpointsNetworkingV1ApiService) ListNetworkingV1NetworkLinkEndpoints(ctx context.Context) ApiListNetworkingV1NetworkLinkEndpointsRequest {
	return ApiListNetworkingV1NetworkLinkEndpointsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return ListNetworkingV1NetworkLinkEndpoints200Response
func (a *NetworkLinkEndpointsNetworkingV1ApiService) ListNetworkingV1NetworkLinkEndpointsExecute(r ApiListNetworkingV1NetworkLinkEndpointsRequest) (*ListNetworkingV1NetworkLinkEndpoints200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *ListNetworkingV1NetworkLinkEndpoints200Response
	)
	...
	if r.specNetworkLinkService != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "spec.network_link_service", s.Index(i), "multi")
			}
		} else {
			parameterAddToHeaderOrQuery(localVarQueryParams, "spec.network_link_service", t, "multi")
		}
	}
	if r.pageSize != nil {
...
type ApiUpdateNetworkingV1NetworkLinkEndpointRequest struct {
	...
	ApiService *NetworkLinkEndpointsNetworkingV1ApiService
	id string
	updateNetworkingV1NetworkLinkEndpointRequest *UpdateNetworkingV1NetworkLinkEndpointRequest
}

func (r ApiUpdateNetworkingV1NetworkLinkEndpointRequest) UpdateNetworkingV1NetworkLinkEndpointRequest(updateNetworkingV1NetworkLinkEndpointRequest UpdateNetworkingV1NetworkLinkEndpointRequest) ApiUpdateNetworkingV1NetworkLinkEndpointRequest {
	r.updateNetworkingV1NetworkLinkEndpointRequest = &updateNetworkingV1NetworkLinkEndpointRequest
	return r
}

func (r ApiUpdateNetworkingV1NetworkLinkEndpointRequest) Execute() (*GetNetworkingV1NetworkLinkEndpoint200Response, *http.Response, error) {
...
*/
func (a *NetworkLinkEndpointsNetworkingV1ApiService) UpdateNetworkingV1NetworkLinkEndpoint(ctx context.Context, id string) ApiUpdateNetworkingV1NetworkLinkEndpointRequest {
	return ApiUpdateNetworkingV1NetworkLinkEndpointRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
//  @return GetNetworkingV1NetworkLinkEndpoint200Response
func (a *NetworkLinkEndpointsNetworkingV1ApiService) UpdateNetworkingV1NetworkLinkEndpointExecute(r ApiUpdateNetworkingV1NetworkLinkEndpointRequest) (*GetNetworkingV1NetworkLinkEndpoint200Response, *http.Response, error) {
	var (
	...
	// body params
	localVarPostBody = r.updateNetworkingV1NetworkLinkEndpointRequest
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
