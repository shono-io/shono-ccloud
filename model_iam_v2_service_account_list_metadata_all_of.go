...
// checks if the IamV2ServiceAccountListMetadataAllOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IamV2ServiceAccountListMetadataAllOf{}

// IamV2ServiceAccountListMetadataAllOf struct for IamV2ServiceAccountListMetadataAllOf
type IamV2ServiceAccountListMetadataAllOf struct {
...
func NewIamV2ServiceAccountListMetadataAllOf() *IamV2ServiceAccountListMetadataAllOf {
	this := IamV2ServiceAccountListMetadataAllOf{}
	return &this
}
...
func (o IamV2ServiceAccountListMetadataAllOf) MarshalJSON() ([]byte, error) {
...
func (o IamV2ServiceAccountListMetadataAllOf) ToMap() (map[string]interface{}, error) {
...
type NullableIamV2ServiceAccountListMetadataAllOf struct {
	value *IamV2ServiceAccountListMetadataAllOf
	isSet bool
}

func (v NullableIamV2ServiceAccountListMetadataAllOf) Get() *IamV2ServiceAccountListMetadataAllOf {
	return v.value
}

func (v *NullableIamV2ServiceAccountListMetadataAllOf) Set(val *IamV2ServiceAccountListMetadataAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableIamV2ServiceAccountListMetadataAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableIamV2ServiceAccountListMetadataAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIamV2ServiceAccountListMetadataAllOf(val *IamV2ServiceAccountListMetadataAllOf) *NullableIamV2ServiceAccountListMetadataAllOf {
	return &NullableIamV2ServiceAccountListMetadataAllOf{value: val, isSet: true}
}

func (v NullableIamV2ServiceAccountListMetadataAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIamV2ServiceAccountListMetadataAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
