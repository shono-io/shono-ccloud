...
// checks if the SrcmV2ClusterListDataInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SrcmV2ClusterListDataInner{}

// SrcmV2ClusterListDataInner struct for SrcmV2ClusterListDataInner
type SrcmV2ClusterListDataInner struct {
	...
	Id string `json:"id"`
	Metadata SrcmV2ClusterMetadata `json:"metadata"`
...
func NewSrcmV2ClusterListDataInner(id string, metadata SrcmV2ClusterMetadata, spec map[string]interface{}, status SrcmV2ClusterStatus) *SrcmV2ClusterListDataInner {
	this := SrcmV2ClusterListDataInner{}
	this.Id = id
...
func (o SrcmV2ClusterListDataInner) MarshalJSON() ([]byte, error) {
...
func (o SrcmV2ClusterListDataInner) ToMap() (map[string]interface{}, error) {
...
type NullableSrcmV2ClusterListDataInner struct {
	value *SrcmV2ClusterListDataInner
	isSet bool
}

func (v NullableSrcmV2ClusterListDataInner) Get() *SrcmV2ClusterListDataInner {
	return v.value
}

func (v *NullableSrcmV2ClusterListDataInner) Set(val *SrcmV2ClusterListDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableSrcmV2ClusterListDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableSrcmV2ClusterListDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSrcmV2ClusterListDataInner(val *SrcmV2ClusterListDataInner) *NullableSrcmV2ClusterListDataInner {
	return &NullableSrcmV2ClusterListDataInner{value: val, isSet: true}
}

func (v NullableSrcmV2ClusterListDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSrcmV2ClusterListDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
