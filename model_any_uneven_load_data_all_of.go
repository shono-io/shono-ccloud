...
// checks if the AnyUnevenLoadDataAllOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AnyUnevenLoadDataAllOf{}
...
func (o AnyUnevenLoadDataAllOf) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["cluster_id"] = o.ClusterId
	toSerialize["status"] = o.Status
	toSerialize["previous_status"] = o.PreviousStatus
	// skip: status_updated_at is readOnly
	// skip: previous_status_updated_at is readOnly
