...
// checks if the ListLinksResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListLinksResponseData{}
...
func NewListLinksResponseData(kind string, metadata ResourceMetadata, linkName string, clusterLinkId string) *ListLinksResponseData {
...
func (o *ListLinksResponseData) GetSourceClusterId() string {
	if o == nil || IsNil(o.SourceClusterId.Get()) {
		var ret string
		return ret
	}
...
func (o *ListLinksResponseData) GetDestinationClusterId() string {
	if o == nil || IsNil(o.DestinationClusterId.Get()) {
		var ret string
		return ret
	}
...
func (o *ListLinksResponseData) GetLinkErrorMessage() string {
	if o == nil || IsNil(o.LinkErrorMessage.Get()) {
		var ret string
		return ret
	}
...
func (o ListLinksResponseData) ToMap() (map[string]interface{}, error) {
