...
// checks if the NetworkingV1AzureNetwork type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NetworkingV1AzureNetwork{}
...
func (o *NetworkingV1AzureNetwork) GetPrivateLinkServiceAliases() map[string]string {
	if o == nil || IsNil(o.PrivateLinkServiceAliases) {
...
func (o *NetworkingV1AzureNetwork) GetPrivateLinkServiceResourceIds() map[string]string {
	if o == nil || IsNil(o.PrivateLinkServiceResourceIds) {
		var ret map[string]string
		return ret
	}
...
func (o NetworkingV1AzureNetwork) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["kind"] = o.Kind
	// skip: vnet is readOnly
	// skip: subscription is readOnly
	// skip: private_link_service_aliases is readOnly
	// skip: private_link_service_resource_ids is readOnly
