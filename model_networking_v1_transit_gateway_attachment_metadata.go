...
// checks if the NetworkingV1TransitGatewayAttachmentMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NetworkingV1TransitGatewayAttachmentMetadata{}

// NetworkingV1TransitGatewayAttachmentMetadata struct for NetworkingV1TransitGatewayAttachmentMetadata
type NetworkingV1TransitGatewayAttachmentMetadata struct {
...
func NewNetworkingV1TransitGatewayAttachmentMetadata(self interface{}) *NetworkingV1TransitGatewayAttachmentMetadata {
	this := NetworkingV1TransitGatewayAttachmentMetadata{}
	this.Self = self
	return &this
}
...
func (o NetworkingV1TransitGatewayAttachmentMetadata) MarshalJSON() ([]byte, error) {
...
func (o NetworkingV1TransitGatewayAttachmentMetadata) ToMap() (map[string]interface{}, error) {
...
type NullableNetworkingV1TransitGatewayAttachmentMetadata struct {
	value *NetworkingV1TransitGatewayAttachmentMetadata
	isSet bool
}

func (v NullableNetworkingV1TransitGatewayAttachmentMetadata) Get() *NetworkingV1TransitGatewayAttachmentMetadata {
	return v.value
}

func (v *NullableNetworkingV1TransitGatewayAttachmentMetadata) Set(val *NetworkingV1TransitGatewayAttachmentMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableNetworkingV1TransitGatewayAttachmentMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableNetworkingV1TransitGatewayAttachmentMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNetworkingV1TransitGatewayAttachmentMetadata(val *NetworkingV1TransitGatewayAttachmentMetadata) *NullableNetworkingV1TransitGatewayAttachmentMetadata {
	return &NullableNetworkingV1TransitGatewayAttachmentMetadata{value: val, isSet: true}
}

func (v NullableNetworkingV1TransitGatewayAttachmentMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNetworkingV1TransitGatewayAttachmentMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
