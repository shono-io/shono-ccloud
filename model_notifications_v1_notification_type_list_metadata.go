...
// checks if the NotificationsV1NotificationTypeListMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NotificationsV1NotificationTypeListMetadata{}

// NotificationsV1NotificationTypeListMetadata struct for NotificationsV1NotificationTypeListMetadata
type NotificationsV1NotificationTypeListMetadata struct {
...
func NewNotificationsV1NotificationTypeListMetadata() *NotificationsV1NotificationTypeListMetadata {
	this := NotificationsV1NotificationTypeListMetadata{}
	return &this
}
...
func (o *NotificationsV1NotificationTypeListMetadata) SetFirst(v interface{}) {
	o.First = v
}
...
func (o *NotificationsV1NotificationTypeListMetadata) GetPrev() interface{} {
	if o == nil {
		var ret interface{}
		return ret
	}
...
func (o NotificationsV1NotificationTypeListMetadata) MarshalJSON() ([]byte, error) {
...
func (o NotificationsV1NotificationTypeListMetadata) ToMap() (map[string]interface{}, error) {
...
type NullableNotificationsV1NotificationTypeListMetadata struct {
	value *NotificationsV1NotificationTypeListMetadata
	isSet bool
}

func (v NullableNotificationsV1NotificationTypeListMetadata) Get() *NotificationsV1NotificationTypeListMetadata {
	return v.value
}

func (v *NullableNotificationsV1NotificationTypeListMetadata) Set(val *NotificationsV1NotificationTypeListMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableNotificationsV1NotificationTypeListMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableNotificationsV1NotificationTypeListMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNotificationsV1NotificationTypeListMetadata(val *NotificationsV1NotificationTypeListMetadata) *NullableNotificationsV1NotificationTypeListMetadata {
	return &NullableNotificationsV1NotificationTypeListMetadata{value: val, isSet: true}
}

func (v NullableNotificationsV1NotificationTypeListMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNotificationsV1NotificationTypeListMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
