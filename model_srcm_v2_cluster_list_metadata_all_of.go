...
// checks if the SrcmV2ClusterListMetadataAllOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SrcmV2ClusterListMetadataAllOf{}

// SrcmV2ClusterListMetadataAllOf struct for SrcmV2ClusterListMetadataAllOf
type SrcmV2ClusterListMetadataAllOf struct {
...
func NewSrcmV2ClusterListMetadataAllOf() *SrcmV2ClusterListMetadataAllOf {
	this := SrcmV2ClusterListMetadataAllOf{}
	return &this
}
...
func (o SrcmV2ClusterListMetadataAllOf) MarshalJSON() ([]byte, error) {
...
func (o SrcmV2ClusterListMetadataAllOf) ToMap() (map[string]interface{}, error) {
...
type NullableSrcmV2ClusterListMetadataAllOf struct {
	value *SrcmV2ClusterListMetadataAllOf
	isSet bool
}

func (v NullableSrcmV2ClusterListMetadataAllOf) Get() *SrcmV2ClusterListMetadataAllOf {
	return v.value
}

func (v *NullableSrcmV2ClusterListMetadataAllOf) Set(val *SrcmV2ClusterListMetadataAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableSrcmV2ClusterListMetadataAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableSrcmV2ClusterListMetadataAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSrcmV2ClusterListMetadataAllOf(val *SrcmV2ClusterListMetadataAllOf) *NullableSrcmV2ClusterListMetadataAllOf {
	return &NullableSrcmV2ClusterListMetadataAllOf{value: val, isSet: true}
}

func (v NullableSrcmV2ClusterListMetadataAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSrcmV2ClusterListMetadataAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
