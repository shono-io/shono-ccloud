...
// checks if the SrcmV2Cluster type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SrcmV2Cluster{}
...
func (o SrcmV2Cluster) ToMap() (map[string]interface{}, error) {
