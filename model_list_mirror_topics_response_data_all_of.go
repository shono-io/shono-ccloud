...
// checks if the ListMirrorTopicsResponseDataAllOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListMirrorTopicsResponseDataAllOf{}
...
func (o ListMirrorTopicsResponseDataAllOf) ToMap() (map[string]interface{}, error) {
