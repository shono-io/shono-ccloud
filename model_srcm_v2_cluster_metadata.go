...
// checks if the SrcmV2ClusterMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SrcmV2ClusterMetadata{}

// SrcmV2ClusterMetadata struct for SrcmV2ClusterMetadata
type SrcmV2ClusterMetadata struct {
...
func (o SrcmV2ClusterMetadata) MarshalJSON() ([]byte, error) {
...
func (o SrcmV2ClusterMetadata) ToMap() (map[string]interface{}, error) {
...
type NullableSrcmV2ClusterMetadata struct {
	value *SrcmV2ClusterMetadata
	isSet bool
}

func (v NullableSrcmV2ClusterMetadata) Get() *SrcmV2ClusterMetadata {
	return v.value
}

func (v *NullableSrcmV2ClusterMetadata) Set(val *SrcmV2ClusterMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableSrcmV2ClusterMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableSrcmV2ClusterMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSrcmV2ClusterMetadata(val *SrcmV2ClusterMetadata) *NullableSrcmV2ClusterMetadata {
	return &NullableSrcmV2ClusterMetadata{value: val, isSet: true}
}

func (v NullableSrcmV2ClusterMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSrcmV2ClusterMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
