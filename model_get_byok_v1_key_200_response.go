...
// checks if the GetByokV1Key200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetByokV1Key200Response{}

// GetByokV1Key200Response struct for GetByokV1Key200Response
type GetByokV1Key200Response struct {
	...
	Id string `json:"id"`
	Metadata *ByokV1KeyMetadata `json:"metadata,omitempty"`
	Key ByokV1KeyKey `json:"key"`
...
// SetMetadata gets a reference to the given ByokV1KeyMetadata and assigns it to the Metadata field.
...
func (o GetByokV1Key200Response) MarshalJSON() ([]byte, error) {
...
func (o GetByokV1Key200Response) ToMap() (map[string]interface{}, error) {
	...
	// skip: provider is readOnly
	// skip: state is readOnly
	return toSerialize, nil
}

type NullableGetByokV1Key200Response struct {
	value *GetByokV1Key200Response
	isSet bool
}

func (v NullableGetByokV1Key200Response) Get() *GetByokV1Key200Response {
	return v.value
}

func (v *NullableGetByokV1Key200Response) Set(val *GetByokV1Key200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetByokV1Key200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetByokV1Key200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetByokV1Key200Response(val *GetByokV1Key200Response) *NullableGetByokV1Key200Response {
	return &NullableGetByokV1Key200Response{value: val, isSet: true}
}

func (v NullableGetByokV1Key200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetByokV1Key200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
