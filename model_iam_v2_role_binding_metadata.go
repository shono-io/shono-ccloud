...
// checks if the IamV2RoleBindingMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IamV2RoleBindingMetadata{}

// IamV2RoleBindingMetadata struct for IamV2RoleBindingMetadata
type IamV2RoleBindingMetadata struct {
...
func (o IamV2RoleBindingMetadata) MarshalJSON() ([]byte, error) {
...
func (o IamV2RoleBindingMetadata) ToMap() (map[string]interface{}, error) {
...
type NullableIamV2RoleBindingMetadata struct {
	value *IamV2RoleBindingMetadata
	isSet bool
}

func (v NullableIamV2RoleBindingMetadata) Get() *IamV2RoleBindingMetadata {
	return v.value
}

func (v *NullableIamV2RoleBindingMetadata) Set(val *IamV2RoleBindingMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableIamV2RoleBindingMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableIamV2RoleBindingMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIamV2RoleBindingMetadata(val *IamV2RoleBindingMetadata) *NullableIamV2RoleBindingMetadata {
	return &NullableIamV2RoleBindingMetadata{value: val, isSet: true}
}

func (v NullableIamV2RoleBindingMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIamV2RoleBindingMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
