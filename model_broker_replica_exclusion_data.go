...
// checks if the BrokerReplicaExclusionData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BrokerReplicaExclusionData{}
...
func (o BrokerReplicaExclusionData) ToMap() (map[string]interface{}, error) {
