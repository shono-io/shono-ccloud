...
func NotificationsV1MsTeamsTargetAsNotificationsV1Target(v *NotificationsV1MsTeamsTarget) NotificationsV1Target {
	return NotificationsV1Target{
		NotificationsV1MsTeamsTarget: v,
	}
}
...
func NotificationsV1RoleEmailTargetAsNotificationsV1Target(v *NotificationsV1RoleEmailTarget) NotificationsV1Target {
	return NotificationsV1Target{
		NotificationsV1RoleEmailTarget: v,
	}
}
...
func NotificationsV1UserEmailTargetAsNotificationsV1Target(v *NotificationsV1UserEmailTarget) NotificationsV1Target {
	return NotificationsV1Target{
		NotificationsV1UserEmailTarget: v,
	}
}
...
func NotificationsV1WebhookTargetAsNotificationsV1Target(v *NotificationsV1WebhookTarget) NotificationsV1Target {
	return NotificationsV1Target{
		NotificationsV1WebhookTarget: v,
	}
}
...
func (dst *NotificationsV1Target) UnmarshalJSON(data []byte) error {
	var err error
	match := 0
	// try to unmarshal data into NotificationsV1MsTeamsTarget
	err = newStrictDecoder(data).Decode(&dst.NotificationsV1MsTeamsTarget)
	if err == nil {
		jsonNotificationsV1MsTeamsTarget, _ := json.Marshal(dst.NotificationsV1MsTeamsTarget)
		if string(jsonNotificationsV1MsTeamsTarget) == "{}" { // empty struct
	...
	// try to unmarshal data into NotificationsV1RoleEmailTarget
	err = newStrictDecoder(data).Decode(&dst.NotificationsV1RoleEmailTarget)
	if err == nil {
		jsonNotificationsV1RoleEmailTarget, _ := json.Marshal(dst.NotificationsV1RoleEmailTarget)
		if string(jsonNotificationsV1RoleEmailTarget) == "{}" { // empty struct
	...
	// try to unmarshal data into NotificationsV1SlackTarget
	err = newStrictDecoder(data).Decode(&dst.NotificationsV1SlackTarget)
	if err == nil {
		jsonNotificationsV1SlackTarget, _ := json.Marshal(dst.NotificationsV1SlackTarget)
		if string(jsonNotificationsV1SlackTarget) == "{}" { // empty struct
	...
	// try to unmarshal data into NotificationsV1UserEmailTarget
	err = newStrictDecoder(data).Decode(&dst.NotificationsV1UserEmailTarget)
	if err == nil {
		jsonNotificationsV1UserEmailTarget, _ := json.Marshal(dst.NotificationsV1UserEmailTarget)
		if string(jsonNotificationsV1UserEmailTarget) == "{}" { // empty struct
	...
	// try to unmarshal data into NotificationsV1WebhookTarget
	err = newStrictDecoder(data).Decode(&dst.NotificationsV1WebhookTarget)
	if err == nil {
		jsonNotificationsV1WebhookTarget, _ := json.Marshal(dst.NotificationsV1WebhookTarget)
		if string(jsonNotificationsV1WebhookTarget) == "{}" { // empty struct
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("data matches more than one schema in oneOf(NotificationsV1Target)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return fmt.Errorf("data failed to match schemas in oneOf(NotificationsV1Target)")
	}
}
...
func (src NotificationsV1Target) MarshalJSON() ([]byte, error) {
	if src.NotificationsV1MsTeamsTarget != nil {
		return json.Marshal(&src.NotificationsV1MsTeamsTarget)
	}

	if src.NotificationsV1RoleEmailTarget != nil {
		return json.Marshal(&src.NotificationsV1RoleEmailTarget)
	}

	if src.NotificationsV1SlackTarget != nil {
		return json.Marshal(&src.NotificationsV1SlackTarget)
	}

	if src.NotificationsV1UserEmailTarget != nil {
		return json.Marshal(&src.NotificationsV1UserEmailTarget)
	}

	if src.NotificationsV1WebhookTarget != nil {
		return json.Marshal(&src.NotificationsV1WebhookTarget)
	}
