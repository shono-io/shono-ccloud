...
// checks if the CreateTopicRequestData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateTopicRequestData{}
...
func (o CreateTopicRequestData) ToMap() (map[string]interface{}, error) {
