...
// checks if the ListMirrorTopicsResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListMirrorTopicsResponseData{}
...
// and a boolean to check if the value has been set.
func (o *ListMirrorTopicsResponseData) GetMirrorLagsOk() ([]MirrorLag, bool) {
	if o == nil {
		return nil, false
	}
...
func (o ListMirrorTopicsResponseData) ToMap() (map[string]interface{}, error) {
