...
// checks if the ConsumerLagDataAllOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ConsumerLagDataAllOf{}
...
func (o ConsumerLagDataAllOf) ToMap() (map[string]interface{}, error) {
