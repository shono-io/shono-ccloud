...
// checks if the NetworkingV1NetworkLinkServiceAssociationSpec type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NetworkingV1NetworkLinkServiceAssociationSpec{}
...
func (o *NetworkingV1NetworkLinkServiceAssociationSpec) GetNetworkLinkEndpoint() string {
	if o == nil || IsNil(o.NetworkLinkEndpoint) {
		var ret string
		return ret
	}
...
func (o NetworkingV1NetworkLinkServiceAssociationSpec) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	// skip: display_name is readOnly
	// skip: description is readOnly
	// skip: network_link_endpoint is readOnly
