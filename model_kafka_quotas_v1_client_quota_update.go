...
// checks if the KafkaQuotasV1ClientQuotaUpdate type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &KafkaQuotasV1ClientQuotaUpdate{}
...
func (o KafkaQuotasV1ClientQuotaUpdate) ToMap() (map[string]interface{}, error) {
