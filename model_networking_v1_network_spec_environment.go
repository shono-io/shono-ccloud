...
// checks if the NetworkingV1NetworkSpecEnvironment type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NetworkingV1NetworkSpecEnvironment{}

// NetworkingV1NetworkSpecEnvironment The environment to which this belongs.
type NetworkingV1NetworkSpecEnvironment struct {
...
func NewNetworkingV1NetworkSpecEnvironment(id string, related string, resourceName string) *NetworkingV1NetworkSpecEnvironment {
	this := NetworkingV1NetworkSpecEnvironment{}
	this.Id = id
...
func (o NetworkingV1NetworkSpecEnvironment) MarshalJSON() ([]byte, error) {
...
func (o NetworkingV1NetworkSpecEnvironment) ToMap() (map[string]interface{}, error) {
...
type NullableNetworkingV1NetworkSpecEnvironment struct {
	value *NetworkingV1NetworkSpecEnvironment
	isSet bool
}

func (v NullableNetworkingV1NetworkSpecEnvironment) Get() *NetworkingV1NetworkSpecEnvironment {
	return v.value
}

func (v *NullableNetworkingV1NetworkSpecEnvironment) Set(val *NetworkingV1NetworkSpecEnvironment) {
	v.value = val
	v.isSet = true
}

func (v NullableNetworkingV1NetworkSpecEnvironment) IsSet() bool {
	return v.isSet
}

func (v *NullableNetworkingV1NetworkSpecEnvironment) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNetworkingV1NetworkSpecEnvironment(val *NetworkingV1NetworkSpecEnvironment) *NullableNetworkingV1NetworkSpecEnvironment {
	return &NullableNetworkingV1NetworkSpecEnvironment{value: val, isSet: true}
}

func (v NullableNetworkingV1NetworkSpecEnvironment) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNetworkingV1NetworkSpecEnvironment) UnmarshalJSON(src []byte) error {
	v.isSet = true
