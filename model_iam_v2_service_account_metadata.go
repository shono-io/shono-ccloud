...
// checks if the IamV2ServiceAccountMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IamV2ServiceAccountMetadata{}

// IamV2ServiceAccountMetadata struct for IamV2ServiceAccountMetadata
type IamV2ServiceAccountMetadata struct {
...
func NewIamV2ServiceAccountMetadata(self interface{}) *IamV2ServiceAccountMetadata {
	this := IamV2ServiceAccountMetadata{}
	this.Self = self
	return &this
}
...
func (o IamV2ServiceAccountMetadata) MarshalJSON() ([]byte, error) {
...
func (o IamV2ServiceAccountMetadata) ToMap() (map[string]interface{}, error) {
...
type NullableIamV2ServiceAccountMetadata struct {
	value *IamV2ServiceAccountMetadata
	isSet bool
}

func (v NullableIamV2ServiceAccountMetadata) Get() *IamV2ServiceAccountMetadata {
	return v.value
}

func (v *NullableIamV2ServiceAccountMetadata) Set(val *IamV2ServiceAccountMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableIamV2ServiceAccountMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableIamV2ServiceAccountMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIamV2ServiceAccountMetadata(val *IamV2ServiceAccountMetadata) *NullableIamV2ServiceAccountMetadata {
	return &NullableIamV2ServiceAccountMetadata{value: val, isSet: true}
}

func (v NullableIamV2ServiceAccountMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIamV2ServiceAccountMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
