...
// checks if the NetworkingV1NetworkLinkEndpointSpec type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NetworkingV1NetworkLinkEndpointSpec{}
...
type NetworkingV1NetworkLinkEndpointSpec struct {
	...
	Environment *SrcmV2ClusterSpecEnvironment `json:"environment,omitempty"`
	Network *NetworkingV1NetworkLinkServiceSpecNetwork `json:"network,omitempty"`
	NetworkLinkService *NetworkingV1NetworkLinkEndpointSpecNetworkLinkService `json:"network_link_service,omitempty"`
}
...
func (o *NetworkingV1NetworkLinkEndpointSpec) GetEnvironment() SrcmV2ClusterSpecEnvironment {
	if o == nil || IsNil(o.Environment) {
		var ret SrcmV2ClusterSpecEnvironment
		return ret
	}
...
// SetEnvironment gets a reference to the given SrcmV2ClusterSpecEnvironment and assigns it to the Environment field.
...
func (o *NetworkingV1NetworkLinkEndpointSpec) GetNetwork() NetworkingV1NetworkLinkServiceSpecNetwork {
	if o == nil || IsNil(o.Network) {
		var ret NetworkingV1NetworkLinkServiceSpecNetwork
		return ret
	}
	return *o.Network
}
...
// SetNetwork gets a reference to the given NetworkingV1NetworkLinkServiceSpecNetwork and assigns it to the Network field.
...
func (o *NetworkingV1NetworkLinkEndpointSpec) GetNetworkLinkService() NetworkingV1NetworkLinkEndpointSpecNetworkLinkService {
	if o == nil || IsNil(o.NetworkLinkService) {
		var ret NetworkingV1NetworkLinkEndpointSpecNetworkLinkService
		return ret
	}
...
// SetNetworkLinkService gets a reference to the given NetworkingV1NetworkLinkEndpointSpecNetworkLinkService and assigns it to the NetworkLinkService field.
...
func (o NetworkingV1NetworkLinkEndpointSpec) ToMap() (map[string]interface{}, error) {
