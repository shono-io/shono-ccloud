...
// checks if the NetworkingV1NetworkLinkEndpointUpdate type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NetworkingV1NetworkLinkEndpointUpdate{}
...
func (o NetworkingV1NetworkLinkEndpointUpdate) ToMap() (map[string]interface{}, error) {
