...
// checks if the CreateIamV2RoleBindingRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateIamV2RoleBindingRequest{}

// CreateIamV2RoleBindingRequest struct for CreateIamV2RoleBindingRequest
type CreateIamV2RoleBindingRequest struct {
...
func NewCreateIamV2RoleBindingRequest(principal string, roleName string, crnPattern string) *CreateIamV2RoleBindingRequest {
	this := CreateIamV2RoleBindingRequest{}
...
func (o CreateIamV2RoleBindingRequest) MarshalJSON() ([]byte, error) {
...
func (o CreateIamV2RoleBindingRequest) ToMap() (map[string]interface{}, error) {
...
type NullableCreateIamV2RoleBindingRequest struct {
	value *CreateIamV2RoleBindingRequest
	isSet bool
}

func (v NullableCreateIamV2RoleBindingRequest) Get() *CreateIamV2RoleBindingRequest {
	return v.value
}

func (v *NullableCreateIamV2RoleBindingRequest) Set(val *CreateIamV2RoleBindingRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateIamV2RoleBindingRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateIamV2RoleBindingRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateIamV2RoleBindingRequest(val *CreateIamV2RoleBindingRequest) *NullableCreateIamV2RoleBindingRequest {
	return &NullableCreateIamV2RoleBindingRequest{value: val, isSet: true}
}

func (v NullableCreateIamV2RoleBindingRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateIamV2RoleBindingRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
