...
// checks if the IamV2IdentityProviderUpdate type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IamV2IdentityProviderUpdate{}
...
// and a boolean to check if the value has been set.
func (o *IamV2IdentityProviderUpdate) GetKeysOk() ([]IamV2JwksObject, bool) {
	if o == nil || IsNil(o.Keys) {
		return nil, false
	}
	return o.Keys, true
...
func (o IamV2IdentityProviderUpdate) ToMap() (map[string]interface{}, error) {
