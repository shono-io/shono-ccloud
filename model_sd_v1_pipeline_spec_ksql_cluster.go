...
// checks if the SdV1PipelineSpecKsqlCluster type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SdV1PipelineSpecKsqlCluster{}

// SdV1PipelineSpecKsqlCluster The ksql_cluster associated with this object.
type SdV1PipelineSpecKsqlCluster struct {
...
func NewSdV1PipelineSpecKsqlCluster(id string, related string, resourceName string) *SdV1PipelineSpecKsqlCluster {
	this := SdV1PipelineSpecKsqlCluster{}
	this.Id = id
...
func (o SdV1PipelineSpecKsqlCluster) MarshalJSON() ([]byte, error) {
...
func (o SdV1PipelineSpecKsqlCluster) ToMap() (map[string]interface{}, error) {
...
type NullableSdV1PipelineSpecKsqlCluster struct {
	value *SdV1PipelineSpecKsqlCluster
	isSet bool
}

func (v NullableSdV1PipelineSpecKsqlCluster) Get() *SdV1PipelineSpecKsqlCluster {
	return v.value
}

func (v *NullableSdV1PipelineSpecKsqlCluster) Set(val *SdV1PipelineSpecKsqlCluster) {
	v.value = val
	v.isSet = true
}

func (v NullableSdV1PipelineSpecKsqlCluster) IsSet() bool {
	return v.isSet
}

func (v *NullableSdV1PipelineSpecKsqlCluster) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSdV1PipelineSpecKsqlCluster(val *SdV1PipelineSpecKsqlCluster) *NullableSdV1PipelineSpecKsqlCluster {
	return &NullableSdV1PipelineSpecKsqlCluster{value: val, isSet: true}
}

func (v NullableSdV1PipelineSpecKsqlCluster) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSdV1PipelineSpecKsqlCluster) UnmarshalJSON(src []byte) error {
	v.isSet = true
