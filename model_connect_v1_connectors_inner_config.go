...
// checks if the ConnectV1ConnectorsInnerConfig type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ConnectV1ConnectorsInnerConfig{}

// ConnectV1ConnectorsInnerConfig Configuration parameters for the connector. These configurations are the minimum set of key-value pairs (KVP) which can be used to define how the connector connects Kafka to the external system. Some of these KVPs are common to all the connectors, such as connection parameters to Kafka, connector metadata, etc. The list of common connector configurations is as follows    - cloud.environment   - cloud.provider   - connector.class   - kafka.api.key   - kafka.api.secret   - kafka.endpoint   - kafka.region   - name  A specific connector such as `GcsSink` would have additional parameters such as `gcs.bucket.name`, `flush.size`, etc.
type ConnectV1ConnectorsInnerConfig struct {
...
func NewConnectV1ConnectorsInnerConfig(cloudEnvironment string, cloudProvider string, connectorClass string, name string, kafkaEndpoint string, kafkaRegion string, kafkaApiKey string, kafkaApiSecret string) *ConnectV1ConnectorsInnerConfig {
	this := ConnectV1ConnectorsInnerConfig{}
	this.CloudEnvironment = cloudEnvironment
	this.CloudProvider = cloudProvider
	this.ConnectorClass = connectorClass
	this.Name = name
	this.KafkaEndpoint = kafkaEndpoint
	this.KafkaRegion = kafkaRegion
...
// GetCloudEnvironment returns the CloudEnvironment field value
func (o *ConnectV1ConnectorsInnerConfig) GetCloudEnvironment() string {
	...
	return o.CloudEnvironment
}

// GetCloudEnvironmentOk returns a tuple with the CloudEnvironment field value
// and a boolean to check if the value has been set.
func (o *ConnectV1ConnectorsInnerConfig) GetCloudEnvironmentOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.CloudEnvironment, true
}

// SetCloudEnvironment sets field value
func (o *ConnectV1ConnectorsInnerConfig) SetCloudEnvironment(v string) {
	o.CloudEnvironment = v
}
...
// GetKafkaEndpoint returns the KafkaEndpoint field value
func (o *ConnectV1ConnectorsInnerConfig) GetKafkaEndpoint() string {
	...
	return o.KafkaEndpoint
}

// GetKafkaEndpointOk returns a tuple with the KafkaEndpoint field value
// and a boolean to check if the value has been set.
func (o *ConnectV1ConnectorsInnerConfig) GetKafkaEndpointOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.KafkaEndpoint, true
}

// SetKafkaEndpoint sets field value
func (o *ConnectV1ConnectorsInnerConfig) SetKafkaEndpoint(v string) {
	o.KafkaEndpoint = v
}

// GetKafkaRegion returns the KafkaRegion field value
func (o *ConnectV1ConnectorsInnerConfig) GetKafkaRegion() string {
	...
	return o.KafkaRegion
}

// GetKafkaRegionOk returns a tuple with the KafkaRegion field value
// and a boolean to check if the value has been set.
func (o *ConnectV1ConnectorsInnerConfig) GetKafkaRegionOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.KafkaRegion, true
}

// SetKafkaRegion sets field value
func (o *ConnectV1ConnectorsInnerConfig) SetKafkaRegion(v string) {
	o.KafkaRegion = v
}

// GetKafkaApiKey returns the KafkaApiKey field value
func (o *ConnectV1ConnectorsInnerConfig) GetKafkaApiKey() string {
	...
	return o.KafkaApiKey
}

// GetKafkaApiKeyOk returns a tuple with the KafkaApiKey field value
// and a boolean to check if the value has been set.
func (o *ConnectV1ConnectorsInnerConfig) GetKafkaApiKeyOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.KafkaApiKey, true
}

// SetKafkaApiKey sets field value
func (o *ConnectV1ConnectorsInnerConfig) SetKafkaApiKey(v string) {
	o.KafkaApiKey = v
}

// GetKafkaApiSecret returns the KafkaApiSecret field value
func (o *ConnectV1ConnectorsInnerConfig) GetKafkaApiSecret() string {
	...
	return o.KafkaApiSecret
}

// GetKafkaApiSecretOk returns a tuple with the KafkaApiSecret field value
// and a boolean to check if the value has been set.
func (o *ConnectV1ConnectorsInnerConfig) GetKafkaApiSecretOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.KafkaApiSecret, true
}

// SetKafkaApiSecret sets field value
func (o *ConnectV1ConnectorsInnerConfig) SetKafkaApiSecret(v string) {
	o.KafkaApiSecret = v
}

func (o ConnectV1ConnectorsInnerConfig) MarshalJSON() ([]byte, error) {
...
func (o ConnectV1ConnectorsInnerConfig) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["cloud.environment"] = o.CloudEnvironment
	toSerialize["cloud.provider"] = o.CloudProvider
	toSerialize["connector.class"] = o.ConnectorClass
	toSerialize["name"] = o.Name
	toSerialize["kafka.endpoint"] = o.KafkaEndpoint
	toSerialize["kafka.region"] = o.KafkaRegion
	toSerialize["kafka.api.key"] = o.KafkaApiKey
	toSerialize["kafka.api.secret"] = o.KafkaApiSecret
	return toSerialize, nil
}

type NullableConnectV1ConnectorsInnerConfig struct {
	value *ConnectV1ConnectorsInnerConfig
	isSet bool
}

func (v NullableConnectV1ConnectorsInnerConfig) Get() *ConnectV1ConnectorsInnerConfig {
	return v.value
}

func (v *NullableConnectV1ConnectorsInnerConfig) Set(val *ConnectV1ConnectorsInnerConfig) {
	v.value = val
	v.isSet = true
}

func (v NullableConnectV1ConnectorsInnerConfig) IsSet() bool {
	return v.isSet
}

func (v *NullableConnectV1ConnectorsInnerConfig) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableConnectV1ConnectorsInnerConfig(val *ConnectV1ConnectorsInnerConfig) *NullableConnectV1ConnectorsInnerConfig {
	return &NullableConnectV1ConnectorsInnerConfig{value: val, isSet: true}
}

func (v NullableConnectV1ConnectorsInnerConfig) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableConnectV1ConnectorsInnerConfig) UnmarshalJSON(src []byte) error {
	v.isSet = true
