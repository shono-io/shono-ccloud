...
// checks if the PartnerV2Organization type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PartnerV2Organization{}
...
func (o PartnerV2Organization) ToMap() (map[string]interface{}, error) {
