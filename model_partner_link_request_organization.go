...
// checks if the PartnerLinkRequestOrganization type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PartnerLinkRequestOrganization{}

// PartnerLinkRequestOrganization struct for PartnerLinkRequestOrganization
type PartnerLinkRequestOrganization struct {
...
func NewPartnerLinkRequestOrganization(ssoConfig PartnerV2OrganizationSsoConfig) *PartnerLinkRequestOrganization {
	this := PartnerLinkRequestOrganization{}
...
func (o PartnerLinkRequestOrganization) MarshalJSON() ([]byte, error) {
...
func (o PartnerLinkRequestOrganization) ToMap() (map[string]interface{}, error) {
...
type NullablePartnerLinkRequestOrganization struct {
	value *PartnerLinkRequestOrganization
	isSet bool
}

func (v NullablePartnerLinkRequestOrganization) Get() *PartnerLinkRequestOrganization {
	return v.value
}

func (v *NullablePartnerLinkRequestOrganization) Set(val *PartnerLinkRequestOrganization) {
	v.value = val
	v.isSet = true
}

func (v NullablePartnerLinkRequestOrganization) IsSet() bool {
	return v.isSet
}

func (v *NullablePartnerLinkRequestOrganization) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePartnerLinkRequestOrganization(val *PartnerLinkRequestOrganization) *NullablePartnerLinkRequestOrganization {
	return &NullablePartnerLinkRequestOrganization{value: val, isSet: true}
}

func (v NullablePartnerLinkRequestOrganization) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePartnerLinkRequestOrganization) UnmarshalJSON(src []byte) error {
	v.isSet = true
