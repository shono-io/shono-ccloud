...
type ApiCreateIamV2ApiKeyRequest struct {
	...
	createIamV2ApiKeyRequest *CreateIamV2ApiKeyRequest
}

func (r ApiCreateIamV2ApiKeyRequest) CreateIamV2ApiKeyRequest(createIamV2ApiKeyRequest CreateIamV2ApiKeyRequest) ApiCreateIamV2ApiKeyRequest {
	r.createIamV2ApiKeyRequest = &createIamV2ApiKeyRequest
	return r
}

func (r ApiCreateIamV2ApiKeyRequest) Execute() (*CreateIamV2ApiKey202Response, *http.Response, error) {
...
*/
func (a *APIKeysIamV2ApiService) CreateIamV2ApiKey(ctx context.Context) ApiCreateIamV2ApiKeyRequest {
	return ApiCreateIamV2ApiKeyRequest{
		ApiService: a,
		ctx: ctx,
	}
...
//  @return CreateIamV2ApiKey202Response
func (a *APIKeysIamV2ApiService) CreateIamV2ApiKeyExecute(r ApiCreateIamV2ApiKeyRequest) (*CreateIamV2ApiKey202Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *CreateIamV2ApiKey202Response
	)
	...
	// body params
	localVarPostBody = r.createIamV2ApiKeyRequest
...
func (r ApiDeleteIamV2ApiKeyRequest) Execute() (*http.Response, error) {
...
*/
func (a *APIKeysIamV2ApiService) DeleteIamV2ApiKey(ctx context.Context, id string) ApiDeleteIamV2ApiKeyRequest {
	return ApiDeleteIamV2ApiKeyRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
func (a *APIKeysIamV2ApiService) DeleteIamV2ApiKeyExecute(r ApiDeleteIamV2ApiKeyRequest) (*http.Response, error) {
	var (
...
func (r ApiGetIamV2ApiKeyRequest) Execute() (*GetIamV2ApiKey200Response, *http.Response, error) {
...
*/
func (a *APIKeysIamV2ApiService) GetIamV2ApiKey(ctx context.Context, id string) ApiGetIamV2ApiKeyRequest {
	return ApiGetIamV2ApiKeyRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
//  @return GetIamV2ApiKey200Response
func (a *APIKeysIamV2ApiService) GetIamV2ApiKeyExecute(r ApiGetIamV2ApiKeyRequest) (*GetIamV2ApiKey200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *GetIamV2ApiKey200Response
	)
...
func (r ApiListIamV2ApiKeysRequest) Execute() (*ListIamV2ApiKeys200Response, *http.Response, error) {
...
*/
func (a *APIKeysIamV2ApiService) ListIamV2ApiKeys(ctx context.Context) ApiListIamV2ApiKeysRequest {
	return ApiListIamV2ApiKeysRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return ListIamV2ApiKeys200Response
func (a *APIKeysIamV2ApiService) ListIamV2ApiKeysExecute(r ApiListIamV2ApiKeysRequest) (*ListIamV2ApiKeys200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *ListIamV2ApiKeys200Response
	)
	...
	if r.specOwner != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "spec.owner", r.specOwner, "")
	}
	if r.specResource != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "spec.resource", r.specResource, "")
	}
	if r.pageSize != nil {
...
func (r ApiUpdateIamV2ApiKeyRequest) Execute() (*GetIamV2ApiKey200Response, *http.Response, error) {
...
*/
func (a *APIKeysIamV2ApiService) UpdateIamV2ApiKey(ctx context.Context, id string) ApiUpdateIamV2ApiKeyRequest {
	return ApiUpdateIamV2ApiKeyRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
//  @return GetIamV2ApiKey200Response
func (a *APIKeysIamV2ApiService) UpdateIamV2ApiKeyExecute(r ApiUpdateIamV2ApiKeyRequest) (*GetIamV2ApiKey200Response, *http.Response, error) {
	var (
