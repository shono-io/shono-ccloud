...
// checks if the UpdateSdV1PipelineRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateSdV1PipelineRequest{}

// UpdateSdV1PipelineRequest struct for UpdateSdV1PipelineRequest
type UpdateSdV1PipelineRequest struct {
...
func NewUpdateSdV1PipelineRequest(spec UpdateCmkV2ClusterRequestAllOfSpec) *UpdateSdV1PipelineRequest {
	this := UpdateSdV1PipelineRequest{}
	this.Spec = spec
	return &this
}
...
func (o UpdateSdV1PipelineRequest) MarshalJSON() ([]byte, error) {
...
func (o UpdateSdV1PipelineRequest) ToMap() (map[string]interface{}, error) {
...
type NullableUpdateSdV1PipelineRequest struct {
	value *UpdateSdV1PipelineRequest
	isSet bool
}

func (v NullableUpdateSdV1PipelineRequest) Get() *UpdateSdV1PipelineRequest {
	return v.value
}

func (v *NullableUpdateSdV1PipelineRequest) Set(val *UpdateSdV1PipelineRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdateSdV1PipelineRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableUpdateSdV1PipelineRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpdateSdV1PipelineRequest(val *UpdateSdV1PipelineRequest) *NullableUpdateSdV1PipelineRequest {
	return &NullableUpdateSdV1PipelineRequest{value: val, isSet: true}
}

func (v NullableUpdateSdV1PipelineRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpdateSdV1PipelineRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
