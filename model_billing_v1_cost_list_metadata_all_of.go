...
// checks if the BillingV1CostListMetadataAllOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BillingV1CostListMetadataAllOf{}

// BillingV1CostListMetadataAllOf struct for BillingV1CostListMetadataAllOf
type BillingV1CostListMetadataAllOf struct {
...
func NewBillingV1CostListMetadataAllOf() *BillingV1CostListMetadataAllOf {
	this := BillingV1CostListMetadataAllOf{}
	return &this
}
...
func (o BillingV1CostListMetadataAllOf) MarshalJSON() ([]byte, error) {
...
func (o BillingV1CostListMetadataAllOf) ToMap() (map[string]interface{}, error) {
...
type NullableBillingV1CostListMetadataAllOf struct {
	value *BillingV1CostListMetadataAllOf
	isSet bool
}

func (v NullableBillingV1CostListMetadataAllOf) Get() *BillingV1CostListMetadataAllOf {
	return v.value
}

func (v *NullableBillingV1CostListMetadataAllOf) Set(val *BillingV1CostListMetadataAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableBillingV1CostListMetadataAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableBillingV1CostListMetadataAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBillingV1CostListMetadataAllOf(val *BillingV1CostListMetadataAllOf) *NullableBillingV1CostListMetadataAllOf {
	return &NullableBillingV1CostListMetadataAllOf{value: val, isSet: true}
}

func (v NullableBillingV1CostListMetadataAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBillingV1CostListMetadataAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
