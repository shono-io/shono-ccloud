...
// checks if the KafkaQuotasV1ClientQuotaListDataInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &KafkaQuotasV1ClientQuotaListDataInner{}

// KafkaQuotasV1ClientQuotaListDataInner struct for KafkaQuotasV1ClientQuotaListDataInner
type KafkaQuotasV1ClientQuotaListDataInner struct {
	...
	Id string `json:"id"`
	Metadata KafkaQuotasV1ClientQuotaMetadata `json:"metadata"`
...
func NewKafkaQuotasV1ClientQuotaListDataInner(id string, metadata KafkaQuotasV1ClientQuotaMetadata, spec map[string]interface{}) *KafkaQuotasV1ClientQuotaListDataInner {
	this := KafkaQuotasV1ClientQuotaListDataInner{}
	this.Id = id
...
func (o KafkaQuotasV1ClientQuotaListDataInner) MarshalJSON() ([]byte, error) {
...
func (o KafkaQuotasV1ClientQuotaListDataInner) ToMap() (map[string]interface{}, error) {
...
type NullableKafkaQuotasV1ClientQuotaListDataInner struct {
	value *KafkaQuotasV1ClientQuotaListDataInner
	isSet bool
}

func (v NullableKafkaQuotasV1ClientQuotaListDataInner) Get() *KafkaQuotasV1ClientQuotaListDataInner {
	return v.value
}

func (v *NullableKafkaQuotasV1ClientQuotaListDataInner) Set(val *KafkaQuotasV1ClientQuotaListDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableKafkaQuotasV1ClientQuotaListDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableKafkaQuotasV1ClientQuotaListDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableKafkaQuotasV1ClientQuotaListDataInner(val *KafkaQuotasV1ClientQuotaListDataInner) *NullableKafkaQuotasV1ClientQuotaListDataInner {
	return &NullableKafkaQuotasV1ClientQuotaListDataInner{value: val, isSet: true}
}

func (v NullableKafkaQuotasV1ClientQuotaListDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableKafkaQuotasV1ClientQuotaListDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
