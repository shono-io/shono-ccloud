...
// checks if the NotificationsV1NotificationTypeListDataInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NotificationsV1NotificationTypeListDataInner{}

// NotificationsV1NotificationTypeListDataInner struct for NotificationsV1NotificationTypeListDataInner
type NotificationsV1NotificationTypeListDataInner struct {
	...
	Id string `json:"id"`
	Metadata NotificationsV1NotificationTypeMetadata `json:"metadata"`
...
func NewNotificationsV1NotificationTypeListDataInner(id string, metadata NotificationsV1NotificationTypeMetadata, displayName string, category string, description string, subscriptionPriority string, isIncludedInPlan bool, severity string) *NotificationsV1NotificationTypeListDataInner {
	this := NotificationsV1NotificationTypeListDataInner{}
	this.Id = id
...
func (o *NotificationsV1NotificationTypeListDataInner) HasKind() bool {
	if o != nil && !IsNil(o.Kind) {
		return true
	}
...
func (o NotificationsV1NotificationTypeListDataInner) MarshalJSON() ([]byte, error) {
...
func (o NotificationsV1NotificationTypeListDataInner) ToMap() (map[string]interface{}, error) {
...
type NullableNotificationsV1NotificationTypeListDataInner struct {
	value *NotificationsV1NotificationTypeListDataInner
	isSet bool
}

func (v NullableNotificationsV1NotificationTypeListDataInner) Get() *NotificationsV1NotificationTypeListDataInner {
	return v.value
}

func (v *NullableNotificationsV1NotificationTypeListDataInner) Set(val *NotificationsV1NotificationTypeListDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableNotificationsV1NotificationTypeListDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableNotificationsV1NotificationTypeListDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNotificationsV1NotificationTypeListDataInner(val *NotificationsV1NotificationTypeListDataInner) *NullableNotificationsV1NotificationTypeListDataInner {
	return &NullableNotificationsV1NotificationTypeListDataInner{value: val, isSet: true}
}

func (v NullableNotificationsV1NotificationTypeListDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNotificationsV1NotificationTypeListDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
