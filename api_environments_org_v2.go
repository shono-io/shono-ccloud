...
type ApiCreateOrgV2EnvironmentRequest struct {
	...
	createOrgV2EnvironmentRequest *CreateOrgV2EnvironmentRequest
}

func (r ApiCreateOrgV2EnvironmentRequest) CreateOrgV2EnvironmentRequest(createOrgV2EnvironmentRequest CreateOrgV2EnvironmentRequest) ApiCreateOrgV2EnvironmentRequest {
	r.createOrgV2EnvironmentRequest = &createOrgV2EnvironmentRequest
	return r
}

func (r ApiCreateOrgV2EnvironmentRequest) Execute() (*CreateOrgV2EnvironmentRequest, *http.Response, error) {
...
*/
func (a *EnvironmentsOrgV2ApiService) CreateOrgV2Environment(ctx context.Context) ApiCreateOrgV2EnvironmentRequest {
	return ApiCreateOrgV2EnvironmentRequest{
		ApiService: a,
		ctx: ctx,
	}
...
//  @return CreateOrgV2EnvironmentRequest
func (a *EnvironmentsOrgV2ApiService) CreateOrgV2EnvironmentExecute(r ApiCreateOrgV2EnvironmentRequest) (*CreateOrgV2EnvironmentRequest, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *CreateOrgV2EnvironmentRequest
	)
	...
	// body params
	localVarPostBody = r.createOrgV2EnvironmentRequest
...
func (r ApiDeleteOrgV2EnvironmentRequest) Execute() (*http.Response, error) {
...
*/
func (a *EnvironmentsOrgV2ApiService) DeleteOrgV2Environment(ctx context.Context, id string) ApiDeleteOrgV2EnvironmentRequest {
	return ApiDeleteOrgV2EnvironmentRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
func (a *EnvironmentsOrgV2ApiService) DeleteOrgV2EnvironmentExecute(r ApiDeleteOrgV2EnvironmentRequest) (*http.Response, error) {
	var (
...
func (r ApiGetOrgV2EnvironmentRequest) Execute() (*GetOrgV2Environment200Response, *http.Response, error) {
...
*/
func (a *EnvironmentsOrgV2ApiService) GetOrgV2Environment(ctx context.Context, id string) ApiGetOrgV2EnvironmentRequest {
	return ApiGetOrgV2EnvironmentRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
//  @return GetOrgV2Environment200Response
func (a *EnvironmentsOrgV2ApiService) GetOrgV2EnvironmentExecute(r ApiGetOrgV2EnvironmentRequest) (*GetOrgV2Environment200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *GetOrgV2Environment200Response
	)
...
func (r ApiListOrgV2EnvironmentsRequest) Execute() (*ListOrgV2Environments200Response, *http.Response, error) {
...
*/
func (a *EnvironmentsOrgV2ApiService) ListOrgV2Environments(ctx context.Context) ApiListOrgV2EnvironmentsRequest {
	return ApiListOrgV2EnvironmentsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return ListOrgV2Environments200Response
func (a *EnvironmentsOrgV2ApiService) ListOrgV2EnvironmentsExecute(r ApiListOrgV2EnvironmentsRequest) (*ListOrgV2Environments200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *ListOrgV2Environments200Response
	)
...
func (r ApiUpdateOrgV2EnvironmentRequest) Execute() (*GetOrgV2Environment200Response, *http.Response, error) {
...
*/
func (a *EnvironmentsOrgV2ApiService) UpdateOrgV2Environment(ctx context.Context, id string) ApiUpdateOrgV2EnvironmentRequest {
	return ApiUpdateOrgV2EnvironmentRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
//  @return GetOrgV2Environment200Response
func (a *EnvironmentsOrgV2ApiService) UpdateOrgV2EnvironmentExecute(r ApiUpdateOrgV2EnvironmentRequest) (*GetOrgV2Environment200Response, *http.Response, error) {
	var (
