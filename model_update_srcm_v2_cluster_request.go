...
// checks if the UpdateSrcmV2ClusterRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateSrcmV2ClusterRequest{}

// UpdateSrcmV2ClusterRequest struct for UpdateSrcmV2ClusterRequest
type UpdateSrcmV2ClusterRequest struct {
...
func NewUpdateSrcmV2ClusterRequest(spec UpdateCmkV2ClusterRequestAllOfSpec) *UpdateSrcmV2ClusterRequest {
	this := UpdateSrcmV2ClusterRequest{}
	this.Spec = spec
	return &this
}
...
func (o UpdateSrcmV2ClusterRequest) MarshalJSON() ([]byte, error) {
...
func (o UpdateSrcmV2ClusterRequest) ToMap() (map[string]interface{}, error) {
...
type NullableUpdateSrcmV2ClusterRequest struct {
	value *UpdateSrcmV2ClusterRequest
	isSet bool
}

func (v NullableUpdateSrcmV2ClusterRequest) Get() *UpdateSrcmV2ClusterRequest {
	return v.value
}

func (v *NullableUpdateSrcmV2ClusterRequest) Set(val *UpdateSrcmV2ClusterRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdateSrcmV2ClusterRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableUpdateSrcmV2ClusterRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpdateSrcmV2ClusterRequest(val *UpdateSrcmV2ClusterRequest) *NullableUpdateSrcmV2ClusterRequest {
	return &NullableUpdateSrcmV2ClusterRequest{value: val, isSet: true}
}

func (v NullableUpdateSrcmV2ClusterRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpdateSrcmV2ClusterRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
