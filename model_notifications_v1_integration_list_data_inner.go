...
// checks if the NotificationsV1IntegrationListDataInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NotificationsV1IntegrationListDataInner{}

// NotificationsV1IntegrationListDataInner struct for NotificationsV1IntegrationListDataInner
type NotificationsV1IntegrationListDataInner struct {
	...
	Id string `json:"id"`
	Metadata NotificationsV1IntegrationMetadata `json:"metadata"`
...
func NewNotificationsV1IntegrationListDataInner(id string, metadata NotificationsV1IntegrationMetadata, displayName string, target NotificationsV1IntegrationTarget) *NotificationsV1IntegrationListDataInner {
	this := NotificationsV1IntegrationListDataInner{}
	this.Id = id
...
func (o NotificationsV1IntegrationListDataInner) MarshalJSON() ([]byte, error) {
...
func (o NotificationsV1IntegrationListDataInner) ToMap() (map[string]interface{}, error) {
...
type NullableNotificationsV1IntegrationListDataInner struct {
	value *NotificationsV1IntegrationListDataInner
	isSet bool
}

func (v NullableNotificationsV1IntegrationListDataInner) Get() *NotificationsV1IntegrationListDataInner {
	return v.value
}

func (v *NullableNotificationsV1IntegrationListDataInner) Set(val *NotificationsV1IntegrationListDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableNotificationsV1IntegrationListDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableNotificationsV1IntegrationListDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNotificationsV1IntegrationListDataInner(val *NotificationsV1IntegrationListDataInner) *NullableNotificationsV1IntegrationListDataInner {
	return &NullableNotificationsV1IntegrationListDataInner{value: val, isSet: true}
}

func (v NullableNotificationsV1IntegrationListDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNotificationsV1IntegrationListDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
