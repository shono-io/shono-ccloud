...
// checks if the NetworkingV1NetworkLinkServiceListMetadataAllOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NetworkingV1NetworkLinkServiceListMetadataAllOf{}

// NetworkingV1NetworkLinkServiceListMetadataAllOf struct for NetworkingV1NetworkLinkServiceListMetadataAllOf
type NetworkingV1NetworkLinkServiceListMetadataAllOf struct {
...
func NewNetworkingV1NetworkLinkServiceListMetadataAllOf() *NetworkingV1NetworkLinkServiceListMetadataAllOf {
	this := NetworkingV1NetworkLinkServiceListMetadataAllOf{}
	return &this
}
...
func (o NetworkingV1NetworkLinkServiceListMetadataAllOf) MarshalJSON() ([]byte, error) {
...
func (o NetworkingV1NetworkLinkServiceListMetadataAllOf) ToMap() (map[string]interface{}, error) {
...
type NullableNetworkingV1NetworkLinkServiceListMetadataAllOf struct {
	value *NetworkingV1NetworkLinkServiceListMetadataAllOf
	isSet bool
}

func (v NullableNetworkingV1NetworkLinkServiceListMetadataAllOf) Get() *NetworkingV1NetworkLinkServiceListMetadataAllOf {
	return v.value
}

func (v *NullableNetworkingV1NetworkLinkServiceListMetadataAllOf) Set(val *NetworkingV1NetworkLinkServiceListMetadataAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableNetworkingV1NetworkLinkServiceListMetadataAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableNetworkingV1NetworkLinkServiceListMetadataAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNetworkingV1NetworkLinkServiceListMetadataAllOf(val *NetworkingV1NetworkLinkServiceListMetadataAllOf) *NullableNetworkingV1NetworkLinkServiceListMetadataAllOf {
	return &NullableNetworkingV1NetworkLinkServiceListMetadataAllOf{value: val, isSet: true}
}

func (v NullableNetworkingV1NetworkLinkServiceListMetadataAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNetworkingV1NetworkLinkServiceListMetadataAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
