...
func (r ApiCreateTagDefsRequest) Execute() ([]TagDefResponse, *http.Response, error) {
...
*/
func (a *TypesV1ApiService) CreateTagDefs(ctx context.Context) ApiCreateTagDefsRequest {
	return ApiCreateTagDefsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *TypesV1ApiService) CreateTagDefsExecute(r ApiCreateTagDefsRequest) ([]TagDefResponse, *http.Response, error) {
	var (
...
func (r ApiDeleteTagDefRequest) Execute() (*http.Response, error) {
...
*/
func (a *TypesV1ApiService) DeleteTagDef(ctx context.Context, tagName string) ApiDeleteTagDefRequest {
	return ApiDeleteTagDefRequest{
		ApiService: a,
		ctx: ctx,
		tagName: tagName,
...
// Execute executes the request
func (a *TypesV1ApiService) DeleteTagDefExecute(r ApiDeleteTagDefRequest) (*http.Response, error) {
	var (
...
func (r ApiGetAllTagDefsRequest) Execute() ([]TagDefResponse, *http.Response, error) {
...
*/
func (a *TypesV1ApiService) GetAllTagDefs(ctx context.Context) ApiGetAllTagDefsRequest {
	return ApiGetAllTagDefsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return []TagDefResponse
func (a *TypesV1ApiService) GetAllTagDefsExecute(r ApiGetAllTagDefsRequest) ([]TagDefResponse, *http.Response, error) {
	var (
...
func (r ApiGetTagDefByNameRequest) Execute() (*TagDef, *http.Response, error) {
...
*/
func (a *TypesV1ApiService) GetTagDefByName(ctx context.Context, tagName string) ApiGetTagDefByNameRequest {
	return ApiGetTagDefByNameRequest{
		ApiService: a,
		ctx: ctx,
		tagName: tagName,
...
// Execute executes the request
//  @return TagDef
func (a *TypesV1ApiService) GetTagDefByNameExecute(r ApiGetTagDefByNameRequest) (*TagDef, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r ApiUpdateTagDefsRequest) Execute() ([]TagDefResponse, *http.Response, error) {
...
*/
func (a *TypesV1ApiService) UpdateTagDefs(ctx context.Context) ApiUpdateTagDefsRequest {
	return ApiUpdateTagDefsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return []TagDefResponse
func (a *TypesV1ApiService) UpdateTagDefsExecute(r ApiUpdateTagDefsRequest) ([]TagDefResponse, *http.Response, error) {
	var (
