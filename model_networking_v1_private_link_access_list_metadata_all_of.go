...
// checks if the NetworkingV1PrivateLinkAccessListMetadataAllOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NetworkingV1PrivateLinkAccessListMetadataAllOf{}

// NetworkingV1PrivateLinkAccessListMetadataAllOf struct for NetworkingV1PrivateLinkAccessListMetadataAllOf
type NetworkingV1PrivateLinkAccessListMetadataAllOf struct {
...
func NewNetworkingV1PrivateLinkAccessListMetadataAllOf() *NetworkingV1PrivateLinkAccessListMetadataAllOf {
	this := NetworkingV1PrivateLinkAccessListMetadataAllOf{}
	return &this
}
...
func (o NetworkingV1PrivateLinkAccessListMetadataAllOf) MarshalJSON() ([]byte, error) {
...
func (o NetworkingV1PrivateLinkAccessListMetadataAllOf) ToMap() (map[string]interface{}, error) {
...
type NullableNetworkingV1PrivateLinkAccessListMetadataAllOf struct {
	value *NetworkingV1PrivateLinkAccessListMetadataAllOf
	isSet bool
}

func (v NullableNetworkingV1PrivateLinkAccessListMetadataAllOf) Get() *NetworkingV1PrivateLinkAccessListMetadataAllOf {
	return v.value
}

func (v *NullableNetworkingV1PrivateLinkAccessListMetadataAllOf) Set(val *NetworkingV1PrivateLinkAccessListMetadataAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableNetworkingV1PrivateLinkAccessListMetadataAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableNetworkingV1PrivateLinkAccessListMetadataAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNetworkingV1PrivateLinkAccessListMetadataAllOf(val *NetworkingV1PrivateLinkAccessListMetadataAllOf) *NullableNetworkingV1PrivateLinkAccessListMetadataAllOf {
	return &NullableNetworkingV1PrivateLinkAccessListMetadataAllOf{value: val, isSet: true}
}

func (v NullableNetworkingV1PrivateLinkAccessListMetadataAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNetworkingV1PrivateLinkAccessListMetadataAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
