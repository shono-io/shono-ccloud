...
// checks if the NetworkingV1NetworkLinkServiceMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NetworkingV1NetworkLinkServiceMetadata{}

// NetworkingV1NetworkLinkServiceMetadata struct for NetworkingV1NetworkLinkServiceMetadata
type NetworkingV1NetworkLinkServiceMetadata struct {
...
func NewNetworkingV1NetworkLinkServiceMetadata(self interface{}) *NetworkingV1NetworkLinkServiceMetadata {
	this := NetworkingV1NetworkLinkServiceMetadata{}
	this.Self = self
	return &this
}
...
func (o NetworkingV1NetworkLinkServiceMetadata) MarshalJSON() ([]byte, error) {
...
func (o NetworkingV1NetworkLinkServiceMetadata) ToMap() (map[string]interface{}, error) {
...
type NullableNetworkingV1NetworkLinkServiceMetadata struct {
	value *NetworkingV1NetworkLinkServiceMetadata
	isSet bool
}

func (v NullableNetworkingV1NetworkLinkServiceMetadata) Get() *NetworkingV1NetworkLinkServiceMetadata {
	return v.value
}

func (v *NullableNetworkingV1NetworkLinkServiceMetadata) Set(val *NetworkingV1NetworkLinkServiceMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableNetworkingV1NetworkLinkServiceMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableNetworkingV1NetworkLinkServiceMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNetworkingV1NetworkLinkServiceMetadata(val *NetworkingV1NetworkLinkServiceMetadata) *NullableNetworkingV1NetworkLinkServiceMetadata {
	return &NullableNetworkingV1NetworkLinkServiceMetadata{value: val, isSet: true}
}

func (v NullableNetworkingV1NetworkLinkServiceMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNetworkingV1NetworkLinkServiceMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
