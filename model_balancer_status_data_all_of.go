...
// checks if the BalancerStatusDataAllOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BalancerStatusDataAllOf{}
...
func (o BalancerStatusDataAllOf) ToMap() (map[string]interface{}, error) {
