...
// checks if the GetIamV2IdentityPool200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetIamV2IdentityPool200Response{}

// GetIamV2IdentityPool200Response struct for GetIamV2IdentityPool200Response
type GetIamV2IdentityPool200Response struct {
	...
	Id string `json:"id"`
	Metadata *IamV2IdentityPoolMetadata `json:"metadata,omitempty"`
...
func NewGetIamV2IdentityPool200Response(apiVersion string, kind string, id string, displayName string, description string, identityClaim string, filter string, principal string, state string) *GetIamV2IdentityPool200Response {
	this := GetIamV2IdentityPool200Response{}
...
func (o *GetIamV2IdentityPool200Response) GetMetadata() IamV2IdentityPoolMetadata {
	if o == nil || IsNil(o.Metadata) {
		var ret IamV2IdentityPoolMetadata
		return ret
	}
	return *o.Metadata
}
...
// SetMetadata gets a reference to the given IamV2IdentityPoolMetadata and assigns it to the Metadata field.
...
// GetIdentityClaim returns the IdentityClaim field value
...
// GetIdentityClaimOk returns a tuple with the IdentityClaim field value
// and a boolean to check if the value has been set.
...
// SetIdentityClaim sets field value
...
func (o GetIamV2IdentityPool200Response) MarshalJSON() ([]byte, error) {
...
func (o GetIamV2IdentityPool200Response) ToMap() (map[string]interface{}, error) {
	...
	// skip: principal is readOnly
	// skip: state is readOnly
	return toSerialize, nil
}

type NullableGetIamV2IdentityPool200Response struct {
	value *GetIamV2IdentityPool200Response
	isSet bool
}

func (v NullableGetIamV2IdentityPool200Response) Get() *GetIamV2IdentityPool200Response {
	return v.value
}

func (v *NullableGetIamV2IdentityPool200Response) Set(val *GetIamV2IdentityPool200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetIamV2IdentityPool200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetIamV2IdentityPool200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetIamV2IdentityPool200Response(val *GetIamV2IdentityPool200Response) *NullableGetIamV2IdentityPool200Response {
	return &NullableGetIamV2IdentityPool200Response{value: val, isSet: true}
}

func (v NullableGetIamV2IdentityPool200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetIamV2IdentityPool200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
