...
// checks if the IamV2InvitationListMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IamV2InvitationListMetadata{}

// IamV2InvitationListMetadata struct for IamV2InvitationListMetadata
type IamV2InvitationListMetadata struct {
...
func NewIamV2InvitationListMetadata() *IamV2InvitationListMetadata {
	this := IamV2InvitationListMetadata{}
	return &this
}
...
func (o *IamV2InvitationListMetadata) HasFirst() bool {
	if o != nil && IsNil(o.First) {
		return true
	}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *IamV2InvitationListMetadata) GetPrevOk() (*interface{}, bool) {
...
func (o IamV2InvitationListMetadata) MarshalJSON() ([]byte, error) {
...
func (o IamV2InvitationListMetadata) ToMap() (map[string]interface{}, error) {
...
type NullableIamV2InvitationListMetadata struct {
	value *IamV2InvitationListMetadata
	isSet bool
}

func (v NullableIamV2InvitationListMetadata) Get() *IamV2InvitationListMetadata {
	return v.value
}

func (v *NullableIamV2InvitationListMetadata) Set(val *IamV2InvitationListMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableIamV2InvitationListMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableIamV2InvitationListMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIamV2InvitationListMetadata(val *IamV2InvitationListMetadata) *NullableIamV2InvitationListMetadata {
	return &NullableIamV2InvitationListMetadata{value: val, isSet: true}
}

func (v NullableIamV2InvitationListMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIamV2InvitationListMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
