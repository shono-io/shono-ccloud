...
// checks if the ConsumerData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ConsumerData{}
...
func (o ConsumerData) ToMap() (map[string]interface{}, error) {
