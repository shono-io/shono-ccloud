...
// checks if the IamV2IdentityProviderListMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IamV2IdentityProviderListMetadata{}

// IamV2IdentityProviderListMetadata struct for IamV2IdentityProviderListMetadata
type IamV2IdentityProviderListMetadata struct {
...
func NewIamV2IdentityProviderListMetadata() *IamV2IdentityProviderListMetadata {
	this := IamV2IdentityProviderListMetadata{}
	return &this
}
...
func (o IamV2IdentityProviderListMetadata) MarshalJSON() ([]byte, error) {
...
func (o IamV2IdentityProviderListMetadata) ToMap() (map[string]interface{}, error) {
...
type NullableIamV2IdentityProviderListMetadata struct {
	value *IamV2IdentityProviderListMetadata
	isSet bool
}

func (v NullableIamV2IdentityProviderListMetadata) Get() *IamV2IdentityProviderListMetadata {
	return v.value
}

func (v *NullableIamV2IdentityProviderListMetadata) Set(val *IamV2IdentityProviderListMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableIamV2IdentityProviderListMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableIamV2IdentityProviderListMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIamV2IdentityProviderListMetadata(val *IamV2IdentityProviderListMetadata) *NullableIamV2IdentityProviderListMetadata {
	return &NullableIamV2IdentityProviderListMetadata{value: val, isSet: true}
}

func (v NullableIamV2IdentityProviderListMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIamV2IdentityProviderListMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
