...
// checks if the CmkV2Dedicated type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CmkV2Dedicated{}
...
func (o CmkV2Dedicated) ToMap() (map[string]interface{}, error) {
