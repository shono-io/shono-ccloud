...
// checks if the ConsumerGroupLagSummaryDataAllOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ConsumerGroupLagSummaryDataAllOf{}
...
func (o *ConsumerGroupLagSummaryDataAllOf) GetMaxLagInstanceId() string {
	if o == nil || IsNil(o.MaxLagInstanceId.Get()) {
		var ret string
		return ret
	}
...
func (o ConsumerGroupLagSummaryDataAllOf) ToMap() (map[string]interface{}, error) {
