...
// checks if the OrgV2Environment type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OrgV2Environment{}
...
func (o OrgV2Environment) ToMap() (map[string]interface{}, error) {
