...
// checks if the IamV2ApiKeyMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IamV2ApiKeyMetadata{}

// IamV2ApiKeyMetadata struct for IamV2ApiKeyMetadata
type IamV2ApiKeyMetadata struct {
...
func (o IamV2ApiKeyMetadata) MarshalJSON() ([]byte, error) {
...
func (o IamV2ApiKeyMetadata) ToMap() (map[string]interface{}, error) {
...
type NullableIamV2ApiKeyMetadata struct {
	value *IamV2ApiKeyMetadata
	isSet bool
}

func (v NullableIamV2ApiKeyMetadata) Get() *IamV2ApiKeyMetadata {
	return v.value
}

func (v *NullableIamV2ApiKeyMetadata) Set(val *IamV2ApiKeyMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableIamV2ApiKeyMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableIamV2ApiKeyMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIamV2ApiKeyMetadata(val *IamV2ApiKeyMetadata) *NullableIamV2ApiKeyMetadata {
	return &NullableIamV2ApiKeyMetadata{value: val, isSet: true}
}

func (v NullableIamV2ApiKeyMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIamV2ApiKeyMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
