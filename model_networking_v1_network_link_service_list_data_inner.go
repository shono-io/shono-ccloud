...
// checks if the NetworkingV1NetworkLinkServiceListDataInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NetworkingV1NetworkLinkServiceListDataInner{}

// NetworkingV1NetworkLinkServiceListDataInner struct for NetworkingV1NetworkLinkServiceListDataInner
type NetworkingV1NetworkLinkServiceListDataInner struct {
	...
	Id string `json:"id"`
	Metadata NetworkingV1NetworkLinkServiceMetadata `json:"metadata"`
...
func NewNetworkingV1NetworkLinkServiceListDataInner(id string, metadata NetworkingV1NetworkLinkServiceMetadata, spec map[string]interface{}, status NetworkingV1NetworkLinkServiceStatus) *NetworkingV1NetworkLinkServiceListDataInner {
	this := NetworkingV1NetworkLinkServiceListDataInner{}
	this.Id = id
...
func (o NetworkingV1NetworkLinkServiceListDataInner) MarshalJSON() ([]byte, error) {
...
func (o NetworkingV1NetworkLinkServiceListDataInner) ToMap() (map[string]interface{}, error) {
...
type NullableNetworkingV1NetworkLinkServiceListDataInner struct {
	value *NetworkingV1NetworkLinkServiceListDataInner
	isSet bool
}

func (v NullableNetworkingV1NetworkLinkServiceListDataInner) Get() *NetworkingV1NetworkLinkServiceListDataInner {
	return v.value
}

func (v *NullableNetworkingV1NetworkLinkServiceListDataInner) Set(val *NetworkingV1NetworkLinkServiceListDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableNetworkingV1NetworkLinkServiceListDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableNetworkingV1NetworkLinkServiceListDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNetworkingV1NetworkLinkServiceListDataInner(val *NetworkingV1NetworkLinkServiceListDataInner) *NullableNetworkingV1NetworkLinkServiceListDataInner {
	return &NullableNetworkingV1NetworkLinkServiceListDataInner{value: val, isSet: true}
}

func (v NullableNetworkingV1NetworkLinkServiceListDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNetworkingV1NetworkLinkServiceListDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
