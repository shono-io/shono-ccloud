...
// checks if the CreatePartnerV2EntitlementRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreatePartnerV2EntitlementRequest{}

// CreatePartnerV2EntitlementRequest struct for CreatePartnerV2EntitlementRequest
type CreatePartnerV2EntitlementRequest struct {
...
func NewCreatePartnerV2EntitlementRequest(externalId string, name string, planId string, productId string) *CreatePartnerV2EntitlementRequest {
	this := CreatePartnerV2EntitlementRequest{}
...
func (o CreatePartnerV2EntitlementRequest) MarshalJSON() ([]byte, error) {
...
func (o CreatePartnerV2EntitlementRequest) ToMap() (map[string]interface{}, error) {
...
type NullableCreatePartnerV2EntitlementRequest struct {
	value *CreatePartnerV2EntitlementRequest
	isSet bool
}

func (v NullableCreatePartnerV2EntitlementRequest) Get() *CreatePartnerV2EntitlementRequest {
	return v.value
}

func (v *NullableCreatePartnerV2EntitlementRequest) Set(val *CreatePartnerV2EntitlementRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableCreatePartnerV2EntitlementRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableCreatePartnerV2EntitlementRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreatePartnerV2EntitlementRequest(val *CreatePartnerV2EntitlementRequest) *NullableCreatePartnerV2EntitlementRequest {
	return &NullableCreatePartnerV2EntitlementRequest{value: val, isSet: true}
}

func (v NullableCreatePartnerV2EntitlementRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreatePartnerV2EntitlementRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
