...
// checks if the ReplicaDataAllOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ReplicaDataAllOf{}
...
func (o ReplicaDataAllOf) ToMap() (map[string]interface{}, error) {
