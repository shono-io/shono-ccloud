...
// checks if the ConsumerAssignmentDataAllOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ConsumerAssignmentDataAllOf{}
...
func (o ConsumerAssignmentDataAllOf) ToMap() (map[string]interface{}, error) {
