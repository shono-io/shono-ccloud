...
// checks if the NetworkingV1NetworkLinkServiceAssociationListMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NetworkingV1NetworkLinkServiceAssociationListMetadata{}

// NetworkingV1NetworkLinkServiceAssociationListMetadata struct for NetworkingV1NetworkLinkServiceAssociationListMetadata
type NetworkingV1NetworkLinkServiceAssociationListMetadata struct {
...
func NewNetworkingV1NetworkLinkServiceAssociationListMetadata() *NetworkingV1NetworkLinkServiceAssociationListMetadata {
	this := NetworkingV1NetworkLinkServiceAssociationListMetadata{}
	return &this
}
...
func (o *NetworkingV1NetworkLinkServiceAssociationListMetadata) SetFirst(v interface{}) {
	o.First = v
}
...
func (o *NetworkingV1NetworkLinkServiceAssociationListMetadata) GetPrev() interface{} {
	if o == nil {
		var ret interface{}
		return ret
	}
...
// SetPrev gets a reference to the given interface{} and assigns it to the Prev field.
...
func (o NetworkingV1NetworkLinkServiceAssociationListMetadata) MarshalJSON() ([]byte, error) {
...
func (o NetworkingV1NetworkLinkServiceAssociationListMetadata) ToMap() (map[string]interface{}, error) {
...
type NullableNetworkingV1NetworkLinkServiceAssociationListMetadata struct {
	value *NetworkingV1NetworkLinkServiceAssociationListMetadata
	isSet bool
}

func (v NullableNetworkingV1NetworkLinkServiceAssociationListMetadata) Get() *NetworkingV1NetworkLinkServiceAssociationListMetadata {
	return v.value
}

func (v *NullableNetworkingV1NetworkLinkServiceAssociationListMetadata) Set(val *NetworkingV1NetworkLinkServiceAssociationListMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableNetworkingV1NetworkLinkServiceAssociationListMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableNetworkingV1NetworkLinkServiceAssociationListMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNetworkingV1NetworkLinkServiceAssociationListMetadata(val *NetworkingV1NetworkLinkServiceAssociationListMetadata) *NullableNetworkingV1NetworkLinkServiceAssociationListMetadata {
	return &NullableNetworkingV1NetworkLinkServiceAssociationListMetadata{value: val, isSet: true}
}

func (v NullableNetworkingV1NetworkLinkServiceAssociationListMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNetworkingV1NetworkLinkServiceAssociationListMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
