...
// checks if the CmkV2ClusterListMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CmkV2ClusterListMetadata{}

// CmkV2ClusterListMetadata struct for CmkV2ClusterListMetadata
type CmkV2ClusterListMetadata struct {
...
func (o *CmkV2ClusterListMetadata) HasFirst() bool {
	if o != nil && IsNil(o.First) {
		return true
	}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *CmkV2ClusterListMetadata) GetPrevOk() (*interface{}, bool) {
...
func (o CmkV2ClusterListMetadata) MarshalJSON() ([]byte, error) {
...
func (o CmkV2ClusterListMetadata) ToMap() (map[string]interface{}, error) {
...
type NullableCmkV2ClusterListMetadata struct {
	value *CmkV2ClusterListMetadata
	isSet bool
}

func (v NullableCmkV2ClusterListMetadata) Get() *CmkV2ClusterListMetadata {
	return v.value
}

func (v *NullableCmkV2ClusterListMetadata) Set(val *CmkV2ClusterListMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableCmkV2ClusterListMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableCmkV2ClusterListMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCmkV2ClusterListMetadata(val *CmkV2ClusterListMetadata) *NullableCmkV2ClusterListMetadata {
	return &NullableCmkV2ClusterListMetadata{value: val, isSet: true}
}

func (v NullableCmkV2ClusterListMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCmkV2ClusterListMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
