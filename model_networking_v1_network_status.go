...
// checks if the NetworkingV1NetworkStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NetworkingV1NetworkStatus{}
...
type NetworkingV1NetworkStatus struct {
	...
	Cloud *NetworkingV1NetworkStatusCloud `json:"cloud,omitempty"`
}
...
func (o *NetworkingV1NetworkStatus) GetZonalSubdomains() map[string]string {
	if o == nil || IsNil(o.ZonalSubdomains) {
...
func (o *NetworkingV1NetworkStatus) GetCloud() NetworkingV1NetworkStatusCloud {
	if o == nil || IsNil(o.Cloud) {
		var ret NetworkingV1NetworkStatusCloud
		return ret
	}
	return *o.Cloud
}
...
// and a boolean to check if the value has been set.
func (o *NetworkingV1NetworkStatus) GetCloudOk() (*NetworkingV1NetworkStatusCloud, bool) {
	if o == nil || IsNil(o.Cloud) {
		return nil, false
	}
	return o.Cloud, true
...
// SetCloud gets a reference to the given NetworkingV1NetworkStatusCloud and assigns it to the Cloud field.
func (o *NetworkingV1NetworkStatus) SetCloud(v NetworkingV1NetworkStatusCloud) {
	o.Cloud = &v
}
...
func (o NetworkingV1NetworkStatus) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	// skip: phase is readOnly
	// skip: supported_connection_types is readOnly
	// skip: active_connection_types is readOnly
	// skip: error_code is readOnly
	// skip: error_message is readOnly
	// skip: dns_domain is readOnly
	// skip: zonal_subdomains is readOnly
	if !IsNil(o.Cloud) {
