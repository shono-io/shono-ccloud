...
// checks if the NotificationsV1IntegrationListMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NotificationsV1IntegrationListMetadata{}

// NotificationsV1IntegrationListMetadata struct for NotificationsV1IntegrationListMetadata
type NotificationsV1IntegrationListMetadata struct {
...
func NewNotificationsV1IntegrationListMetadata() *NotificationsV1IntegrationListMetadata {
	this := NotificationsV1IntegrationListMetadata{}
	return &this
}
...
func (o *NotificationsV1IntegrationListMetadata) GetPrev() interface{} {
	if o == nil {
		var ret interface{}
		return ret
	}
...
func (o NotificationsV1IntegrationListMetadata) MarshalJSON() ([]byte, error) {
...
func (o NotificationsV1IntegrationListMetadata) ToMap() (map[string]interface{}, error) {
...
type NullableNotificationsV1IntegrationListMetadata struct {
	value *NotificationsV1IntegrationListMetadata
	isSet bool
}

func (v NullableNotificationsV1IntegrationListMetadata) Get() *NotificationsV1IntegrationListMetadata {
	return v.value
}

func (v *NullableNotificationsV1IntegrationListMetadata) Set(val *NotificationsV1IntegrationListMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableNotificationsV1IntegrationListMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableNotificationsV1IntegrationListMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNotificationsV1IntegrationListMetadata(val *NotificationsV1IntegrationListMetadata) *NullableNotificationsV1IntegrationListMetadata {
	return &NullableNotificationsV1IntegrationListMetadata{value: val, isSet: true}
}

func (v NullableNotificationsV1IntegrationListMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNotificationsV1IntegrationListMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
