...
// checks if the NetworkingV1NetworkLinkEndpoint type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NetworkingV1NetworkLinkEndpoint{}
...
func (o NetworkingV1NetworkLinkEndpoint) ToMap() (map[string]interface{}, error) {
