...
type ApiGetKafkaPartitionRequest struct {
	ctx context.Context
	ApiService *PartitionV3ApiService
	clusterId string
	topicName string
	partitionId int32
}

func (r ApiGetKafkaPartitionRequest) Execute() (*PartitionData, *http.Response, error) {
...
*/
func (a *PartitionV3ApiService) GetKafkaPartition(ctx context.Context, clusterId string, topicName string, partitionId int32) ApiGetKafkaPartitionRequest {
	return ApiGetKafkaPartitionRequest{
		ApiService: a,
		ctx: ctx,
		clusterId: clusterId,
...
func (a *PartitionV3ApiService) GetKafkaPartitionExecute(r ApiGetKafkaPartitionRequest) (*PartitionData, *http.Response, error) {
	var (
...
func (r ApiListKafkaPartitionsRequest) Execute() (*PartitionDataList, *http.Response, error) {
...
*/
func (a *PartitionV3ApiService) ListKafkaPartitions(ctx context.Context, clusterId string, topicName string) ApiListKafkaPartitionsRequest {
	return ApiListKafkaPartitionsRequest{
		ApiService: a,
		ctx: ctx,
		clusterId: clusterId,
...
func (a *PartitionV3ApiService) ListKafkaPartitionsExecute(r ApiListKafkaPartitionsRequest) (*PartitionDataList, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
