...
// checks if the CreateKafkaQuotasV1ClientQuotaRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateKafkaQuotasV1ClientQuotaRequest{}

// CreateKafkaQuotasV1ClientQuotaRequest struct for CreateKafkaQuotasV1ClientQuotaRequest
type CreateKafkaQuotasV1ClientQuotaRequest struct {
	...
	Spec CreateKafkaQuotasV1ClientQuotaRequestAllOf1Spec `json:"spec"`
}
...
func NewCreateKafkaQuotasV1ClientQuotaRequest(spec CreateKafkaQuotasV1ClientQuotaRequestAllOf1Spec) *CreateKafkaQuotasV1ClientQuotaRequest {
	this := CreateKafkaQuotasV1ClientQuotaRequest{}
	this.Spec = spec
	return &this
}
...
func (o *CreateKafkaQuotasV1ClientQuotaRequest) GetSpec() CreateKafkaQuotasV1ClientQuotaRequestAllOf1Spec {
	if o == nil {
		var ret CreateKafkaQuotasV1ClientQuotaRequestAllOf1Spec
		return ret
	}
...
func (o CreateKafkaQuotasV1ClientQuotaRequest) MarshalJSON() ([]byte, error) {
...
func (o CreateKafkaQuotasV1ClientQuotaRequest) ToMap() (map[string]interface{}, error) {
...
type NullableCreateKafkaQuotasV1ClientQuotaRequest struct {
	value *CreateKafkaQuotasV1ClientQuotaRequest
	isSet bool
}

func (v NullableCreateKafkaQuotasV1ClientQuotaRequest) Get() *CreateKafkaQuotasV1ClientQuotaRequest {
	return v.value
}

func (v *NullableCreateKafkaQuotasV1ClientQuotaRequest) Set(val *CreateKafkaQuotasV1ClientQuotaRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateKafkaQuotasV1ClientQuotaRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateKafkaQuotasV1ClientQuotaRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateKafkaQuotasV1ClientQuotaRequest(val *CreateKafkaQuotasV1ClientQuotaRequest) *NullableCreateKafkaQuotasV1ClientQuotaRequest {
	return &NullableCreateKafkaQuotasV1ClientQuotaRequest{value: val, isSet: true}
}

func (v NullableCreateKafkaQuotasV1ClientQuotaRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateKafkaQuotasV1ClientQuotaRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
