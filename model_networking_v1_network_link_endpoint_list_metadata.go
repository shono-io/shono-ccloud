...
// checks if the NetworkingV1NetworkLinkEndpointListMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NetworkingV1NetworkLinkEndpointListMetadata{}

// NetworkingV1NetworkLinkEndpointListMetadata struct for NetworkingV1NetworkLinkEndpointListMetadata
type NetworkingV1NetworkLinkEndpointListMetadata struct {
...
func NewNetworkingV1NetworkLinkEndpointListMetadata() *NetworkingV1NetworkLinkEndpointListMetadata {
	this := NetworkingV1NetworkLinkEndpointListMetadata{}
	return &this
}
...
func (o *NetworkingV1NetworkLinkEndpointListMetadata) SetFirst(v interface{}) {
	o.First = v
}
...
func (o *NetworkingV1NetworkLinkEndpointListMetadata) GetPrev() interface{} {
	if o == nil {
		var ret interface{}
		return ret
	}
...
func (o NetworkingV1NetworkLinkEndpointListMetadata) MarshalJSON() ([]byte, error) {
...
func (o NetworkingV1NetworkLinkEndpointListMetadata) ToMap() (map[string]interface{}, error) {
...
type NullableNetworkingV1NetworkLinkEndpointListMetadata struct {
	value *NetworkingV1NetworkLinkEndpointListMetadata
	isSet bool
}

func (v NullableNetworkingV1NetworkLinkEndpointListMetadata) Get() *NetworkingV1NetworkLinkEndpointListMetadata {
	return v.value
}

func (v *NullableNetworkingV1NetworkLinkEndpointListMetadata) Set(val *NetworkingV1NetworkLinkEndpointListMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableNetworkingV1NetworkLinkEndpointListMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableNetworkingV1NetworkLinkEndpointListMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNetworkingV1NetworkLinkEndpointListMetadata(val *NetworkingV1NetworkLinkEndpointListMetadata) *NullableNetworkingV1NetworkLinkEndpointListMetadata {
	return &NullableNetworkingV1NetworkLinkEndpointListMetadata{value: val, isSet: true}
}

func (v NullableNetworkingV1NetworkLinkEndpointListMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNetworkingV1NetworkLinkEndpointListMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
