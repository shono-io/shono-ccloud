...
// checks if the IamV2ApiKeySpec type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IamV2ApiKeySpec{}
...
type IamV2ApiKeySpec struct {
	...
	Owner *IamV2ApiKeySpecOwner `json:"owner,omitempty"`
	Resource NullableIamV2ApiKeySpecResource `json:"resource,omitempty"`
}
...
// SetOwner gets a reference to the given IamV2ApiKeySpecOwner and assigns it to the Owner field.
...
func (o *IamV2ApiKeySpec) GetResource() IamV2ApiKeySpecResource {
	if o == nil || IsNil(o.Resource.Get()) {
		var ret IamV2ApiKeySpecResource
		return ret
	}
...
// SetResource gets a reference to the given NullableIamV2ApiKeySpecResource and assigns it to the Resource field.
...
func (o IamV2ApiKeySpec) ToMap() (map[string]interface{}, error) {
