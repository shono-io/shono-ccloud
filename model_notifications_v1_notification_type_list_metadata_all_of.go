...
// checks if the NotificationsV1NotificationTypeListMetadataAllOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NotificationsV1NotificationTypeListMetadataAllOf{}

// NotificationsV1NotificationTypeListMetadataAllOf struct for NotificationsV1NotificationTypeListMetadataAllOf
type NotificationsV1NotificationTypeListMetadataAllOf struct {
...
func NewNotificationsV1NotificationTypeListMetadataAllOf() *NotificationsV1NotificationTypeListMetadataAllOf {
	this := NotificationsV1NotificationTypeListMetadataAllOf{}
	return &this
}
...
func (o NotificationsV1NotificationTypeListMetadataAllOf) MarshalJSON() ([]byte, error) {
...
func (o NotificationsV1NotificationTypeListMetadataAllOf) ToMap() (map[string]interface{}, error) {
...
type NullableNotificationsV1NotificationTypeListMetadataAllOf struct {
	value *NotificationsV1NotificationTypeListMetadataAllOf
	isSet bool
}

func (v NullableNotificationsV1NotificationTypeListMetadataAllOf) Get() *NotificationsV1NotificationTypeListMetadataAllOf {
	return v.value
}

func (v *NullableNotificationsV1NotificationTypeListMetadataAllOf) Set(val *NotificationsV1NotificationTypeListMetadataAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableNotificationsV1NotificationTypeListMetadataAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableNotificationsV1NotificationTypeListMetadataAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNotificationsV1NotificationTypeListMetadataAllOf(val *NotificationsV1NotificationTypeListMetadataAllOf) *NullableNotificationsV1NotificationTypeListMetadataAllOf {
	return &NullableNotificationsV1NotificationTypeListMetadataAllOf{value: val, isSet: true}
}

func (v NullableNotificationsV1NotificationTypeListMetadataAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNotificationsV1NotificationTypeListMetadataAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
