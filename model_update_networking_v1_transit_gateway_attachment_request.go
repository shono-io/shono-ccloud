...
// checks if the UpdateNetworkingV1TransitGatewayAttachmentRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateNetworkingV1TransitGatewayAttachmentRequest{}

// UpdateNetworkingV1TransitGatewayAttachmentRequest struct for UpdateNetworkingV1TransitGatewayAttachmentRequest
type UpdateNetworkingV1TransitGatewayAttachmentRequest struct {
	...
	Spec UpdateCmkV2ClusterRequestAllOfSpec `json:"spec"`
...
func NewUpdateNetworkingV1TransitGatewayAttachmentRequest(spec UpdateCmkV2ClusterRequestAllOfSpec) *UpdateNetworkingV1TransitGatewayAttachmentRequest {
	this := UpdateNetworkingV1TransitGatewayAttachmentRequest{}
	this.Spec = spec
	return &this
}
...
func (o *UpdateNetworkingV1TransitGatewayAttachmentRequest) GetSpec() UpdateCmkV2ClusterRequestAllOfSpec {
	if o == nil {
		var ret UpdateCmkV2ClusterRequestAllOfSpec
		return ret
	}
...
func (o *UpdateNetworkingV1TransitGatewayAttachmentRequest) SetSpec(v UpdateCmkV2ClusterRequestAllOfSpec) {
	o.Spec = v
}
...
func (o UpdateNetworkingV1TransitGatewayAttachmentRequest) MarshalJSON() ([]byte, error) {
...
func (o UpdateNetworkingV1TransitGatewayAttachmentRequest) ToMap() (map[string]interface{}, error) {
...
type NullableUpdateNetworkingV1TransitGatewayAttachmentRequest struct {
	value *UpdateNetworkingV1TransitGatewayAttachmentRequest
	isSet bool
}

func (v NullableUpdateNetworkingV1TransitGatewayAttachmentRequest) Get() *UpdateNetworkingV1TransitGatewayAttachmentRequest {
	return v.value
}

func (v *NullableUpdateNetworkingV1TransitGatewayAttachmentRequest) Set(val *UpdateNetworkingV1TransitGatewayAttachmentRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdateNetworkingV1TransitGatewayAttachmentRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableUpdateNetworkingV1TransitGatewayAttachmentRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpdateNetworkingV1TransitGatewayAttachmentRequest(val *UpdateNetworkingV1TransitGatewayAttachmentRequest) *NullableUpdateNetworkingV1TransitGatewayAttachmentRequest {
	return &NullableUpdateNetworkingV1TransitGatewayAttachmentRequest{value: val, isSet: true}
}

func (v NullableUpdateNetworkingV1TransitGatewayAttachmentRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpdateNetworkingV1TransitGatewayAttachmentRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
