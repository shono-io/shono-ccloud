...
// checks if the BrokerData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BrokerData{}
...
func (o BrokerData) ToMap() (map[string]interface{}, error) {
