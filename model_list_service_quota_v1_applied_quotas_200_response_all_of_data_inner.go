...
// checks if the ListServiceQuotaV1AppliedQuotas200ResponseAllOfDataInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListServiceQuotaV1AppliedQuotas200ResponseAllOfDataInner{}

// ListServiceQuotaV1AppliedQuotas200ResponseAllOfDataInner struct for ListServiceQuotaV1AppliedQuotas200ResponseAllOfDataInner
type ListServiceQuotaV1AppliedQuotas200ResponseAllOfDataInner struct {
...
// NewListServiceQuotaV1AppliedQuotas200ResponseAllOfDataInner instantiates a new ListServiceQuotaV1AppliedQuotas200ResponseAllOfDataInner object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewListServiceQuotaV1AppliedQuotas200ResponseAllOfDataInner() *ListServiceQuotaV1AppliedQuotas200ResponseAllOfDataInner {
	this := ListServiceQuotaV1AppliedQuotas200ResponseAllOfDataInner{}
	return &this
}

// NewListServiceQuotaV1AppliedQuotas200ResponseAllOfDataInnerWithDefaults instantiates a new ListServiceQuotaV1AppliedQuotas200ResponseAllOfDataInner object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewListServiceQuotaV1AppliedQuotas200ResponseAllOfDataInnerWithDefaults() *ListServiceQuotaV1AppliedQuotas200ResponseAllOfDataInner {
	this := ListServiceQuotaV1AppliedQuotas200ResponseAllOfDataInner{}
	return &this
}

// GetUser returns the User field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *ListServiceQuotaV1AppliedQuotas200ResponseAllOfDataInner) GetUser() interface{} {
	if o == nil {
		var ret interface{}
		return ret
	}
...
func (o *ListServiceQuotaV1AppliedQuotas200ResponseAllOfDataInner) GetUserOk() (*interface{}, bool) {
...
func (o *ListServiceQuotaV1AppliedQuotas200ResponseAllOfDataInner) HasUser() bool {
	if o != nil && IsNil(o.User) {
		return true
	}
...
func (o *ListServiceQuotaV1AppliedQuotas200ResponseAllOfDataInner) SetUser(v interface{}) {
	o.User = v
}

// GetOrganization returns the Organization field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *ListServiceQuotaV1AppliedQuotas200ResponseAllOfDataInner) GetOrganization() interface{} {
	if o == nil {
		var ret interface{}
		return ret
	}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *ListServiceQuotaV1AppliedQuotas200ResponseAllOfDataInner) GetOrganizationOk() (*interface{}, bool) {
...
func (o *ListServiceQuotaV1AppliedQuotas200ResponseAllOfDataInner) HasOrganization() bool {
	if o != nil && IsNil(o.Organization) {
		return true
	}
...
func (o *ListServiceQuotaV1AppliedQuotas200ResponseAllOfDataInner) SetOrganization(v interface{}) {
	o.Organization = v
}

// GetEnvironment returns the Environment field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *ListServiceQuotaV1AppliedQuotas200ResponseAllOfDataInner) GetEnvironment() interface{} {
	if o == nil {
		var ret interface{}
		return ret
	}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *ListServiceQuotaV1AppliedQuotas200ResponseAllOfDataInner) GetEnvironmentOk() (*interface{}, bool) {
...
func (o *ListServiceQuotaV1AppliedQuotas200ResponseAllOfDataInner) HasEnvironment() bool {
	if o != nil && IsNil(o.Environment) {
		return true
	}
...
func (o *ListServiceQuotaV1AppliedQuotas200ResponseAllOfDataInner) SetEnvironment(v interface{}) {
	o.Environment = v
}

// GetNetwork returns the Network field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *ListServiceQuotaV1AppliedQuotas200ResponseAllOfDataInner) GetNetwork() interface{} {
	if o == nil {
		var ret interface{}
		return ret
	}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *ListServiceQuotaV1AppliedQuotas200ResponseAllOfDataInner) GetNetworkOk() (*interface{}, bool) {
...
func (o *ListServiceQuotaV1AppliedQuotas200ResponseAllOfDataInner) HasNetwork() bool {
	if o != nil && IsNil(o.Network) {
		return true
	}
...
func (o *ListServiceQuotaV1AppliedQuotas200ResponseAllOfDataInner) SetNetwork(v interface{}) {
	o.Network = v
}

// GetKafkaCluster returns the KafkaCluster field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *ListServiceQuotaV1AppliedQuotas200ResponseAllOfDataInner) GetKafkaCluster() interface{} {
	if o == nil {
		var ret interface{}
		return ret
	}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *ListServiceQuotaV1AppliedQuotas200ResponseAllOfDataInner) GetKafkaClusterOk() (*interface{}, bool) {
	if o == nil || IsNil(o.KafkaCluster) {
		return nil, false
	}
...
func (o *ListServiceQuotaV1AppliedQuotas200ResponseAllOfDataInner) HasKafkaCluster() bool {
	if o != nil && IsNil(o.KafkaCluster) {
		return true
	}
...
// SetKafkaCluster gets a reference to the given interface{} and assigns it to the KafkaCluster field.
func (o *ListServiceQuotaV1AppliedQuotas200ResponseAllOfDataInner) SetKafkaCluster(v interface{}) {
	o.KafkaCluster = v
}

func (o ListServiceQuotaV1AppliedQuotas200ResponseAllOfDataInner) MarshalJSON() ([]byte, error) {
...
func (o ListServiceQuotaV1AppliedQuotas200ResponseAllOfDataInner) ToMap() (map[string]interface{}, error) {
...
type NullableListServiceQuotaV1AppliedQuotas200ResponseAllOfDataInner struct {
	value *ListServiceQuotaV1AppliedQuotas200ResponseAllOfDataInner
	isSet bool
}

func (v NullableListServiceQuotaV1AppliedQuotas200ResponseAllOfDataInner) Get() *ListServiceQuotaV1AppliedQuotas200ResponseAllOfDataInner {
	return v.value
}

func (v *NullableListServiceQuotaV1AppliedQuotas200ResponseAllOfDataInner) Set(val *ListServiceQuotaV1AppliedQuotas200ResponseAllOfDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableListServiceQuotaV1AppliedQuotas200ResponseAllOfDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableListServiceQuotaV1AppliedQuotas200ResponseAllOfDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListServiceQuotaV1AppliedQuotas200ResponseAllOfDataInner(val *ListServiceQuotaV1AppliedQuotas200ResponseAllOfDataInner) *NullableListServiceQuotaV1AppliedQuotas200ResponseAllOfDataInner {
	return &NullableListServiceQuotaV1AppliedQuotas200ResponseAllOfDataInner{value: val, isSet: true}
}

func (v NullableListServiceQuotaV1AppliedQuotas200ResponseAllOfDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListServiceQuotaV1AppliedQuotas200ResponseAllOfDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
