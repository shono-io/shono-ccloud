...
// checks if the NetworkingV1PrivateLinkAccess type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NetworkingV1PrivateLinkAccess{}
...
func (o *NetworkingV1PrivateLinkAccess) GetMetadata() NetworkingV1PrivateLinkAccessMetadata {
...
// and a boolean to check if the value has been set.
func (o *NetworkingV1PrivateLinkAccess) GetMetadataOk() (*NetworkingV1PrivateLinkAccessMetadata, bool) {
	if o == nil || IsNil(o.Metadata) {
		return nil, false
	}
...
func (o *NetworkingV1PrivateLinkAccess) SetMetadata(v NetworkingV1PrivateLinkAccessMetadata) {
	o.Metadata = &v
}
...
func (o NetworkingV1PrivateLinkAccess) ToMap() (map[string]interface{}, error) {
