...
// checks if the OrgV2EnvironmentMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OrgV2EnvironmentMetadata{}

// OrgV2EnvironmentMetadata struct for OrgV2EnvironmentMetadata
type OrgV2EnvironmentMetadata struct {
...
func (o OrgV2EnvironmentMetadata) MarshalJSON() ([]byte, error) {
...
func (o OrgV2EnvironmentMetadata) ToMap() (map[string]interface{}, error) {
...
type NullableOrgV2EnvironmentMetadata struct {
	value *OrgV2EnvironmentMetadata
	isSet bool
}

func (v NullableOrgV2EnvironmentMetadata) Get() *OrgV2EnvironmentMetadata {
	return v.value
}

func (v *NullableOrgV2EnvironmentMetadata) Set(val *OrgV2EnvironmentMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableOrgV2EnvironmentMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableOrgV2EnvironmentMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOrgV2EnvironmentMetadata(val *OrgV2EnvironmentMetadata) *NullableOrgV2EnvironmentMetadata {
	return &NullableOrgV2EnvironmentMetadata{value: val, isSet: true}
}

func (v NullableOrgV2EnvironmentMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOrgV2EnvironmentMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
