...
// checks if the NetworkingV1NetworkLinkServiceAssociationListDataInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NetworkingV1NetworkLinkServiceAssociationListDataInner{}

// NetworkingV1NetworkLinkServiceAssociationListDataInner struct for NetworkingV1NetworkLinkServiceAssociationListDataInner
type NetworkingV1NetworkLinkServiceAssociationListDataInner struct {
	...
	Id string `json:"id"`
	Metadata NetworkingV1NetworkLinkServiceAssociationMetadata `json:"metadata"`
...
func NewNetworkingV1NetworkLinkServiceAssociationListDataInner(id string, metadata NetworkingV1NetworkLinkServiceAssociationMetadata, spec map[string]interface{}, status NetworkingV1NetworkLinkServiceAssociationStatus) *NetworkingV1NetworkLinkServiceAssociationListDataInner {
	this := NetworkingV1NetworkLinkServiceAssociationListDataInner{}
	this.Id = id
...
func (o NetworkingV1NetworkLinkServiceAssociationListDataInner) MarshalJSON() ([]byte, error) {
...
func (o NetworkingV1NetworkLinkServiceAssociationListDataInner) ToMap() (map[string]interface{}, error) {
...
type NullableNetworkingV1NetworkLinkServiceAssociationListDataInner struct {
	value *NetworkingV1NetworkLinkServiceAssociationListDataInner
	isSet bool
}

func (v NullableNetworkingV1NetworkLinkServiceAssociationListDataInner) Get() *NetworkingV1NetworkLinkServiceAssociationListDataInner {
	return v.value
}

func (v *NullableNetworkingV1NetworkLinkServiceAssociationListDataInner) Set(val *NetworkingV1NetworkLinkServiceAssociationListDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableNetworkingV1NetworkLinkServiceAssociationListDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableNetworkingV1NetworkLinkServiceAssociationListDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNetworkingV1NetworkLinkServiceAssociationListDataInner(val *NetworkingV1NetworkLinkServiceAssociationListDataInner) *NullableNetworkingV1NetworkLinkServiceAssociationListDataInner {
	return &NullableNetworkingV1NetworkLinkServiceAssociationListDataInner{value: val, isSet: true}
}

func (v NullableNetworkingV1NetworkLinkServiceAssociationListDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNetworkingV1NetworkLinkServiceAssociationListDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
