...
// checks if the IamV2IdentityProviderListDataInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IamV2IdentityProviderListDataInner{}

// IamV2IdentityProviderListDataInner struct for IamV2IdentityProviderListDataInner
type IamV2IdentityProviderListDataInner struct {
	...
	Id string `json:"id"`
	Metadata IamV2IdentityProviderMetadata `json:"metadata"`
...
func NewIamV2IdentityProviderListDataInner(id string, metadata IamV2IdentityProviderMetadata, displayName string, description string, state string, issuer string, jwksUri string) *IamV2IdentityProviderListDataInner {
	this := IamV2IdentityProviderListDataInner{}
	this.Id = id
...
func (o IamV2IdentityProviderListDataInner) MarshalJSON() ([]byte, error) {
...
func (o IamV2IdentityProviderListDataInner) ToMap() (map[string]interface{}, error) {
...
type NullableIamV2IdentityProviderListDataInner struct {
	value *IamV2IdentityProviderListDataInner
	isSet bool
}

func (v NullableIamV2IdentityProviderListDataInner) Get() *IamV2IdentityProviderListDataInner {
	return v.value
}

func (v *NullableIamV2IdentityProviderListDataInner) Set(val *IamV2IdentityProviderListDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableIamV2IdentityProviderListDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableIamV2IdentityProviderListDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIamV2IdentityProviderListDataInner(val *IamV2IdentityProviderListDataInner) *NullableIamV2IdentityProviderListDataInner {
	return &NullableIamV2IdentityProviderListDataInner{value: val, isSet: true}
}

func (v NullableIamV2IdentityProviderListDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIamV2IdentityProviderListDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
