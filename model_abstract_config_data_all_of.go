...
// checks if the AbstractConfigDataAllOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AbstractConfigDataAllOf{}
...
func (o AbstractConfigDataAllOf) ToMap() (map[string]interface{}, error) {
