...
// checks if the OrgV2EnvironmentListMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OrgV2EnvironmentListMetadata{}

// OrgV2EnvironmentListMetadata struct for OrgV2EnvironmentListMetadata
type OrgV2EnvironmentListMetadata struct {
...
func NewOrgV2EnvironmentListMetadata() *OrgV2EnvironmentListMetadata {
	this := OrgV2EnvironmentListMetadata{}
	return &this
}
...
func (o *OrgV2EnvironmentListMetadata) HasFirst() bool {
	if o != nil && IsNil(o.First) {
		return true
	}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *OrgV2EnvironmentListMetadata) GetPrevOk() (*interface{}, bool) {
...
func (o OrgV2EnvironmentListMetadata) MarshalJSON() ([]byte, error) {
...
func (o OrgV2EnvironmentListMetadata) ToMap() (map[string]interface{}, error) {
...
type NullableOrgV2EnvironmentListMetadata struct {
	value *OrgV2EnvironmentListMetadata
	isSet bool
}

func (v NullableOrgV2EnvironmentListMetadata) Get() *OrgV2EnvironmentListMetadata {
	return v.value
}

func (v *NullableOrgV2EnvironmentListMetadata) Set(val *OrgV2EnvironmentListMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableOrgV2EnvironmentListMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableOrgV2EnvironmentListMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOrgV2EnvironmentListMetadata(val *OrgV2EnvironmentListMetadata) *NullableOrgV2EnvironmentListMetadata {
	return &NullableOrgV2EnvironmentListMetadata{value: val, isSet: true}
}

func (v NullableOrgV2EnvironmentListMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOrgV2EnvironmentListMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
