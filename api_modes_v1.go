...
type ApiDeleteSubjectModeRequest struct {
	ctx context.Context
	ApiService *ModesV1ApiService
	subject string
}

func (r ApiDeleteSubjectModeRequest) Execute() (*Mode, *http.Response, error) {
...
*/
func (a *ModesV1ApiService) DeleteSubjectMode(ctx context.Context, subject string) ApiDeleteSubjectModeRequest {
	return ApiDeleteSubjectModeRequest{
		ApiService: a,
		ctx: ctx,
		subject: subject,
...
//  @return Mode
func (a *ModesV1ApiService) DeleteSubjectModeExecute(r ApiDeleteSubjectModeRequest) (*Mode, *http.Response, error) {
	var (
...
func (r ApiGetModeRequest) Execute() (*Mode, *http.Response, error) {
...
*/
func (a *ModesV1ApiService) GetMode(ctx context.Context, subject string) ApiGetModeRequest {
	return ApiGetModeRequest{
		ApiService: a,
		ctx: ctx,
		subject: subject,
...
// Execute executes the request
//  @return Mode
func (a *ModesV1ApiService) GetModeExecute(r ApiGetModeRequest) (*Mode, *http.Response, error) {
	var (
...
func (r ApiGetTopLevelModeRequest) Execute() (*Mode, *http.Response, error) {
...
*/
func (a *ModesV1ApiService) GetTopLevelMode(ctx context.Context) ApiGetTopLevelModeRequest {
	return ApiGetTopLevelModeRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return Mode
func (a *ModesV1ApiService) GetTopLevelModeExecute(r ApiGetTopLevelModeRequest) (*Mode, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r ApiUpdateModeRequest) Execute() (*ModeUpdateRequest, *http.Response, error) {
...
*/
func (a *ModesV1ApiService) UpdateMode(ctx context.Context, subject string) ApiUpdateModeRequest {
	return ApiUpdateModeRequest{
		ApiService: a,
		ctx: ctx,
		subject: subject,
...
func (a *ModesV1ApiService) UpdateModeExecute(r ApiUpdateModeRequest) (*ModeUpdateRequest, *http.Response, error) {
	var (
...
func (r ApiUpdateTopLevelModeRequest) Execute() (*ModeUpdateRequest, *http.Response, error) {
...
*/
func (a *ModesV1ApiService) UpdateTopLevelMode(ctx context.Context) ApiUpdateTopLevelModeRequest {
	return ApiUpdateTopLevelModeRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return ModeUpdateRequest
func (a *ModesV1ApiService) UpdateTopLevelModeExecute(r ApiUpdateTopLevelModeRequest) (*ModeUpdateRequest, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
