...
// checks if the IamV2ServiceAccountUpdate type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IamV2ServiceAccountUpdate{}
...
func (o IamV2ServiceAccountUpdate) ToMap() (map[string]interface{}, error) {
