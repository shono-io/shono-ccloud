...
// checks if the IamV2ServiceAccount type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IamV2ServiceAccount{}
...
func (o IamV2ServiceAccount) ToMap() (map[string]interface{}, error) {
