...
// checks if the IamV2UserUpdate type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IamV2UserUpdate{}
...
func (o IamV2UserUpdate) ToMap() (map[string]interface{}, error) {
