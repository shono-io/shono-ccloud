...
// checks if the IamV2IdentityPoolListMetadata type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IamV2IdentityPoolListMetadata{}

// IamV2IdentityPoolListMetadata struct for IamV2IdentityPoolListMetadata
type IamV2IdentityPoolListMetadata struct {
...
func NewIamV2IdentityPoolListMetadata() *IamV2IdentityPoolListMetadata {
	this := IamV2IdentityPoolListMetadata{}
	return &this
}
...
func (o IamV2IdentityPoolListMetadata) MarshalJSON() ([]byte, error) {
...
func (o IamV2IdentityPoolListMetadata) ToMap() (map[string]interface{}, error) {
...
type NullableIamV2IdentityPoolListMetadata struct {
	value *IamV2IdentityPoolListMetadata
	isSet bool
}

func (v NullableIamV2IdentityPoolListMetadata) Get() *IamV2IdentityPoolListMetadata {
	return v.value
}

func (v *NullableIamV2IdentityPoolListMetadata) Set(val *IamV2IdentityPoolListMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableIamV2IdentityPoolListMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableIamV2IdentityPoolListMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIamV2IdentityPoolListMetadata(val *IamV2IdentityPoolListMetadata) *NullableIamV2IdentityPoolListMetadata {
	return &NullableIamV2IdentityPoolListMetadata{value: val, isSet: true}
}

func (v NullableIamV2IdentityPoolListMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIamV2IdentityPoolListMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true
