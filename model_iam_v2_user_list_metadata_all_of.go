...
// checks if the IamV2UserListMetadataAllOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IamV2UserListMetadataAllOf{}

// IamV2UserListMetadataAllOf struct for IamV2UserListMetadataAllOf
type IamV2UserListMetadataAllOf struct {
...
func NewIamV2UserListMetadataAllOf() *IamV2UserListMetadataAllOf {
	this := IamV2UserListMetadataAllOf{}
	return &this
}
...
func (o IamV2UserListMetadataAllOf) MarshalJSON() ([]byte, error) {
...
func (o IamV2UserListMetadataAllOf) ToMap() (map[string]interface{}, error) {
...
type NullableIamV2UserListMetadataAllOf struct {
	value *IamV2UserListMetadataAllOf
	isSet bool
}

func (v NullableIamV2UserListMetadataAllOf) Get() *IamV2UserListMetadataAllOf {
	return v.value
}

func (v *NullableIamV2UserListMetadataAllOf) Set(val *IamV2UserListMetadataAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableIamV2UserListMetadataAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableIamV2UserListMetadataAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIamV2UserListMetadataAllOf(val *IamV2UserListMetadataAllOf) *NullableIamV2UserListMetadataAllOf {
	return &NullableIamV2UserListMetadataAllOf{value: val, isSet: true}
}

func (v NullableIamV2UserListMetadataAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIamV2UserListMetadataAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
