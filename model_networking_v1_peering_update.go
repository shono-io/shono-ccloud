...
// checks if the NetworkingV1PeeringUpdate type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NetworkingV1PeeringUpdate{}
...
func (o NetworkingV1PeeringUpdate) ToMap() (map[string]interface{}, error) {
