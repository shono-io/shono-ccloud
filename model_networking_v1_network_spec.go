...
// checks if the NetworkingV1NetworkSpec type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NetworkingV1NetworkSpec{}
...
type NetworkingV1NetworkSpec struct {
	...
	DnsConfig *NetworkingV1NetworkSpecDnsConfig `json:"dns_config,omitempty"`
...
func (o *NetworkingV1NetworkSpec) GetDnsConfig() NetworkingV1NetworkSpecDnsConfig {
	if o == nil || IsNil(o.DnsConfig) {
		var ret NetworkingV1NetworkSpecDnsConfig
		return ret
	}
	return *o.DnsConfig
}
...
// SetDnsConfig gets a reference to the given NetworkingV1NetworkSpecDnsConfig and assigns it to the DnsConfig field.
...
func (o NetworkingV1NetworkSpec) ToMap() (map[string]interface{}, error) {
