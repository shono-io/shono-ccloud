...
// checks if the SrcmV2RegionListMetadataAllOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SrcmV2RegionListMetadataAllOf{}

// SrcmV2RegionListMetadataAllOf struct for SrcmV2RegionListMetadataAllOf
type SrcmV2RegionListMetadataAllOf struct {
...
func NewSrcmV2RegionListMetadataAllOf() *SrcmV2RegionListMetadataAllOf {
	this := SrcmV2RegionListMetadataAllOf{}
	return &this
}
...
func (o SrcmV2RegionListMetadataAllOf) MarshalJSON() ([]byte, error) {
...
func (o SrcmV2RegionListMetadataAllOf) ToMap() (map[string]interface{}, error) {
...
type NullableSrcmV2RegionListMetadataAllOf struct {
	value *SrcmV2RegionListMetadataAllOf
	isSet bool
}

func (v NullableSrcmV2RegionListMetadataAllOf) Get() *SrcmV2RegionListMetadataAllOf {
	return v.value
}

func (v *NullableSrcmV2RegionListMetadataAllOf) Set(val *SrcmV2RegionListMetadataAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableSrcmV2RegionListMetadataAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableSrcmV2RegionListMetadataAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSrcmV2RegionListMetadataAllOf(val *SrcmV2RegionListMetadataAllOf) *NullableSrcmV2RegionListMetadataAllOf {
	return &NullableSrcmV2RegionListMetadataAllOf{value: val, isSet: true}
}

func (v NullableSrcmV2RegionListMetadataAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSrcmV2RegionListMetadataAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
