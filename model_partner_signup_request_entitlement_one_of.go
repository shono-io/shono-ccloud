...
// checks if the PartnerSignupRequestEntitlementOneOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PartnerSignupRequestEntitlementOneOf{}

// PartnerSignupRequestEntitlementOneOf struct for PartnerSignupRequestEntitlementOneOf
type PartnerSignupRequestEntitlementOneOf struct {
	...
	Organization *PartnerV2EntitlementOrganization `json:"organization,omitempty"`
}
...
func NewPartnerSignupRequestEntitlementOneOf(externalId string, name string, planId string, productId string) *PartnerSignupRequestEntitlementOneOf {
	this := PartnerSignupRequestEntitlementOneOf{}
...
func (o *PartnerSignupRequestEntitlementOneOf) GetOrganization() PartnerV2EntitlementOrganization {
	if o == nil || IsNil(o.Organization) {
		var ret PartnerV2EntitlementOrganization
		return ret
	}
...
// SetOrganization gets a reference to the given PartnerV2EntitlementOrganization and assigns it to the Organization field.
func (o *PartnerSignupRequestEntitlementOneOf) SetOrganization(v PartnerV2EntitlementOrganization) {
	o.Organization = &v
}

func (o PartnerSignupRequestEntitlementOneOf) MarshalJSON() ([]byte, error) {
...
func (o PartnerSignupRequestEntitlementOneOf) ToMap() (map[string]interface{}, error) {
...
type NullablePartnerSignupRequestEntitlementOneOf struct {
	value *PartnerSignupRequestEntitlementOneOf
	isSet bool
}

func (v NullablePartnerSignupRequestEntitlementOneOf) Get() *PartnerSignupRequestEntitlementOneOf {
	return v.value
}

func (v *NullablePartnerSignupRequestEntitlementOneOf) Set(val *PartnerSignupRequestEntitlementOneOf) {
	v.value = val
	v.isSet = true
}

func (v NullablePartnerSignupRequestEntitlementOneOf) IsSet() bool {
	return v.isSet
}

func (v *NullablePartnerSignupRequestEntitlementOneOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePartnerSignupRequestEntitlementOneOf(val *PartnerSignupRequestEntitlementOneOf) *NullablePartnerSignupRequestEntitlementOneOf {
	return &NullablePartnerSignupRequestEntitlementOneOf{value: val, isSet: true}
}

func (v NullablePartnerSignupRequestEntitlementOneOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePartnerSignupRequestEntitlementOneOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
